...
fn build_prompt(content: &str, locale: &str, locales: &Locales) -> String {
    ...
    lines.push("14. Inside [app-screenshot-start ... app-screenshot-end], the alt= attribute is the accessible description of the image. TRANSLATE its text like title=, keep it on the block, and escape any apostrophe in the translated value with a backslash.".to_string());
    lines.push(String::new());
