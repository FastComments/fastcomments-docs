...
Als je in de EU bent, moet je aan de client-widgets doorgeven in welke regio je zit. Zie [examples/example-eu](https://github.com/FastComments/fastcomments-react/blob/master/examples/example-eu/src/App.tsx);
