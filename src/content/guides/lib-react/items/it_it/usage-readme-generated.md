...
Se ti trovi nell'UE, vorrai indicare ai widget client in quale regione ti trovi. Vedi [examples/example-eu](https://github.com/FastComments/fastcomments-react/blob/master/examples/example-eu/src/App.tsx);
