...
CSV datoteka zakazanih komentara podrzava sljedece stupce:
...
Trebat ce vam stupac Parent ID ako zelite podrzati automatizirane ugniježdene odgovore.
...
3. Morate definirati ID. Mozete jednostavno koristiti rastuci identifikatore poput 1, 2, 3, 4, 5.
4. Ako zelite koristiti ugniježdene odgovore, jednostavno postavite vrijednost stupca `Parent ID` na `ID` drugog komentara.
...
6. Polje `Avatar`, ako se koristi, mora biti javno dostupna slika. Bit ce kopirana i posluzena s naseg CDN-a.
