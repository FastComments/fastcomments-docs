...
Враћа: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_sso_user_api_response.go)

## Примјер

[inline-code-attrs-start title = 'PatchSSOUser Примјер'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (опционо)
	...
	// одговор од `PatchSSOUser`: PatchSSOUserAPIResponse
