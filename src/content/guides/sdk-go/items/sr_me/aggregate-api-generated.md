...
Vraća: [`AggregateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_aggregate_response.go)
...
func main() {
	...
	// odgovor od `Aggregate`: AggregateResponse
