...
[inline-code-attrs-start title = 'DeleteTenant Примјер'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (опционо)
	...
	// одговор од `DeleteTenant`: APIEmptyResponse
