...
Враћа: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_adjust_votes_response.go)

## Примјер

[inline-code-attrs-start title = 'PostAdjustCommentVotes Примјер'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// одговор са `PostAdjustCommentVotes`: AdjustVotesResponse
