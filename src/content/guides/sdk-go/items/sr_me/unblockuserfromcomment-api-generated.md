...
Враћа: [`UnBlockCommentPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_un_block_comment_public_200_response.go)

## Примјер

[inline-code-attrs-start title = 'Примјер UnBlockUserFromComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// одговор са `UnBlockUserFromComment`: UnBlockCommentPublic200Response
