...
Враћа: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_create_user_badge_response.go)
...
func main() {
	...
	// одговор од `CreateUserBadge`: APICreateUserBadgeResponse
