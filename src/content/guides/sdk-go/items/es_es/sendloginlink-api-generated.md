...
[inline-code-attrs-start title = 'Ejemplo de SendLoginLink'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  (opcional)
	...
	// respuesta de `SendLoginLink`: FlagCommentPublic200Response
