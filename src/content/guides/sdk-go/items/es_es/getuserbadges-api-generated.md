...
Devuelve: [`GetUserBadges200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_badges_200_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de GetUserBadges'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	badgeId := "badgeId_example" // string |  (opcional)
	type_ := float64(1.2) // float64 |  (opcional)
	displayedOnComments := true // bool |  (opcional)
	...
	// respuesta de `GetUserBadges`: GetUserBadges200Response
