...
[inline-code-attrs-start title = 'Ejemplo PostCommentsByIds'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error al llamar a `ModerationAPI.PostCommentsByIds``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Respuesta HTTP completa: %v\n", r)
	}
	// respuesta de `PostCommentsByIds`: ModerationAPIChildCommentsResponse
	fmt.Fprintf(os.Stdout, "Respuesta de `ModerationAPI.PostCommentsByIds`: %v\n", resp)
}
[inline-code-end]