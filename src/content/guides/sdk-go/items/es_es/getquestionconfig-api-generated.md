...
Devuelve: [`GetQuestionConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_config_response.go)
...
func main() {
	...
	// respuesta de `GetQuestionConfig`: GetQuestionConfigResponse
