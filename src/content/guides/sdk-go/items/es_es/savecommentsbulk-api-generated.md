...
Devuelve: [`[]SaveCommentsBulkResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_save_comments_bulk_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de SaveCommentsBulk'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `SaveCommentsBulk`: []SaveCommentsBulkResponse
