...
Devuelve: [`AggregateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_aggregate_response.go)
...
func main() {
	...
	// respuesta de `Aggregate`: AggregateResponse
