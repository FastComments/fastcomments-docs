...
Devuelve: [`APIEmptySuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_empty_success_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de UpdateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `UpdateUserBadge`: APIEmptySuccessResponse
