...
[inline-code-attrs-start title = 'Ejemplo de PostSetCommentSpamStatus'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	permNotSpam := true // bool |  (opcional)
	...
	// respuesta de `PostSetCommentSpamStatus`: APIEmptyResponse
