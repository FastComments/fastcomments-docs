...
Devuelve: [`GetUserPresenceStatusesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_presence_statuses_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de GetUserPresenceStatuses'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `GetUserPresenceStatuses`: GetUserPresenceStatusesResponse
