...
[inline-code-attrs-start title = 'Ejemplo de DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (opcional)
	...
	// respuesta de `DeleteTenant`: FlagCommentPublic200Response
