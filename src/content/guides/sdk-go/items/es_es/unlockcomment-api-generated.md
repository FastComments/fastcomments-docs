...
Devuelve: [`LockComment200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_lock_comment_200_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de UnLockComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `UnLockComment`: LockComment200Response
