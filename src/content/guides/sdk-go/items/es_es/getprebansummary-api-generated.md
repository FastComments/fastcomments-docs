...
Devuelve: [`PreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_pre_ban_summary.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de GetPreBanSummary'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `GetPreBanSummary`: PreBanSummary
