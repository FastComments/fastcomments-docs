...
Devuelve: [`CreateFeedPostResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_post_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de CreateFeedPostPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `CreateFeedPostPublic`: CreateFeedPostResponse
