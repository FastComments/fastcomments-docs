...
Devuelve: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_200_response.go)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de CreateTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respuesta de `CreateTenant`: CreateTenant200Response
