...
Devuelve: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_response.go)
...
func main() {
	...
	// respuesta de `CreateTenant`: CreateTenantResponse
