...
Vrača: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Primer

[inline-code-attrs-start title = 'Primer AddDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odgovor iz `AddDomainConfig`: AddDomainConfig200Response
