...
Vrača: [`GetHashTagsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_hash_tags_response.go)
...
func main() {
	...
	// odgovor iz `GetHashTags`: GetHashTagsResponse
