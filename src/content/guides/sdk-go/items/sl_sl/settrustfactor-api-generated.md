...
Vrne: [`SetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_user_trust_factor_response.go)

## Primer

[inline-code-attrs-start title = 'SetTrustFactor Primer'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	trustFactor := "trustFactor_example" // string |  (neobvezno)
