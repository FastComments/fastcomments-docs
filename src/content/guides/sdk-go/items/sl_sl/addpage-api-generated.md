...
Vrne: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)
...
func main() {
	...
	// odgovor iz `AddPage`: AddPageAPIResponse
