...
Vrača: [`GetQuestionResultsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_results_response.go)
...
func main() {
	...
	startDate := "startDate_example" // string |  (neobvezno)
	questionId := "questionId_example" // string |  (neobvezno)
	questionIds := "questionIds_example" // string |  (neobvezno)
