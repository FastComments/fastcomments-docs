...
| domainToUpdate | string | pot | Da |  |

## Odgovor

Vrne: [`GetDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_domain_config_200_response.go)

## Primer

[inline-code-attrs-start title = 'Primer PatchDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odgovor iz `PatchDomainConfig`: GetDomainConfig200Response
