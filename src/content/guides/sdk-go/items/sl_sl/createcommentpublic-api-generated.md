...
Vrne: [`SaveCommentsResponseWithPresence`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_save_comments_response_with_presence.go)
...
func main() {
	...
	// odgovor iz `CreateCommentPublic`: SaveCommentsResponseWithPresence
