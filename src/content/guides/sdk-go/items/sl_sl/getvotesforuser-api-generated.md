...
Vrača: [`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_votes_for_user_response.go)
...
func main() {
	...
	// odgovor iz `GetVotesForUser`: GetVotesForUserResponse
