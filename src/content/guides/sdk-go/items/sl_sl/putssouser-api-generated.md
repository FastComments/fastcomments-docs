...
Vrne: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## Primer

[inline-code-attrs-start title = 'Primer PutSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (neobvezno)
	...
	// odgovor od `PutSSOUser`: PutSSOUserAPIResponse
