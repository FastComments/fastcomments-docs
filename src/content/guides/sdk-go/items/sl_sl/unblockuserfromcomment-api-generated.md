...
Vrne: [`UnblockSuccess`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_unblock_success.go)
...
func main() {
	...
	// odgovor iz `UnBlockUserFromComment`: UnblockSuccess
