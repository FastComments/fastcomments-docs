...
Vrača: [`SetCommentApprovedResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_comment_approved_response.go)
...
func main() {
	...
	// odgovor iz `PostSetCommentApprovalStatus`: SetCommentApprovedResponse
