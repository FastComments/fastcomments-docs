...
Vrne: [`CreateFeedPostResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_post_response.go)
...
func main() {
	...
	// odgovor iz `CreateFeedPostPublic`: CreateFeedPostResponse
