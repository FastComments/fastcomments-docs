...
Vrača: [`GetSSOUsersResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_users_response.go)
...
func main() {
	...
	// odgovor iz `GetSSOUsers`: GetSSOUsersResponse
