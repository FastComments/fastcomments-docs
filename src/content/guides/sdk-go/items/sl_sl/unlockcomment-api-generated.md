...
Vrača: [`LockComment200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_lock_comment_200_response.go)

## Primer

[inline-code-attrs-start title = 'UnLockComment Primer'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odgovor iz `UnLockComment`: LockComment200Response
