...
Gibt zurück: [`GetAuditLogsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_audit_logs_response.go)

## Beispiel

[inline-code-attrs-start title = 'GetAuditLogs Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `GetAuditLogs`: GetAuditLogsResponse
