...
Gibt zurück: [`GetUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_response.go)
...
func main() {
	...
	// Antwort von `GetUser`: GetUserResponse
