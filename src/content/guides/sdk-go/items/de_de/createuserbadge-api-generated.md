...
Gibt zurück: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_user_badge_200_response.go)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für CreateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `CreateUserBadge`: CreateUserBadge200Response
