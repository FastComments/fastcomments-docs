...
Gibt zurück: [`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_hash_tag_response.go)
...
func main() {
	...
	// Antwort von `AddHashTag`: CreateHashTagResponse
