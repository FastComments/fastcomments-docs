...
Gibt zurück: [`BlockFromCommentPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_block_from_comment_public_200_response.go)

## Beispiel

[inline-code-attrs-start title = 'BlockUserFromComment Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `BlockUserFromComment`: BlockFromCommentPublic200Response
