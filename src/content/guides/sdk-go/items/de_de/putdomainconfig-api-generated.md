...
Gibt zurück: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_domain_config_response.go)

## Beispiel

[inline-code-attrs-start title = 'PutDomainConfig Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `PutDomainConfig`: PutDomainConfigResponse
