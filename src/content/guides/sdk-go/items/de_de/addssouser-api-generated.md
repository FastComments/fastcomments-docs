...
Gibt zurück: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)

## Beispiel

[inline-code-attrs-start title = 'AddSSOUser Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `AddSSOUser`: AddSSOUserAPIResponse
