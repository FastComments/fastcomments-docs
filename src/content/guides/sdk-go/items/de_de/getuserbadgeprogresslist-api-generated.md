...
Gibt zurück: [`APIGetUserBadgeProgressListResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_get_user_badge_progress_list_response.go)

## Beispiel

[inline-code-attrs-start title = 'GetUserBadgeProgressList Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `GetUserBadgeProgressList`: APIGetUserBadgeProgressListResponse
