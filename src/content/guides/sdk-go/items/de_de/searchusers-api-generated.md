...
Gibt zurück: [`SearchUsersResult`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_search_users_result.go)
...
func main() {
	...
	// Antwort von `SearchUsers`: SearchUsersResult
