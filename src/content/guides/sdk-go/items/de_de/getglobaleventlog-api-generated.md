...
Gibt zurück: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)
...
func main() {
	...
	// Antwort von `GetGlobalEventLog`: GetEventLogResponse
