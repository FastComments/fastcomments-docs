...
Gibt zurück: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_pre_ban_summary.go)

## Beispiel

[inline-code-attrs-start title = 'PostBulkPreBanSummary Beispiel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `PostBulkPreBanSummary`: BulkPreBanSummary
