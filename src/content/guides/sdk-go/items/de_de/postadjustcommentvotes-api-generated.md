...
Gibt zurück: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_adjust_votes_response.go)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für PostAdjustCommentVotes'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Antwort von `PostAdjustCommentVotes`: AdjustVotesResponse
