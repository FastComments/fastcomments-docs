...
[inline-code-attrs-start title = 'Пример CreateV2PageReact'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	title := "title_example" // string |  (необавезно)
	...
	// одговор од `CreateV2PageReact`: CreateV1PageReact
