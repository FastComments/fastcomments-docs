...
Враћа: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)
...
func main() {
	...
	// одговор од `AddSSOUser`: AddSSOUserAPIResponse
