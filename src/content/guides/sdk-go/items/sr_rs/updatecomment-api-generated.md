...
[inline-code-attrs-start title = 'Пример UpdateComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	contextUserId := "contextUserId_example" // string |  (опционално)
	...
	// одговор са `UpdateComment`: FlagCommentPublic200Response
