...
Враћа: [`DeleteDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_domain_config_response.go)
...
func main() {
	...
	// одговор од `DeleteDomainConfig`: DeleteDomainConfigResponse
