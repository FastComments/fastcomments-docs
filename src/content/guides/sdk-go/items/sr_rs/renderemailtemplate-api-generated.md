...
Враћа: [`RenderEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_render_email_template_response.go)
...
func main() {
	...
	// одговор од `RenderEmailTemplate`: RenderEmailTemplateResponse
