...
Враћа: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за PutSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (необавезно)
	...
	// одговор од `PutSSOUser`: PutSSOUserAPIResponse
