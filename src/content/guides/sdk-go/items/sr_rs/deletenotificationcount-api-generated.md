...
[inline-code-attrs-start title = 'Пример за DeleteNotificationCount'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// одговор од `DeleteNotificationCount`: FlagCommentPublic200Response
