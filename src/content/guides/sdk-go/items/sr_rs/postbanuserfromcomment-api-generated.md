...
func main() {
	...
	banEmail := true // bool |  (опционо)
	banEmailDomain := true // bool |  (опционо)
	banIP := true // bool |  (опционо)
	deleteAllUsersComments := true // bool |  (опционо)
	bannedUntil := "bannedUntil_example" // string |  (опционо)
	isShadowBan := true // bool |  (опционо)
	updateId := "updateId_example" // string |  (опционо)
	banReason := "banReason_example" // string |  (опционо)
	...
	// одговор са `PostBanUserFromComment`: BanUserFromCommentResult
