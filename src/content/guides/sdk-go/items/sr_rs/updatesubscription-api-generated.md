...
Враћа: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)
...
func main() {
	...
	// одговор од `UpdateSubscription`: UpdateSubscriptionAPIResponse
