...
Renvoie : [`GifGetLargeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_gif_get_large_response.go)

## Exemple

[inline-code-attrs-start title = 'Exemple GetGifLarge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `GetGifLarge` : GifGetLargeResponse
