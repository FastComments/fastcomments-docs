...
Renvoie : [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_domain_config_response.go)
...
func main() {
	...
	// réponse de `PatchDomainConfig` : PatchDomainConfigResponse
