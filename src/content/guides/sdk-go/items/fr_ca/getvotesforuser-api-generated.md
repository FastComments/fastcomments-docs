...
Retourne: [`GetVotesForUser200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_votes_for_user_200_response.go)

## Exemple

[inline-code-attrs-start title = 'Exemple pour GetVotesForUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `GetVotesForUser`: GetVotesForUser200Response
