...
Retourne: [`GetV2PageReacts`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_v2_page_reacts.go)

## Exemple

[inline-code-attrs-start title = 'Exemple de GetV2PageReacts'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `GetV2PageReacts`: GetV2PageReacts
