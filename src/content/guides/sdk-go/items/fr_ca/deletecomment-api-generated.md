...
Renvoie : [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_comment_result.go)

## Exemple

[inline-code-attrs-start title = 'Exemple de DeleteComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `DeleteComment`: DeleteCommentResult
