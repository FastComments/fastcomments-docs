...
[inline-code-attrs-start title = 'Exemple de DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (optionnel)
	...
	// réponse de `DeleteTenant`: APIEmptyResponse
