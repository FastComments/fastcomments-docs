...
Retourne : [`GetModeratorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_moderator_response.go)
...
func main() {
	...
	// réponse de `GetModerator`: GetModeratorResponse
