...
Renvoie : [`UnBlockCommentPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_un_block_comment_public_200_response.go)

## Exemple

[inline-code-attrs-start title = 'Exemple pour UnBlockUserFromComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `UnBlockUserFromComment`: UnBlockCommentPublic200Response
