...
Renvoie : [`UpdateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_user_badge_200_response.go)

## Exemple

[inline-code-attrs-start title = 'Exemple de UpdateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// réponse de `UpdateUserBadge`: UpdateUserBadge200Response
