...
Retourne : [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_domain_configs_response.go)
...
func main() {
	...
	// réponse de `GetDomainConfigs` : GetDomainConfigsResponse
