...
Επιστρέφει: [`ReactFeedPostResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_react_feed_post_response.go)
...
func main() {
	...
	// απόκριση από `ReactFeedPostPublic`: ReactFeedPostResponse
