...
| Name | Type | Τοποθεσία | Required | Περιγραφή |
|------|------|----------|----------|-------------|
...
[inline-code-attrs-start title = 'Παράδειγμα UpdateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απόκριση από `UpdateUserBadge`: APIEmptySuccessResponse
