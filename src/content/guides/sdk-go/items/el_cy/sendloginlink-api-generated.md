...
[inline-code-attrs-start title = 'Παράδειγμα SendLoginLink'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  (προαιρετικό)
	...
	// απάντηση από `SendLoginLink`: FlagCommentPublic200Response
