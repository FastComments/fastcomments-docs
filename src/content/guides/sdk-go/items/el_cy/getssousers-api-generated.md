...
Επιστρέφει: [`GetSSOUsers200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_users_200_response.go)
...
func main() {
	...
	// απάντηση από `GetSSOUsers`: GetSSOUsers200Response
