...
[inline-code-attrs-start title = 'Παράδειγμα DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (προαιρετικό)
	...
	// απάντηση από `DeleteTenant`: APIEmptyResponse
