...
[inline-code-attrs-start title = 'Παράδειγμα Ενημέρωσης Moderator'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απάντηση από `UpdateModerator`: FlagCommentPublic200Response
