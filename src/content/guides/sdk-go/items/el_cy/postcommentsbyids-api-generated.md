...
[inline-code-attrs-start title = 'Παράδειγμα PostCommentsByIds'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απόκριση από `PostCommentsByIds`: ModerationAPIChildCommentsResponse
