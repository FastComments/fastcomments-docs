...
Επιστρέφει: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα PutSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (προαιρετικό)
	...
	// απάντηση από `PutSSOUser`: PutSSOUserAPIResponse
