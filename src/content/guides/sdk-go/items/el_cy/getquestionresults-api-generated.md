...
[inline-code-attrs-start title = 'Παράδειγμα GetQuestionResults'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	startDate := "startDate_example" // string |  (προαιρετικό)
	questionId := "questionId_example" // string |  (προαιρετικό)
	questionIds := "questionIds_example" // string |  (προαιρετικό)
	...
	// απόκριση από `GetQuestionResults`: GetQuestionResultsResponse
