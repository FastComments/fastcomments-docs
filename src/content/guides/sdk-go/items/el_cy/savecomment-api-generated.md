...
Επιστρέφει: [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_save_comment_response.go)
...
func main() {
	...
	// απόκριση από `SaveComment`: APISaveCommentResponse
