...
Επιστρέφει: [`GetTicketsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tickets_response.go)
...
func main() {
	...
	// απάντηση από `GetTickets`: GetTicketsResponse
