...
Επιστρέφει: [`LockComment200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_lock_comment_200_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα UnLockComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απάντηση από `UnLockComment`: LockComment200Response
