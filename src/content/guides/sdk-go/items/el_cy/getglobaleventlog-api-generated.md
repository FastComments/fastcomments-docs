...
Επιστρέφει: [`GetEventLog200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_200_response.go)
...
func main() {
	...
	// απόκριση από `GetGlobalEventLog`: GetEventLog200Response
