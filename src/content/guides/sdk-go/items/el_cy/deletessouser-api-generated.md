...
Επιστρέφει: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_sso_user_api_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα DeleteSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := true // bool |  (προαιρετικό)
	commentDeleteMode := "commentDeleteMode_example" // string |  (προαιρετικό)
