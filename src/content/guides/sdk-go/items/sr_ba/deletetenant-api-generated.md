...
[inline-code-attrs-start title = 'Primjer DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (neobavezno)
	...
	// odgovor od `DeleteTenant`: APIEmptyResponse
