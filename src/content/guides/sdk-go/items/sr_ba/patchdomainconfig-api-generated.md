...
Враћа: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_domain_config_response.go)

## Пример

[inline-code-attrs-start title = 'PatchDomainConfig Пример'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// одговор од `PatchDomainConfig`: PatchDomainConfigResponse
