...
[inline-code-attrs-start title = 'Primjer SetTrustFactor'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	userId := "userId_example" // string |  (opcijalno)
	trustFactor := "trustFactor_example" // string |  (opcijalno)
	sso := "sso_example" // string |  (opcijalno)
