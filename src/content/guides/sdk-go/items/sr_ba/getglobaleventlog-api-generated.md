...
Vraća: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)

## Primjer

[inline-code-attrs-start title = 'Primjer GetGlobalEventLog'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	endTime := int64(789) // int64 |  (neobavezno)
	...
	// odgovor iz `GetGlobalEventLog`: GetEventLogResponse
