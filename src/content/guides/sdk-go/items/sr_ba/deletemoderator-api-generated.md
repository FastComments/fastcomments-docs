...
[inline-code-attrs-start title = 'Пример брисања модератора'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sendEmail := "sendEmail_example" // string |  (необавезно)
	...
	// одговор из `DeleteModerator`: FlagCommentPublic200Response
