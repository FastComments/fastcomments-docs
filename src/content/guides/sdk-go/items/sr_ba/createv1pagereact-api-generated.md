...
[inline-code-attrs-start title = 'CreateV1PageReact Пример'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	title := "title_example" // string |  (опционо)
	...
	// одговор од `CreateV1PageReact`: CreateV1PageReact
