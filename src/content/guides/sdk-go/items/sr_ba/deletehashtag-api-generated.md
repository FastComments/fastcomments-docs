...
[inline-code-attrs-start title = 'Primjer brisanja hashtag-a'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	tenantId := "tenantId_example" // string |  (opcionalno)
	deleteHashTagRequest := *openapiclient.NewDeleteHashTagRequest() // DeleteHashTagRequest |  (opcionalno)
