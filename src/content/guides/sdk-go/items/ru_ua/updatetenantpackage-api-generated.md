...
[inline-code-attrs-start title = 'Пример UpdateTenantPackage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `UpdateTenantPackage`: FlagCommentPublic200Response
