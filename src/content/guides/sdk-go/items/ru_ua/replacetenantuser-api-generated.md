...
[inline-code-attrs-start title = 'Пример ReplaceTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := "updateComments_example" // string |  (необязательно)
	...
	// ответ от `ReplaceTenantUser`: FlagCommentPublic200Response
