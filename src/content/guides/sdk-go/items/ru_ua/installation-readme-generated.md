...
PublicAPI позволяет получать доступ к публичным эндпоинтам без аутентификации:
...
#### API по умолчанию (требуется API‑ключ)
...
#### API модерации (панель модератора)
...
func main() {
    ...
    // Вывести список комментариев для модерации с помощью ModerationAPI
