...
Возвращает: [`GetUserNotificationCount200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_notification_count_200_response.go)
...
func main() {
	...
	// ответ от `GetUserNotificationCount`: GetUserNotificationCount200Response
