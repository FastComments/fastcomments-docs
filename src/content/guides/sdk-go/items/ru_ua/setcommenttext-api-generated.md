...
Возвращает: [`SetCommentText200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_comment_text_200_response.go)
...
func main() {
	...
	// ответ от `SetCommentText`: SetCommentText200Response
