...
Возвращает: [`GetGifsSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_gifs_search_response.go)
...
func main() {
	...
	// ответ от `GetGifsSearch`: GetGifsSearchResponse
