...
Возвращает: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_user_by_id_api_response.go)
...
func main() {
	...
	// ответ от `GetSSOUserById`: GetSSOUserByIdAPIResponse
