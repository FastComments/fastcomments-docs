...
Возвращает: [`AddDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_response.go)
...
func main() {
	...
	// ответ от `AddDomainConfig`: AddDomainConfigResponse
