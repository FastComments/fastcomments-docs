...
Возвращает: [`CreateFeedPost200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_post_200_response.go)
...
func main() {
	...
	// ответ от `CreateFeedPost`: CreateFeedPost200Response
