...
[inline-code-attrs-start title = 'Пример PostRestoreDeletedComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `PostRestoreDeletedComment`: APIEmptyResponse
