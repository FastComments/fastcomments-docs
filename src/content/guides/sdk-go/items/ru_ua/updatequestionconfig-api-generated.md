...
[inline-code-attrs-start title = 'Пример запроса UpdateQuestionConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `UpdateQuestionConfig`: FlagCommentPublic200Response
