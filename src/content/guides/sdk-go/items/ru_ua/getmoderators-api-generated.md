...
Возвращает: [`GetModerators200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_moderators_200_response.go)
...
func main() {
	...
	// ответ от `GetModerators`: GetModerators200Response
