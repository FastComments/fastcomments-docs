...
[inline-code-attrs-start title = 'Пример PutDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `PutDomainConfig`: GetDomainConfig200Response
