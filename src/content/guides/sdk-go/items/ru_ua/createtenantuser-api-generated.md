...
Возвращает: [`CreateTenantUser200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_user_200_response.go)

## Пример

[inline-code-attrs-start title = 'Пример CreateTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `CreateTenantUser`: CreateTenantUser200Response
