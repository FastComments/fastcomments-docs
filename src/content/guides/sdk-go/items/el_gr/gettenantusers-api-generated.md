...
Επιστρέφει: [`GetTenantUsersResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_users_response.go)
...
func main() {
	...
	// απάντηση από `GetTenantUsers`: GetTenantUsersResponse
