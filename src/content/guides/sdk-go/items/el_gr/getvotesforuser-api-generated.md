...
| Name | Type | Τοποθεσία | Απαιτείται | Περιγραφή |
|------|------|----------|----------|-------------|
...
Επιστρέφει: [`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_votes_for_user_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα GetVotesForUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απάντηση από `GetVotesForUser`: GetVotesForUserResponse
