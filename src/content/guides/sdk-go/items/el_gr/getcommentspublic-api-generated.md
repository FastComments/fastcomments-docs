...
Επιστρέφει: [`GetCommentsResponseWithPresencePublicComment`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comments_response_with_presence_public_comment_.go)
...
func main() {
	...
	// απάντηση από `GetCommentsPublic`: GetCommentsResponseWithPresencePublicComment
