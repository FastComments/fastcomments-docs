...
[inline-code-attrs-start title = 'Παράδειγμα CreateV1PageReact'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απόκριση από `CreateV1PageReact`: CreateV1PageReact
