...
Επιστρέφει: [`DeleteFeedPostPublicResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_feed_post_public_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα DeleteFeedPostPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απάντηση από `DeleteFeedPostPublic`: DeleteFeedPostPublicResponse
