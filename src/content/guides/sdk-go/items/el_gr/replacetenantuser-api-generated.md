...
[inline-code-attrs-start title = 'Παράδειγμα ReplaceTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := "updateComments_example" // string |  (προαιρετικό)
	...
	// απάντηση από `ReplaceTenantUser`: FlagCommentPublic200Response
