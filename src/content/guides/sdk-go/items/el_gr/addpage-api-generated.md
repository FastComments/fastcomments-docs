...
Επιστρέφει: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα AddPage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απόκριση από `AddPage`: AddPageAPIResponse
