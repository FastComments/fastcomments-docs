...
[inline-code-attrs-start title = 'Παράδειγμα DeleteTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := "deleteComments_example" // string |  (προαιρετικό)
	...
	// απάντηση από `DeleteTenantUser`: FlagCommentPublic200Response
