...
[inline-code-attrs-start title = 'Παράδειγμα BlockUserFromComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απόκριση από το `BlockUserFromComment`: BlockSuccess
