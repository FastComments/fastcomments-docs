...
| urlId | string | query | Όχι | Χρησιμοποιείται για να καθορίσει εάν η τρέχουσα σελίδα είναι εγγεγραμμένη. |
...
func main() {
	...
	urlId := "urlId_example" // string | Χρησιμοποιείται για να καθορίσει εάν η τρέχουσα σελίδα είναι εγγεγραμμένη. (προαιρετικό)
