...
Επιστρέφει: [`GetPendingWebhookEventCountResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_pending_webhook_event_count_response.go)
...
func main() {
	...
	// απόκριση από `GetPendingWebhookEventCount`: GetPendingWebhookEventCountResponse
