...
Επιστρέφει: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα AddSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// απάντηση από `AddSSOUser`: AddSSOUserAPIResponse
