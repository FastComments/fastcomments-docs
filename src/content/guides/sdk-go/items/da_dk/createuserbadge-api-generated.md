...
Returnerer: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_user_badge_200_response.go)

## Eksempel

[inline-code-attrs-start title = 'Eksempel på CreateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `CreateUserBadge`: CreateUserBadge200Response
