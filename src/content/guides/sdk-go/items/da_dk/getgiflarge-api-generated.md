...
Returnerer: [`GifGetLargeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_gif_get_large_response.go)

## Eksempel

[inline-code-attrs-start title = 'GetGifLarge Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `GetGifLarge`: GifGetLargeResponse
