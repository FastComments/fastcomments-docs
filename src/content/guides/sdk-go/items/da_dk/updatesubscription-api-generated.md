...
Returnerer: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)

## Eksempel

[inline-code-attrs-start title = 'UpdateSubscription-eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `UpdateSubscription`: UpdateSubscriptionAPIResponse
