...
Returnerer: [`AwardUserBadgeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_award_user_badge_response.go)

## Eksempel

[inline-code-attrs-start title = 'PutAwardBadge Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `PutAwardBadge`: AwardUserBadgeResponse
