...
Returnerer: [`GetFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_feed_posts_response.go)

## Eksempel

[inline-code-attrs-start title = 'GetFeedPosts-eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `GetFeedPosts`: GetFeedPostsResponse
