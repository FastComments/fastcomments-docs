...
Returnerer: [`GetTickets200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tickets_200_response.go)

## Eksempel

[inline-code-attrs-start title = 'GetTickets Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	state := float64(1.2) // float64 |  (valgfri)
	...
	// svar fra `GetTickets`: GetTickets200Response
