...
Returnerer: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Eksempel

[inline-code-attrs-start title = 'AddDomainConfig Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respons fra `AddDomainConfig`: AddDomainConfig200Response
