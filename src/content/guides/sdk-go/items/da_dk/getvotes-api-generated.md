...
Returnerer: [`GetVotesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_votes_response.go)
...
func main() {
	...
	// svar fra `GetVotes`: GetVotesResponse
