...
Returnerer: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_aggregate_question_results_200_response.go)

## Eksempel

[inline-code-attrs-start title = 'BulkAggregateQuestionResults Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `BulkAggregateQuestionResults`: BulkAggregateQuestionResults200Response
