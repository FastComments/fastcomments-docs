...
Returnerer: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_pre_ban_summary.go)

## Eksempel

[inline-code-attrs-start title = 'PostBulkPreBanSummary Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `PostBulkPreBanSummary`: BulkPreBanSummary
