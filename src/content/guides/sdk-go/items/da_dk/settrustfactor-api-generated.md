...
Returnerer: [`SetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_user_trust_factor_response.go)
...
func main() {
	...
	// svar fra `SetTrustFactor`: SetUserTrustFactorResponse
