...
[inline-code-attrs-start title = 'Eksempel på DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (valgfri)
	...
	// svar fra `DeleteTenant`: FlagCommentPublic200Response
