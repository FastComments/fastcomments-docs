...
Returnerer: [`GetSSOUsersResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_users_response.go)
...
func main() {
	...
	// svar fra `GetSSOUsers`: GetSSOUsersResponse
