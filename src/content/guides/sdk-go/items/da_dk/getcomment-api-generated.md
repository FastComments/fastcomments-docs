...
Returnerer: [`APIGetCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_get_comment_response.go)
...
func main() {
	...
	// svar fra `GetComment`: APIGetCommentResponse
