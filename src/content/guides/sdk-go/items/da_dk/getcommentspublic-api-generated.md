...
Returnerer: [`GetCommentsResponseWithPresencePublicComment`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comments_response_with_presence_public_comment_.go)

## Eksempel

[inline-code-attrs-start title = 'GetCommentsPublic Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `GetCommentsPublic`: GetCommentsResponseWithPresencePublicComment
