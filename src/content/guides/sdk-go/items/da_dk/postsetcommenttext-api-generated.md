...
Returnerer: [`SetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_comment_text_response.go)

## Eksempel

[inline-code-attrs-start title = 'PostSetCommentText Eksempel'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// svar fra `PostSetCommentText`: SetCommentTextResponse
