...
| sizePreset | string | query | No | Preset veličine: "Default" (1000x1000px) ili "CrossPlatform" (stvara veličine za popularne uređaje) |
| urlId | string | query | No | ID stranice s koje se vrši učitavanje, za konfiguraciju |
...
func main() {
	...
	sizePreset := openapiclient.SizePreset("Default") // SizePreset | Preset veličine: \"Default\" (1000x1000px) ili \"CrossPlatform\" (stvara veličine za popularne uređaje) (opcionalno)
	urlId := "urlId_example" // string | ID stranice s koje se vrši učitavanje, za konfiguraciju (opcionalno)
