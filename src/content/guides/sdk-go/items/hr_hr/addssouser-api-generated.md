...
Vraća: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)

## Primjer

[inline-code-attrs-start title = 'Primjer AddSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odgovor od `AddSSOUser`: AddSSOUserAPIResponse
