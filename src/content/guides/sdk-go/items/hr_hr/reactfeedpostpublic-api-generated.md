...
Vraća: [`ReactFeedPostPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_react_feed_post_public_200_response.go)

## Primjer

[inline-code-attrs-start title = 'ReactFeedPostPublic Primjer'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odgovor iz `ReactFeedPostPublic`: ReactFeedPostPublic200Response
