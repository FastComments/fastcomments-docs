...
| commentIds | string | query | Yes | Lista ID-jeva komentara razdvojenih zarezom. |
| sso | string | query | No |  |
...
func main() {
	...
	commentIds := "commentIds_example" // string | Lista ID-jeva komentara razdvojenih zarezom.
