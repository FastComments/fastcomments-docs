...
Vraća: [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_domain_configs_response.go)
...
func main() {
	...
	// odgovor od `GetDomainConfigs`: GetDomainConfigsResponse
