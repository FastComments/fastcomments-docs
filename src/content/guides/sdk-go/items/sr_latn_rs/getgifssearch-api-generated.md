...
Vraća: [`GetGifsSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_gifs_search_response.go)

## Primer

[inline-code-attrs-start title = 'Primer GetGifsSearch'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	rating := "rating_example" // string |  (opciono)
	page := float64(1.2) // float64 |  (opciono)
	...
	// odgovor iz `GetGifsSearch`: GetGifsSearchResponse
