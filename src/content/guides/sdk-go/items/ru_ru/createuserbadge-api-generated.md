...
Возвращает: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_create_user_badge_response.go)
...
func main() {
	...
	// ответ от `CreateUserBadge`: APICreateUserBadgeResponse
