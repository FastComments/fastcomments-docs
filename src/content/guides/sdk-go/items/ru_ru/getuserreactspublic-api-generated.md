...
[inline-code-attrs-start title = 'Пример GetUserReactsPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	postIds := []string{"Inner_example"} // []string |  (необязательно)
