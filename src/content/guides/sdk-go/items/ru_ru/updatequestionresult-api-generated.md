...
[inline-code-attrs-start title = 'Пример UpdateQuestionResult'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `UpdateQuestionResult`: FlagCommentPublic200Response
