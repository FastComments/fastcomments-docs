...
[inline-code-attrs-start title = 'Пример DeleteQuestionResult'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `DeleteQuestionResult`: FlagCommentPublic200Response
