...
[inline-code-attrs-start title = 'Пример UpdateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `UpdateUserBadge`: UpdateUserBadge200Response
