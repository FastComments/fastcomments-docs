...
Возвращает: [`GetNotificationsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_notifications_response.go)
...
func main() {
	...
	// ответ от `GetNotifications`: GetNotificationsResponse
