...
Возвращает: [`GetHashTags200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_hash_tags_200_response.go)
...
func main() {
	...
	// ответ от `GetHashTags`: GetHashTags200Response
