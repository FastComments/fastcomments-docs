...
Возвращает: [`PublicFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_feed_posts_response.go)
...
func main() {
	...
	// ответ от `GetFeedPostsPublic`: PublicFeedPostsResponse
