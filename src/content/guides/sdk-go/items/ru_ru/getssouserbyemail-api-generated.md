...
Возвращает: [`GetSSOUserByEmailAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_user_by_email_api_response.go)
...
func main() {
	...
	// ответ от `GetSSOUserByEmail`: GetSSOUserByEmailAPIResponse
