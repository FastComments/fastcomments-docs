...
Возвращает: [`GetTicket200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_ticket_200_response.go)
...
func main() {
	...
	// ответ от `GetTicket`: GetTicket200Response
