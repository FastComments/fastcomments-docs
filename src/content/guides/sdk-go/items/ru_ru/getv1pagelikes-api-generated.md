...
Возвращает: [`GetV1PageLikes`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_v1_page_likes.go)

## Пример

[inline-code-attrs-start title = 'Пример GetV1PageLikes'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `GetV1PageLikes`: GetV1PageLikes
