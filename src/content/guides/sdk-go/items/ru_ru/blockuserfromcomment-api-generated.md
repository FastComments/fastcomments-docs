...
[inline-code-attrs-start title = 'Пример BlockUserFromComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `BlockUserFromComment`: BlockFromCommentPublic200Response
