...
Возвращает: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_pages_api_response.go)
...
func main() {
	...
	// ответ от `GetPages`: GetPagesAPIResponse
