...
[inline-code-attrs-start title = 'Пример использования PostBanUserUndo'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// ответ от `PostBanUserUndo`: APIEmptyResponse
