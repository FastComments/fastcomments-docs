...
Возвращает: [`ModerationUserSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_user_search_response.go)
...
func main() {
	...
	// ответ от `GetSearchUsers`: ModerationUserSearchResponse
