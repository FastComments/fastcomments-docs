...
Возвращает: [`PublicAPISetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_api_set_comment_text_response.go)
...
func main() {
	...
	// ответ от `SetCommentText`: PublicAPISetCommentTextResponse
