...
Возвращает: [`LockComment200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_lock_comment_200_response.go)
...
func main() {
	...
	// ответ от `UnLockComment`: LockComment200Response
