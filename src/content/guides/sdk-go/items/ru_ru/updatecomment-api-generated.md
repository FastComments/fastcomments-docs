...
func main() {
	...
	contextUserId := "contextUserId_example" // string |  (необязательный)
	doSpamCheck := true // bool |  (необязательный)
	isLive := true // bool |  (необязательный)
	...
	// ответ от `UpdateComment`: APIEmptyResponse
