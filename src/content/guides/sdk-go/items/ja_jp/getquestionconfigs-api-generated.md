...
戻り値: [`GetQuestionConfigsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_configs_response.go)
...
func main() {
	...
	// `GetQuestionConfigs` のレスポンス: GetQuestionConfigsResponse
