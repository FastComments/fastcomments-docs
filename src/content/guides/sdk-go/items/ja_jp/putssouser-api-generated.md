...
返却: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## 例

[inline-code-attrs-start title = 'PutSSOUser の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (オプション)
	...
	// `PutSSOUser` のレスポンス: PutSSOUserAPIResponse
