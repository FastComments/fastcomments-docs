...
戻り値: [`GifGetLargeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_gif_get_large_response.go)

## 例

[inline-code-attrs-start title = 'GetGifLarge の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetGifLarge` のレスポンス: GifGetLargeResponse
