...
[inline-code-attrs-start title = 'SendLoginLink の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  （オプション）
	...
	// `SendLoginLink` のレスポンス: APIEmptyResponse
