...
戻り値: [`GetFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_feed_posts_response.go)

## 例

[inline-code-attrs-start title = 'GetFeedPosts の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	tags := []string{"Inner_example"} // []string |  （オプション）
	...
	// `GetFeedPosts` のレスポンス: GetFeedPostsResponse
