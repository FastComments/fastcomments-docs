...
戻り値: [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_ticket_response.go)
...
func main() {
	...
	// `CreateTicket` のレスポンス: CreateTicketResponse
