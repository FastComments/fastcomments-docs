...
返却値: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_comment_result.go)
...
func main() {
	...
	// `DeleteComment` のレスポンス: DeleteCommentResult
