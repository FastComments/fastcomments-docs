...
返却: [`GetUserManualBadgesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_manual_badges_response.go)
...
func main() {
	...
	badgesUserId := "badgesUserId_example" // string |  (任意)
	...
	// `GetManualBadgesForUser` からのレスポンス: GetUserManualBadgesResponse
