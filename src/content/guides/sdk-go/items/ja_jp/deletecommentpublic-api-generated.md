...
戻り値: [`DeleteCommentPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_comment_public_200_response.go)

## 例

[inline-code-attrs-start title = 'DeleteCommentPublic の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `DeleteCommentPublic` のレスポンス: DeleteCommentPublic200Response
