...
戻り値: [`GetTenantPackagesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_packages_response.go)
...
func main() {
	...
	// `GetTenantPackages` のレスポンス: GetTenantPackagesResponse
