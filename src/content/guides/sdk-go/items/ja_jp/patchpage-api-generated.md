...
戻り値: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_page_api_response.go)

## 例

[inline-code-attrs-start title = 'PatchPage の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `PatchPage` のレスポンス: PatchPageAPIResponse
