...
返却: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)
...
func main() {
	...
	// `GetEventLog` のレスポンス: GetEventLogResponse
