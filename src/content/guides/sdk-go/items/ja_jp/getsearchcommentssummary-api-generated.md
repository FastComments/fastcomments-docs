...
返却値: [`ModerationCommentSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_comment_search_response.go)

## 例

[inline-code-attrs-start title = 'GetSearchCommentsSummary の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetSearchCommentsSummary` からのレスポンス: ModerationCommentSearchResponse
