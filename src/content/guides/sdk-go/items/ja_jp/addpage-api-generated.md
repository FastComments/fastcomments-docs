...
戻り値: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)

## 例

[inline-code-attrs-start title = 'AddPageの例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `AddPage` のレスポンス: AddPageAPIResponse
