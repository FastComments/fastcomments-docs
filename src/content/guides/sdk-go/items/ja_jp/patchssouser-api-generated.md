...
戻り値: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_sso_user_api_response.go)

## 例

[inline-code-attrs-start title = 'PatchSSOUser の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `PatchSSOUser` のレスポンス: PatchSSOUserAPIResponse
