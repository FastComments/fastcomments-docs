...
戻り値: [`GetCommentBanStatusResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_ban_status_response.go)

## 例

[inline-code-attrs-start title = 'GetCommentBanStatus の例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetCommentBanStatus` のレスポンス: GetCommentBanStatusResponse
