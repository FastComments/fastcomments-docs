...
Повертає: [`GetUserNotificationCountResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_notification_count_response.go)
...
func main() {
	...
	// відповідь від `GetUserNotificationCount`: GetUserNotificationCountResponse
