...
Повертає: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_response.go)
...
func main() {
	...
	// відповідь від `CreateTenant`: CreateTenantResponse
