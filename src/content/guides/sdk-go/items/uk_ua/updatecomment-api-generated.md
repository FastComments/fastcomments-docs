...
func main() {
	...
	contextUserId := "contextUserId_example" // string |  (необов'язковий)
	doSpamCheck := true // bool |  (необов'язковий)
	isLive := true // bool |  (необов'язковий)
	...
	// відповідь від `UpdateComment`: FlagCommentPublic200Response
