...
Повертає: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## Приклад

[inline-code-attrs-start title = 'Приклад PutSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// відповідь від `PutSSOUser`: PutSSOUserAPIResponse
