...
Повертає: [`APIEmptySuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_empty_success_response.go)
...
func main() {
	...
	// відповідь від `UpdateUserBadge`: APIEmptySuccessResponse
