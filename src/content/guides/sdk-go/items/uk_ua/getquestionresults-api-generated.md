...
Повертає: [`GetQuestionResultsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_results_response.go)
...
func main() {
	...
	// відповідь від `GetQuestionResults`: GetQuestionResultsResponse
