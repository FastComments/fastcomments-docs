...
Повертає: [`GetCommentVoteUserNamesSuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_vote_user_names_success_response.go)
...
func main() {
	...
	// відповідь від `GetCommentVoteUserNames`: GetCommentVoteUserNamesSuccessResponse
