...
Повертає: [`GetUserPresenceStatuses200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_presence_statuses_200_response.go)

## Приклад

[inline-code-attrs-start title = 'Приклад GetUserPresenceStatuses'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// відповідь від `GetUserPresenceStatuses`: GetUserPresenceStatuses200Response
