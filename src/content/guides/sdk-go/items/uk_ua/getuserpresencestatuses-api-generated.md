...
Повертає: [`GetUserPresenceStatusesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_presence_statuses_response.go)
...
func main() {
	...
	// відповідь від `GetUserPresenceStatuses`: GetUserPresenceStatusesResponse
