...
Повертає: [`SetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_user_trust_factor_response.go)

## Приклад

[inline-code-attrs-start title = 'Приклад SetTrustFactor'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	trustFactor := "trustFactor_example" // string |  (необов'язково)
