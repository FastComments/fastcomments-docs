...
[inline-code-attrs-start title = 'Приклад SendLoginLink'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  (необов'язковий)
	...
	// відповідь від `SendLoginLink`: FlagCommentPublic200Response
