...
[inline-code-attrs-start title = 'Приклад PostRestoreDeletedComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	broadcastId := "broadcastId_example" // string |  (optional) // (необов'язковий)
	sso := "sso_example" // string |  (optional) // (необов'язковий)
	...
	// відповідь від `PostRestoreDeletedComment`: APIEmptyResponse
