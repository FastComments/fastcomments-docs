...
Повертає: [`APIGetUserBadgeProgressListResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_get_user_badge_progress_list_response.go)
...
func main() {
	...
	// відповідь від `GetUserBadgeProgressList`: APIGetUserBadgeProgressListResponse
