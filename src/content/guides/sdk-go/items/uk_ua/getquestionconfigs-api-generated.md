...
Повертає: [`GetQuestionConfigs200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_configs_200_response.go)
...
func main() {
	...
	skip := float64(1.2) // float64 |  (необов'язкове)
