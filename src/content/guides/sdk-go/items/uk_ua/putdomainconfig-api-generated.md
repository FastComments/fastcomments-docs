...
Повертає: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_domain_config_response.go)

## Приклад

[inline-code-attrs-start title = 'Приклад PutDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// відповідь від `PutDomainConfig`: PutDomainConfigResponse
