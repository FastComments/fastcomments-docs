...
[inline-code-attrs-start title = 'Приклад DeletePendingWebhookEvent'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// відповідь від `DeletePendingWebhookEvent`: FlagCommentPublic200Response
