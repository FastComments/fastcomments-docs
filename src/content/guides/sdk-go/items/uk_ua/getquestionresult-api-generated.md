...
Повертає: [`GetQuestionResultResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_result_response.go)
...
func main() {
	...
	// відповідь від `GetQuestionResult`: GetQuestionResultResponse
