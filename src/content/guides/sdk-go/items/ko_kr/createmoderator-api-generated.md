...
반환: [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_moderator_response.go)
...
func main() {
	...
	// `CreateModerator`의 응답: CreateModeratorResponse
