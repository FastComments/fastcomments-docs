...
반환: [`AddHashTag200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_hash_tag_200_response.go)
...
func main() {
	...
	createHashTagBody := *openapiclient.NewCreateHashTagBody("Tag_example") // CreateHashTagBody |  (선택 사항)
	...
	// `AddHashTag`의 응답: AddHashTag200Response
