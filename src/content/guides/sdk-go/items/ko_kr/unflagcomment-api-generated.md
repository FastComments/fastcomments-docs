...
반환: [`FlagCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_flag_comment_response.go)
...
func main() {
	...
	// `UnFlagComment`의 응답: FlagCommentResponse
