...
반환값: [`FlagComment200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_flag_comment_200_response.go)

## 예제

[inline-code-attrs-start title = 'UnFlagComment 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `UnFlagComment`의 응답: FlagComment200Response
