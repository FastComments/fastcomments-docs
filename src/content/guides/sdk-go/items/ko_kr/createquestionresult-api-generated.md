...
반환: [`CreateQuestionResultResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_question_result_response.go)
...
func main() {
	...
	// `CreateQuestionResult`의 응답: CreateQuestionResultResponse
