...
[inline-code-attrs-start title = 'PostUnFlagComment 예시'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	broadcastId := "broadcastId_example" // string |  (선택사항)
	...
	// `PostUnFlagComment`의 응답: APIEmptyResponse
