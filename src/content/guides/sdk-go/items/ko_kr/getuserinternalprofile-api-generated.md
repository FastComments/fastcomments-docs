...
반환: [`GetUserInternalProfileResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_internal_profile_response.go)

## 예제

[inline-code-attrs-start title = 'GetUserInternalProfile 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetUserInternalProfile`의 응답: GetUserInternalProfileResponse
