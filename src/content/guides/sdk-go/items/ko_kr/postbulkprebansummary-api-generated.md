...
[inline-code-attrs-start title = 'PostBulkPreBanSummary 예시'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	includeByUserIdAndEmail := true // bool |  (옵션)
	includeByIP := true // bool |  (옵션)
	includeByEmailDomain := true // bool |  (옵션)
	...
	// 응답 from `PostBulkPreBanSummary`: BulkPreBanSummary
