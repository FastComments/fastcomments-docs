...
반환: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_response.go)
...
func main() {
	...
	// `CreateTenant`의 응답: CreateTenantResponse
