...
반환: [`GetTenantPackagesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_packages_response.go)
...
func main() {
	...
	// `GetTenantPackages`의 응답: GetTenantPackagesResponse
