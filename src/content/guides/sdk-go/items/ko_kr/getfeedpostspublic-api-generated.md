...
반환: [`PublicFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_feed_posts_response.go)
...
func main() {
	...
	// `GetFeedPostsPublic`의 응답: PublicFeedPostsResponse
