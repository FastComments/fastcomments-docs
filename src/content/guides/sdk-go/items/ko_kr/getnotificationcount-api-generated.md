...
반환: [`GetNotificationCount200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_notification_count_200_response.go)

## 예제

[inline-code-attrs-start title = 'GetNotificationCount 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	fromCommentId := "fromCommentId_example" // string |  (선택 사항)
	...
	// `GetNotificationCount`의 응답: GetNotificationCount200Response
