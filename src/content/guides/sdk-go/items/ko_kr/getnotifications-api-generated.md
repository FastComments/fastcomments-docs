...
반환: [`GetNotifications200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_notifications_200_response.go)

## 예제

[inline-code-attrs-start title = 'GetNotifications 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetNotifications`의 응답: GetNotifications200Response
