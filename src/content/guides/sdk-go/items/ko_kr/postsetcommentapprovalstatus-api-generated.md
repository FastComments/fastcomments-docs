...
반환: [`SetCommentApprovedResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_comment_approved_response.go)

## 예시

[inline-code-attrs-start title = 'PostSetCommentApprovalStatus 예시'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `PostSetCommentApprovalStatus`에 대한 응답: SetCommentApprovedResponse
