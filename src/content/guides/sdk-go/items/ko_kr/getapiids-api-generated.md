...
func main() {
	...
	textSearch := "textSearch_example" // string |  (optional) -> (선택 사항)
	byIPFromComment := "byIPFromComment_example" // string |  (optional) -> (선택 사항)
	filters := "filters_example" // string |  (optional) -> (선택 사항)
	searchFilters := "searchFilters_example" // string |  (optional) -> (선택 사항)
	afterId := "afterId_example" // string |  (optional) -> (선택 사항)
	demo := true // bool |  (optional) -> (선택 사항)
	sso := "sso_example" // string |  (optional) -> (선택 사항)
	...
	// `GetApiIds`에 대한 응답: ModerationAPIGetCommentIdsResponse
