...
반환: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_aggregate_question_results_200_response.go)

## 예제

[inline-code-attrs-start title = 'BulkAggregateQuestionResults 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `BulkAggregateQuestionResults`의 응답: BulkAggregateQuestionResults200Response
