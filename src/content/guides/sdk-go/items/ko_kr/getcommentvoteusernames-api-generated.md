...
반환: [`GetCommentVoteUserNamesSuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_vote_user_names_success_response.go)
...
func main() {
	...
	// `GetCommentVoteUserNames`의 응답: GetCommentVoteUserNamesSuccessResponse
