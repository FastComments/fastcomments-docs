...
[inline-code-attrs-start title = 'UpdateComment 예제'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	contextUserId := "contextUserId_example" // string |  (선택)
	doSpamCheck := true // bool |  (선택)
	isLive := true // bool |  (선택)
	...
	// `UpdateComment`의 응답: FlagCommentPublic200Response
