...
반환: [`CreateQuestionConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_question_config_response.go)
...
func main() {
	...
	// `CreateQuestionConfig`의 응답: CreateQuestionConfigResponse
