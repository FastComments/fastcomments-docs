...
반환: [`GetEmailTemplatesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_email_templates_response.go)
...
func main() {
	...
	// `GetEmailTemplates`의 응답: GetEmailTemplatesResponse
