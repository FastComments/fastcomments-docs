...
מחזיר: [`GetUserBadgeProgressList200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_badge_progress_list_200_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-GetUserBadgeProgressList'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`GetUserBadgeProgressList`: GetUserBadgeProgressList200Response
