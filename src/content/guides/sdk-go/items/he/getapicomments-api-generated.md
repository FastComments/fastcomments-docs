...
מחזיר: [`ModerationAPIGetCommentsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_get_comments_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמת GetApiComments'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	count := float64(1.2) // float64 |  (אופציונלי)
	...
	// תגובה מ-`GetApiComments`: ModerationAPIGetCommentsResponse
