...
[inline-code-attrs-start title = 'דוגמה ל-DeleteTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := "deleteComments_example" // string |  (אופציונלי)
	...
	// תגובה מ-`DeleteTenantUser`: FlagCommentPublic200Response
