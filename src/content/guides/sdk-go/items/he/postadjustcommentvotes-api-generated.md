...
מחזיר: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_adjust_votes_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-PostAdjustCommentVotes'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`PostAdjustCommentVotes`: AdjustVotesResponse
