...
מחזיר: [`PublicAPISetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_api_set_comment_text_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-SetCommentText'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ- `SetCommentText`: PublicAPISetCommentTextResponse
