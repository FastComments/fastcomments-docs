...
מחזיר: [`GetCommentsForUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comments_for_user_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-GetCommentsForUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	repliesToUserId := "repliesToUserId_example" // string |  (אופציונלי)
	...
	// תגובה מ-`GetCommentsForUser`: GetCommentsForUserResponse
