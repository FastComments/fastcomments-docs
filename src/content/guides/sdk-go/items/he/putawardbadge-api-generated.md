...
מחזיר: [`AwardUserBadgeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_award_user_badge_response.go)
...
func main() {
	...
	// תגובה מ-`PutAwardBadge`: AwardUserBadgeResponse
