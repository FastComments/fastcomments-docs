...
מחזיר: [`GetTenantResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_response.go)
...
func main() {
	...
	// תגובה מ־`GetTenant`: GetTenantResponse
