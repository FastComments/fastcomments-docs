...
[inline-code-attrs-start title = 'דוגמת SendInvite'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	fromName := "fromName_example" // מחרוזת | 
	...
	// תגובה מ-`SendInvite`: APIEmptyResponse
