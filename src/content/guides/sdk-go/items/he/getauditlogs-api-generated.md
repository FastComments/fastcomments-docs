...
מחזיר: [`GetAuditLogsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_audit_logs_response.go)
...
func main() {
	...
	// תגובה מ־`GetAuditLogs`: GetAuditLogsResponse
