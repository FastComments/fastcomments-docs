...
מחזיר: [`ModerationAPICommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_comment_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-GetModerationComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	includeEmail := true // bool |  (אופציונלי)
	includeIP := true // bool |  (אופציונלי)
	...
	// תגובה מ-`GetModerationComment`: ModerationAPICommentResponse
