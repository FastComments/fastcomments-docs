...
[inline-code-attrs-start title = 'דוגמת PostSetCommentReviewStatus'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	reviewed := true // בוליאני |  (אופציונלי)
	broadcastId := "broadcastId_example" // מחרוזת |  (אופציונלי)
	...
	// תגובה מ-`PostSetCommentReviewStatus`: APIEmptyResponse
