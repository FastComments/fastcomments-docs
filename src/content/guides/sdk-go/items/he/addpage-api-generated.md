...
מחזיר: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמת AddPage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`AddPage`: AddPageAPIResponse
