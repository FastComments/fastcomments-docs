...
מחזיר: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_email_template_response.go)
...
func main() {
	...
	// תגובה מ-`CreateEmailTemplate`: CreateEmailTemplateResponse
