...
מחזיר: [`CreateQuestionResult200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_question_result_200_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה של CreateQuestionResult'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`CreateQuestionResult`: CreateQuestionResult200Response
