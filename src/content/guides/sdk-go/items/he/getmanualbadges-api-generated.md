...
מחזיר: [`GetTenantManualBadgesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_manual_badges_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמת GetManualBadges'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`GetManualBadges`: GetTenantManualBadgesResponse
