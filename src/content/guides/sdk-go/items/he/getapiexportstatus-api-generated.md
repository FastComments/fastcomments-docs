...
מחזיר: [`ModerationExportStatusResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_export_status_response.go)
...
func main() {
	...
	// תגובה מ-`GetApiExportStatus`: ModerationExportStatusResponse
