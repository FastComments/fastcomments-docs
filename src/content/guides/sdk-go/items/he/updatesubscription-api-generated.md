...
מחזיר: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-UpdateSubscription'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// תגובה מ-`UpdateSubscription`: UpdateSubscriptionAPIResponse
