...
Döndürür: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)

## Örnek

[inline-code-attrs-start title = 'AddPage Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `AddPage`'den gelen yanıt: AddPageAPIResponse
