...
Döndürür: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Örnek

[inline-code-attrs-start title = 'AddDomainConfig Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `AddDomainConfig` yanıtı: AddDomainConfig200Response
