...
Döndürür: [`SetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_set_comment_text_response.go)

## Örnek

[inline-code-attrs-start title = 'PostSetCommentText Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `PostSetCommentText` yanıtı: SetCommentTextResponse
