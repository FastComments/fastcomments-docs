...
Döndürür: [`ReactFeedPostResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_react_feed_post_response.go)

## Örnek

[inline-code-attrs-start title = 'ReactFeedPostPublic Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `ReactFeedPostPublic` yanıtı: ReactFeedPostResponse
