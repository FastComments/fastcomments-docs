...
Döndürür: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_posts_response.go)
...
func main() {
	...
	// `CreateFeedPost`'ten gelen yanıt: CreateFeedPostsResponse
