...
[inline-code-attrs-start title = 'DeleteTenant Example'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (isteğe bağlı)
	...
	// `DeleteTenant`'den gelen yanıt: APIEmptyResponse
