...
[inline-code-attrs-start title = 'DeleteModerator Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sendEmail := "sendEmail_example" // string |  (isteğe bağlı)
	...
	// `DeleteModerator`'den dönen yanıt: FlagCommentPublic200Response
