...
Döndürür: [`UpdateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_user_badge_200_response.go)

## Örnek

[inline-code-attrs-start title = 'UpdateUserBadge Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `UpdateUserBadge`'den gelen yanıt: UpdateUserBadge200Response
