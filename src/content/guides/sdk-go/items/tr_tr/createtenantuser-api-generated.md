...
Döndürür: [`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_user_response.go)
...
func main() {
	...
	// `CreateTenantUser`'den gelen yanıt: CreateTenantUserResponse
