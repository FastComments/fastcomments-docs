...
[inline-code-attrs-start title = 'UpdateTenantUser Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `UpdateTenantUser`'den dönen yanıt: APIEmptyResponse
