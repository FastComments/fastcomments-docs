...
Döndürür: [`GetTenantUsers200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_users_200_response.go)
...
func main() {
	...
	// `GetTenantUsers`'den yanıt: GetTenantUsers200Response
