...
Dönen değer: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_user_badge_200_response.go)
...
func main() {
	...
	// `CreateUserBadge`'den gelen yanıt: CreateUserBadge200Response
