...
[inline-code-attrs-start title = 'BlockFromCommentPublic Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `BlockFromCommentPublic`'den dönen yanıt: BlockFromCommentPublic200Response
