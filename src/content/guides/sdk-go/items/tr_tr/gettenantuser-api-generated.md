...
Döndürür: [`GetTenantUser200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_user_200_response.go)
...
func main() {
	...
	// `GetTenantUser`'den gelen yanıt: GetTenantUser200Response
