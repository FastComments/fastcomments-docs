...
Döndürür: [`DeleteFeedPostPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_feed_post_public_200_response.go)

## Örnek

[inline-code-attrs-start title = 'DeleteFeedPostPublic Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `DeleteFeedPostPublic` yanıtı: DeleteFeedPostPublic200Response
