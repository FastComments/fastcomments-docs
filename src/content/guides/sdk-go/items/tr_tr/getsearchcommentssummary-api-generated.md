...
Dönen değer: [`ModerationCommentSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_comment_search_response.go)

## Örnek

[inline-code-attrs-start title = 'GetSearchCommentsSummary Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `GetSearchCommentsSummary`'den gelen yanıt: ModerationCommentSearchResponse
