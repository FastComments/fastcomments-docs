...
[inline-code-attrs-start title = 'PostFlagComment Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `PostFlagComment` işleminden yanıt: APIEmptyResponse
