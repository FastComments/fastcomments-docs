...
Dönüş: [`GetVotesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_votes_response.go)
...
func main() {
	...
	// `GetVotes`'ten gelen yanıt: GetVotesResponse
