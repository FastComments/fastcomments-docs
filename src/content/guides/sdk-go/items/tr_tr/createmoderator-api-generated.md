...
Döndürür: [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_moderator_response.go)
...
func main() {
	...
	// `CreateModerator`'den gelen yanıt: CreateModeratorResponse
