...
Döndürür: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)
...
func main() {
	...
	endTime := int64(789) // int64 |  (isteğe bağlı)
	...
	// `GetGlobalEventLog`'den gelen yanıt: GetEventLogResponse
