...
Döndürür: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)

## Örnek

[inline-code-attrs-start title = 'AddSSOUser Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `AddSSOUser`'den dönen yanıt: AddSSOUserAPIResponse
