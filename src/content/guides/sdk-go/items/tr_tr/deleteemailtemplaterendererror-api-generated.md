...
[inline-code-attrs-start title = 'DeleteEmailTemplateRenderError Örneği'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// `DeleteEmailTemplateRenderError`'den dönen yanıt: FlagCommentPublic200Response
