...
Връща: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)
...
func main() {
	...
	endTime := int64(789) // int64 |  (по избор)
	...
	// отговор от `GetGlobalEventLog`: GetEventLogResponse
