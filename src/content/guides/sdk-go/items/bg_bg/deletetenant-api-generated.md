...
[inline-code-attrs-start title = 'Пример за DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (по избор)
	...
	// отговор от `DeleteTenant`: APIEmptyResponse
