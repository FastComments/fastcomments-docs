...
Връща: [`ModerationAPIGetCommentsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_get_comments_response.go)

## Example

[inline-code-attrs-start title = 'Пример за GetApiComments'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	count := float64(1.2) // float64 |  (по избор)
	...
	// отговор от `GetApiComments`: ModerationAPIGetCommentsResponse
