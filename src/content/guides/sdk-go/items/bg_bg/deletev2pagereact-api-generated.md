...
[inline-code-attrs-start title = 'Пример за DeleteV2PageReact'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `DeleteV2PageReact`: CreateV1PageReact
