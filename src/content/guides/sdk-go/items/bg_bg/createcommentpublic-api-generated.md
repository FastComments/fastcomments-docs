...
Връща: [`SaveCommentsResponseWithPresence`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_save_comments_response_with_presence.go)

## Пример

[inline-code-attrs-start title = 'Пример за CreateCommentPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sessionId := "sessionId_example" // string |  (по избор)
	...
	// отговор от `CreateCommentPublic`: SaveCommentsResponseWithPresence
