...
[inline-code-attrs-start title = 'Пример за UpdateUserNotificationStatus'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `UpdateUserNotificationStatus`: UpdateUserNotificationStatus200Response
