...
Връща: [`RenderEmailTemplate200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_render_email_template_200_response.go)
...
func main() {
	...
	locale := "locale_example" // низ |  (незадължително)
	...
	// отговор от `RenderEmailTemplate`: RenderEmailTemplate200Response
