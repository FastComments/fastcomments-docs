...
Връща: [`CreateTenantPackageResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_package_response.go)
...
func main() {
	...
	// отговор от `CreateTenantPackage`: CreateTenantPackageResponse
