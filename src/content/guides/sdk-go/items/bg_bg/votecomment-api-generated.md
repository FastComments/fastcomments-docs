...
Връща: [`VoteResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_vote_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за VoteComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sessionId := "sessionId_example" // string |  (незадължително)
	...
	// отговор от `VoteComment`: VoteResponse
