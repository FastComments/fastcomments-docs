...
Връща: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_sso_user_by_id_api_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за GetSSOUserById'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
