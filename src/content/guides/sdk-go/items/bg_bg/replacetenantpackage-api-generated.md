...
[inline-code-attrs-start title = 'Пример за ReplaceTenantPackage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `ReplaceTenantPackage`: APIEmptyResponse
