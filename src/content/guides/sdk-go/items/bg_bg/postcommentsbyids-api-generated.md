...
[inline-code-attrs-start title = 'Пример за PostCommentsByIds'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `PostCommentsByIds`: ModerationAPIChildCommentsResponse
