...
Връща: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)
...
func main() {
	...
	updateComments := true // bool |  (по избор)
	...
	// отговор от `PutSSOUser`: PutSSOUserAPIResponse
