...
[inline-code-attrs-start title = 'Пример за ReplaceTenantUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := "updateComments_example" // string |  (по избор)
	...
	// отговор от `ReplaceTenantUser`: FlagCommentPublic200Response
