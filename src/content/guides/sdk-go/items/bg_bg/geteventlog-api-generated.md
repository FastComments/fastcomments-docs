...
[inline-code-attrs-start title = 'Пример за GetEventLog'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	endTime := int64(789) // int64 |  (незадължително)
	...
	// отговор от `GetEventLog`: GetEventLogResponse
