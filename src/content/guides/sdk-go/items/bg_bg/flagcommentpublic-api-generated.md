...
[inline-code-attrs-start title = 'Пример за FlagCommentPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `FlagCommentPublic`: FlagCommentPublic200Response
