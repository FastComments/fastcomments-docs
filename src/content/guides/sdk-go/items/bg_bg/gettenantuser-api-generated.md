...
Връща: [`GetTenantUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_user_response.go)
...
func main() {
	...
	// отговор от `GetTenantUser`: GetTenantUserResponse
