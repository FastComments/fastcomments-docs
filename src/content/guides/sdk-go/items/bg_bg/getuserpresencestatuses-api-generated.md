...
Връща: [`GetUserPresenceStatuses200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_presence_statuses_200_response.go)

## Пример

[inline-code-attrs-start title = 'Пример на GetUserPresenceStatuses'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `GetUserPresenceStatuses`: GetUserPresenceStatuses200Response
