...
Връща: [`CreateQuestionResult200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_question_result_200_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за CreateQuestionResult'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Отговор от `CreateQuestionResult`: CreateQuestionResult200Response
