...
Връща: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_pre_ban_summary.go)
...
func main() {
	...
	includeByUserIdAndEmail := true // bool |  (по избор)
	includeByIP := true // bool |  (по избор)
	includeByEmailDomain := true // bool |  (по избор)
	...
	// отговор от `PostBulkPreBanSummary`: BulkPreBanSummary
