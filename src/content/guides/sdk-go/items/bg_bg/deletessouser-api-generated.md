...
Връща: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_sso_user_api_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за DeleteSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := true // bool |  (по избор)
	...
	// отговор от `DeleteSSOUser`: DeleteSSOUserAPIResponse
