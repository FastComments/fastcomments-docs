...
Връща: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_page_api_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за AddPage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `AddPage`: AddPageAPIResponse
