...
[inline-code-attrs-start title = 'Пример за DeleteV1PageReact'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `DeleteV1PageReact`: CreateV1PageReact
