...
Връща: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Example

[inline-code-attrs-start title = 'Пример за AddDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `AddDomainConfig`: AddDomainConfig200Response
