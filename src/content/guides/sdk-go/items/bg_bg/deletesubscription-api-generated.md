...
Връща: [`DeleteSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_subscription_api_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за DeleteSubscription'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `DeleteSubscription`: DeleteSubscriptionAPIResponse
