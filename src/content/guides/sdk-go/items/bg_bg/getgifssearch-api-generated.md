...
Връща: [`GetGifsSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_gifs_search_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за GetGifsSearch'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	rating := "rating_example" // string |  (по избор)
	...
	// отговор от `GetGifsSearch`: GetGifsSearchResponse
