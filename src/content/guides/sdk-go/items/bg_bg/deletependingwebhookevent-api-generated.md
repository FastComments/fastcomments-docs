...
[inline-code-attrs-start title = 'Пример за DeletePendingWebhookEvent'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `DeletePendingWebhookEvent`: FlagCommentPublic200Response
