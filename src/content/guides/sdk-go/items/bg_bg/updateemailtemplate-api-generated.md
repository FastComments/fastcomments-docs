...
[inline-code-attrs-start title = 'UpdateEmailTemplate Пример'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `UpdateEmailTemplate`: APIEmptyResponse
