...
Връща: [`GetUserReactsPublic200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_reacts_public_200_response.go)
...
func main() {
	...
	postIds := []string{"Inner_example"} // []string |  (незадължително)
