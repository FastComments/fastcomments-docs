...
Връща: [`GetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_text_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за GetModerationCommentText'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Отговор от `GetModerationCommentText`: GetCommentTextResponse
