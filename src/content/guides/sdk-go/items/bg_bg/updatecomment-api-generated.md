...
[inline-code-attrs-start title = 'Пример за UpdateComment'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	contextUserId := "contextUserId_example" // string |  (незадължително)
	...
	// отговор от `UpdateComment`: APIEmptyResponse
