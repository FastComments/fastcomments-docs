...
Връща: [`GetV2PageReactUsersResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_v2_page_react_users_response.go)

## Пример

[inline-code-attrs-start title = 'Пример за GetV2PageReactUsers'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
