...
[inline-code-attrs-start title = 'Пример за ResetUserNotificationCount'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// отговор от `ResetUserNotificationCount`: ResetUserNotifications200Response
