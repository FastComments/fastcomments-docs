...
Връща: [`AggregateQuestionResultsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_aggregate_question_results_response.go)
...
func main() {
	...
	// отговор от `AggregateQuestionResults`: AggregateQuestionResultsResponse
