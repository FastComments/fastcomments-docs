...
Renvoie : [`GetEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_email_template_response.go)
...
func main() {
	...
	// réponse de `GetEmailTemplate` : GetEmailTemplateResponse
