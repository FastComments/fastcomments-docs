...
Retourne : [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_sso_user_api_response.go)

## Exemple

[inline-code-attrs-start title = 'Exemple PutSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (optionnel)
	...
	// réponse de `PutSSOUser` : PutSSOUserAPIResponse
