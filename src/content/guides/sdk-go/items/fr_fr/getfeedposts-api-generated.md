...
Retourne : [`GetFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_feed_posts_response.go)
...
func main() {
	...
	// réponse de `GetFeedPosts` : GetFeedPostsResponse
