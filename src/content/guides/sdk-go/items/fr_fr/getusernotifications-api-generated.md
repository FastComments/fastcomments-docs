...
Renvoie : [`GetMyNotificationsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_my_notifications_response.go)
...
func main() {
	...
	urlId := "urlId_example" // string | Permet de déterminer si la page actuelle est abonnée. (optionnel)
