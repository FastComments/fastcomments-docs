...
[inline-code-attrs-start title = 'Exemple DeleteModerator'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sendEmail := "sendEmail_example" // string |  (optionnel)
	...
	// réponse de `DeleteModerator`: FlagCommentPublic200Response
