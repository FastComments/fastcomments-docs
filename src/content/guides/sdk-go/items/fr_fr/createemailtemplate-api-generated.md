...
Renvoie: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_email_template_response.go)
...
func main() {
	...
	// réponse de `CreateEmailTemplate`: CreateEmailTemplateResponse
