...
Renvoie : [`PreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_pre_ban_summary.go)
...
func main() {
	...
	// réponse de `GetPreBanSummary`: PreBanSummary
