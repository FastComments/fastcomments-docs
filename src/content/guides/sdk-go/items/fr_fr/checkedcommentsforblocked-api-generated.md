...
| commentIds | string | query | Oui | Une liste d'ID de commentaires séparés par des virgules. |
...
func main() {
	...
	commentIds := "commentIds_example" // string | Liste d'ID de commentaires séparés par des virgules.
