...
[inline-code-attrs-start title = 'PostFlagComment Exemple'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "Erreur lors de l'appel de `ModerationAPI.PostFlagComment``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Réponse HTTP complète: %v\n", r)
	}
	// réponse de `PostFlagComment` : APIEmptyResponse
	fmt.Fprintf(os.Stdout, "Réponse de `ModerationAPI.PostFlagComment`: %v\n", resp)
}
[inline-code-end]