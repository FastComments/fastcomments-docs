...
回傳: [`GetFeedPostsStats200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_feed_posts_stats_200_response.go)
...
func main() {
	...
	// `GetFeedPostsStats` 的回應: GetFeedPostsStats200Response
