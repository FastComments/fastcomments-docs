...
回傳: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_email_template_response.go)
...
func main() {
	...
	// 來自 `CreateEmailTemplate` 的回應: CreateEmailTemplateResponse
