...
回傳: [`ModerationAPICommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_comment_response.go)
...
func main() {
	...
	// 來自 `GetModerationComment`: ModerationAPICommentResponse
