...
回傳: [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_save_comment_response.go)
...
func main() {
	...
	// 回應來自 `SaveComment`： APISaveCommentResponse
