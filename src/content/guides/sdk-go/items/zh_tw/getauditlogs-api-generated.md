...
[inline-code-attrs-start title = 'GetAuditLogs 範例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	order := openapiclient.SORT_DIR("ASC") // SORTDIR |  (可選)
	after := float64(1.2) // float64 |  (可選)
	before := float64(1.2) // float64 |  (可選)
