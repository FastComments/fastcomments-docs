...
[inline-code-attrs-start title = 'PostCommentsByIds 範例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 從 `PostCommentsByIds` 返回的回應: ModerationAPIChildCommentsResponse
