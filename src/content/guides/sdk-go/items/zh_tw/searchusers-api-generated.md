...
回傳: [`SearchUsers200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_search_users_200_response.go)
...
func main() {
	...
	mentionGroupIds := []string{"Inner_example"} // []string |  (可選)
	...
	// `SearchUsers` 的回應：SearchUsers200Response
