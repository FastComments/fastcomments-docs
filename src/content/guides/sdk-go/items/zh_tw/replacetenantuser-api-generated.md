...
[inline-code-attrs-start title = 'ReplaceTenantUser 範例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := "updateComments_example" // string |  （可選）
	...
	// 從 `ReplaceTenantUser` 的回應: FlagCommentPublic200Response
