...
回傳：[`GetTenantsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenants_response.go)
...
func main() {
	...
	// 從 `GetTenants` 的回應：GetTenantsResponse
