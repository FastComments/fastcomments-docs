...
回傳: [`CheckedCommentsForBlocked200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_checked_comments_for_blocked_200_response.go)
...
func main() {
	...
	// 從 `CheckedCommentsForBlocked` 的回應: CheckedCommentsForBlocked200Response
