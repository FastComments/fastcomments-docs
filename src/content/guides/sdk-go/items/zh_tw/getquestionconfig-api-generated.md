...
回傳: [`GetQuestionConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_config_response.go)
...
func main() {
	...
	// 從 `GetQuestionConfig` 的回應: GetQuestionConfigResponse
