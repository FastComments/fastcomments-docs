...
回傳：[`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_tenant_user_response.go)
...
func main() {
	...
	// 從 `CreateTenantUser` 的回應：CreateTenantUserResponse
