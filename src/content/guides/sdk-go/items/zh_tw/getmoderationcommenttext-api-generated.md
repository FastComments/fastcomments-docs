...
回傳: [`GetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_text_response.go)

## 範例

[inline-code-attrs-start title = 'GetModerationCommentText 範例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 從 `GetModerationCommentText` 的回應：GetCommentTextResponse
