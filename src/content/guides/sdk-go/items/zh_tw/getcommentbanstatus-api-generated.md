...
回傳: [`GetCommentBanStatusResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_ban_status_response.go)
...
func main() {
	...
	// 從 `GetCommentBanStatus` 的回應：GetCommentBanStatusResponse
