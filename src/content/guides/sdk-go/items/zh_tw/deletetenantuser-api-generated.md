...
[inline-code-attrs-start title = 'DeleteTenantUser 範例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := "deleteComments_example" // string |  (可選)
	...
	// 從 `DeleteTenantUser` 的回應：FlagCommentPublic200Response
