...
回傳: [`RenderEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_render_email_template_response.go)
...
func main() {
	...
	// 來自 `RenderEmailTemplate` 的回應: RenderEmailTemplateResponse
