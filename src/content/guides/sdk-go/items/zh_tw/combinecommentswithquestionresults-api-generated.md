...
回傳: [`CombineCommentsWithQuestionResults200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_combine_comments_with_question_results_200_response.go)
...
func main() {
	...
	// 來自 `CombineCommentsWithQuestionResults` 的回應：CombineCommentsWithQuestionResults200Response
