...
回傳: [`DeleteFeedPostPublicResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_feed_post_public_response.go)
...
func main() {
	...
	// 來自 `DeleteFeedPostPublic` 的回應: DeleteFeedPostPublicResponse
