...
回傳：[`GetEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_email_template_response.go)
...
func main() {
	...
	// 從 `GetEmailTemplate` 的回應：GetEmailTemplateResponse
