...
[inline-code-attrs-start title = 'Esempio DeleteTenant'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sure := "sure_example" // string |  (opzionale)
	...
	// risposta da `DeleteTenant`: APIEmptyResponse
