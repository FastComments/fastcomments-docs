...
Restituisce: [`ModerationAPIChildCommentsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_child_comments_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di PostCommentsByIds'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `PostCommentsByIds`: ModerationAPIChildCommentsResponse
