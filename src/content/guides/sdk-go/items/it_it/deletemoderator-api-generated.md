...
[inline-code-attrs-start title = 'Esempio di DeleteModerator'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sendEmail := "sendEmail_example" // string |  (opzionale)
	...
	// risposta da `DeleteModerator`: APIEmptyResponse
