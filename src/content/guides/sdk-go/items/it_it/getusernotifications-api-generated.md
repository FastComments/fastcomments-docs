...
Restituisce: [`GetMyNotificationsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_my_notifications_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio GetUserNotifications'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	urlId := "urlId_example" // string | Utilizzato per determinare se la pagina corrente è sottoscritta. (opzionale)
	...
	includeTenantNotifications := true // bool |  (opzionale)
	...
	// risposta da `GetUserNotifications`: GetMyNotificationsResponse
