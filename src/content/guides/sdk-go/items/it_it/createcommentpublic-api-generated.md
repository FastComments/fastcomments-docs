...
Restituisce: [`SaveCommentsResponseWithPresence`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_save_comments_response_with_presence.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di CreateCommentPublic'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sessionId := "sessionId_example" // string |  (opzionale)
	...
	// risposta da `CreateCommentPublic`: SaveCommentsResponseWithPresence
