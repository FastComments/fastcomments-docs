...
Restituisce: [`GetCommentVoteUserNamesSuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_vote_user_names_success_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetCommentVoteUserNames'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `GetCommentVoteUserNames`: GetCommentVoteUserNamesSuccessResponse
