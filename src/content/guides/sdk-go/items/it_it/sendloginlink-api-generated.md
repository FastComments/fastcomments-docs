...
[inline-code-attrs-start title = 'Esempio di SendLoginLink'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  (opzionale)
	...
	// risposta da `SendLoginLink`: APIEmptyResponse
