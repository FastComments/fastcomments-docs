...
Restituisce: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di UpdateSubscription'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// Risposta da `UpdateSubscription`: UpdateSubscriptionAPIResponse
