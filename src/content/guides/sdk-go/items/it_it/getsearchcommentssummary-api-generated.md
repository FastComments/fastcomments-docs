...
Restituisce: [`ModerationCommentSearchResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_comment_search_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetSearchCommentsSummary'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `GetSearchCommentsSummary`: ModerationCommentSearchResponse
