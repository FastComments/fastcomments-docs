...
Restituisce: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_aggregate_question_results_200_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di BulkAggregateQuestionResults'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `BulkAggregateQuestionResults`: BulkAggregateQuestionResults200Response
