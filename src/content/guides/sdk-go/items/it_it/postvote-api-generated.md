...
[inline-code-attrs-start title = 'Esempio di PostVote'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	direction := "direction_example" // string |  (opzionale)
	...
	// risposta da `PostVote`: VoteResponse
