...
Restituisce: [`ModerationAPICountCommentsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_moderation_api_count_comments_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetCount'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	filter := "filter_example" // string |  (opzionale)
	...
	// risposta da `GetCount`: ModerationAPICountCommentsResponse
