...
Restituisce: [`APIGetUserBadgesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_get_user_badges_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetUserBadges'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	badgeId := "badgeId_example" // string |  (opzionale)
	type_ := float64(1.2) // float64 |  (opzionale)
	displayedOnComments := true // bool |  (opzionale)
	...
	// risposta da `GetUserBadges`: APIGetUserBadgesResponse
