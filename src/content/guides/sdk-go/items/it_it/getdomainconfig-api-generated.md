...
Restituisce: [`GetDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_domain_config_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `GetDomainConfig`: GetDomainConfigResponse
