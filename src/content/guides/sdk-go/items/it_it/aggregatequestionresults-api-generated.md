...
Restituisce: [`AggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_aggregate_question_results_200_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di AggregateQuestionResults'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	timeBucket := openapiclient.AggregateTimeBucket("day") // AggregateTimeBucket |  (opzionale)
	...
	// risposta da `AggregateQuestionResults`: AggregateQuestionResults200Response
