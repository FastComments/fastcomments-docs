...
Restituisce: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di AddDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `AddDomainConfig`: AddDomainConfig200Response
