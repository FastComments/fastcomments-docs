...
Restituisce: [`ChangeTicketStateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_change_ticket_state_response.go)
...
func main() {
	...
	// risposta da `ChangeTicketState`: ChangeTicketStateResponse
