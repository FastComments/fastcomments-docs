...
Restituisce: [`GetTenantPackagesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_packages_response.go)
...
func main() {
	...
	// risposta da `GetTenantPackages`: GetTenantPackagesResponse
