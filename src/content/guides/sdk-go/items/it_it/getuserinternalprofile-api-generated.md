...
Restituisce: [`GetUserInternalProfileResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_internal_profile_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio di GetUserInternalProfile'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `GetUserInternalProfile`: GetUserInternalProfileResponse
