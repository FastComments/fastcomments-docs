...
Restituisce: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_page_api_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio PatchPage'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `PatchPage`: PatchPageAPIResponse
