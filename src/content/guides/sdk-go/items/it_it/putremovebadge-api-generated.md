...
Restituisce: [`RemoveUserBadgeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_remove_user_badge_response.go)

## Esempio

[inline-code-attrs-start title = 'Esempio PutRemoveBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// risposta da `PutRemoveBadge`: RemoveUserBadgeResponse
