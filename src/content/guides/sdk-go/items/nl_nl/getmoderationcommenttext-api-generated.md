...
Retourneert: [`GetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comment_text_response.go)
...
func main() {
	...
	// response van `GetModerationCommentText`: GetCommentTextResponse
