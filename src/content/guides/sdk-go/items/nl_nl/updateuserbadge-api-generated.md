...
Retourneert: [`APIEmptySuccessResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_empty_success_response.go)
...
func main() {
	...
	// antwoord van `UpdateUserBadge`: APIEmptySuccessResponse
