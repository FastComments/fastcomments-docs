...
[inline-code-attrs-start title = 'PostVote Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	direction := "direction_example" // string |  (optioneel)
	...
	// antwoord van `PostVote`: VoteResponse
