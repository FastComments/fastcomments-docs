...
Geeft terug: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_sso_user_api_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'PatchSSOUser Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// antwoord van `PatchSSOUser`: PatchSSOUserAPIResponse
