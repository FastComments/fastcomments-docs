...
Geeft terug: [`ResetUserNotificationsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_reset_user_notifications_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'ResetUserNotifications Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// antwoord van `ResetUserNotifications`: ResetUserNotificationsResponse
