...
Retourneert: [`GetGifsTrendingResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_gifs_trending_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'GetGifsTrending Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// respons van `GetGifsTrending`: GetGifsTrendingResponse
