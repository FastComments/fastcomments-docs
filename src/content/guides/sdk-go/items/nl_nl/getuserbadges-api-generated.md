...
Geeft terug: [`APIGetUserBadgesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_get_user_badges_response.go)
...
func main() {
	...
	// antwoord van `GetUserBadges`: APIGetUserBadgesResponse
