...
Retourneert: [`PublicAPIGetCommentTextResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_api_get_comment_text_response.go)
...
func main() {
	...
	// antwoord van `GetCommentText`: PublicAPIGetCommentTextResponse
