...
Retourneert: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_email_template_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'CreateEmailTemplate Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// response van `CreateEmailTemplate`: CreateEmailTemplateResponse
