...
Retourneert: [`GetBannedUsersCountResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_banned_users_count_response.go)
...
func main() {
	...
	// antwoord van `GetCounts`: GetBannedUsersCountResponse
