...
Retourneert: [`PublicAPIDeleteCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_public_api_delete_comment_response.go)
...
func main() {
	...
	// Antwoord van `DeleteCommentPublic`: PublicAPIDeleteCommentResponse
