...
[inline-code-attrs-start title = 'SendLoginLink Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	redirectURL := "redirectURL_example" // string |  (optioneel)
	...
	// respons van `SendLoginLink`: FlagCommentPublic200Response
