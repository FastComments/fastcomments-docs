...
Geeft terug: [`GetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_trust_factor_response.go)
...
func main() {
	...
	// reactie van `GetTrustFactor`: GetUserTrustFactorResponse
