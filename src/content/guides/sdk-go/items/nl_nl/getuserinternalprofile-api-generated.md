...
Geeft terug: [`GetUserInternalProfileResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_user_internal_profile_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'GetUserInternalProfile Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// antwoord van `GetUserInternalProfile`: GetUserInternalProfileResponse
