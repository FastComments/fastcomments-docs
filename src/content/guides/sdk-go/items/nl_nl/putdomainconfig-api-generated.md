...
Retourneert: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_domain_config_response.go)
...
func main() {
	...
	// antwoord van `PutDomainConfig`: PutDomainConfigResponse
