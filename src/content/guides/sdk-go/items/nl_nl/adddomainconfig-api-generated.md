...
Retourneert: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'AddDomainConfig Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// antwoord van `AddDomainConfig`: AddDomainConfig200Response
