...
Geeft terug: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_sso_user_api_response.go)

## Voorbeeld

[inline-code-attrs-start title = 'AddSSOUser Voorbeeld'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// reactie van `AddSSOUser`: AddSSOUserAPIResponse
