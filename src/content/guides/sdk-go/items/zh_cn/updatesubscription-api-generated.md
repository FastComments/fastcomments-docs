...
返回：[`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)

## 示例

[inline-code-attrs-start title = 'UpdateSubscription 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 来自 `UpdateSubscription` 的响应: UpdateSubscriptionAPIResponse
