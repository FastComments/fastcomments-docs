...
返回: [`GetEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_email_template_response.go)
...
func main() {
	...
	// 来自 `GetEmailTemplate` 的响应: GetEmailTemplateResponse
