...
返回: [`GetCommentsResponseWithPresencePublicComment`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_comments_response_with_presence_public_comment_.go)

## 示例

[inline-code-attrs-start title = 'GetCommentsPublic 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	countChildren := true // bool |  (可选)
	fetchPageForCommentId := "fetchPageForCommentId_example" // string |  (可选)
	includeConfig := true // bool |  (可选)
	countAll := true // bool |  (可选)
	includei10n := true // bool |  (可选)
	locale := "locale_example" // string |  (可选)
	modules := "modules_example" // string |  (可选)
	isCrawler := true // bool |  (可选)
	includeNotificationCount := true // bool |  (可选)
	asTree := true // bool |  (可选)
	maxTreeDepth := int32(56) // int32 |  (可选)
	useFullTranslationIds := true // bool |  (可选)
	parentId := "parentId_example" // string |  (可选)
	searchText := "searchText_example" // string |  (可选)
	hashTags := []string{"Inner_example"} // []string |  (可选)
	userId := "userId_example" // string |  (可选)
	customConfigStr := "customConfigStr_example" // string |  (可选)
	afterCommentId := "afterCommentId_example" // string |  (可选)
	beforeCommentId := "beforeCommentId_example" // string |  (可选)
	...
	// 来自 `GetCommentsPublic` 的响应: GetCommentsResponseWithPresencePublicComment
