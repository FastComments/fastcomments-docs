...
返回: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_put_domain_config_response.go)

## 示例

[inline-code-attrs-start title = 'PutDomainConfig 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 来自 `PutDomainConfig` 的响应: PutDomainConfigResponse
