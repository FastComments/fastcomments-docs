...
返回: [`ResetUserNotificationsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_reset_user_notifications_response.go)

## 示例

[inline-code-attrs-start title = 'ResetUserNotifications 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 来自 `ResetUserNotifications` 的响应：ResetUserNotificationsResponse
