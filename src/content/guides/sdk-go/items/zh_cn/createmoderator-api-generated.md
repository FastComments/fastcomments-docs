...
返回: [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_moderator_response.go)
...
func main() {
	...
	// 来自 `CreateModerator` 的响应: CreateModeratorResponse
