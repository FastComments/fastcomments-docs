...
[inline-code-attrs-start title = 'GetModerationComment 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	includeEmail := true // bool |  (可选)
	includeIP := true // bool |  (可选)
	...
	// 来自 `GetModerationComment` 的响应: ModerationAPICommentResponse
