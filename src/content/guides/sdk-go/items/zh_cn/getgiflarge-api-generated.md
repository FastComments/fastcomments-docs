...
返回: [`GifGetLargeResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_gif_get_large_response.go)

## 示例

[inline-code-attrs-start title = 'GetGifLarge 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 来自 `GetGifLarge` 的响应：GifGetLargeResponse
