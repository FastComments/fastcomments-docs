...
返回: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_posts_response.go)
...
func main() {
	...
	// 来自 `CreateFeedPost` 的响应: CreateFeedPostsResponse
