...
[inline-code-attrs-start title = 'DeleteModerator 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	sendEmail := "sendEmail_example" // string |  （可选）
	...
	// 来自 `DeleteModerator` 的响应：APIEmptyResponse
