...
返回: [`GetEmailTemplateDefinitions200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_email_template_definitions_200_response.go)
...
func main() {
	...
	// 来自 `GetEmailTemplateDefinitions` 的响应: GetEmailTemplateDefinitions200Response
