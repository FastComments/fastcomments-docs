...
返回: [`GetTenantDailyUsagesResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_tenant_daily_usages_response.go)

## 示例

[inline-code-attrs-start title = 'GetTenantDailyUsages 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	yearNumber := float64(1.2) // float64 |  (可选)
	monthNumber := float64(1.2) // float64 |  (可选)
	dayNumber := float64(1.2) // float64 |  (可选)
	...
	// 来自 `GetTenantDailyUsages` 的响应: GetTenantDailyUsagesResponse
