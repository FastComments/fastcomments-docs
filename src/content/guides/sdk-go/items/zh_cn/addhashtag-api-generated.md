...
返回: [`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_hash_tag_response.go)
...
func main() {
	...
	// 来自 `AddHashTag` 的响应: CreateHashTagResponse
