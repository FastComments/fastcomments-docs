...
返回: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_event_log_response.go)

## 示例

[inline-code-attrs-start title = 'GetEventLog 示例'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// 来自 `GetEventLog` 的响应: GetEventLogResponse
