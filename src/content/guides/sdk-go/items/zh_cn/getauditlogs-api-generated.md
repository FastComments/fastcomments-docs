...
返回: [`GetAuditLogsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_audit_logs_response.go)
...
func main() {
	...
	// 来自 `GetAuditLogs` 的响应: GetAuditLogsResponse
