...
返回: [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_api_save_comment_response.go)
...
func main() {
	...
	// 来自 `SaveComment` 的响应：APISaveCommentResponse
