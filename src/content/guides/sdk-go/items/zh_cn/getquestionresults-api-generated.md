...
返回：[`GetQuestionResultsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_question_results_response.go)
...
func main() {
	...
	// 来自 `GetQuestionResults` 的响应: GetQuestionResultsResponse
