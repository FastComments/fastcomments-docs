...
[inline-code-attrs-start title = 'Przykład GetManualBadgesForUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	badgesUserId := "badgesUserId_example" // string |  (opcjonalne)
	...
	// odpowiedź z `GetManualBadgesForUser`: GetUserManualBadgesResponse
