...
Zwraca: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_patch_sso_user_api_response.go)

## Przykład

[inline-code-attrs-start title = 'Przykład PatchSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	updateComments := true // bool |  (opcjonalne)
	...
	// odpowiedź z `PatchSSOUser`: PatchSSOUserAPIResponse
