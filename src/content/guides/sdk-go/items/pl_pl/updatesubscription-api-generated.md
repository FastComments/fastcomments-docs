...
Zwraca: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_update_subscription_api_response.go)

## Przykład

[inline-code-attrs-start title = 'Przykład UpdateSubscription'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odpowiedź z `UpdateSubscription`: UpdateSubscriptionAPIResponse
