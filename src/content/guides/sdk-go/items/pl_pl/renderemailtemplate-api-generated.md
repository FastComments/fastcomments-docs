...
Zwraca: [`RenderEmailTemplateResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_render_email_template_response.go)

## Przykład

[inline-code-attrs-start title = 'Przykład RenderEmailTemplate'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odpowiedź z `RenderEmailTemplate`: RenderEmailTemplateResponse
