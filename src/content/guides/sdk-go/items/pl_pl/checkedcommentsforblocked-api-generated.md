...
Zwraca: [`CheckedCommentsForBlocked200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_checked_comments_for_blocked_200_response.go)

## Przykład

[inline-code-attrs-start title = 'Przykład CheckedCommentsForBlocked'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	commentIds := "commentIds_example" // string | Lista identyfikatorów komentarzy rozdzielona przecinkami.
