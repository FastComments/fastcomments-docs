...
Zwraca: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_bulk_pre_ban_summary.go)

## Przykład

[inline-code-attrs-start title = 'PostBulkPreBanSummary Przykład'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	includeByUserIdAndEmail := true // bool |  (opcjonalnie)
	includeByIP := true // bool |  (opcjonalnie)
	includeByEmailDomain := true // bool |  (opcjonalnie)
	...
	// odpowiedź z `PostBulkPreBanSummary`: BulkPreBanSummary
