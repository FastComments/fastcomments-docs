...
Zwraca: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_user_badge_200_response.go)

## Przykład

[inline-code-attrs-start title = 'Przykład CreateUserBadge'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// odpowiedź z `CreateUserBadge`: CreateUserBadge200Response
