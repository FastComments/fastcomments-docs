...
Zwraca: [`GetHashTagsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_hash_tags_response.go)
...
func main() {
	...
	// odpowiedź z `GetHashTags`: GetHashTagsResponse
