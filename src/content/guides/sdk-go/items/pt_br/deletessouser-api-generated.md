...
Retorna: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_delete_sso_user_api_response.go)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de DeleteSSOUser'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	deleteComments := true // bool |  (opcional)
	...
	// resposta de `DeleteSSOUser`: DeleteSSOUserAPIResponse
