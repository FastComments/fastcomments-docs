...
Retorna: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_create_feed_posts_response.go)
...
func main() {
	...
	// resposta de `CreateFeedPost`: CreateFeedPostsResponse
