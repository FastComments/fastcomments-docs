...
| ids | string | query | Sim | IDs de usuário separados por vírgula. |

## Resposta

Retorna: [`PageUsersInfoResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_page_users_info_response.go)

## Exemplo

[inline-code-attrs-start title = 'Exemplo GetUsersInfo'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	ids := "ids_example" // string | IDs de usuário separados por vírgula.
	...
	// resposta de `GetUsersInfo`: PageUsersInfoResponse
