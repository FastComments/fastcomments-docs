...
Retorna: [`GetTicketResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_get_ticket_response.go)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de GetTicket'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// resposta de `GetTicket`: GetTicketResponse
