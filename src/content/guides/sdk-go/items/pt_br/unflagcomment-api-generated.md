...
Retorna: [`FlagCommentResponse`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_flag_comment_response.go)
...
func main() {
	...
	// resposta de `UnFlagComment`: FlagCommentResponse
