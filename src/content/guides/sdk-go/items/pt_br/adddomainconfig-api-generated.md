...
Retorna: [`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-go/blob/master/client/model_add_domain_config_200_response.go)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de AddDomainConfig'; type = 'go'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
package main
...
func main() {
	...
	// resposta de `AddDomainConfig`: AddDomainConfig200Response
