...
[inline-code-attrs-start title = 'MCP Endepunkt'; type = 'text'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Claude Code Opsætning'; type = 'bash'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'API-nøgle Endepunkt'; type = 'text'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
