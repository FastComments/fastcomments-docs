When sharing code snippets, FastComments tries to automatically detect which
programming language the code snippet is in so it can automatically format it and apply syntax highlighting.
