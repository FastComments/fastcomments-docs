---
Les snippets de code sont de petits morceaux de code, d'où le terme "snippets" de code, qui peuvent être partagés lors de la rédaction d'un commentaire.
...
Avec FastComments, il suffit de coller un snippet de code pour qu'il soit automatiquement détecté et formaté.

Lors de la rédaction d'un commentaire, le snippet de code sera entouré de blocs `<code>`, et le formatage se produit
après l'envoi de votre commentaire.

L'encapsulation dans des blocs `<code>` est automatique lorsque vous collez un snippet de code, dans de nombreux langages.

Sinon, vous pouvez sélectionner un passage de texte et cliquer sur le bouton `Code` dans la barre d'outils.
