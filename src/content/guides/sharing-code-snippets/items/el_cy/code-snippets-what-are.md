Τα αποσπάσματα κώδικα είναι μικρά κομμάτια κώδικα, hence "snippets" of code, που μπορούν να κοινοποιηθούν όταν σχολιάζετε.
...
Όταν σχολιάζετε, το απόσπασμα κώδικα θα τυλιχθεί σε `<code>` blocks, και η μορφοποίηση γίνεται
αφού υποβάλετε το σχόλιό σας.

Το τύλιγμα σε `<code>` blocks γίνεται αυτόματα όταν επικολλάτε ένα απόσπασμα κώδικα, σε πολλές γλώσσες.

Εναλλακτικά, μπορείτε να επιλέξετε ένα κομμάτι κειμένου και να κάνετε κλικ στο κουμπί `Code` στη γραμμή εργαλείων.
