---
Fragmenty kodu to małe kawałki kodu, stąd nazwa "snippets" kodu, które można udostępniać podczas komentowania.
...
W FastComments wystarczy wkleić fragment kodu, aby został automatycznie wykryty i sformatowany.

Podczas komentowania fragment kodu zostanie opakowany w bloki `<code>`, a formatowanie nastąpi
po przesłaniu komentarza.

Opakowanie w bloki `<code>` jest automatyczne podczas wklejania fragmentu kodu, w wielu językach.
