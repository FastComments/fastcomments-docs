Code-Snippets sind kleine Teile von Code, daher "Snippets", die beim Kommentieren geteilt werden können.
...
Bei FastComments sollte das einfache Einfügen eines Codeausschnitts automatisch erkannt und formatiert werden.

When commenting, the code snippet will be wrapped in `<code>` blocks, and the formatting happens
nachdem Sie Ihren Kommentar abgesendet haben.

Das Einschließen in `<code>`-Blöcke erfolgt automatisch beim Einfügen eines Codeausschnitts, in vielen Sprachen.

Alternativ können Sie eine Textpassage markieren und in der Symbolleiste auf die Schaltfläche `Code` klicken.
