Codefragmenten zijn kleine stukjes code, vandaar de term "snippets", die gedeeld kunnen worden bij het plaatsen van een opmerking.
...
Met FastComments zou het simpelweg plakken van een codefragment automatisch moeten worden gedetecteerd en geformatteerd.

Bij het reageren wordt het codefragment omgeven door `<code>`-blokken, en de opmaak gebeurt nadat je je opmerking hebt verzonden.

Het omhullen met `<code>`-blokken gebeurt automatisch wanneer je een codefragment plakt, in veel talen.

Alternatief kun je een stuk tekst markeren en op de `Code`-knop in de werkbalk klikken.