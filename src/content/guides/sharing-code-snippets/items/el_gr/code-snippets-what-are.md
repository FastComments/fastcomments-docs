Τα αποσπάσματα κώδικα είναι μικρά κομμάτια κώδικα, επομένως «αποσπάσματα» κώδικα, που μπορούν να κοινοποιηθούν κατά το σχολιασμό.
...
Με το FastComments, απλώς επικολλώντας ένα απόσπασμα κώδικα θα πρέπει να ανιχνεύεται και να μορφοποιείται αυτόματα.

Κατά το σχολιασμό, το απόσπασμα κώδικα θα τοποθετηθεί μέσα σε μπλοκ `<code>`, και η μορφοποίηση συμβαίνει
αφού υποβάλετε το σχόλιό σας.
