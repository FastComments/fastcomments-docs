---
When sharing code snippets, FastComments does its best to automatically determine which
программирование язык фрагмента кода, чтобы автоматически отформатировать и применить подсветку синтаксиса.
