Фрагменты кода — это небольшие куски кода, отсюда термин "snippets", которые можно публиковать в комментариях.
...
В FastComments при простом вставлении фрагмента кода он должен автоматически распознаваться и форматироваться.

При комментировании фрагмент кода будет обёрнут в блоки `<code>`, а форматирование произойдёт после отправки комментария.

Оборачивание в блоки `<code>` выполняется автоматически при вставке фрагмента кода во многих языках.

Кроме того, вы можете выделить часть текста и нажать кнопку `Code` на панели инструментов.