Isječci koda su mali dijelovi koda, otuda naziv "isječci" koda, koji se mogu dijeliti prilikom komentarisanja.
...
Uz FastComments, jednostavno lijepljenje isječka koda bi trebalo da se automatski otkrije i formatira.

Prilikom komentarisanja, isječak koda će biti obavijen u `<code>` blokove, a formatiranje se vrši
nakon što pošaljete svoj komentar.

Obavijanje u `<code>` blokove je automatsko prilikom lijepljenja isječka koda, u mnogim programskim jezicima.

Alternativno, možete označiti dio teksta i kliknuti na dugme `Code` u alatnoj traci.