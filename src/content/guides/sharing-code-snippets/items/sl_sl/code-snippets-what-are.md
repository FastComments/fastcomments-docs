Kodni izrezki so majhni koščki kode, torej "izrezki" kode, ki jih je mogoče deliti med komentiranjem.
...
Z FastComments se z enostavnim lepljenjem izrezka kode ta samodejno zazna in formatira.

Pri komentiranju bo izrezek kode zavit v `<code>` bloke, in formatiranje se izvede
po oddaji vašega komentarja.

Zavijanje v `<code>` bloke je samodejno pri lepljenju izrezka kode v mnogih jezikih.

Alternativno lahko označite del besedila in kliknete gumb `Code` na orodni vrstici.