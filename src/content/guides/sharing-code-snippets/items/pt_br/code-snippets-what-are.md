Trechos de código são pequenos pedaços de código, portanto "snippets" de código, que podem ser compartilhados ao comentar.
...
Com o FastComments, ao simplesmente colar um trecho de código, ele deve ser automaticamente detectado e formatado.

Ao comentar, o trecho de código será envolvido em blocos `<code>`, e a formatação acontece
depois que você enviar seu comentário.

A inclusão em blocos `<code>` é automática ao colar um trecho de código, em muitas linguagens.

Como alternativa, você pode destacar um trecho de texto e clicar no botão `Code` na barra de ferramentas.