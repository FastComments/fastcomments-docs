---
Фрагменти кода су мали делови кода, дакле "фрагменти" кода, који се могу делити при коментарисању.
...
Са FastComments-ом, једноставним налепљивањем фрагмента кода он би требало да буде аутоматски откривен и форматиран.

Када коментаришете, фрагмент кода ће бити обавијен у `<code>` блокове, а форматирање се дешава
 након што пошаљете свој коментар.

Обавијање у `<code>` блокове је аутоматско када налепите фрагмент кода, за многе језике.
