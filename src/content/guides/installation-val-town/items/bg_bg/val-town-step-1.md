...
[inline-code-attrs-start title = 'Уиджет за коментари в HTTP вал'; type='javascript' inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Резервен вариант без JavaScript'; type='html' inline-code-attrs-end]
[inline-code-start]
<noscript>
