...
[inline-code-attrs-start title = 'Віджет коментаря в HTTP val'; type='javascript' inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Резерв без JavaScript'; type='html' inline-code-attrs-end]
[inline-code-start]
<noscript>
