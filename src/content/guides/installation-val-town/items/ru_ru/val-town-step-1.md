...
[inline-code-attrs-start title = 'Виджет комментариев в HTTP val'; type='javascript' inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Запасной вариант без JavaScript'; type='html' inline-code-attrs-end]
[inline-code-start]
<noscript>
