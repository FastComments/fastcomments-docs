---
משתמשים שהתויגו יקבלו אימייל שמיידע אותם שהם תויגו או הוזכרו בתגובה.
...
כיבוי ההתראות ימנע שליחת האימיילים הללו, ובכל אימייל נכללת כותרת שמאפשרת ללקוחות הדוא"ל לאפשר למשתמש לבטל את המנוי בקלות.
