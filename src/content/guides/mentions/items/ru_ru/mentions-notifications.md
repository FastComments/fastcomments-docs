---
Помеченные пользователи получат электронное письмо с уведомлением о том, что их пометили (упомянули) в комментарии.
...
Отключение уведомлений предотвратит отправку этих писем, а в каждом письме присутствует заголовок, который позволяет почтовым клиентам удобно предоставить пользователю возможность отписаться.
