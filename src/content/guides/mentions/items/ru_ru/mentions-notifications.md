---
Отмеченные пользователи получат электронное письмо с уведомлением о том, что их отметили, то есть упомянули в комментарии.
...
Отключение уведомлений предотвратит отправку этих писем, а в каждом письме присутствует заголовок, позволяющий почтовым клиентам предоставить пользователю возможность легко отписаться.
