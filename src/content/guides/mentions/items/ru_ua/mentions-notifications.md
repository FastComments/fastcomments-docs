---
Отмеченные пользователи получат электронное письмо, уведомляющее их о том, что их отметили или упомянули в комментарии.
...
Отключение уведомлений прекратит отправку этих писем; в каждом письме есть заголовок, который позволяет почтовым клиентам легко предложить пользователю отписаться.
---