Отмеченные пользователи получат письмо, уведомляющее их о том, что их отметили или упомянули в комментарии.
...
Отключение уведомлений предотвратит получение этих писем, а в каждом письме присутствует заголовок, чтобы почтовые клиенты могли автоматически предложить пользователю отписаться.
