...
Desativar as notificações impedirá o envio desses e-mails, e um cabeçalho é fornecido em cada e-mail para que os clientes de e-mail possam permitir que o usuário cancele a inscrição de forma transparente.
