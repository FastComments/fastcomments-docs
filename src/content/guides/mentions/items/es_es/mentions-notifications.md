...
Desactivar las notificaciones impedirá el envío de estos correos electrónicos, y se incluye un encabezado en cada correo para que los clientes de correo permitan al usuario darse de baja sin problemas.
