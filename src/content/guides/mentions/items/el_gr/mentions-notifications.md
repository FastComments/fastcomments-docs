---
Οι χρήστες που έχουν επισημανθεί θα λάβουν ένα email που τους ενημερώνει ότι έχουν επισημανθεί ή αναφερθεί σε ένα σχόλιο.
...
Η απενεργοποίηση των ειδοποιήσεων θα αποτρέψει την αποστολή αυτών των email, και σε κάθε μήνυμα περιλαμβάνεται μια κεφαλίδα ώστε οι πελάτες ηλεκτρονικού ταχυδρομείου να επιτρέπουν στον χρήστη να κάνει απεγγραφή απρόσκοπτα.
