...
Η απενεργοποίηση των ειδοποιήσεων θα αποτρέψει την αποστολή αυτών των email, και σε κάθε email παρέχεται μια κεφαλίδα ώστε οι πελάτες ηλεκτρονικού ταχυδρομείου να επιτρέπουν στον χρήστη να κάνει απεγγραφή ομαλά.
