Gli utenti taggati riceveranno un'email che li informerà di essere stati taggati, o menzionati, in un commento.
...
Disattivare le notifiche impedirà l'invio di queste email, e in ogni email è fornita un'intestazione in modo che i client di posta possano consentire all'utente di annullare facilmente l'iscrizione.
