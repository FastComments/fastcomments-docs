---
Потребителите, които са били тагнати или споменати в коментар, ще получат имейл, който ги уведомява за това.
...
Изключването на известията ще попречи на изпращането на тези имейли, а във всеки имейл е включен хедър, който позволява на имейл клиентите да дадат възможност на потребителя да се отпише безпроблемно.
