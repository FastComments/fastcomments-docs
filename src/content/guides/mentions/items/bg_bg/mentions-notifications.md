...
Изключването на известията ще предотврати изпращането на тези имейли, а във всеки имейл е включен хедър, така че пощенските клиенти да могат безпроблемно да позволят на потребителя да се отписва.
