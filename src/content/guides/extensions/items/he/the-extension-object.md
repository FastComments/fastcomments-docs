...
[inline-code-start]
/**
 * אובייקט ההרחבה FastCommentsUI. משמש לטעינה עצלה של רכיבים מסוימים. לדוגמה, מערכת הביקורות אינה משמשת את כל הלקוחות,
 * ולכן אנו טוענים את ההרחבה רק כאשר אנו זקוקים לה.
 *
 ...
 * @property {Function} [replyAreaInputBottom] - מחזיר HTML להוספה בתוך מסגרת קלט התגובה, מתחת לשדה הטקסט (משמש בסקרים לעורך הסקר במקום). מקבל את מזהה התגובה ההורה, או null לתיבת תגובה ראשית.
 ...
 * @param {Object.<string, Function>} clickListeners - מאפשי אירועי לחיצה, לפי שם מחלקה, שניתן לשנותם באמצעות הפנייה.
 * @returns void
 */
