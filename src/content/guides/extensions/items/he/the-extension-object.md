...
[inline-code-start]
/**
 * אובייקט ההרחבה FastCommentsUI. משמש לטעינה עצלנית של רכיבים מסוימים. לדוגמה, מערכת הסקירות אינה
 ...
 * @property {Object} commentsById - הפנייה לאובייקט המכיל את כל ההערות לפי מזהה, המתעדכן באופן רציף.
 ...
 * @property {Function} isSiteAdmin - מחזירה האם הצופה הוא מנהל או מודרטור של השוכר. ידוע לאחר ההבאה הראשונה.
 * @property {FastCommentsUIExtensionMenuBottomCallback} [menuBottom] - (LEGACY) מחזירה HTML להוספה לחלק התחתון של אלמנט התפריט לכל תגובה.
