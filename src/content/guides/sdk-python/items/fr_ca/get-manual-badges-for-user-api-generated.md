...
Retourne : [`GetUserManualBadgesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_manual_badges_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    badges_user_id = 'badges_user_id_example' # str |  (facultatif)
