...
[inline-code-attrs-start title = 'save_comments_bulk Exemple'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Exemples pour chaque méthode d'authentification sont fournis ci-dessous, utilisez l'exemple qui
