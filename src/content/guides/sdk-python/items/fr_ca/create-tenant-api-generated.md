...
Renvoie: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant200_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de create_tenant'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# La définition de l'hôte est optionnelle et, par défaut, utilise https://fastcomments.com
