...
[inline-code-attrs-start title = 'un_flag_comment Exemple'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# qui répond à votre cas d'utilisation d'authentification.
