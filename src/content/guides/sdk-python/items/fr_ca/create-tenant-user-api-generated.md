...
Retourne: [`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant_user_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de create_tenant_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# l'exemple qui satisfait votre cas d'utilisation d'authentification.
