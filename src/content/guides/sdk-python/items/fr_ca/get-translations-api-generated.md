...
Renvoie : [`GetTranslationsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_translations_response.py)
...
# Définir l'hôte est facultatif et le défaut est https://fastcomments.com
