...
Retourne: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pages_api_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de get_pages'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Décommentez ci-dessous pour ajouter un préfixe (p. ex. Bearer) pour la clé API, si nécessaire
