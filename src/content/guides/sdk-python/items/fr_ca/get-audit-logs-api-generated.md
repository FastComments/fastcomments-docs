...
[inline-code-attrs-start title = 'Exemple de get_audit_logs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Spécifier l'hôte est optionnel et la valeur par défaut est https://fastcomments.com
