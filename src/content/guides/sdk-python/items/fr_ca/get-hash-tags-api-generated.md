...
Renvoie : [`GetHashTagsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_hash_tags_response.py)
...
# La définition de l'hôte est facultative et par défaut est https://fastcomments.com
