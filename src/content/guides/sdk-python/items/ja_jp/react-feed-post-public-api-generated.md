...
戻り値: [`ReactFeedPostResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/react_feed_post_response.py)

## 例

[inline-code-attrs-start title = 'react_feed_post_public の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    is_undo = True # bool |  (省略可)
    broadcast_id = 'broadcast_id_example' # str |  (省略可)
