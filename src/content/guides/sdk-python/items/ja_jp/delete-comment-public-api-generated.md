...
戻り値: [`DeleteCommentPublic200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_comment_public200_response.py)
...
# サポートされる設定パラメータの一覧は configuration.py を参照してください。
