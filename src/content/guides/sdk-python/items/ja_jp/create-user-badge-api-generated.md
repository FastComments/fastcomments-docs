...
戻り値: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_create_user_badge_response.py)
...
# 以下に各認証方法の例を示します。使用する例は
# あなたの認証ユースケースを満たすものを選んでください。
