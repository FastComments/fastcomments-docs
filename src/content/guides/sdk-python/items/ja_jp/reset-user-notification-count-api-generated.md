...
返却値: [`ResetUserNotificationsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/reset_user_notifications_response.py)
...
# ホストの定義は省略可能で、省略した場合のデフォルトは https://fastcomments.com です
