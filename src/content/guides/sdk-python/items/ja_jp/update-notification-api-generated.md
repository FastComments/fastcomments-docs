...
[inline-code-attrs-start title = 'update_notification の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ホストの定義は任意で、省略すると https://fastcomments.com が使われます
...
# 以下に各認証方式の例を示します。ご自身の認証ケースに合う例を使用してください。

# Configure API key authorization: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 必要に応じて API キー用のプレフィックス（例: Bearer）を設定するには、以下の行のコメントアウトを外してください
