...
[inline-code-attrs-start title = 'get_gifs_trending 例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# configuration.py にはサポートされているすべての設定パラメータのリストがあります
