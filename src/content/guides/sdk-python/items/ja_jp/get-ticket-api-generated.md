...
戻り値: [`GetTicket200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_ticket200_response.py)
...
# 各認証方法の例を以下に示します。自分の認証ユースケースに合う例を使用してください。
