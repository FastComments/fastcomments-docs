...
返り値: [`AwardUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/award_user_badge_response.py)

## 例

[inline-code-attrs-start title = 'put_award_badge 例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# configuration.py にサポートされているすべての構成パラメータの一覧があります。
