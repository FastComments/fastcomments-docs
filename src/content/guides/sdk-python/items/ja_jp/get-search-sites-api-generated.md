...
返却: [`ModerationSiteSearchResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/moderation_site_search_response.py)

## 例

[inline-code-attrs-start title = 'get_search_sites の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    value = 'value_example' # str |  (optional) -> str |  （オプション）
    sso = 'sso_example' # str |  (optional) -> str |  （オプション）
