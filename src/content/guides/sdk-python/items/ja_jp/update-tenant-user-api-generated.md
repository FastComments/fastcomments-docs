...
[inline-code-attrs-start title = 'update_tenant_user の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 必要に応じて API キーにプレフィックス（例: Bearer）を設定するには、以下の行のコメントアウトを解除してください
# configuration.api_key_prefix['api_key'] = 'Bearer'

# API クライアントのインスタンスを使ったコンテキストに入る（with構文）
with client.ApiClient(configuration) as api_client:
    ...
    update_comments = 'update_comments_example' # str |  （オプション）
