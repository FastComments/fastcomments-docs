...
[inline-code-attrs-start title = 'send_login_link の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# サポートされるすべての設定パラメータの一覧は configuration.py を参照してください。
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    redirect_url = 'redirect_url_example' # str |  （オプション）
