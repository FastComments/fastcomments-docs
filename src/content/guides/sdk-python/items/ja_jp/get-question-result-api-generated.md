...
戻り値: [`GetQuestionResult200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_result200_response.py)

## 例

[inline-code-attrs-start title = 'get_question_result の例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# これは API サーバーのセキュリティポリシーに従う必要があります。
# 以下に各認証方式の例を示します。例の中から
# 自分の認証ユースケースに合うものを使用してください。
