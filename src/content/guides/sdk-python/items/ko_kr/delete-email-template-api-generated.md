...
[inline-code-attrs-start title = 'delete_email_template 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# API 서버 보안 정책에 따라.
# 각 인증 방법에 대한 예제가 아래에 제공됩니다. 사용하시는
# 인증 시나리오에 맞는 예제를 사용하세요.
