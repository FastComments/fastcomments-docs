...
반환: [`GetUserBadgeProgressById200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_badge_progress_by_id200_response.py)

## 예제

[inline-code-attrs-start title = 'get_user_badge_progress_by_id 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 각 인증 방법에 대한 예시가 아래에 제공됩니다. 자신의 인증 사용 사례에
# 맞는 예시를 사용하세요.

# API 키 인증 구성: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 필요하면 아래의 주석을 해제하여 API 키의 접두사(예: Bearer)를 설정하세요
