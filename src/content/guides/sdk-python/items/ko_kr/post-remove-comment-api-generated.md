...
반환: [`PostRemoveCommentApiResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/post_remove_comment_api_response.py)

## 예시

[inline-code-attrs-start title = 'post_remove_comment 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
