...
반환: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_user_badge200_response.py)

## 예제

[inline-code-attrs-start title = 'create_user_badge 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에는 각 인증 방법에 대한 예제가 제공됩니다. 사용 사례에 맞는
# 예제를 사용하세요.

# Configure API key authorization: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 필요하다면 아래의 주석을 제거하여 API 키의 접두사(예: Bearer)를 설정하세요
