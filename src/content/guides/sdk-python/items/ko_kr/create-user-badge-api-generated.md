...
반환: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_create_user_badge_response.py)
...
# 각 인증 방법에 대한 예제가 아래에 제공되며, 사용 사례에
# 맞는 예제를 사용하십시오.
