...
| urlId | string | query | No | 현재 페이지가 구독되었는지 여부를 확인하는 데 사용됩니다. |
...
[inline-code-attrs-start title = 'get_user_notifications 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | 현재 페이지가 구독되었는지 여부를 확인하는 데 사용됩니다. (optional)
