...
반환: [`APIGetUserBadgesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_get_user_badges_response.py)
...
# 필요하면 아래의 주석을 제거하여 API 키 접두사(예: Bearer)를 설정하세요
