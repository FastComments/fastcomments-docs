...
[inline-code-attrs-start title = 'get_user_badges 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 각 인증 방법에 대한 예제가 아래에 제공됩니다. 사용 사례에 맞는 예제를 사용하십시오.

# API 키 인증 구성: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 필요시 API 키에 대한 접두사(예: Bearer)를 설정하려면 아래 주석을 해제하십시오
