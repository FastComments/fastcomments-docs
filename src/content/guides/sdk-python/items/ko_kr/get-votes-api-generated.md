...
반환: [`GetVotesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_votes_response.py)
...
# 아래에는 각 인증 방법에 대한 예제가 제공됩니다. 해당 인증 사용 사례에
# 맞는 예제를 사용하세요.
