...
[inline-code-attrs-start title = 'delete_pending_webhook_event 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 클라이언트는 API 서버의 보안 정책에 따라 인증 및 권한 부여 매개변수를 구성해야 합니다.
# 각 인증 방법의 예제는 아래에 제공됩니다. 자신의 인증 사용 사례에 맞는 예제를 사용하세요.
