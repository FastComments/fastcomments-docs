...
[inline-code-attrs-start title = 'get_user_internal_profile 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 지원되는 모든 구성 매개변수는 configuration.py를 참조하세요.
