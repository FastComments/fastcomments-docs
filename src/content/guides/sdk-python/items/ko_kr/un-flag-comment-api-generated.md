...
[inline-code-attrs-start title = 'un_flag_comment 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 필요하다면 아래의 주석을 제거하여 API 키에 대한 접두사(예: Bearer)를 설정하세요
...
with client.ApiClient(configuration) as api_client:
    ...
    anon_user_id = 'anon_user_id_example' # str |  (선택사항)
