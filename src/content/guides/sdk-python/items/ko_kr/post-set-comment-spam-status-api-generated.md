...
[inline-code-attrs-start title = 'post_set_comment_spam_status 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 호스트 정의는 선택사항이며 기본값은 https://fastcomments.com
