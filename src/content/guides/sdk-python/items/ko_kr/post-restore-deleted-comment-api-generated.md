...
[inline-code-attrs-start title = 'post_restore_deleted_comment 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 지원되는 모든 구성 매개변수 목록은 configuration.py 를 참조하십시오.
