...
반환: [`GetTenantPackageResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_package_response.py)

## 예제

[inline-code-attrs-start title = 'get_tenant_package 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 필요하다면 아래의 주석을 해제하여 API 키의 접두사(예: Bearer)를 설정하세요
