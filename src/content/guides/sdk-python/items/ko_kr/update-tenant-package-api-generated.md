...
[inline-code-attrs-start title = 'update_tenant_package 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에는 각 인증 방법의 예제가 제공되며, 귀하의 인증 사용 사례에 맞는 예제를 사용하세요.
