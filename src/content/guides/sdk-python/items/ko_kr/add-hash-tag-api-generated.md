...
반환: [`AddHashTag200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/add_hash_tag200_response.py)

## 예제

[inline-code-attrs-start title = 'add_hash_tag 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에 각 인증 방법에 대한 예제가 제공됩니다. 해당 인증 사용 사례에
# 맞는 예제를 사용하세요.
...
with client.ApiClient(configuration) as api_client:
    ...
    create_hash_tag_body = client.CreateHashTagBody() # CreateHashTagBody |  (선택 사항)
