...
[inline-code-attrs-start title = 'combine_comments_with_question_results 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 클라이언트는 인증 및 권한 부여 매개변수를 API 서버 보안 정책에 따라 구성해야 합니다.
...
# 필요에 따라 API 키의 접두사(예: Bearer)를 설정하려면 아래 주석을 해제하십시오
