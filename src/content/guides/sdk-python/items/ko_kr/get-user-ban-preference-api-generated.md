...
[inline-code-attrs-start title = 'get_user_ban_preference 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# configuration.py에서 지원되는 모든 구성 매개변수의 목록을 참조하세요.
