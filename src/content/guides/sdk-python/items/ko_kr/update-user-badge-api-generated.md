...
[inline-code-attrs-start title = 'update_user_badge 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# API 클라이언트 인스턴스를 사용하는 컨텍스트로 진입합니다
