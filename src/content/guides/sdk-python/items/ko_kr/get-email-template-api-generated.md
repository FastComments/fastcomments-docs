...
반환: [`GetEmailTemplateResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_template_response.py)

## 예제

[inline-code-attrs-start title = 'get_email_template 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 모든 지원되는 설정 매개변수 목록은 configuration.py를 참조하세요.
...
# API 서버 보안 정책에 따라.
# 각 인증 방법에 대한 예제가 아래에 제공됩니다. 해당 예제 중
