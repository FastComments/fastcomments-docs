...
[inline-code-attrs-start title = 'delete_moderation_vote 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# configuration.py 파일에서 지원되는 모든 설정 매개변수 목록을 확인하십시오.
...
with client.ApiClient(configuration) as api_client:
    ...
    broadcast_id = 'broadcast_id_example' # str |  (optional) => (옵션)
    sso = 'sso_example' # str |  (optional) => (옵션)
