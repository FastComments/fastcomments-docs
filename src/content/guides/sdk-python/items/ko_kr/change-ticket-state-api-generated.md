...
반환: [`ChangeTicketState200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/change_ticket_state200_response.py)

## 예제

[inline-code-attrs-start title = 'change_ticket_state 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# API 서버 보안 정책에 따라
# 아래에 각 인증 방법의 예제가 제공됩니다. 자신의 인증 사용 사례에
# 맞는 예제를 사용하세요.

# API 키 인증 구성: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 필요하다면 API 키의 접두사(예: Bearer)를 설정하려면 아래 주석 처리를 해제하세요
