...
반환: [`GetTenantUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_user_response.py)

## 예제

[inline-code-attrs-start title = 'get_tenant_user 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에는 각 인증 방법에 대한 예가 제공됩니다. 사용 사례에 맞는 예를 사용하세요.
