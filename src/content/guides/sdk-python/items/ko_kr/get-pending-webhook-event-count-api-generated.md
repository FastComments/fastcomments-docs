...
반환: [`GetPendingWebhookEventCountResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pending_webhook_event_count_response.py)

## 예시

[inline-code-attrs-start title = 'get_pending_webhook_event_count 예시'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 클라이언트는 API 서버 보안 정책에 따라 인증 및 인가 매개변수를 구성해야 합니다.
