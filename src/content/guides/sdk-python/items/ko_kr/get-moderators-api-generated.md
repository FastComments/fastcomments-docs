...
반환: [`GetModerators200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_moderators200_response.py)

## 예제

[inline-code-attrs-start title = 'get_moderators 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에는 각 인증 방법의 예제가 제공됩니다. 사용 사례에 맞는 예제를 사용하세요.
