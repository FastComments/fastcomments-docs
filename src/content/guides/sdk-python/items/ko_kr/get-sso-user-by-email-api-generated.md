...
반환: [`GetSSOUserByEmailAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_sso_user_by_email_api_response.py)

## 예제

[inline-code-attrs-start title = 'get_sso_user_by_email 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에 각 인증 방식에 대한 예제가 제공되어 있으니, 자신의 인증 사용 사례에 맞는 예제를 사용하세요.
