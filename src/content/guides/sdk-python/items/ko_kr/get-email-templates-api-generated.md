...
반환: [`GetEmailTemplatesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_templates_response.py)

## 예제

[inline-code-attrs-start title = 'get_email_templates 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 아래에 각 인증 방법의 예제가 제공됩니다. 자신의 인증 사용 사례에 맞는 예제를 사용하세요.
