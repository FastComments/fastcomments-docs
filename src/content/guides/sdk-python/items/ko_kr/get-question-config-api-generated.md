...
반환: [`GetQuestionConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_config_response.py)

## 예제

[inline-code-attrs-start title = 'get_question_config 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 이는 API 서버 보안 정책을 따라야 합니다.
# 각 인증 방식에 대한 예제가 아래에 제공됩니다. 아래 예제들 중
# 사용자의 인증 사용 사례에 맞는 것을 사용하세요.
