...
반환: [`GetQuestionConfig200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_config200_response.py)
...
# 아래에는 각 인증 방법에 대한 예제가 제공됩니다. 다음 중
# 본인의 인증 사용 사례를 만족하는 예제를 사용하세요.
