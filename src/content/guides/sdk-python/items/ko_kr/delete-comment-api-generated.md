...
반환: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_comment_result.py)
...
# 아래에 각 인증 방법에 대한 예제가 제공되어 있으니, 사용 사례에 맞는 예제를 사용하세요.
