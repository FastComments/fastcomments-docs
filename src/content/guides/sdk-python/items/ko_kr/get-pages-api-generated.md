...
반환: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pages_api_response.py)

## 예제

[inline-code-attrs-start title = 'get_pages 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 각 인증 방법에 대한 예제가 아래에 제공됩니다. 귀하의 인증 사용 사례에
# 맞는 예제를 사용하세요.

# Configure API key authorization: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 필요하다면 API 키의 접두사(예: Bearer)를 설정하려면 아래의 주석을 해제하세요
