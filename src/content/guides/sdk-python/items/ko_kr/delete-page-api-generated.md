...
반환: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_page_api_response.py)

## 예제

[inline-code-attrs-start title = 'delete_page 예제'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 각 인증 방법의 예시는 아래에 제공됩니다. 아래 예제 중
