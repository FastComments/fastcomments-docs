...
[inline-code-attrs-start title = 'delete_moderator Example'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Configure the client's authentication and authorization parameters
...
# Configure API key authentication: api_key
