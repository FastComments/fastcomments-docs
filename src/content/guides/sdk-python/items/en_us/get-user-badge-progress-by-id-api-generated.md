...
Returns: [`GetUserBadgeProgressById200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_badge_progress_by_id200_response.py)

## Example

[inline-code-attrs-start title = 'get_user_badge_progress_by_id Example'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# fits your authentication use case.
