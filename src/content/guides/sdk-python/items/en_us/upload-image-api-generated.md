...
| urlId | string | query | No | Page ID that the upload is originating from, for configuration |
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | Page ID that the upload is coming from, for configuration (optional)
