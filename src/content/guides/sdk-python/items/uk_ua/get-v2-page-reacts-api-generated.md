...
Повертає: [`GetV2PageReacts`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_v2_page_reacts.py)

## Приклад

[inline-code-attrs-start title = 'Приклад get_v2_page_reacts'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Відкриваємо контекст із екземпляром клієнта API
