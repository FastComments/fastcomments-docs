...
[inline-code-attrs-start title = 'Приклад update_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# що відповідає вашому сценарію використання.
...
# Перейдіть у контекст з екземпляром API-клієнта
