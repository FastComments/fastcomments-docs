...
[inline-code-attrs-start title = 'vote_comment Приклад'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    session_id = 'session_id_example' # str |  (необов'язково)
