...
[inline-code-attrs-start title = 'Приклад post_comments_by_ids'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Відкриваємо контекст з екземпляром клієнта API
