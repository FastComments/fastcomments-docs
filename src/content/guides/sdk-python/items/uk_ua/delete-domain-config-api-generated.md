...
Повертає: [`DeleteDomainConfig200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_domain_config200_response.py)
...
# Вказівка хоста необов'язкова та за замовчуванням https://fastcomments.com
