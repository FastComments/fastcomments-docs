...
Повертає: [`GetQuestionConfigsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_configs_response.py)

## Приклад

[inline-code-attrs-start title = 'Приклад get_question_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Визначення host-адреси необов'язкове й за замовчуванням https://fastcomments.com
