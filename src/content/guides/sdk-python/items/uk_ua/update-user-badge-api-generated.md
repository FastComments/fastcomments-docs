...
Повертає: [`UpdateUserBadge200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/update_user_badge200_response.py)

## Приклад

[inline-code-attrs-start title = 'Приклад update_user_badge'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Вказування host необов'язкове і за замовчуванням — https://fastcomments.com
