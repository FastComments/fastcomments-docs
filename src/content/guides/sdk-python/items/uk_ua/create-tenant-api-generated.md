...
Повертає: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant200_response.py)
...
# Визначення host необов'язкове, значення за замовчуванням — https://fastcomments.com
