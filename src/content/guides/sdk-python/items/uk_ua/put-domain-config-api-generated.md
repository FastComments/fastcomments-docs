...
Повертає: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/put_domain_config_response.py)
...
# Увійдіть у контекст, використовуючи екземпляр API-клієнта
