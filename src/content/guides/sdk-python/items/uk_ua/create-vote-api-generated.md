...
[inline-code-attrs-start title = 'create_vote Приклад'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Відкриття контексту з інстансом API клієнта
with client.ApiClient(configuration) as api_client:
    # Створення інстансу класу API
