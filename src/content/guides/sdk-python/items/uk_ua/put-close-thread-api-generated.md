...
[inline-code-attrs-start title = 'Приклад put_close_thread'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Визначення хоста необов'язкове і за замовчуванням використовує https://fastcomments.com
