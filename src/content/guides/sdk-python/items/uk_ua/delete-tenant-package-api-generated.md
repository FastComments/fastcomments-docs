...
[inline-code-attrs-start title = 'Приклад delete_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# підходить для вашого сценарію автентифікації.
