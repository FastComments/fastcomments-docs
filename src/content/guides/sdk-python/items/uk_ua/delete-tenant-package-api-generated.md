...
[inline-code-attrs-start title = 'delete_tenant_package Приклад'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Приклади для кожного методу автентифікації наведено нижче — використовуйте приклад, який
