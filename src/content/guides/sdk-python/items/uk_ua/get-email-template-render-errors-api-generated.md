...
Повертає: [`GetEmailTemplateRenderErrorsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_template_render_errors_response.py)
...
# Визначення хоста опціональне і за замовчуванням https://fastcomments.com
