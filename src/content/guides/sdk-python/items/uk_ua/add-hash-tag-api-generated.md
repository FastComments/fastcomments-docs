...
Повертає: [`AddHashTag200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/add_hash_tag200_response.py)
...
# Приклади для кожного методу автентифікації наведені нижче, використайте
# приклад, який відповідає вашому випадку використання автентифікації.
...
with client.ApiClient(configuration) as api_client:
    ...
    create_hash_tag_body = client.CreateHashTagBody() # CreateHashTagBody |  (необов'язково)
