...
[inline-code-attrs-start title = 'Приклад delete_v2_page_react'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Визначення host є необов'язковим і за замовчуванням https://fastcomments.com
