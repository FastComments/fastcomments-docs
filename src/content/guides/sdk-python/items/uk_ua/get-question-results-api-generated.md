...
Повертає: [`GetQuestionResultsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_results_response.py)
...
# Клієнт повинен налаштувати параметри автентифікації та авторизації відповідно до політики безпеки API-сервера.
# Нижче наведено приклади для кожного методу автентифікації, використайте приклад, який підходить для вашого випадку.
...
with client.ApiClient(configuration) as api_client:
    ...
    start_date = 'start_date_example' # str |  (необов’язковий)
    question_id = 'question_id_example' # str |  (необов’язковий)
    question_ids = 'question_ids_example' # str |  (необов’язковий)
