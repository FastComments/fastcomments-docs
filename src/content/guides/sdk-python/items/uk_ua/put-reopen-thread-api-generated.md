...
[inline-code-attrs-start title = 'put_reopen_thread Приклад'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Створити контекст з екземпляром API клієнта
