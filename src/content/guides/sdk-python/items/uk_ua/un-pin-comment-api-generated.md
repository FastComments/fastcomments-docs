...
[inline-code-attrs-start title = 'Приклад un_pin_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Використовуйте контекст із екземпляром API-клієнта
