...
[inline-code-attrs-start title = 'Приклад get_moderation_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Визначення хоста — необов’язково, за замовчуванням https://fastcomments.com
