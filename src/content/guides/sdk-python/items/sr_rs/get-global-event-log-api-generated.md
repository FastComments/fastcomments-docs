...
Враћа: [`GetEventLogResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_event_log_response.py)

## Пример

[inline-code-attrs-start title = 'get_global_event_log Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Постављање host-а је опционално и подразумева се као https://fastcomments.com
