...
# Постављање хоста је опционално и подразумевано је на https://fastcomments.com
# Погледајте configuration.py за листу свих подржаних параметара конфигурације.
# Клијент мора да постави параметре аутентификације и ауторизације
...
# Откоментирајте доле за подешавање префикса (нпр. Bearer) за API кључ, ако је потребно
