...
[inline-code-attrs-start title = 'Пример replace_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Примери за сваки метод аутентификације дата су у наставку, користите пример који
# задовољава ваш случај коришћења аутентификације.

# Конфигуришите авторизацију преко API кључа: api_key
