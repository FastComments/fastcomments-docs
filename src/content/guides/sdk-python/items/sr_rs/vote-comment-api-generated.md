...
[inline-code-attrs-start title = 'vote_comment Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Подешавање host-а је опциони и подразумева се https://fastcomments.com
