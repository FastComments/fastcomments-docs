...
Враћа: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_page_api_response.py)

## Пример

[inline-code-attrs-start title = 'patch_page пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Клијент треба да подеси параметре аутентификације и овлашћења
...
# Одакоментарите испод да подесите префикс (нпр. Bearer) за API кључ, ако је потребно
