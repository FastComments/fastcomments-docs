...
# Постављање host-а је опциони и подразумева се на https://fastcomments.com
...
# Ако је потребно, откоментирајте следећу линију да бисте подесили префикс (нпр. Bearer) за API кључ
