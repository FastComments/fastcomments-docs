...
[inline-code-attrs-start title = 'get_ban_users_from_comment Primer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definisanje host-a je opcionalno i podrazumeva https://fastcomments.com
