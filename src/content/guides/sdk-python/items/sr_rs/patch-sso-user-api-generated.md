...
Враћа: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_sso_user_api_response.py)

## Пример

[inline-code-attrs-start title = 'patch_sso_user Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Подешавање host-а је опционo и подразумевано је https://fastcomments.com
