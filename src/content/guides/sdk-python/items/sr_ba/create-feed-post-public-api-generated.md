...
Враћа: [`CreateFeedPostPublic200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_feed_post_public200_response.py)

## Примјер

[inline-code-attrs-start title = 'Примјер create_feed_post_public'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Постављање host-а је необавезно и подразумевано је https://fastcomments.com
...
with client.ApiClient(configuration) as api_client:
    ...
    broadcast_id = 'broadcast_id_example' # str |  (необавезно)
