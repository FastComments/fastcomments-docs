...
[inline-code-attrs-start title = 'delete_vote Primjer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Otkomentarišite ispod kako biste postavili prefiks (npr. Bearer) za API ključ, ukoliko je potrebno
