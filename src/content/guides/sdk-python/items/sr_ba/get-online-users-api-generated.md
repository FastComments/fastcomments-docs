...
| afterUserId | string | query | No | Kursor prekidač: proslijedite nextAfterUserId iz prethodnog odgovora. Obavezno kada je postavljen afterName kako se ne bi izostavili zapisi zbog istih imena. |
...
with client.ApiClient(configuration) as api_client:
    ...
    after_user_id = 'after_user_id_example' # str | Kursor prekidač: proslijedite nextAfterUserId iz prethodnog odgovora. Obavezno kada je postavljen afterName kako se ne bi izostavili zapisi zbog istih imena. (opcionalno)
