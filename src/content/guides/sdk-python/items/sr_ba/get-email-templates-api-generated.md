...
[inline-code-attrs-start title = 'get_email_templates Примјер'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Уклоните коментар испод да подесите префикс (нпр. Bearer) за API key, ако је потребно
