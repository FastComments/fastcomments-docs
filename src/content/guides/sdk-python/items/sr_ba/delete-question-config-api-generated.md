...
[inline-code-attrs-start title = 'Примјер delete_question_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Постављање host-а је опционално и подразумјевано је https://fastcomments.com
...
# Примјери за сваки метод аутентификације налазе се испод, употребите примјер који
# одговара вашем случају коришћења.

# Конфигуришите овлаштење API кључем: api_key
