...
[inline-code-attrs-start title = 'put_remove_badge Primjer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Odgovor ModerationApi->put_remove_badge:\n")
        pprint(api_response)
    except Exception as e:
        print("Izuzetak prilikom poziva ModerationApi->put_remove_badge: %s\n" % e)
[inline-code-end]