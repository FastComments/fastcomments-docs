...
| urlId | string | query | No | ID de la page depuis laquelle le téléversement est effectué, pour configurer |

## Réponse

Renvoie : [`UploadImageResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/upload_image_response.py)
...
# Définir l'hôte est optionnel et par défaut vaut https://fastcomments.com
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | ID de la page depuis laquelle le téléversement est effectué, pour configurer (optionnel)
