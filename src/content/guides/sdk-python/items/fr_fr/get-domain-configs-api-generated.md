...
Renvoie : [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_domain_configs_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple get_domain_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Entrez dans le contexte avec une instance du client API
