...
Renvoie : [`BlockSuccess`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/block_success.py)

## Exemple

[inline-code-attrs-start title = 'block_user_from_comment Exemple'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Des exemples pour chaque méthode d'authentification sont fournis ci-dessous, utilisez celui qui répond à votre cas d'utilisation.
# Configurer l'autorisation par clé API : api_key
# Décommentez ci-dessous pour définir le préfixe (ex. Bearer) pour la clé API, si nécessaire
