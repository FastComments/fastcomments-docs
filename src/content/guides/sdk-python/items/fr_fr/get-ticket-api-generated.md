...
Retourne : [`GetTicket200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_ticket200_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de get_ticket'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# qui correspond à votre cas d'utilisation d'auth.
