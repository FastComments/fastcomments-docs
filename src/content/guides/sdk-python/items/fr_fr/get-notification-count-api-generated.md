...
Renvoie: [`GetNotificationCount200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_notification_count200_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de get_notification_count'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Décommentez ci-dessous pour configurer un préfixe (ex. Bearer) pour la clé API, si nécessaire
...
with client.ApiClient(configuration) as api_client:
    ...
    from_comment_id = 'from_comment_id_example' # str |  (optionnel)
