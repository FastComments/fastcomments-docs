...
[inline-code-attrs-start title = 'post_set_comment_spam_status Exemple'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    spam = True # bool |  (facultatif)
    perm_not_spam = True # bool |  (facultatif)
