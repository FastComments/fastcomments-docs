...
Retourne : [`ModerationSuggestResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/moderation_suggest_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple get_search_suggest'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# La définition du host est facultative et par défaut https://fastcomments.com
