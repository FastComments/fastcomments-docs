...
Renvoie: [`GetUserBadgeProgressList200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_badge_progress_list200_response.py)

## Exemple

[inline-code-attrs-start title = 'Exemple de get_user_badge_progress_list'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Décommentez ci-dessous pour configurer un préfixe (par exemple Bearer) pour la clé API, si nécessaire
