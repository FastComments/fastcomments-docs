...
Retourne: [`GetUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_response.py)
...
# La définition de l'hôte est optionnelle et prend la valeur par défaut https://fastcomments.com
