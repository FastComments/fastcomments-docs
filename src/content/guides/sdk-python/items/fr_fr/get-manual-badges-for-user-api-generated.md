...
[inline-code-attrs-start title = 'get_manual_badges_for_user Exemple'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    badges_user_id = 'badges_user_id_example' # str |  (optionnel)
