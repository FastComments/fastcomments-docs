...
Renvoie: [`GetPendingWebhookEvents200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pending_webhook_events200_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    external_id = 'external_id_example' # str |  (facultatif)
    event_type = 'event_type_example' # str |  (facultatif)
    type = 'type_example' # str |  (facultatif)
    domain = 'domain_example' # str |  (facultatif)
    attempt_count_gt = 3.4 # float |  (facultatif)
