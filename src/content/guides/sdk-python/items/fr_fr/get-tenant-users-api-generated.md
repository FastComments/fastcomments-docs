...
Renvoie : [`GetTenantUsersResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_users_response.py)
...
# qui satisfait votre cas d'utilisation d'auth.
