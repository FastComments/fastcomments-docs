...
Retourne : [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_comment_result.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    context_user_id = 'context_user_id_example' # str |  (facultatif)
