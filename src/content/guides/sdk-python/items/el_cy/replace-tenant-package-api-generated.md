...
[inline-code-attrs-start title = 'Παράδειγμα replace_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Αφαιρέστε το σχόλιο παρακάτω για να ρυθμίσετε prefix (π.χ. Bearer) για το API key, αν χρειάζεται
