...
| sizePreset | string | query | No | Προκαθορισμένο μέγεθος: \"Default\" (1000x1000px) ή \"CrossPlatform\" (δημιουργεί μεγέθη για δημοφιλείς συσκευές) |
...
# Η καθορισμός του host είναι προαιρετικός και προεπιλεγμένος στο https://fastcomments.com
...
# Εισαγωγή περιβάλλοντος με μια παρουσία του API client
with client.ApiClient(configuration) as api_client:
    # Δημιουργία μιας παρουσίασης της κλάσης API
    api_instance = client.PublicApi(api_client)
    tenant_id = 'tenant_id_example' # str | 
    file = None # bytes | 
    size_preset = client.SizePreset() # SizePreset | Προκαθορισμένο μέγεθος: \"Default\" (1000x1000px) ή \"CrossPlatform\" (δημιουργεί μεγέθη για δημοφιλείς συσκευές) (optional)
    url_id = 'url_id_example' # str | Αναγνωριστικό σελίδας από το οποίο γίνεται η μεταφόρτωση, για διαμόρφωση (optional)
