...
[inline-code-attrs-start title = 'create_comment_public Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ο καθορισμός του host είναι προαιρετικός και προεπιλεγμένος στην τιμή https://fastcomments.com
