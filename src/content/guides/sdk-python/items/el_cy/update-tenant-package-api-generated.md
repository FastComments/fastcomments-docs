...
[inline-code-attrs-start title = 'update_tenant_package Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ο client πρέπει να ρυθμίσει τις παραμέτρους πιστοποίησης (authentication) και εξουσιοδότησης (authorization)
...
with client.ApiClient(configuration) as api_client:
    # Δημιουργία instance της κλάσης API
