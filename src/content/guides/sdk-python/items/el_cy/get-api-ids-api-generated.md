...
[inline-code-attrs-start title = 'Παράδειγμα get_api_ids'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Η ορισμός του host είναι προαιρετικός και προεπιλεγείται στο https://fastcomments.com
