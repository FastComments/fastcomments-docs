...
[inline-code-attrs-start title = 'flag_comment_public Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ο ορισμός του host είναι προαιρετικός και προεπιλέγεται στο https://fastcomments.com
...
# Μπείτε σε ένα πλαίσιο με ένα στιγμιότυπο του πελάτη API
