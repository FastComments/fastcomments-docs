...
# Απενεργοποιήστε (αποσχολιάστε) παρακάτω για να ορίσετε πρόθεμα (π.χ. Bearer) για το κλειδί API, εάν χρειάζεται
# configuration.api_key_prefix['api_key'] = 'Bearer'

# Εισαγάγετε ένα πλαίσιο με μια περίπτωση του πελάτη API
