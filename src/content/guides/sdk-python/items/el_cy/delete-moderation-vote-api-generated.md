...
[inline-code-attrs-start title = 'delete_moderation_vote Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Εισάγετε ένα context με ένα αντίγραφο του client API
