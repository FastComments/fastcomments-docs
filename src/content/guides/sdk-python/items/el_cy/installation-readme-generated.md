...
Κάθε ετικετοποιημένη [GitHub Release](https://github.com/fastcomments/fastcomments-python/releases) περιλαμβάνει επίσης ένα προ-κατασκευασμένο wheel αν προτιμάτε να εγκαταστήσετε ένα δυαδικό τεχνητό αρχείο απευθείας.
