...
[inline-code-attrs-start title = 'put_remove_badge Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ορίζοντας τον κεντρικό εξυπηρετητή είναι προαιρετικό και προεπιλεγμένο στο https://fastcomments.com
