...
[inline-code-attrs-start title = 'Παράδειγμα post_set_comment_spam_status'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Δείτε το configuration.py για τη λίστα με όλες τις υποστηριζόμενες παραμέτρους διαμόρφωσης.
