...
Returnerer: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_domain_config_response.py)

## Eksempel

[inline-code-attrs-start title = 'patch_domain_config eksempel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Start en context med en instans af API-klienten
