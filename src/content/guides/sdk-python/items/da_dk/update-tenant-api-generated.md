...
[inline-code-attrs-start title = 'update_tenant Eksempel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Fjern kommentar på nedenstående for at sætte prefix (f.eks. Bearer) for API-nøglen, hvis nødvendigt
