...
[inline-code-attrs-start title = 'Eksempel på delete_moderator'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Eksempler på hver godkendelsesmetode er vist nedenfor — brug det eksempel, der passer til dit brugstilfælde.
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    send_email = 'send_email_example' # str |  (valgfri)
