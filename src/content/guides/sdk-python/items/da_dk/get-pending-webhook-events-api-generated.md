...
# opfylder din godkendelsesuse case.
...
with client.ApiClient(configuration) as api_client:
    ...
    comment_id = 'comment_id_example' # str |  (valgfrit)
    external_id = 'external_id_example' # str |  (valgfrit)
    event_type = 'event_type_example' # str |  (valgfrit)
    type = 'type_example' # str |  (valgfrit)
    domain = 'domain_example' # str |  (valgfrit)
    attempt_count_gt = 3.4 # float |  (valgfrit)
