...
[inline-code-attrs-start title = 'set_trust_factor Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    trust_factor = 'trust_factor_example' # str |  (opcjonalny)
