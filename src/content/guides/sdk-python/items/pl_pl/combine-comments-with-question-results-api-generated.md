...
[inline-code-attrs-start title = 'combine_comments_with_question_results Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Przykłady dla każdej metody autoryzacji są podane poniżej, użyj przykładu,
