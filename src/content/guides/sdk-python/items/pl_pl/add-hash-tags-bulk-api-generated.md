...
Zwraca: [`BulkCreateHashTagsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/bulk_create_hash_tags_response.py)

## Przykład

[inline-code-attrs-start title = 'Przykład add_hash_tags_bulk'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# odpowiada Twojemu scenariuszowi użycia.
...
with client.ApiClient(configuration) as api_client:
    ...
    bulk_create_hash_tags_body = client.BulkCreateHashTagsBody() # BulkCreateHashTagsBody |  (opcjonalne)
