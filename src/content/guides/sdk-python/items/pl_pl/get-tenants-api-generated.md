...
[inline-code-attrs-start title = 'get_tenants Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    meta = 'meta_example' # str |  (opcjonalny)
    skip = 3.4 # float |  (opcjonalny)
