...
|------|------|----------|----------|-------------|
| tenantId | `string` | Lokalizacja | Tak |  |
| isLive | `boolean` | Lokalizacja | Nie |  |
| doSpamCheck | `boolean` | Lokalizacja | Nie |  |
| sendEmails | `boolean` | Lokalizacja | Nie |  |
| populateNotifications | `boolean` | Lokalizacja | Nie |  |
