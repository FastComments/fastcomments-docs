...
[inline-code-attrs-start title = 'save_comment Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# spełnia Twój przypadek użycia uwierzytelnienia.
...
with client.ApiClient(configuration) as api_client:
    ...
    is_live = True # bool |  (opcjonalny)
    do_spam_check = True # bool |  (opcjonalny)
    send_emails = True # bool |  (opcjonalny)
    populate_notifications = True # bool |  (opcjonalny)
