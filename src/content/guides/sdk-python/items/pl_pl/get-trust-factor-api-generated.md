...
[inline-code-attrs-start title = 'get_trust_factor Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Zobacz plik configuration.py, aby zobaczyć listę wszystkich obsługiwanych parametrów konfiguracyjnych.
