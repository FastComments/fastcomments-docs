...
Zwraca: [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_domain_configs_response.py)

## Przykład

[inline-code-attrs-start title = 'Przykład get_domain_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Poniżej zamieszczono przykłady dla każdej metody uwierzytelniania; użyj
# przykładu, który spełnia Twoje potrzeby uwierzytelniania.
