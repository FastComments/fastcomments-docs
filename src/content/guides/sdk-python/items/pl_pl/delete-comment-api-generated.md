...
[inline-code-attrs-start title = 'delete_comment Przykład'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    context_user_id = 'context_user_id_example' # str |  (opcjonalny)
