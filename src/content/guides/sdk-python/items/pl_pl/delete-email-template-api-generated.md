...
[inline-code-attrs-start title = 'Przykład delete_email_template'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# odpowiada Twojemu przypadkowi użycia autoryzacji.

# Skonfiguruj autoryzację kluczem API: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Odkomentuj poniższe, aby ustawić prefiks (np. Bearer) dla klucza API, jeśli to potrzebne
