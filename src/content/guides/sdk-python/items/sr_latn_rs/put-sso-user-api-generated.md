...
[inline-code-attrs-start title = 'put_sso_user Primer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Primeri za svaki metod autorizacije su dati ispod, upotrebite onaj
# koji zadovoljava vaš slučaj upotrebe autorizacije.

# Konfigurišite autorizaciju putem API ključa: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Otkomentarišite dole da biste podesili prefiks (npr. Bearer) za API ključ, ako je potrebno
