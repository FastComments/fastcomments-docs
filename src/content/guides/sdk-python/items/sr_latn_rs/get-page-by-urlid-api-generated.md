...
Vraća: [`GetPageByURLIdAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_page_by_urlid_api_response.py)

## Primer

[inline-code-attrs-start title = 'get_page_by_urlid Primer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Primeri za svaki metod autentifikacije dat su dole, koristite primer koji
