...
Döndürür: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_sso_user_by_id_api_response.py)

## Örnek

[inline-code-attrs-start title = 'get_sso_user_by_id Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# kullanım durumunuza uygun örneği kullanın.
