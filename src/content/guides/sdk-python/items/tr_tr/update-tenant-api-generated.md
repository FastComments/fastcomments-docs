...
[inline-code-attrs-start title = 'update_tenant Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Her yetkilendirme yöntemi için örnekler aşağıda verilmiştir, aşağıdaki örneklerden
