...
[inline-code-attrs-start title = 'update_question_result Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Sunucu (host) tanımlanması isteğe bağlıdır ve varsayılan https://fastcomments.com'dur
...
# API istemcisi örneği ile bir bağlam (context) içine girin
