...
Döndürür: [`GetTicketResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_ticket_response.py)
...
# Gerekirse API anahtarı için önek (örn. Bearer) eklemek için aşağıdaki satırı yorumdan kaldırın
