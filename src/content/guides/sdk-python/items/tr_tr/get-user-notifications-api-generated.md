...
| urlId | string | sorgu | Hayır | Mevcut sayfanın abone olup olmadığını belirlemek için kullanılır. |
...
| includeTenantNotifications | boolean | sorgu | Hayır |  |
| sso | string | sorgu | Hayır |  |

## Yanıt

Döndürür: [`GetMyNotificationsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_my_notifications_response.py)
