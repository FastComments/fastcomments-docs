...
Döndürür: [`GetTenantUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_user_response.py)

## Örnek

[inline-code-attrs-start title = 'get_tenant_user Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Tüm desteklenen yapılandırma parametrelerinin listesi için configuration.py'ya bakın.
