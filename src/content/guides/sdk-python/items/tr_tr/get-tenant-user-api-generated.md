...
Döndürür: [`GetTenantUser200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_user200_response.py)
...
# Ana bilgisayarın tanımlanması isteğe bağlıdır ve varsayılan olarak https://fastcomments.com kullanılır
...
# kimlik doğrulama kullanım durumunuza uyan örneği.
