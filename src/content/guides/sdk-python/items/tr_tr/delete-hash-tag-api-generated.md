...
# Her kimlik doğrulama yöntemi için örnekler aşağıda verilmiştir; kendi kullanım durumunuza uyan örneği kullanın.

# API anahtarı yetkilendirmesini yapılandırın: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Gerekirse API anahtarı için önek (ör. Bearer) ayarlamak üzere aşağıdaki satırı etkinleştirin
...
with client.ApiClient(configuration) as api_client:
    ...
    delete_hash_tag_request = client.DeleteHashTagRequest() # DeleteHashTagRequest |  (isteğe bağlı)
