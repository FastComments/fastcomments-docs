...
Döndürür: [`GetEmailTemplateDefinitionsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_template_definitions_response.py)
...
# Desteklenen tüm yapılandırma parametrelerinin listesi için configuration.py'ye bakın.
...
# Gerekirse API anahtarı için öneki (ör. Bearer) ayarlamak için aşağıdaki yorum işaretini kaldırın
