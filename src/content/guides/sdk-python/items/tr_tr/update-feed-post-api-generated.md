...
[inline-code-attrs-start title = 'update_feed_post Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Aşağıda her kimlik doğrulama yöntemi için örnekler sağlanmıştır; kimlik doğrulama kullanım durumunuza uyan örneği kullanın.
...
# API istemcisinin bir örneğiyle bir context bloğuna girin
