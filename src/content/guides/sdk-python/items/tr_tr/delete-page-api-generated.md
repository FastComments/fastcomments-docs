...
Döndürür: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_page_api_response.py)

## Örnek

[inline-code-attrs-start title = 'delete_page Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Gerekirse API anahtarı için önek (ör. Bearer) ayarı yapmak üzere aşağıdaki satırın yorumunu kaldırın
