...
Dönen değer: [`APIEmptyResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_empty_response.py)
...
# Sunucu tanımı isteğe bağlıdır ve varsayılan https://fastcomments.com adresidir.
