...
[inline-code-attrs-start title = 'delete_moderation_vote Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Sunucunun (host) tanımlanması isteğe bağlıdır ve varsayılan https://fastcomments.com'tur
