...
Döndürür: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_subscriptions_api_response.py)

## Örnek

[inline-code-attrs-start title = 'get_subscriptions Örneği'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Gerekirse API anahtarı için önek (ör. Bearer) ayarı yapmak üzere aşağıdakilerin yorumunu kaldırın
