...
[inline-code-attrs-start title = 'delete_tenant_user Örnek'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Host tanımlamak isteğe bağlıdır ve varsayılan olarak https://fastcomments.com olarak ayarlanır
...
# Bir API istemcisi örneği ile bir bağlam (context) girin
