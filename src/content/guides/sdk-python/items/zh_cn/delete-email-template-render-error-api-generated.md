...
[inline-code-attrs-start title = 'delete_email_template_render_error 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 如有需要，取消注释下面的代码为 API 密钥设置前缀（例如 Bearer）
