...
返回: [`GetUserBadgeProgressList200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_badge_progress_list200_response.py)
...
# 如有必要，取消注释下面行以为 API 密钥设置前缀（例如 Bearer）
