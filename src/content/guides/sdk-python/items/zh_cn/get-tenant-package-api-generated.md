...
返回: [`GetTenantPackageResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_package_response.py)

## 示例

[inline-code-attrs-start title = 'get_tenant_package 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 以下提供了每种身份验证方法的示例，请使用适合您使用场景的示例。
