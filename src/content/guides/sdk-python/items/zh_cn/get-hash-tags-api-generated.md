...
返回: [`GetHashTagsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_hash_tags_response.py)
...
# 客户端必须配置认证和授权参数
# 以符合 API 服务器的安全策略。
# 为每种认证方法提供了以下示例，请使用满足您
# 认证用例的示例。
# Configure API key authorization: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 如有需要，可取消下面的注释以为 API 密钥设置前缀（例如 Bearer）
