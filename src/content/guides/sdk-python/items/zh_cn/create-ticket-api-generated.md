...
返回: [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_ticket_response.py)
...
# 每种身份验证方法的示例在下面提供，请使用符合您身份验证用例的示例。
#
