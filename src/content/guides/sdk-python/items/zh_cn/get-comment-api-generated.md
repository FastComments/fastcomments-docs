...
返回: [`APIGetCommentResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_get_comment_response.py)

## 示例

[inline-code-attrs-start title = 'get_comment 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 下面提供了每种身份验证方法的示例，请使用符合您身份验证用例的示例。
#
