...
返回: [`CheckedCommentsForBlocked200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/checked_comments_for_blocked200_response.py)

## 示例

[inline-code-attrs-start title = 'checked_comments_for_blocked 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    comment_ids = 'comment_ids_example' # str | 以逗号分隔的评论 ID 列表。
