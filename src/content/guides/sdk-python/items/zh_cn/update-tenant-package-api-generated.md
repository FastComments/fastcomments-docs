...
[inline-code-attrs-start title = 'update_tenant_package 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 定义主机是可选的，缺省为 https://fastcomments.com
