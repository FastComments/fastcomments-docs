...
返回：[`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant_user_response.py)

## 示例

[inline-code-attrs-start title = 'create_tenant_user 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 如有需要，可取消注释以为 API 密钥设置前缀（例如 Bearer）
