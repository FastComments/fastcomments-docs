...
[inline-code-attrs-start title = 'delete_notification_count 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 下方提供了每种验证方法的示例，请使用符合您验证需求的示例。

# 配置 API 密钥授权：api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 如有需要，取消注释下面内容为 API 密钥设置前缀（例如 Bearer）
