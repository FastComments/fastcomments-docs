...
[inline-code-attrs-start title = 'delete_email_template 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 客户端必须根据 API 服务的安全策略配置认证和授权参数。
# 下面提供了每种认证方法的示例，请使用适合您认证用例的示例。

# 配置 API key 授权：api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 如果需要，请取消注释以下内容以设置 API key 的前缀（例如 Bearer）
