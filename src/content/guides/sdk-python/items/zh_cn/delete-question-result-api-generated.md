...
[inline-code-attrs-start title = 'delete_question_result 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 下面为每种身份验证方法提供了示例，请使用满足你使用场景的示例。

# 配置 API 密钥授权：api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 如有需要，请取消注释以下行以设置 API 密钥前缀（例如 Bearer）
