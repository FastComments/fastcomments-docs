...
返回: [`GetEmailTemplateRenderErrors200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_template_render_errors200_response.py)

## 示例

[inline-code-attrs-start title = 'get_email_template_render_errors 示例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 下方提供了每种身份验证方法的示例，请使用适合您身份验证用例的示例。
