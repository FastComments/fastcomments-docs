...
# Uđi u kontekst s instancom API klijenta
with client.ApiClient(configuration) as api_client:
    # Stvori instancu API klase
    ...
    try:
        ...
        print("Odgovor DefaultApi->un_block_user_from_comment:\n")
        pprint(api_response)
    except Exception as e:
        print("Izuzetak prilikom poziva DefaultApi->un_block_user_from_comment: %s\n" % e)
[inline-code-end]
