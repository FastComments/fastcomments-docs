...
Vraća: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/bulk_pre_ban_summary.py)

## Primjer

[inline-code-attrs-start title = 'post_bulk_pre_ban_summary Primjer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    include_by_user_id_and_email = True # bool |  (neobavezno)
    include_by_ip = True # bool |  (neobavezno)
    include_by_email_domain = True # bool |  (neobavezno)
