...
[inline-code-attrs-start title = 'Primjer get_count'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Uđite u kontekst instance API klijenta
with client.ApiClient(configuration) as api_client:
    ...
    filter = 'filter_example' # str |  (opcionalno)
