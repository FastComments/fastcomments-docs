...
[inline-code-attrs-start title = 'Primjer get_gifs_search'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definiranje hosta je opcionalno i po defaultu je https://fastcomments.com
...
with client.ApiClient(configuration) as api_client:
    ...
    rating = 'rating_example' # str |  (neobavezno)
