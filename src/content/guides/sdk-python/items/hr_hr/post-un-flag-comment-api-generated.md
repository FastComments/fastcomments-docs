...
[inline-code-attrs-start title = 'post_un_flag_comment Primjer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Izuzetak pri pozivu ModerationApi->post_un_flag_comment: %s\n" % e)
[inline-code-end]