...
[inline-code-attrs-start title = 'Primjer post_ban_user_undo'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Izuzetak pri pozivanju ModerationApi->post_ban_user_undo: %s\n" % e)
[inline-code-end]
