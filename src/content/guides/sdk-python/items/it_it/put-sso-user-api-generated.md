...
Restituisce: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/put_sso_user_api_response.py)

## Esempio

[inline-code-attrs-start title = 'Esempio put_sso_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Rimuovi il commento sottostante per impostare un prefisso (es. Bearer) per la API key, se necessario
