...
Restituisce: [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_moderator_response.py)
...
# La definizione dell'host è facoltativa e ha valore predefinito https://fastcomments.com
...
# Decommenta le righe sottostanti per impostare un prefisso (es. Bearer) per l'API key, se necessario
