...
Restituisce: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_feed_posts_response.py)

## Esempio

[inline-code-attrs-start title = 'Esempio create_feed_post'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Esempi per ciascun metodo di autenticazione sono forniti di seguito, usare l'esempio che
