...
[inline-code-attrs-start title = 'post_un_flag_comment Esempio'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definire l'host è facoltativo e predefinito su https://fastcomments.com
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("La risposta di ModerationApi->post_un_flag_comment:\n")
        pprint(api_response)
    except Exception as e:
        print("Eccezione durante la chiamata a ModerationApi->post_un_flag_comment: %s\n" % e)
[inline-code-end]