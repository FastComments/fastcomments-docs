...
[inline-code-attrs-start title = 'Esempio per delete_tenant_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Gli esempi per ogni metodo di autenticazione sono forniti di seguito; usa
