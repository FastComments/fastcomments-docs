...
[inline-code-attrs-start title = 'Esempio di delete_tenant_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    delete_comments = 'delete_comments_example' # str |  (opzionale)
