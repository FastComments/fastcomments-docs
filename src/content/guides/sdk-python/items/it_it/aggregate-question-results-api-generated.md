...
[inline-code-attrs-start title = 'aggregate_question_results Esempio'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Sono forniti esempi per ogni metodo di autenticazione, usa l'esempio che
