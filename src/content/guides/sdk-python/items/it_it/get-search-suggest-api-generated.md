...
[inline-code-attrs-start title = 'Esempio get_search_suggest'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    text_search = 'text_search_example' # str |  (facoltativo)
