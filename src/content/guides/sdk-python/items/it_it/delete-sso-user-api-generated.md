...
Restituisce: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_sso_user_api_response.py)

## Esempio

[inline-code-attrs-start title = 'Esempio di delete_sso_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    delete_comments = True # bool |  (opzionale)
    comment_delete_mode = 'comment_delete_mode_example' # str |  (opzionale)
