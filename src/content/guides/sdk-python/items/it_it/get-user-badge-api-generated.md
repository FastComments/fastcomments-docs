...
Restituisce: [`APIGetUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_get_user_badge_response.py)

## Esempio

[inline-code-attrs-start title = 'Esempio di get_user_badge'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Decommenta quanto sotto per impostare un prefisso (es. Bearer) per l'API key, se necessario
