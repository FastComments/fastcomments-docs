...
[inline-code-attrs-start title = 'Esempio patch_domain_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Decommentare sotto per impostare il prefisso (es. Bearer) per la API key, se necessario
