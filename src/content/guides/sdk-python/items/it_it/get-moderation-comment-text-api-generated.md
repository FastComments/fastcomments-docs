...
[inline-code-attrs-start title = 'get_moderation_comment_text Esempio'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_moderation_comment_text(tenant_id, comment_id, sso=sio)
