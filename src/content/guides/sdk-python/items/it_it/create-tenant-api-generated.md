...
Restituisce: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant_response.py)
...
# Decommenta quanto sotto per impostare un prefisso (es. Bearer) per API key, se necessario
