...
Restituisce: [`APIGetCommentsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_get_comments_response.py)
...
# Gli esempi per ogni metodo di auth sono forniti di seguito; usa l'esempio che
...
with client.ApiClient(configuration) as api_client:
    ...
    context_user_id = 'context_user_id_example' # str |  (opzionale)
    hash_tag = 'hash_tag_example' # str |  (opzionale)
    parent_id = 'parent_id_example' # str |  (opzionale)
    direction = client.SortDirections() # SortDirections |  (opzionale)
    from_date = 56 # int |  (opzionale)
    to_date = 56 # int |  (opzionale)
