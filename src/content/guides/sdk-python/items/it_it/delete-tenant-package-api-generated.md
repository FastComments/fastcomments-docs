...
[inline-code-attrs-start title = 'delete_tenant_package Esempio'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Vengono forniti esempi per ogni metodo di autenticazione qui sotto; usare l'esempio che
