...
Restituisce: [`GetDomainConfigs200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_domain_configs200_response.py)

## Esempio

[inline-code-attrs-start title = 'Esempio di get_domain_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Gli esempi per ogni metodo di autenticazione sono forniti sotto, usa l'esempio che
