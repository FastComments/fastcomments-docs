...
[inline-code-attrs-start title = 'Esempio di update_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Sono forniti esempi per ciascun metodo di autenticazione qui sotto; usa l'esempio che
