...
[inline-code-attrs-start title = 'get_api_comments Esempio'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("La risposta di ModerationApi->get_api_comments:\n")
        pprint(api_response)
    except Exception as e:
        print("Eccezione durante la chiamata a ModerationApi->get_api_comments: %s\n" % e)
[inline-code-end]