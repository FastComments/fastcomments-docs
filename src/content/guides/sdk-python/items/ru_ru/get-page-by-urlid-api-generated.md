...
Возвращает: [`GetPageByURLIdAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_page_by_urlid_api_response.py)

## Пример

[inline-code-attrs-start title = 'Пример get_page_by_urlid'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
