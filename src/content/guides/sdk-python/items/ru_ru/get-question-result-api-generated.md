...
Возвращает: [`GetQuestionResult200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_result200_response.py)
...
# Настройте авторизацию через API-ключ: api_key
