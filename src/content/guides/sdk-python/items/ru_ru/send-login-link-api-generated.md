...
[inline-code-attrs-start title = 'send_login_link Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    redirect_url = 'redirect_url_example' # str |  (необязательно)
