...
[inline-code-attrs-start title = 'post_flag_comment Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# См. configuration.py для полного списка поддерживаемых параметров конфигурации.
