...
[inline-code-attrs-start title = 'Пример delete_email_template_render_error'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Настройка авторизации с API-ключом: api_key
