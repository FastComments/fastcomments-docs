...
Возвращает: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/adjust_votes_response.py)
...
# Войдите в контекст с экземпляром API client
