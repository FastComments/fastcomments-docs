...
| urlId | string | query | No | Идентификатор страницы, откуда происходит загрузка, для настройки |
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | Идентификатор страницы, откуда происходит загрузка, для настройки (optional)
