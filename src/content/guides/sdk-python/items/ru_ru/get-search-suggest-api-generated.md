...
[inline-code-attrs-start title = 'Пример использования get_search_suggest'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Определение хоста не обязательно и по умолчанию установлено в https://fastcomments.com
