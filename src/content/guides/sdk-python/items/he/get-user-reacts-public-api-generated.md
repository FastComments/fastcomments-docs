...
[inline-code-attrs-start title = 'get_user_reacts_public דוגמה'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הכנס לתוך קונטקסט עם מופע של לקוח ה-API
