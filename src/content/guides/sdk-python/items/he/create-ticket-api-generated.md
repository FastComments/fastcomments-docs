...
מחזיר: [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_ticket_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-create_ticket'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# עיינו ב-configuration.py לקבלת רשימה של כל פרמטרי התצורה הנתמכים.
