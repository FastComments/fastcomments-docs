...
מחזיר: [`CreateQuestionResultResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_question_result_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-create_question_result'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראה את configuration.py לקבלת רשימה של כל פרמטרי התצורה הנתמכים.
