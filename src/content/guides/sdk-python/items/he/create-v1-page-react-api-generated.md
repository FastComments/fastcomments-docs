...
[inline-code-attrs-start title = 'דוגמה ל-create_v1_page_react'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# עיינו ב-configuration.py עבור רשימה של כל פרמטרי התצורה הנתמכים.
