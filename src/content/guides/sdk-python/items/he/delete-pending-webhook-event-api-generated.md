...
[inline-code-attrs-start title = 'דוגמה ל-delete_pending_webhook_event'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# תספק את מקרה השימוש שלכם לאימות.
#
# Configure API key authorization: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# הסירו את ההערה מהשורה למטה כדי להגדיר קידומת (לדוגמה Bearer) עבור מפתח ה-API, אם נדרש
