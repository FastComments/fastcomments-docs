...
מחזיר: [`BulkAggregateQuestionResultsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/bulk_aggregate_question_results_response.py)

## דוגמה

[inline-code-attrs-start title = 'bulk_aggregate_question_results דוגמה'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הלקוח צריך להגדיר את פרמטרי האימות וההרשאות
# בהתאם למדיניות האבטחה של שרת ה-API.
# בדוגמאות למטה יש דוגמאות לכל שיטת אימות — השתמש בדוגמה
