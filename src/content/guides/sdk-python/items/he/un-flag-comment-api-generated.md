...
[inline-code-attrs-start title = 'דוגמה ל-un_flag_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הגדרת ה-host אופציונלית ובאופן ברירת מחדל היא https://fastcomments.com
