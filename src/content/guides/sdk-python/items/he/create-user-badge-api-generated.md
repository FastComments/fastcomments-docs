...
מחזיר: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_create_user_badge_response.py)
...
# דוגמאות לכל שיטת אימות מופיעות למטה, השתמש בדוגמה
