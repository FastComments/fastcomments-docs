...
מוחזר: [`DeleteFeedPostPublic200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_feed_post_public200_response.py)
...
# הכנס להקשר (context) עם מופע של קליינט ה-API
