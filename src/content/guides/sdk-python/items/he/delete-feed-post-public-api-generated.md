...
[inline-code-attrs-start title = 'דוגמה delete_feed_post_public'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ההגדרה של המארח היא אופציונלית ובברירת מחדל https://fastcomments.com
