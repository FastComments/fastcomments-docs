...
[inline-code-attrs-start title = 'דוגמה של send_invite'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראה את configuration.py לקבלת רשימת כל פרמטרי התצורה הנתמכים.
