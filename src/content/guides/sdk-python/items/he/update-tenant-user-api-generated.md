...
[inline-code-attrs-start title = 'update_tenant_user דוגמה'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# למטה יש דוגמאות לכל שיטת אימות; השתמשו בדוגמה שמתאימה למקרה השימוש שלכם.

# Configure API key authorization: api_key
# Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
# configuration.api_key_prefix['api_key'] = 'Bearer'

# הכנסו להקשר עם מופע של ה-API
