...
מחזיר: [`GetAuditLogsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_audit_logs_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה של get_audit_logs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הגדרת ה-host היא אופציונלית והברירת המחדל היא https://fastcomments.com
