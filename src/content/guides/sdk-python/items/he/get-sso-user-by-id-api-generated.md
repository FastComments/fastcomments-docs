...
מחזיר: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_sso_user_by_id_api_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_sso_user_by_id'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הגדרת host אופציונלית ותוגדר כברירת מחדל כ-https://fastcomments.com
...
# היכנס להקשר עם מופע של ApiClient
