...
[inline-code-attrs-start title = 'דוגמה post_flag_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הגדרת ה‑host היא אופציונלית ובברירת מחדל ל‑https://fastcomments.com
