...
מחזיר: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/add_sso_user_api_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-add_sso_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראו את configuration.py עבור רשימה של כל הפרמטרים הנתמכים בקונפיגורציה.
...
# דוגמאות לכל שיטת אימות מופיעות להלן, השתמש בדוגמה
