...
מחזיר: [`GetCachedNotificationCountResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_cached_notification_count_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_cached_notification_count'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# דוגמאות עבור כל שיטת אימות מסופקות להלן, השתמש בדוגמה
