...
[inline-code-attrs-start title = 'דוגמת get_search_pages'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראו configuration.py לקבלת רשימה של כל פרמטרי ההגדרות הנתמכים.
