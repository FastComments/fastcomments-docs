...
מחזיר: [`SearchUsersResult`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/search_users_result.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמת search_users'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
