...
מחזירה: [`SetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/set_user_trust_factor_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמת set_trust_factor'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראו configuration.py לרשימה של כל פרמטרי ההגדרה הנתמכים.
