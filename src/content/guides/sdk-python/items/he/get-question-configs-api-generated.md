...
[inline-code-attrs-start title = 'דוגמת get_question_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הסר את ההערה למטה כדי להגדיר הקדמה (למשל Bearer) למפתח ה-API, אם נדרש
