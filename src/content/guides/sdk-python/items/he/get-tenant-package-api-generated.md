...
מחזיר: [`GetTenantPackageResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_package_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראו את configuration.py לרשימה של כל פרמטרי הקונפיגורציה הנתמכים.
...
# תואמת את מקרה השימוש שלכם.

# קונפיגורציה של אימות באמצעות מפתח API: api_key
