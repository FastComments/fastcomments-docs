...
מחזירה: [`VoteResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/vote_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמת vote_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ראה configuration.py לקבלת רשימת כל פרמטרי ההגדרות הנתמכים.
configuration = client.Configuration(
    host = "https://fastcomments.com"
)


# הכנס הקשר (context) עם מופע של לקוח ה-API
