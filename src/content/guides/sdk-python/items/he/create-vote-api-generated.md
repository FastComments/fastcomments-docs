...
[inline-code-attrs-start title = 'דוגמת create_vote'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# מתאימה לתרחיש השימוש שלך באימות.

# הגדר את אימות מפתח ה-API: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# הסר את ההערה להלן כדי להגדיר קידומת (למשל Bearer) עבור מפתח ה-API, אם צריך
