...
מחזיר: [`GetUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_response.py)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# עיין ב-configuration.py לקבלת רשימת כל הפרמטרים הנתמכים של התצורה.
