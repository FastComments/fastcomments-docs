...
[inline-code-attrs-start title = 'דוגמה ל-delete_email_template_render_error'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# דוגמות לכל שיטת אימות מסופקות למטה, השתמש בדוגמה ש-
# מתאימה לתרחיש האימות שלך.
