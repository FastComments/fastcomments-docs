...
מחזיר: [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_domain_configs_response.py)
...
# דוגמות לכל שיטת אימות מופיעות למטה, השתמשו בדוגמה ש
