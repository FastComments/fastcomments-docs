...
[inline-code-attrs-start title = 'post_ban_user_from_comment דוגמה'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# הגדרת ה‑host הוא אופציונלי ומוגדר כברירת מחדל ל‑https://fastcomments.com
