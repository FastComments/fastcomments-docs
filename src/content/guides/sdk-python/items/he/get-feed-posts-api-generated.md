...
[inline-code-attrs-start title = 'דוגמת get_feed_posts'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# דוגמאות לכל שיטת אימות ניתנות למטה, השתמשו בדוגמה שתואמת את הצורך שלכם באימות.
