...
[inline-code-attrs-start title = 'Примјер get_domain_configs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Дефинисање параметра host је опционално и подразумева се https://fastcomments.com
