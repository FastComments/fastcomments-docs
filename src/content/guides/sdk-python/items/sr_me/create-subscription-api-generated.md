...
Враћа: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_subscription_api_response.py)

## Пример

[inline-code-attrs-start title = 'create_subscription Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Дефинисање хоста је опционално и подразумево је https://fastcomments.com
