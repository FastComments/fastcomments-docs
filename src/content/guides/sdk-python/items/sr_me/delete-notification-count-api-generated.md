...
[inline-code-attrs-start title = 'delete_notification_count Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Подешавање хоста је опционално и подразумева се на https://fastcomments.com
