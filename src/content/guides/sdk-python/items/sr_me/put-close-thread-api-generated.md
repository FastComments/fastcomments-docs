...
[inline-code-attrs-start title = 'put_close_thread Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Дефинисање host-а је опционално и подразумева се на https://fastcomments.com
