...
[inline-code-attrs-start title = 'get_pre_ban_summary Primjer'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    include_by_user_id_and_email = True # bool |  (opcionalno)
    include_by_ip = True # bool |  (opcionalno)
    include_by_email_domain = True # bool |  (opcionalno)
