...
| afterUserId | string | query | No | Kursor za razbijanje neriješenih situacija: proslijedite nextAfterUserId iz prethodnog odgovora. Potrebno kada je afterName postavljen kako se ne bi propuštali zapisi zbog jednakih imena. |
...
with client.ApiClient(configuration) as api_client:
    ...
    after_user_id = 'after_user_id_example' # str | Kursor za razbijanje neriješenih situacija: proslijedite nextAfterUserId iz prethodnog odgovora. Potrebno kada je afterName postavljen kako se ne bi propuštali zapisi zbog jednakih imena. (optional)
