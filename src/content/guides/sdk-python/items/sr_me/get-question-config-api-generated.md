...
[inline-code-attrs-start title = 'get_question_config Примјер'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Дефинисање параметра host је опционално и подразумевано је https://fastcomments.com
