...
回傳: [`CreateTenantPackage200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant_package200_response.py)
...
# 如需為 API 金鑰設定前綴（例如 Bearer），請解除註解下方程式碼
