...
回傳: [`APIGetUserBadgeProgressListResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/api_get_user_badge_progress_list_response.py)
...
# 若需要，取消下面的註解以設定 API 金鑰的前綴（例如 Bearer）
