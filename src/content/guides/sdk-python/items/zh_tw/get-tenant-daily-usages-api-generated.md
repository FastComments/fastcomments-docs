...
回傳： [`GetTenantDailyUsages200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_daily_usages200_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    year_number = 3.4 # float |  (可選)
    month_number = 3.4 # float |  (可選)
    day_number = 3.4 # float |  (可選)
    skip = 3.4 # float |  (可選)
