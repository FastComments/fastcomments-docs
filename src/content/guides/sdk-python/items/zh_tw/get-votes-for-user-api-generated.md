...
回傳: [`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_votes_for_user_response.py)
...
# 若需要，請取消下列註解來為 API 金鑰設定前綴（例如 Bearer）
