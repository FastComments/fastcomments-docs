...
傳回: [`FlagCommentPublic200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/flag_comment_public200_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    delete_comments = 'delete_comments_example' # str |  (可選)
    comment_delete_mode = 'comment_delete_mode_example' # str |  (可選)
