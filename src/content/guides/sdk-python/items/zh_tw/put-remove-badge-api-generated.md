...
回傳：[`RemoveUserBadgeResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/remove_user_badge_response.py)

## 範例

[inline-code-attrs-start title = 'put_remove_badge 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 定義主機為選填，預設為 https://fastcomments.com
