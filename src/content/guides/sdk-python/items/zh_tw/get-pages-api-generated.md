...
回傳：[`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pages_api_response.py)

## 範例

[inline-code-attrs-start title = 'get_pages 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 定義 host 為選擇性，預設為 https://fastcomments.com
