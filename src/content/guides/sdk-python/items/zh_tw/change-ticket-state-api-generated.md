...
回傳: [`ChangeTicketStateResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/change_ticket_state_response.py)
...
# 如有需要解除註解下方以設定 API 金鑰的前綴（例如 Bearer）
