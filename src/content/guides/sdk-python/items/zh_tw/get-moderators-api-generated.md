...
回傳: [`GetModeratorsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_moderators_response.py)
...
# 用戶端必須依照 API 伺服器的安全政策設定驗證和授權參數。
# 以下提供各種認證方法的範例，請使用符合您使用情境的範例。
