...
回傳： [`GetQuestionResults200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_results200_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    start_date = 'start_date_example' # str |  (可選)
    question_id = 'question_id_example' # str |  (可選)
    question_ids = 'question_ids_example' # str |  (可選)
    skip = 3.4 # float |  (可選)
