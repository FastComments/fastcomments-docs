...
回傳: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_sso_user_api_response.py)

## 範例

[inline-code-attrs-start title = 'patch_sso_user 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 下方提供各種驗證方式的範例，請使用符合您驗證需求的範例。

# 設定 API key 授權：api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# 若需要，取消註解下列內容以設定 API key 的前置字串（例如 Bearer）
