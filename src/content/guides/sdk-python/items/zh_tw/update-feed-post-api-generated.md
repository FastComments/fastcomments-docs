...
[inline-code-attrs-start title = 'update_feed_post 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 若需要，取消註解以下程式以設定 API 金鑰的前綴 (例如 Bearer)
# configuration.api_key_prefix['api_key'] = 'Bearer'

# 以一個 API client 的實例進入一個上下文
