...
[inline-code-attrs-start title = 'delete_notification_count 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 用戶端必須根據 API 伺服器的安全策略來設定驗證與授權參數。
# 下方提供了每種驗證方法的範例，請使用符合你驗證情境的範例。
