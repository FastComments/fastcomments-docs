...
[inline-code-attrs-start title = 'delete_pending_webhook_event 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 設定 host (主機) 為可選，預設為 https://fastcomments.com
