...
回傳: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_page_api_response.py)

## 範例

[inline-code-attrs-start title = 'delete_page 範例'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# 用戶端必須依據 API 伺服器的安全政策來設定驗證與授權參數。
