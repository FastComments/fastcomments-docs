...
[inline-code-attrs-start title = 'Exemplo de delete_question_result'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente abaixo para configurar um prefixo (e.g. Bearer) para API key, se necessário
