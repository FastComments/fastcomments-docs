...
Retorna: [`GetDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_domain_config_response.py)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de get_domain_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# São fornecidos exemplos para cada método de autenticação abaixo, use o exemplo que
