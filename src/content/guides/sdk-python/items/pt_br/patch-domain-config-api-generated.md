...
Retorna: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_domain_config_response.py)
...
# Descomente abaixo para configurar o prefixo (e.g. Bearer) para a API key, se necessário
