...
Retorna: [`DeleteDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_domain_config_response.py)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de delete_domain_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente abaixo para configurar o prefixo (por exemplo, Bearer) para a API key, se necessário
