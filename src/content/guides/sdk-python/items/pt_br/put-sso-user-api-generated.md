...
Retorna: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/put_sso_user_api_response.py)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de put_sso_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definir o host é opcional e tem como valor padrão https://fastcomments.com
...
with client.ApiClient(configuration) as api_client:
    ...
    update_comments = True # bool |  (opcional)
