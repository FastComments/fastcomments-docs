...
Retorna: [`GetTenants200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenants200_response.py)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de get_tenants'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# melhor atender ao seu caso de uso de autenticação.
