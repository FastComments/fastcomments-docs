...
[inline-code-attrs-start title = 'Exemplo get_tenant_daily_usages'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Remova o comentário abaixo para configurar o prefixo (por exemplo, Bearer) para a chave API, se necessário
