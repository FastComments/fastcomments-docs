...
Retorna: [`FlagCommentResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/flag_comment_response.py)

## Exemplo

[inline-code-attrs-start title = 'Exemplo flag_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Configurar a autorização da chave API: api_key
