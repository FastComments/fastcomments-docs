...
[inline-code-attrs-start title = 'aggregate_question_results Exemplo'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Exemplos para cada método de auth são fornecidos abaixo, use o exemplo que
# atenda ao seu caso de uso de auth.
