...
| commentIds | string | query | Ναι | Μια λίστα διαχωρισμένη με κόμμα με τα comment ids. |
...
with client.ApiClient(configuration) as api_client:
    ...
    comment_ids = 'comment_ids_example' # str | Μια λίστα διαχωρισμένη με κόμμα με τα comment ids.
