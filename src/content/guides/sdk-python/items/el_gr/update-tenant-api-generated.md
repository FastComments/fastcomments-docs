...
[inline-code-attrs-start title = 'Παράδειγμα update_tenant'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ο client πρέπει να ρυθμίσει τις παραμέτρους ταυτοποίησης (authentication) και εξουσιοδότησης (authorization)
