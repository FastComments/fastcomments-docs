...
[inline-code-attrs-start title = 'set_comment_text Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Εισέλθετε σε ένα περιβάλλον με μια παρουσία του πελάτη API
