...
[inline-code-attrs-start title = 'Παράδειγμα delete_subscription'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Παρακάτω παρέχονται παραδείγματα για κάθε μέθοδο αυθεντικοποίησης, χρησιμοποιήστε αυτό
# που καλύπτει το σενάριο αυθεντικοποίησής σας.
