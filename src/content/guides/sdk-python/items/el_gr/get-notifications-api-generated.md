...
# Ο πελάτης πρέπει να διαμορφώσει τις παραμέτρους αυθεντικοποίησης και εξουσιοδότησης σύμφωνα με την πολιτική ασφαλείας του διακομιστή API.
...
# Απενεργοποιήστε το παρακάτω για να ρυθμίσετε προθεματικό (π.χ. Bearer) για το κλειδί API, εάν χρειάζεται
