...
[inline-code-attrs-start title = 'get_search_users Παράδειγμα'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Η καθορισμένη διεύθυνση host είναι προαιρετική και προεπιλεγμένη είναι https://fastcomments.com
