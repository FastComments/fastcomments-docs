...
[inline-code-attrs-start title = 'Παράδειγμα flag_comment_public'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Ορισμός του host είναι προαιρετικός και είναι προεπιλεγμένος στο https://fastcomments.com
