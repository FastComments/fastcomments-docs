...
Επιστρέφει: [`DeleteDomainConfig200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_domain_config200_response.py)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα delete_domain_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# ταιριάζει στην περίπτωση χρήσης της αυθεντικοποίησής σας.
...
# Εισέλθετε σε context με ένα στιγμιότυπο του API πελάτη
