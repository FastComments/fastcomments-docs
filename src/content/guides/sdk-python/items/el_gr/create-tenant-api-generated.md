...
Επιστρέφει: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_tenant200_response.py)
...
# Παρακάτω παρέχονται παραδείγματα για κάθε μέθοδο πιστοποίησης — χρησιμοποιήστε αυτό που
# ταιριάζει στην περίπτωσή σας χρήσης πιστοποίησης.
