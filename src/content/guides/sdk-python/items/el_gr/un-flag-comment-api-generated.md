...
[inline-code-attrs-start title = 'Παράδειγμα un_flag_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Εισέλθετε σε περιβάλλον (context) με ένα instance του API client
