...
| urlId | string | query | Όχι | Χρησιμοποιείται για να καθορίσει αν η τρέχουσα σελίδα είναι εγγεγραμμένη. |
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | Χρησιμοποιείται για να καθορίσει αν η τρέχουσα σελίδα είναι εγγεγραμμένη. (προαιρετικό)
