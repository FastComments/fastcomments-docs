...
[inline-code-attrs-start title = 'delete_pending_webhook_event Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Kommentieren Sie das Folgende aus, um ein Präfix (z. B. Bearer) für den API-Schlüssel einzurichten, falls erforderlich
