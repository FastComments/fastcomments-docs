...
[inline-code-attrs-start title = 'save_comment Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Auskommentieren, um ein Präfix (z. B. Bearer) für den API‑Schlüssel festzulegen, falls benötigt
