...
| cursor | string | query | Nein | Opaque pagination cursor returned as `nextCursor` from a prior request. Tied to the same `sortBy`. |
| limit | integer | query | Nein | 1..200, Standard 50 |
| q | string | query | Nein | Optionaler, groß-/kleinschreibungsunabhängiger Präfixfilter für den Titel. |
...
| hasComments | boolean | query | Nein | Wenn true, nur Seiten zurückgeben, die mindestens einen Kommentar haben. |

## Antwort

Gibt zurück: [`GetPublicPagesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_public_pages_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    limit = 56 # int | 1..200, Standardmäßig 50 (optional)
    q = 'q_example' # str | Optionaler, groß-/kleinschreibungsunabhängiger Präfixfilter für den Titel. (optional)
