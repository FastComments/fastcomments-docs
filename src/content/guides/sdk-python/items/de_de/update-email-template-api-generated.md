...
[inline-code-attrs-start title = 'Beispiel für update_email_template'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# API-Schlüssel-Authentifizierung einrichten: api_key
