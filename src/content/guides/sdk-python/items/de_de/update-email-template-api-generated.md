...
[inline-code-attrs-start title = 'update_email_template Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Beispiele für jede Authentifizierungs-Methode werden unten bereitgestellt; verwenden Sie das Beispiel, das
# Ihren Authentifizierungsanforderungen entspricht.

# API-Key-Authentifizierung konfigurieren: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Untenstehende Zeile auskommentieren, um ein Präfix (z. B. Bearer) für den API-Key einzurichten, falls benötigt
