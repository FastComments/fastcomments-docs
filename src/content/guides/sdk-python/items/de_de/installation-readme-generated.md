...
Diese Bibliothek enthält zwei Module: den generierten API‑Client und die Kern‑Python‑Bibliothek, die handgeschriebene Hilfsprogramme enthält, um die Arbeit mit der API zu erleichtern, einschließlich SSO‑Unterstützung.
