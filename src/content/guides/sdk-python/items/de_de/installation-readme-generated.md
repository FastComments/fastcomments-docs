...
Jeder getaggte [GitHub Release](https://github.com/FastComments/fastcomments-python/releases) hat außerdem ein gebautes Wheel angehängt, falls Sie ein binäres Artefakt direkt installieren möchten.
