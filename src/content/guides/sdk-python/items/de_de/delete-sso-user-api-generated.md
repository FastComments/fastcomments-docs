...
Returns: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_sso_user_api_response.py)
...
# Beispiele für jede Authentifizierungsmethode sind unten bereitgestellt, verwenden Sie das Beispiel, das
# Ihren Authentifizierungsanwendungsfall erfüllt.

# API-Schlüssel-Authorisierung konfigurieren: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Kommentieren Sie das Folgende aus, um ein Präfix (z. B. Bearer) für den API-Schlüssel festzulegen, falls nötig
