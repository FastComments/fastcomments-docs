...
Gibt zurück: [`GetTenantUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_tenant_user_response.py)

## Beispiel

[inline-code-attrs-start title = 'get_tenant_user Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Unten auskommentierten Code aktivieren, um ein Präfix (z. B. Bearer) für den API-Key einzurichten, falls erforderlich
