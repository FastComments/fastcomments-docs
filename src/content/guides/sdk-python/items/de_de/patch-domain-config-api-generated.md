...
Gibt zurück: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_domain_config_response.py)

## Beispiel

[inline-code-attrs-start title = 'patch_domain_config Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Die Host-Angabe ist optional und standardmäßig https://fastcomments.com
