...
Gibt zurück: [`ChangeTicketStateResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/change_ticket_state_response.py)

## Beispiel

[inline-code-attrs-start title = 'change_ticket_state Beispiel'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Für jede Auth-Methode sind unten Beispiele aufgeführt; verwenden Sie das Beispiel,
# das Ihren Authentifizierungsanforderungen entspricht.

# API-Key-Authentifizierung konfigurieren: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Entfernen Sie die Kommentarzeichen unten, um ein Präfix (z. B. Bearer) für den API-Key zu setzen, falls nötig
