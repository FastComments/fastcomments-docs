...
[inline-code-attrs-start title = 'post_set_comment_spam_status Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Een context aangaan met een instantie van de API‑client
with client.ApiClient(configuration) as api_client:
    # Een instantie van de API‑klasse maken
