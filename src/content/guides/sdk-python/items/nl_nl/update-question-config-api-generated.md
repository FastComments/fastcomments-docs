...
[inline-code-attrs-start title = 'update_question_config Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Haal de commentaartekens hieronder weg om het prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
