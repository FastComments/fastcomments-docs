...
Geeft terug: [`CombineQuestionResultsWithCommentsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/combine_question_results_with_comments_response.py)
...
# Haal hieronder de commentaarstreepjes weg om een voorvoegsel (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
