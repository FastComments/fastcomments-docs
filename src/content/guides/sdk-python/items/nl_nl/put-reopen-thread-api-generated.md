...
[inline-code-attrs-start title = 'put_reopen_thread Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Bekijk configuration.py voor een lijst van alle ondersteunde configuratie‑parameters.
