...
[inline-code-attrs-start title = 'update_tenant_package Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Het host definiëren is optioneel en staat standaard op https://fastcomments.com
