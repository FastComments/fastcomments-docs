...
[inline-code-attrs-start title = 'update_tenant Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Haal de commentaarmarkering hieronder weg om een prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
