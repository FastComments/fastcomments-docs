...
Retourneert: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_pages_api_response.py)

## Voorbeeld

[inline-code-attrs-start title = 'get_pages Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Haal hieronder het commentaarteken weg om een prefix in te stellen (bijv. Bearer) voor de API-sleutel, indien nodig
