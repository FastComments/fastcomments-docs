...
Retourneert: [`GetEmailTemplatesResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_email_templates_response.py)

## Voorbeeld

[inline-code-attrs-start title = 'Voorbeeld get_email_templates'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# bij uw authenticatiescenario past.

# Configureer API-sleutelautorisatie: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Haal de commentaartekens weg hieronder om een voorvoegsel in te stellen (bijv. Bearer) voor de API-sleutel, indien nodig
