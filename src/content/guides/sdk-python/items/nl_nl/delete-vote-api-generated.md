...
Retourneert: [`DeleteCommentVote200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_comment_vote200_response.py)
...
# voldoet aan uw gebruiksscenario voor authenticatie.

# Configureer API-sleutelautorisatie: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Haal de commentaarregel hieronder weg om een prefix (bijv. Bearer) voor de API-sleutel te instellen, indien nodig
