...
[inline-code-attrs-start title = 'delete_email_template Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Voor elk auth-mechanisme is hieronder een voorbeeld opgenomen; gebruik
# het voorbeeld dat voldoet aan uw auth-vereiste.

# Configureer API-sleutel autorisatie: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Haal de onderstaande commentaartekens weg om een voorvoegsel (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
