...
[inline-code-attrs-start title = 'replace_tenant_user Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Haal onderstaand commentaar weg om een prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
...
with client.ApiClient(configuration) as api_client:
    ...
    update_comments = 'update_comments_example' # str |  (optioneel)
