...
Retourneert: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_subscriptions_api_response.py)

## Voorbeeld

[inline-code-attrs-start title = 'get_subscriptions Voorbeeld'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Haal de commentaartekens weg om een voorvoegsel in te stellen (bijv. Bearer) voor de API-sleutel, indien nodig
