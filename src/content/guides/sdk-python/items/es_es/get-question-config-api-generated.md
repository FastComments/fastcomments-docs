...
Devuelve: [`GetQuestionConfig200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_config200_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de get_question_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definir el host es opcional y usa https://fastcomments.com por defecto
