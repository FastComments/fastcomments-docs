...
Devuelve: [`GetV2PageReactUsersResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_v2_page_react_users_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de get_v2_page_react_users'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Inicie un contexto con una instancia del cliente de la API
