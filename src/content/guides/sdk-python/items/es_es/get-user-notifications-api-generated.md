...
[inline-code-attrs-start title = 'Ejemplo get_user_notifications'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    url_id = 'url_id_example' # str | Utilizado para determinar si la página actual está suscrita. (opcional)
