...
Devuelve: [`GetQuestionResult200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_question_result200_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de get_question_result'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Vea configuration.py para una lista de todos los parámetros de configuración compatibles.
...
# Configurar la autorización con API key: api_key
