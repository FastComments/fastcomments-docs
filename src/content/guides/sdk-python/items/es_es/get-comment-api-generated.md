...
Devuelve: [`GetComment200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_comment200_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de get_comment'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Definir el host es opcional y el valor predeterminado es https://fastcomments.com
...
# A continuación se proporcionan ejemplos para cada método de autenticación; use
