...
[inline-code-attrs-start title = 'Ejemplo de create_v1_page_react'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    title = 'title_example' # str |  (opcional)
