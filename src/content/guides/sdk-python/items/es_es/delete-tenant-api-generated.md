...
[inline-code-attrs-start title = 'delete_tenant Example'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente la siguiente línea para configurar el prefijo (p. ej., Bearer) para la clave de API, si es necesario
