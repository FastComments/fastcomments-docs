...
[inline-code-attrs-start title = 'Ejemplo de update_question_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# A continuación se proporcionan ejemplos para cada método de autenticación; utilice el ejemplo que
# satisfaga su caso de uso de autenticación.

# Configure la autorización por clave de API: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Descomente lo siguiente para establecer el prefijo (p. ej., Bearer) para la clave de API, si es necesario
