...
Devuelve: [`ModerationAPIGetCommentIdsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/moderation_api_get_comment_ids_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo get_api_ids'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("La respuesta de ModerationApi->get_api_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Excepción al llamar a ModerationApi->get_api_ids: %s\n" % e)
[inline-code-end]