...
[inline-code-attrs-start title = 'Ejemplo de delete_hash_tag'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente lo siguiente para establecer un prefijo (p. ej. Bearer) para la API key, si es necesario
