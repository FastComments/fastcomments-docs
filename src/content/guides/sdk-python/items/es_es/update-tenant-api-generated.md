...
[inline-code-attrs-start title = 'Ejemplo de update_tenant'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente a continuación para establecer un prefijo (p. ej., Bearer) para la clave de API, si es necesario
