...
Devuelve: [`GetUserResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_user_response.py)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de get_user'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Establecer el host es opcional y por defecto es https://fastcomments.com
