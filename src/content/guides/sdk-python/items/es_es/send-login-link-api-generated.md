...
[inline-code-attrs-start title = 'Ejemplo de send_login_link'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Descomente abajo para configurar el prefijo (e.g. Bearer) para la clave API, si es necesario
...
with client.ApiClient(configuration) as api_client:
    ...
    id = 'id_example' # str | 
    redirect_url = 'redirect_url_example' # str |  (opcional)
