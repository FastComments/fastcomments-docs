...
[inline-code-attrs-start title = 'update_question_config Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Клиентът трябва да конфигурира параметрите за автентификация и авторизация
