...
[inline-code-attrs-start title = 'Пример за delete_notification_count'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Конфигурирайте авторизацията с API key: api_key
