...
[inline-code-attrs-start title = 'Пример за create_v1_page_react'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Дефинирането на хоста е по желание и по подразбиране е https://fastcomments.com
