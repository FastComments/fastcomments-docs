...
| sizePreset | string | query | No | Размерен набор: "Default" (1000x1000px) или "CrossPlatform" (създва размери за популярни устройства) |
...
with client.ApiClient(configuration) as api_client:
    ...
    file = None # bytes | 
    size_preset = client.SizePreset() # SizePreset | Размерен набор: "Default" (1000x1000px) или "CrossPlatform" (създва размери за популярни устройства) (optional)
    url_id = 'url_id_example' # str | Идентификатор на страницата, от която се извършва качването, за конфигуриране (optional)
