...
Връща: [`GetAuditLogsResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_audit_logs_response.py)

## Пример

[inline-code-attrs-start title = 'Пример за get_audit_logs'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Примерите за всеки метод на удостоверяване са показани по-долу, използвайте примера, 
...
with client.ApiClient(configuration) as api_client:
    ...
    order = client.SORTDIR() # SORTDIR |  (по избор)
    after = 3.4 # float |  (по избор)
    before = 3.4 # float |  (по избор)
