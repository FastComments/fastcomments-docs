...
[inline-code-attrs-start title = 'Пример за delete_question_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Задаването на host е опционално и по подразбиране е https://fastcomments.com
...
# По-долу има примери за всеки метод на удостоверяване, използвайте примера, който
