...
Връща: [`AddDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/add_domain_config_response.py)
...
with client.ApiClient(configuration) as api_client:
    # Създаване на екземпляр на API класа
