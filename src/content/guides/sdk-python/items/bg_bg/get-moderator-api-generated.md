...
Връща: [`GetModerator200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_moderator200_response.py)
...
# отговаря на вашия сценарий на използване за удостоверяване.
