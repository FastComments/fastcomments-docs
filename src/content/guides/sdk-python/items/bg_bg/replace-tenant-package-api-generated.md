...
[inline-code-attrs-start title = 'Пример за replace_tenant_package'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Примерите за всеки метод на удостоверяване са показани по-долу; използвайте този
