...
Връща: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/patch_sso_user_api_response.py)
...
with client.ApiClient(configuration) as api_client:
    ...
    update_comments = True # bool |  (по избор)
