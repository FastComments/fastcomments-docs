...
Връща: [`PostRemoveCommentResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/post_remove_comment_response.py)
...
# Задаването на параметъра host е по избор и по подразбиране е https://fastcomments.com
