...
Vrne: [`CreateQuestionConfig200Response`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_question_config200_response.py)

## Primer

[inline-code-attrs-start title = 'Primer create_question_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Primeri za vsako metodo overjanja so prikazani spodaj, uporabite primer, ki
