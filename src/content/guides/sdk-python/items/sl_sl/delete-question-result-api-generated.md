...
[inline-code-attrs-start title = 'Primer delete_question_result'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Odjemalec mora nastaviti parametre za overjanje in pooblastilo
# v skladu s politiko varnosti API strežnika.
# Spodaj so podani primeri za vsak način overjanja; uporabite primer, ki
