...
Vrača: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/create_subscription_api_response.py)

## Primer

[inline-code-attrs-start title = 'Primer create_subscription'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Določanje gostitelja je izbirno in je privzeto https://fastcomments.com
