...
Vrne: [`GetTicketResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_ticket_response.py)

## Primer

[inline-code-attrs-start title = 'Primer get_ticket'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Spodaj so navedeni primeri za vsako metodo avtentikacije; uporabite tistega,
# ki ustreza vaši uporabi avtentikacije.
