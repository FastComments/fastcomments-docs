...
Vrne: [`DeleteDomainConfigResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/delete_domain_config_response.py)

## Primer

[inline-code-attrs-start title = 'Primer delete_domain_config'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Spodaj so prikazani primeri za vsako metodo overjanja; uporabite tistega,
