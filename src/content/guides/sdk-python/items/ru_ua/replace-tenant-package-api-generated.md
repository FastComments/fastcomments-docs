...
[inline-code-attrs-start title = 'replace_tenant_package Пример'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# который соответствует вашему сценарию.

# Настроить авторизацию по API-ключу: api_key
configuration.api_key['api_key'] = os.environ["API_KEY"]

# Раскомментируйте ниже для установки префикса (например, Bearer) для API-ключа, если нужно
