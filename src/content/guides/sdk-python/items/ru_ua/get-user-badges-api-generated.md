...
# Указание адреса хоста необязательно и по умолчанию используется https://fastcomments.com
...
# который подходит для вашего сценария использования аутентификации.
