...
[inline-code-attrs-start title = 'update_feed_post_public Приклад'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
with client.ApiClient(configuration) as api_client:
    ...
    broadcast_id = 'broadcast_id_example' # str |  (опційно)
    sso = 'sso_example' # str |  (опційно)
