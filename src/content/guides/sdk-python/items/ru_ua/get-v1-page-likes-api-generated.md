...
Возвращает: [`GetV1PageLikes`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_v1_page_likes.py)

## Пример

[inline-code-attrs-start title = 'Пример get_v1_page_likes'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
