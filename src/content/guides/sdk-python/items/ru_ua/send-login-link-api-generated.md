...
[inline-code-attrs-start title = 'Пример использования send_login_link'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Примеры для каждого метода авторизации приведены ниже, используйте пример,
