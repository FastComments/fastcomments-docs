...
Возвращает: [`GetModeratorResponse`](https://github.com/FastComments/fastcomments-python/blob/main/client/models/get_moderator_response.py)

## Пример

[inline-code-attrs-start title = 'Пример get_moderator'; type = 'python'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import client
...
# Примеры для каждого метода аутентификации приведены ниже, используйте тот пример, который
# отвечает вашему случаю использования аутентификации.
