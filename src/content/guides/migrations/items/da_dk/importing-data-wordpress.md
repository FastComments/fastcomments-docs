...
Migreringsprocessen vil blive vist for dig via UI’en under migreringen. De fleste migrationer tager kun et par minutter.

Mekanismen er designet til ikke at lægge unødig belastning på din WordPress‑installation under migreringen.

### CloudFlare & FireWalls

For at den automatiserede WordPress‑opsætning kan fungere, er vi nødt til at foretage kald til din WordPress‑installation.
Firewalls som Cloudflare kan blokere os og få integrationen til at fejle. I sådanne tilfælde kan [vi give dig](https://fastcomments.com/auth/my-account/help) et sæt IP‑adresser, som du kan whitelist’e for integrationen.
