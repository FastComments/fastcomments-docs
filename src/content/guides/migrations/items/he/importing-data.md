...
[app-screenshot-start url='/auth/my-account/manage-data/import'; selector = '.account-block'; alt='דף ייבוא של FastComments עם בחירת הספק ושדות העלאת קובץ עבור קובץ ייצוא'; title='טופס דף הייבוא' app-screenshot-end]
...
[app-screenshot-start url='/auth/my-account/manage-data/import?demo=true'; selector = '.content'; alt='דף ייבוא המציג משימת ייבוא רצה והסטטוס שמדווח על ידי מערכת עיבוד המשימות'; title='סטטוס משימת ייבוא' app-screenshot-end]
