...
By navigating [tutaj](https://fastcomments.com/auth/my-account/manage-data/import) we can upload the file containing the data to migrate.

[app-screenshot-start url='/auth/my-account/manage-data/import'; selector = '.account-block'; alt='Strona importu FastComments z wyborem dostawcy i polami przesyłania pliku eksportu'; title='Formularz strony importu' app-screenshot-end]
...
[app-screenshot-start url='/auth/my-account/manage-data/import?demo=true'; selector = '.content'; alt='Strona importu pokazująca uruchomione zadanie importu i status raportowany przez system przetwarzania zadań'; title='Status zadania importu' app-screenshot-end]
