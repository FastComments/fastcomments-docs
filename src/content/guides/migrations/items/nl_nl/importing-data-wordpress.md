...
Firewalls zoals Cloudflare kunnen ons blokkeren en ervoor zorgen dat de integratie mislukt. In dergelijke gevallen [kunnen we je](https://fastcomments.com/auth/my-account/help) een reeks IP‑adressen geven om op de whitelist te zetten voor de integratie.
