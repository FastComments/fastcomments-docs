...
Het migratieproces wordt via de UI aan je getoond tijdens de migratie. De meeste migraties duren slechts een paar minuten.
...
Firewalls zoals Cloudflare kunnen ons blokkeren en de integratie laten mislukken. In dergelijke gevallen kunnen [we je](https://fastcomments.com/auth/my-account/help) een reeks IP‑adressen geven om op de whitelist te zetten voor de integratie.

### Data Ownership

In het geval van onze WordPress‑migratie wordt elke nieuwe of bijgewerkte commentaargegevens automatisch op de achtergrond gesynchroniseerd met je WordPress‑installatie.
