...
为了让自动化的 WordPress 设置正常工作，我们需要对您的 WordPress 安装进行调用。
像 Cloudflare 这样的防火墙可能会阻止我们的请求，导致集成失败。在这种情况下，[我们可以为您提供](https://fastcomments.com/auth/my-account/help)一组需要加入白名单的 IP，以完成集成。
