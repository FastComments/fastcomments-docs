...
[inline-code-attrs-start title = 'Code-Snippet für ClickFunnels Live-Kommentare'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
<script>
    (function fcLoad() {
        function tryLoad() {
            // manche Anbieter ändern das Code-Snippet, sodass es asynchron ist
