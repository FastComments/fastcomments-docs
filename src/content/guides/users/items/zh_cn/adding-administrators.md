...
[app-screenshot-start url='/auth/my-account/users'; selector = '.content'; alt='账户上列出管理员的用户页面，底部有 “Add User” 按钮'; title='用户页面' app-screenshot-end]

When adding a user we can set their avatar, username, email, locale, and permissions.

[app-screenshot-start url='/auth/my-account/users/new/edit'; selector = '.content'; alt='用户编辑表单，已填写头像、用户名、电子邮件、语言区域和权限字段'; title='添加用户' app-screenshot-end]
