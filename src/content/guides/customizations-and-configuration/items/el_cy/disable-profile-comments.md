...
Κατά προεπιλογή, το FastComments θα εμφανίζει μια καρτέλα "Σχόλια Προφίλ" στα προφίλ χρηστών, επιτρέποντας στους επισκέπτες να αφήνουν σχόλια στο προφίλ κάποιου.
...
Αυτό μπορεί επίσης να γίνει χωρίς κώδικα. Στη σελίδα προσαρμογής του widget, δείτε την ενότητα "Απενεργοποίηση Σχολίων Προφίλ".
