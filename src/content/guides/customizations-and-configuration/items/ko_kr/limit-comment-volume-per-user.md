...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = '.max-comments-per-minute'; alt='위젯 맞춤 설정 페이지의 분당 최대 댓글 수 필드, 기본값은 5로 설정됨'; title='사용자당 댓글 양 제한' app-screenshot-end]
