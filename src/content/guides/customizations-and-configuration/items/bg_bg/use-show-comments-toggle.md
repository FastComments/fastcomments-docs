...
Броят се актуализира в реално време с нишката от коментари. Бутонът не се показва, ако няма коментари.

Това може да се активира без код, като се създаде правило за персонализиране и се включи „Кликнете, за да покажете коментарите“:

[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.click-to-show-comments']; selector = '.click-to-show-comments'; alt='Полето за отметка за показване на коментари е отметнато в правило за персонализиране на страницата за персонализиране на уиджета'; title='Включване на показване на коментари при клик' app-screenshot-end]