...
Мы можем просто вызывать функцию update каждый раз, когда нужно обновить конфигурацию виджета комментариев, как показано ниже. Ниже приведён полностью рабочий пример переключения
тёмного режима с помощью виджета VanillaJS.
