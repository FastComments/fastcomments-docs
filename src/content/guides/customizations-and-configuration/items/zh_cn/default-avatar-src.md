...
当用户首次使用 FastComments 发表评论时，我们会尝试从 <a href="https://gravatar.com/" target="_blank">https://gravatar.com/</a> 获取他们的头像。
...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = '.default-avatar'; alt='小部件自定义页面的默认头像部分，您可以在此设置回退头像图像的 URL'; title='自定义默认头像' app-screenshot-end]
