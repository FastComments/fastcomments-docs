...
Vaš Tenant ID već je primijenjen u <a href="https://fastcomments.com/auth/my-account/get-acct-code" target="_blank">isječku koda widgeta za komentare u vašem nalogu</a>.

Također možete pronaći svoj Tenant ID i upravljati svojim API ključevima [na stranici za API vjerodajnice](https://fastcomments.com/auth/my-account/api-secret).
