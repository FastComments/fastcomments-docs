...
По подразумевaњу, FastComments ће приказати поље за унос коментара и нит коментара у исто време. Да би уштедeо вертикални простор,
такође ће сакрити сва друга обавезна поља док корисник не интерагује са видџетом.
