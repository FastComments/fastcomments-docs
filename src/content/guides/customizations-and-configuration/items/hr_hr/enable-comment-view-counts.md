...
Prema zadanim postavkama, FastComments ne prati tko je pregledao pojedini komentar niti pruža bilo kakve statistike o tome.

Međutim, možemo omogućiti ovu značajku, a sustav će početi pratiti kako svaki korisnik pomiče do komentara.

Kada se to dogodi, broj pored ikone oka prikazane na svakom komentaru će se povećati. Broj se ažurira u stvarnom vremenu i skraćuje prema lokalnim postavkama korisnika.
...
Pratimo ID korisnika* koji je pregledao komentar tijekom jednog tjedna, tako da ako komentar ponovno pregledate unutar tog tjedna, broj se ne povećava. Ako komentar pregledate ponovno
nakon što je tjedan prošao, broj će se ponovno povećati.
