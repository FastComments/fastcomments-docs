...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.disable-live-commenting']; selector = '.disable-live-commenting'; alt='Disable Live Commenting section of the widget customization page, turning off real-time thread updates'; title='Disable Live Commenting' app-screenshot-end]
