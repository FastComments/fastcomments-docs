...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelector = '.single-line-comment-input'; selector = '.single-line-comment-input'; alt='Single-line comment input checkbox turned on in the widget customization page, limiting input to one line'; title='Enable Single-Line Comment Input' app-screenshot-end]
