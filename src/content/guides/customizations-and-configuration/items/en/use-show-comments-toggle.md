...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.click-to-show-comments']; selector = '.click-to-show-comments'; alt='Click to show comments checkbox ticked in a customization rule on the widget customization page'; title='Enable Click to Show Comments' app-screenshot-end]
