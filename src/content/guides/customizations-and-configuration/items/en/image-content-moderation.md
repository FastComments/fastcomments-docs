...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = '.image-profanity-level'; alt='Image Content Moderation Level dropdown on the widget customization page set to off, low, medium or high'; title='Setting The Image Content Moderation Level' app-screenshot-end]
