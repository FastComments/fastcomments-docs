...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = '.max-comment-size'; alt='Max comment size field on the widget customization page, used to cap how many characters a comment can contain'; title='Limit Comment Length' app-screenshot-end]
