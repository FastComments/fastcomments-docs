...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelector = '.show-advanced-option'; selector = '.custom-css'; alt='Custom CSS editor under Show Advanced Options on the widget customization page'; title='Custom CSS Input Area' app-screenshot-end]
