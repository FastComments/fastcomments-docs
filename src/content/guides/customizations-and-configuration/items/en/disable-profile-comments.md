...
By default, FastComments will show a "Profile Comments" tab on user profiles, allowing visitors to leave comments on someone's profile.

However, we can disable this tab:
