...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.allow-anonymous-comments']; selector = '.default-username-label'; alt='Default username field that appears in the customization UI once anonymous commenting is enabled'; title='Setting The Default Username' app-screenshot-end]
