...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.show-advanced-option', '.disable-all-default-styling']; selector = '.disable-all-default-styling'; alt='Disable all default styling checkbox enabled under Advanced Options on the widget customization page'; title='Disabling All Default Styles' app-screenshot-end]
