...
We track the user id* that viewed the comment for one week, so that if you view the comment again within that week it does not increment. If you view the comment again
after the week has passed, the count will increment again.
