...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelector = '.disable-commenter-comment-delete'; selector = '.disable-commenter-comment-delete'; alt='Disable Deleting option on the widget customization page, preventing commenters from removing their comments'; title='Disable Comment Deleting' app-screenshot-end]
