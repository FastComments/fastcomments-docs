...
komentari prikazani, koristi `translations.HIDE_COMMENTS_BUTTON_TEXT`. Prevod može sadržati tekst `[count]` koji će
...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.click-to-show-comments']; selector = '.click-to-show-comments'; alt='Polje za omogućavanje prikaza komentara označeno u pravilu prilagođavanja na stranici za prilagođavanje widgeta'; title='Omogući Klikni da prikažeš komentare' app-screenshot-end]