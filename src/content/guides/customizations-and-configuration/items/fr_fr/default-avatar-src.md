...
Lorsqu'un utilisateur commente avec FastComments pour la première fois, nous tenterons de récupérer son avatar depuis <a href="https://gravatar.com/" target="_blank">https://gravatar.com/</a>.
...
Cela peut également être fait sans code. Dans la page de personnalisation du widget, voir la section « Avatar par défaut ».
