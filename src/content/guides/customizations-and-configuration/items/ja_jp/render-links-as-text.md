...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; clickSelectors = ['.show-advanced-option']; selector = '.comment-html-rendering-mode'; alt='ウィジェットカスタマイズの詳細オプションで、Comment HTML Rendering Option が Links as Text に設定されている状態'; title='リンクをテキストとして表示' app-screenshot-end]