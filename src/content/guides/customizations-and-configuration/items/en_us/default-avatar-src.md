...
When a user comments with FastComments for the first time we will try to fetch their avatar from <a href="http://gravatar.com/" target="_blank">http://gravatar.com/</a>.
