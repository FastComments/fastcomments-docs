...
Bir kullanıcı FastComments ile ilk kez yorum yaptığında avatarını <a href="https://gravatar.com/" target="_blank">https://gravatar.com/</a> adresinden almaya çalışacağız.
...
Bu aynı zamanda kod olmadan da yapılabilir. Widget özelleştirme sayfasında, "Varsayılan Avatar" bölümüne bakın.
...
SSO gibi belirli bir kullanıcı için avatar tanımlamanın ayrı bir bölümde ele alındığını unutmayın.