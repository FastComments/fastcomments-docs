...
Από προεπιλογή, το FastComments θα εμφανίζει το πλαίσιο εισαγωγής σχολίου και το νήμα σχολίων ταυτόχρονα. Για να εξοικονομήσει κάθετο χώρο,
θα αποκρύψει επίσης οποιαδήποτε άλλα απαιτούμενα πεδία μέχρι να γίνει κάποια αλληλεπίδραση με το widget.
