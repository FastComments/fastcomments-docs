...
Όταν ένας χρήστης σχολιάζει με το FastComments για πρώτη φορά, θα προσπαθήσουμε να λάβουμε το avatar του από <a href="http://gravatar.com/" target="_blank">http://gravatar.com/</a>.
