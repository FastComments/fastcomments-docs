...
Προεπιλεγμένα, το FastComments θα εμφανίζει μια καρτέλα "Άμεσα Μηνύματα" στα προφίλ χρηστών, επιτρέποντας στους επισκέπτες να στέλνουν άμεσα μηνύματα σε έναν χρήστη.
