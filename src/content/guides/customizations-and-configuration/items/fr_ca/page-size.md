...
La taille de page peut être personnalisée dans l'[interface de configuration du widget](https://fastcomments.com/auth/my-account/customize-widget) avec des tailles variant de `10` à `200`.
