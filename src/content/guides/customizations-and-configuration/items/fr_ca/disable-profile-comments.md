...
Par défaut, FastComments affichera un onglet "Commentaires de profil" sur les profils d'utilisateurs, permettant aux visiteurs de laisser des commentaires sur le profil de quelqu'un.
...
Cela peut aussi être fait sans code. Sur la page de personnalisation du widget, consultez la section "Désactiver les commentaires de profil".
