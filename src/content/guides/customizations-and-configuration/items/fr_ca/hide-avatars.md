...
[code-example-start config = {hideAvatars: true}; linesToHighlight = [6]; title = 'Masquer les avatars'; code-example-end]

Cela peut être personnalisé sans code, sur la page de personnalisation du widget :

[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = '.hide-avatars'; title='Masquer les avatars' app-screenshot-end]