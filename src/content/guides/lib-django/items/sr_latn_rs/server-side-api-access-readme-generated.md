Sa instaliranim dodatkom `[api]`, pozovite FastComments REST API preko SDK‑a, unapred konfigurisanog sa vašim API ključem i regionom:
...
# Generišite SSO token za API pozive ili prepuštanje klijentu:
