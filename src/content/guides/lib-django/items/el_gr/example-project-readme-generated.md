Μια εκτελέσιμη παρουσίαση βρίσκεται στο [`example/`](https://github.com/FastComments/fastcomments-django/tree/main/example): μια εφαρμογή με αριστερή μπάρα + κύριο σκηνικό με μια σελίδα ανά widget και μια **σελίδα σύνδεσης που εμφανίζει προ-σπόρους χρήστες demo**.  
