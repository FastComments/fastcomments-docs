Коли профілі користувачів відкриваються в контексті вашого сайту (через віджет коментарів), будь-які власні CSS-стилі, які ви застосували до вашого віджета FastComments, автоматично підключаються до модального вікна профілю.
...
Темний режим використовує модифікатор класу `.dark` на `.user-profile`.
