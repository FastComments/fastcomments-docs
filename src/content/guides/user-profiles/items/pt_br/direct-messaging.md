...
**A partir do Perfil de um Usuário:**
...
Algumas implementações permitem clicar no nome do usuário ou no avatar para acessar rapidamente o perfil e as opções de mensagem.

**Link Direto:**
Se você tiver um ID de conversa ou um link de redirecionamento de DM, você pode acessar conversas diretamente.

### Acessando suas Mensagens

Para ver todas as suas conversas de mensagem direta:
...
- **Histórico completo de mensagens** - Todas as mensagens entre você e o outro usuário
- **Atualizações em tempo real** - Novas mensagens aparecem instantaneamente via WebSocket
- **Status online** - Veja se a outra pessoa está online no momento
...
- **Notificações no aplicativo** - Contador de badge no seu perfil
- **Notificações por e-mail** - Dependendo das suas configurações de notificação
- **Alertas em tempo real** - Notificações instantâneas quando você estiver logado
...
3. Selecione a opção ocultar/arquivar
...
Isso limpa o contador de mensagens não lidas dessa conversa.
...
- Discutir assuntos off-topic sem entupir os comentários públicos
- Coordenar-se com outros membros da comunidade
- Fornecer feedback ou sugestões em particular
...
- Bloquee e denuncie usuários que assediam ou abusam via DM
- Tenha cautela com links ou solicitações suspeitas
- Use a função de bloqueio se alguém fizer você se sentir desconfortável
...
- O histórico da conversa é preservado indefinidamente
...
Verifique suas configurações de notificação em [Configurações da Conta](https://fastcomments.com/auth/my-account/edit-notifications) para garantir que as notificações de DM estejam habilitadas.
