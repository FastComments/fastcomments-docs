...
Vérifiez vos paramètres de notification dans les [Paramètres du compte](https://fastcomments.com/auth/my-account/edit-notifications) pour vous assurer que les notifications MD sont activées.
