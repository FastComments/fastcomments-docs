...
- **Suivi des messages non lus** pour ne pas manquer les nouveaux messages

### Démarrer un message direct

Il existe plusieurs façons d'initier une conversation en DM :
...
Pour voir toutes vos conversations en message direct :
...
3. L'option DM sera masquée sur votre profil
...
- Ne partagez pas les DM d'autrui sans autorisation
...
- Prudence face aux liens ou demandes suspectes
- Utilisez la fonction de blocage si quelqu'un vous met mal à l'aise

### Limitations et remarques

**Qui pouvez-vous contacter :**
- Tout utilisateur de FastComments qui n'a pas désactivé les DM
...
- Pas de messagerie de groupe (actuellement en tête-à-tête uniquement)
...
- Assurez-vous de ne pas être bloqué
