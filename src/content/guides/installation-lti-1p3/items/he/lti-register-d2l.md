...
Paste the FastComments registration URL (<a href="https://fastcomments.com/auth/my-account/lti-config" target="_blank">השג אותו כאן</a>) into that field. Leave the other fields blank - they're auto-populated by FastComments during the registration handshake.
