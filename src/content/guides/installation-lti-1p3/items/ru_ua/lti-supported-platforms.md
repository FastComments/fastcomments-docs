...
Любая другая LMS, реализующая спецификацию IMS LTI 1.3 Advantage с Dynamic Registration, также должна работать - выберите **Other LTI 1.3 platform** в выпадающем списке платформ при создании URL регистрации.
