Once FastComments is registered with your LMS, instructors add it to courses the same way they add any other LTI external tool.

#### D2L Brightspace

In a course's content area:
