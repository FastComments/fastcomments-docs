...
4. Approuvez l'outil lorsque la négociation se termine.
...
Tout LMS qui suit la spécification IMS LTI 1.3 Advantage devrait fonctionner avec la même URL d'enregistrement (<a href="https://fastcomments.com/auth/my-account/lti-config" target="_blank">obtenez-le ici</a>). Recherchez un paramètre intitulé "Dynamic Registration", "Tool Registration URL", "Tool initiation registration endpoint", ou similaire.
