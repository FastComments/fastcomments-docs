---
FastComments prend également en charge le widget Page Reacts (également appelé bouton Like flottant) pour Zyro.

Vous pouvez le voir en action en bas à droite de cette page !

1. Tout d'abord, récupérez le code :

[inline-code-attrs-start title = 'Code Zyro pour likes flottants'; type = 'bash'; useDemoTenant = false; isFunctional = false; type = 'html';  inline-code-attrs-end]
[inline-code-start]
