Maintenant ajoutons le code de notre widget.
...
[inline-code-attrs-start title = 'Code des commentaires Zyro'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
Revenons maintenant à notre éditeur de site et cliquez sur `Enter code` :
...
Il est important d'utiliser le code ci‑dessus et non les extraits de code provenant d'autres documentations, car cet extrait a été conçu spécifiquement pour Zyro.
...
Maintenant, faites glisser le widget pour lui donner la taille désirée, vous le verrez apparaître :
