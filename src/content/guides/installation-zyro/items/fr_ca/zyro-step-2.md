...
Retournez maintenant à votre éditeur de site et cliquez sur `Enter code` :
...
Il est important d'utiliser le code ci-dessus et non les extraits de code d'autres documentations, car cet extrait a été conçu spécifiquement pour Zyro.
...
Faites maintenant glisser le widget pour obtenir la taille souhaitée, vous le verrez apparaître :

<div class="screenshot white-bg">
    <div class="title">Ajustez la taille</div>
    <img class="screenshot-image" src="/images/installation-guides/hostinger-step-2-add-code-4.png" alt="Ajustez la taille" />
</div>
