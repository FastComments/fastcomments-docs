FastComments также поддерживает виджет Page Reacts (aka Floating Like button) для Zyro.
...
6. Вы не увидите виджет в режиме предпросмотра, но он появится в опубликованной версии сайта.