...
Ora torniamo al nostro editor del sito e clicchiamo su `Enter code`:
...
Ora dovresti avere qualcosa di simile a quanto segue, che appare vuoto. Questo è normale. Sposta il cursore del mouse sull'area
dove dovrebbe trovarsi il widget:
...
Ora trascina il widget per impostarne la dimensione desiderata; verrà visualizzato:

<div class="screenshot white-bg">
    <div class="title">Ridimensiona</div>
    <img class="screenshot-image" src="/images/installation-guides/hostinger-step-2-add-code-4.png" alt="Ridimensiona" />
</div>
