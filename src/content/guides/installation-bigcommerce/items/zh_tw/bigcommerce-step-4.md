...
<div class="screenshot white-bg">
    <div class="title">發佈變更</div>
    <img class="screenshot-image" src="/images/installation-guides/bigcommerce-step-4-activate-theme.png" alt="發佈變更" />
</div>

Now we can check out our site! If you go to a blog post, you should see a comment box at the bottom.

<div class="screenshot white-bg">
    <div class="title">變更已上線</div>
    <img class="screenshot-image" src="/images/installation-guides/bigcommerce-step-4-live.png" alt="變更已上線" />
</div>
