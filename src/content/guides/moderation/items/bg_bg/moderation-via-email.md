FastComments поддържа ежедневен, седмичен или месечен имейл дайджест за модератори и администратори.

Честотата може да бъде конфигурирана <a href="" target="_blank">тук</a>.
...
Освен че включва общи статистики за вашите коментари, той ще изброи и трите най-нови коментара, които изискват преглед.

За всеки от тези коментари се предоставят директни магически връзки, които:
- Одобряване на коментара.
- Отбелязване на коментара като прегледан и отиване на страницата за отговор.
- Отбелязване на коментара като спам.

Тези връзки за всеки коментар ще ви автентифицират автоматично и ще извършат действието директно от имейла ви.

Освен това в дайджеста има бутон Модериране на коментари, който ще извърши същата автентификация и ще ви отведе до
страницата Модериране на коментари.

Моля, обърнете внимание, че тези магически връзки изтичат след известно време.
...
FastComments изпраща различни видове имейли до модератори и администратори. Ако желаете, можете да се откажете от известията за `Comment Reply`, като в същото време продължавате да получавате известия за `New Comment`, чрез избор на подходящите опции в страницата `Edit Notifications`, показана по-горе.
