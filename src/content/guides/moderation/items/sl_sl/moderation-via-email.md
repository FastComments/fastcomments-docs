...
Poleg prikazovanja splošnih statistik o vaših komentarjih bo tudi prikazal tri najnovejše komentarje, ki zahtevajo pregled.

Za vsak tak komentar so na voljo neposredne magične povezave za:
- Odobrite komentar.
- Označite komentar kot pregledan in pojdite na stran za odgovor.
- Označite komentar kot neželeno pošto.

Te povezave za vsak komentar vas bodo samodejno overile in izvedle dejanje neposredno iz vašega e-poštnega sporočila.

Poleg tega se v povzetku nahaja gumb 'Moderiraj komentarje', ki bo opravil isto overjanje in vas peljal na stran za moderiranje komentarjev.

Upoštevajte, da te magične povezave po določenem času potečejo.
...
FastComments pošilja več vrst e-poštnih sporočil moderatorjem in skrbnikom. Če želite, se lahko odjavite od obvestil `Comment Reply`, pri tem pa še vedno prejemate obvestila `New Comment`, tako da izberete ustrezne možnosti na strani `Edit Notifications`, prikazani zgoraj.
