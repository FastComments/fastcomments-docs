...
Ο πρώτος είναι αν ήδη γνωρίζετε το email τους, μπορείτε να το εισάγετε στη σελίδα <a href="https://fastcomments.com/auth/my-account/moderate-comments/banned-users" target="_blank">αποκλεισμένοι χρήστες</a>.
