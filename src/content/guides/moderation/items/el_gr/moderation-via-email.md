FastComments υποστηρίζει ένα ημερήσιο, εβδομαδιαίο ή μηνιαίο συνοπτικό email για τους Συντονιστές και τους Διαχειριστές.

Η συχνότητα μπορεί να ρυθμιστεί <a href="" target="_blank">εδώ</a>.
...
Εκτός από την παρουσίαση συνολικών στατιστικών σχετικά με τα σχόλιά σας, θα απαριθμήσει επίσης τα τρία πιο πρόσφατα σχόλια που χρειάζονται έλεγχο.

Για κάθε ένα από αυτά τα σχόλια, παρέχονται άμεσοι μαγικοί σύνδεσμοι για:
- Έγκριση του σχολίου.
- Σήμανση του σχολίου ως ελεγμένου και μετάβαση στη σελίδα απάντησης.
- Σήμανση του σχολίου ως ανεπιθύμητο (spam).

Αυτοί οι σύνδεσμοι για κάθε σχόλιο θα σας αυθεντικοποιούν αυτόματα και θα εκτελούν την ενέργεια απευθείας από το email σας.

Επιπλέον, υπάρχει ένα κουμπί Διαχείριση σχολίων στο Συνοπτικό Email, το οποίο θα εκτελέσει την ίδια αυθεντικοποίηση και θα σας οδηγήσει στη σελίδα Διαχείριση σχολίων.

Παρακαλώ σημειώστε ότι αυτοί οι μαγικοί σύνδεσμοι λήγουν μετά από κάποιο διάστημα.
...
Το FastComments στέλνει πολλούς τύπους email προς τους Συντονιστές και τους Διαχειριστές. Εάν επιθυμείτε, είναι δυνατό να απεγγραφείτε από τις ειδοποιήσεις `Comment Reply`, διατηρώντας όμως τις ειδοποιήσεις `New Comment`, επιλέγοντας τις αντίστοιχες επιλογές στη σελίδα `Edit Notifications` που εμφανίζεται παραπάνω.
