FastComments understøtter et dagligt, ugentligt eller månedligt e-mail-resumé for moderatorer og administratorer.
...
Ud over at indeholde overordnede statistikker om dine kommentarer, vil det også liste de tre seneste kommentarer, der kræver gennemgang.

For hver af disse kommentarer er der direkte magiske links til:
- Godkende kommentaren.
- Markere kommentaren som gennemgået og gå til svar-siden.
- Markere kommentaren som spam.

Disse links for hver kommentar vil automatisk autentificere dig og udføre handlingen direkte fra din e-mail.

Derudover er der en knap 'Moderér kommentarer' i resuméet, som vil udføre den samme autentificering og føre dig til siden 'Moderér kommentarer'.

Bemærk, at disse magiske links udløber efter et stykke tid.
...
FastComments sender flere typer e-mails til moderatorer og administratorer. Hvis ønsket, er det muligt at framelde sig notifikationer for `Comment Reply`, mens man stadig modtager notifikationer for `New Comment` ved at vælge de relevante indstillinger på siden `Edit Notifications` vist ovenfor.
