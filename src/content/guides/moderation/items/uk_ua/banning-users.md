...
[app-screenshot-start url='/auth/my-account/moderate-comments/banned-users'; selector = '.content .account-block'; alt='Список забанених користувачів у розділі Модерація коментарів, з адресами забанених електронних листів та кнопкою для додавання нового бану'; title='Сторінка забанених користувачів' app-screenshot-end]
