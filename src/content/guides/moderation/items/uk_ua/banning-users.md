...
[app-screenshot-start url='/auth/my-account/moderate-comments/banned-users'; selector = '.content .account-block'; alt='Список заблокованих користувачів у розділі «Модерація коментарів», з адресами електронної пошти, які заблоковано, та кнопкою для додавання нового бану'; title='Сторінка заблокованих користувачів' app-screenshot-end]
...
[app-screenshot-start url='/auth/my-account/moderate-comments/banned-users/new'; selector = '.content .account-block'; alt='Форма створення нового бану з полем електронної пошти та вибором типу бану: Постійний або Постійний прихований бан'; title='Блокування користувача' app-screenshot-end]
