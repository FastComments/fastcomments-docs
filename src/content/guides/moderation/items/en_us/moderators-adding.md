...
An invite link will be sent to the moderator, which can automatically log them in. In the future, if they wish to log in, they can simply visit the
<a href="https://fastcomments.com/auth/login" target="_blank">login page</a> and enter the name and email that you provided earlier. This will send them
a link to log in.