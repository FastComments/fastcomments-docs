...
The frequency can be configured <a href="" target="_blank">here</a>.
...
In addition to overall statistics about your comments, it also lists the three most recent comments that need review.

For each of those comments, direct magic links are provided to:
- Approve the comment.
- Mark the comment reviewed and go to the respond page.
- Mark the comment as spam.

These links will automatically authenticate you and perform the action directly from your email.
...
FastComments sends several types of emails to Moderators and Administrators. If desired, you can opt out of `Comment Reply` notifications, while
still receiving `New Comment` notifications by choosing the appropriate options on the `Edit Notifications` page shown above.
