...
1. A traditional Naive-Bayes classifier that is continuously trained, which is shared across all FastComments.com tenants.
2. A traditional Naive-Bayes classifier that is continuously trained, which is **isolated** to your tenant.
3. Using ChatGPT 4.

Everyone has access to the shared and isolated Naive-Bayes classifiers.
