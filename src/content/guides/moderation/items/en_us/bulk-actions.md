...
series of comments you want to delete, mark as spam, unapprove, or simply mark as reviewed. Instead of clicking "delete" and "confirm"
...
give you the option to select all comments on the server that match your filters. So even if you need to approve, delete, etc.
