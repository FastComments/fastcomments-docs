...
[app-screenshot-start url='/auth/my-account/moderate-comments/blacklist?blurList=true'; linkUrl='/auth/my-account/moderate-comments/blacklist'; selector = '.account-block'; alt='Word blacklist editor where the default blocked words and phrases can be added to or removed'; title='Comment Word Blacklist' app-screenshot-end]
