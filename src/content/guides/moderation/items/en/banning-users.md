...
[app-screenshot-start url='/auth/my-account/moderate-comments/banned-users'; selector = '.content .filter-form'; alt='Search row on the Banned Users page with a Search By dropdown, a Match dropdown, and a Value input'; title='Searching Banned Users' app-screenshot-end]
