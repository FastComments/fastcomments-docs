...
[app-screenshot-start url='/auth/my-account/moderate-comments/moderators?demo=true'; linkUrl='/auth/my-account/moderate-comments/moderators'; selector = '.account-block'; alt='Edit Moderators page listing each moderator with counts of comments approved, deleted and marked spam'; title='Moderator Stats' app-screenshot-end]
