...
[app-screenshot-start url='/auth/my-account/moderate-comments?filter=&text-search=&page=1&count=3&demo=true'; linkUrl='/auth/my-account/moderate-comments'; selector = 'body'; alt='Full Comment Moderation page for the demo account, showing filters, search and three comments per page'; title='Comment Moderation Page' app-screenshot-end]
