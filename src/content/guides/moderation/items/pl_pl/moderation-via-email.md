FastComments obsługuje codzienny, cotygodniowy lub comiesięczny biuletyn e-mail dla Moderatorów i Administratorów.
...
Oprócz ogólnych statystyk dotyczących twoich komentarzy, biuletyn wyświetli również trzy najnowsze komentarze wymagające przeglądu.

Dla każdego z tych komentarzy udostępnione są bezpośrednie linki, które umożliwiają:
- Zatwierdź komentarz.
- Oznacz komentarz jako przejrzany i przejdź do strony odpowiedzi.
- Oznacz komentarz jako spam.

Te linki dla każdego komentarza automatycznie Cię uwierzytelniają i wykonają odpowiednią akcję z poziomu wiadomości e-mail.

Dodatkowo, w biuletynie znajduje się przycisk Moderuj komentarze, który wykona to samo uwierzytelnienie i przeniesie Cię do
strony Moderowania komentarzy.
...
FastComments wysyła różne typy wiadomości e-mail do Moderatorów i Administratorów. Jeśli chcesz, możesz zrezygnować z powiadomień typu `Comment Reply`, podczas gdy
wciąż otrzymywać powiadomienia `New Comment` wybierając odpowiednie opcje na stronie `Edit Notifications` pokazanej powyżej.
