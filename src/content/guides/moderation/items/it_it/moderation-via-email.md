FastComments supporta un digest via email giornaliero, settimanale o mensile per Moderatori e Amministratori.
...
Oltre a includere statistiche complessive sui tuoi commenti, elencherà anche i tre commenti più recenti che richiedono revisione.

Per ciascuno di questi commenti vengono forniti link magici diretti per:
- Approvare il commento.
- Contrassegnare il commento come revisionato e andare alla pagina di risposta.
- Contrassegnare il commento come spam.

Questi link per ogni commento ti autenticheranno automaticamente ed eseguiranno l'azione direttamente dalla tua email.

Inoltre, nel Digest è presente un pulsante Moderate Comments che eseguirà la stessa autenticazione e ti porterà alla pagina Moderate Comments.

Nota che questi link magici scadono dopo un certo periodo.
...
FastComments invia diversi tipi di email a Moderatori e Amministratori. Se desiderato, è possibile rinunciare alle notifiche `Comment Reply`, continuando però a ricevere le notifiche `New Comment` scegliendo le opzioni appropriate nella pagina `Edit Notifications` mostrata sopra.
