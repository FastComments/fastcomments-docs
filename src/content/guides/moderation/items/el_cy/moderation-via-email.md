FastComments υποστηρίζει Ημερήσια, Εβδομαδιαία ή Μηνιαία σύνοψη μέσω email για Συντονιστές και Διαχειριστές.
...
Εκτός από την παρουσίαση συνολικών στατιστικών για τα σχόλιά σας, θα εμφανίζει επίσης τα τρία πιο πρόσφατα σχόλια που χρειάζονται εξέταση.

Για κάθε ένα από αυτά τα σχόλια παρέχονται άμεσοι μαγικοί σύνδεσμοι για:
- Εγκρίνετε το σχόλιο.
- Σημειώστε το σχόλιο ως εξετασμένο και μεταβείτε στη σελίδα απάντησης.
- Σημειώστε το σχόλιο ως ανεπιθύμητο (spam).

Αυτοί οι σύνδεσμοι για κάθε σχόλιο θα σας αυθεντικοποιούν αυτόματα και θα εκτελούν τη σχετική ενέργεια απευθείας από το email σας.

Επιπλέον, υπάρχει ένα κουμπί "Moderate Comments" στη σύνοψη που θα πραγματοποιεί την ίδια αυθεντικοποίηση και θα σας μεταφέρει στη σελίδα Moderate Comments.

Παρακαλώ σημειώστε ότι αυτοί οι μαγικοί σύνδεσμοι λήγουν μετά από κάποιο χρονικό διάστημα.
...
Το FastComments στέλνει πολλούς τύπους email σε Συντονιστές και Διαχειριστές. Εάν το επιθυμείτε, μπορείτε να απενεργοποιήσετε τις ειδοποιήσεις `Comment Reply`, ενώ συνεχίζετε να λαμβάνετε ειδοποιήσεις `New Comment` επιλέγοντας τις αντίστοιχες επιλογές στη σελίδα `Edit Notifications` που εμφανίστηκε παραπάνω.
