...
A complete installation guide and documentation for the plugin [are here](/guide-installation-wordpress.html).
...
installation so that you retain control of your data. This can be turned off to limit the size of your WordPress database.
