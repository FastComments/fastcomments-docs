...
[inline-code-attrs-start title = 'Ajoutez le module à votre application'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Utilisation - Configuration en ligne'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
Vous pouvez trouver la configuration que le composant Angular supporte <a href="https://github.com/FastComments/fastcomments-typescript/blob/main/src/fast-comments-comment-widget-config.ts" target="_blank">ici</a>.
