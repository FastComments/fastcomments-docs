Чтобы добавить комментарии в ваше приложение на React Native, вы можете найти нашу библиотеку React Native на NPM <a href="https://www.npmjs.com/package/fastcomments-react-native" target="_blank">здесь</a>.
...
// ...
  ...
  const tenantId = 'demo'; // Ваш tenant id. Можно получить с https://fastcomments.com/auth/my-account/api-secret
