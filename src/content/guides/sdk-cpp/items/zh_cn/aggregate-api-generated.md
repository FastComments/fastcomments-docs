---
聚合文档，通过（如果提供了 groupBy）进行分组并应用多种操作。支持不同的操作（例如 sum、countDistinct、avg 等）。
...
返回：[`AggregateResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/AggregateResponse.h)

## 示例

[inline-code-attrs-start title = '聚合 示例'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
