...
| tenantId | string | 是 |  |
| urlId | string | 是 |  |
| options | const GetCommentsPublicOptions& | 是 |  |

## 响应

返回：[`GetCommentsResponseWithPresence_PublicComment_`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetCommentsResponseWithPresence_PublicComment_.h)
