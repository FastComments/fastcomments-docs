...
boost::optional<utility::string_t> editKey = boost::optional<utility::string_t>(U("edit-abc-123"));
boost::optional<utility::string_t> sso = boost::optional<utility::string_t>();
api->getCommentText(tenantId, commentId, editKey, sso)
.then([](pplx::task<std::shared_ptr<GetCommentText_200_response>> t){
    try {
        auto resp = t.get();
        auto finalResp = resp ? resp : std::make_shared<GetCommentText_200_response>();
        (void)finalResp;
