...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегира документе групишући их (ако је groupBy достављен) и примјењујући више операција. Подржане су различите операције (нпр. sum, countDistinct, avg, итд.). |
...
*DefaultApi* | [**getFeedPosts**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#getFeedPosts) | **GET** /api/v1/feed-posts |  потребан tenantId afterId |
...
*PublicApi* | [**getCommentsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getCommentsPublic) | **GET** /comments/{tenantId} |  потребан tenantId urlId |
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  потребан tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  потребан tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  потребан tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Претходни коментатори на страници који ТРЕНУТНО нису на мрежи. Сортирано по displayName. Користите ово након што исцрпите /users/online да бисте приказали секцију "Чланови". Курсор пагинација по commenterName: сервер иде преко парцијалног {tenantId, urlId, commenterName} индекса, од afterName напријед преко $gt, нема $skip трошак. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Тренутно на мрежи гледаоци странице: људи чија је websocket сесија тренутно претплаћена на ову страницу. Враћа anonCount + totalCount (претплатници у "соби", укључујући анонимне гледаоце које не набрајамо). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Листа страница за једног tenant-а. Користи FChat десктоп клијент за попуњавање своје листе соба. Потребно је да је `enableFChat` постављен на true у прилагођеној конфигурацији за сваку страницу. Странице које захтијевају SSO се филтрирају према приступу групе корисника који шаље захтјев. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Вишеструке информације о корисницима за tenant-а. Дати userId-је, враћа приказ корисничких података из User / SSOUser. Користи га виджет за коментаре да обогати кориснике који су се управо појавили путем "presence" догађаја. Нема контекста странице: приватност се спроводи равномјерно (приватни профили су маскирани). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | Омогући или онемогући нотификације за одређени коментар. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | Омогући или онемогући нотификације за страницу. Када су корисници претплаћени на страницу, нотификације се креирају за нове коријене (root) коментаре, као и |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Отпреми и промијени величину слике |
...
## Документација за моделе
 ...
 - [DeleteHashTagRequestBody](https://github.com/FastComments