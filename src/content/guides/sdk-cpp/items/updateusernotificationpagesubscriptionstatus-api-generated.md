...
utility::string_t url = U("https://www.example.com/articles/2026/new-features");
utility::string_t pageTitle = U("New Features in 2026");
...
api->updateUserNotificationPageSubscriptionStatus(tenantId, urlId, url, pageTitle, subscribedOrUnsubscribed, sso)
    .then([](pplx::task<std::shared_ptr<UpdateUserNotificationStatus_200_response>> task){
        try {
            ...
            std::cout << "UpdateUserNotificationStatus result received\n";
        } catch (const std::exception& e) {
            std::cout << "Failed to update subscription: " << e.what() << '\n';
        }
    });
[inline-code-end]
