...
## תיעוד נקודות קצה של API

כל ה-URI יחסיים ל-*https://fastcomments.com*

| קלאס | מתודה | בקשת HTTP | תיאור |
|------------ | ------------- | ------------- | -------------|
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | מאגד מסמכים לפי קיבוץ (אם groupBy סופק) ומבצע מספר פעולות. נתמכות פעולות שונות (כמו sum, countDistinct, avg וכו'). |
...
*DefaultApi* | [**getFeedPosts**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#getFeedPosts) | **GET** /api/v1/feed-posts |  דרוש tenantId afterId |
...
*PublicApi* | [**getCommentsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getCommentsPublic) | **GET** /comments/{tenantId} |  דרוש tenantId urlId |
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  דרוש tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  דרוש tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  דרוש tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | מגיבים קודמים בדף שאינם כעת מחוברים. ממוין לפי displayName. השתמש בזה לאחר מיצוי /users/online כדי להציג מדור "חברים". עימוד בסמן על commenterName: השרת עובר על האינדקס החלקי {tenantId, urlId, commenterName} מהשם שאחריו קדימה באמצעות $gt, ללא עלות $skip. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | צופים מחוברים כעת בדף: אנשים שהסשן websocket שלהם מנוי לדף כרגע. מחזיר anonCount + totalCount (מנויים לכל החדר, כולל צופים אנונימיים שלא נפרט). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | הצג רשימת דפים עבור טננט. משמש את לקוח שולחן העבודה של FChat לאכלס את רשימת החדרים. דורש ש-`enableFChat` יהיה נכון בהגדרה המותאמת שנמצאה לכל דף. דפים שמחייבים SSO מסוננים בהתבסס על הרשאות קבוצה של המשתמש. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | מידע משתמשים גורף עבור טננט. בהינתן userIds, מחזיר פרטי תצוגה מ-User / SSOUser. משמש את ווידג'ט התגובות להעשיר משתמשים שהופיעו באירוע נוכחות. ללא הקשר דף: הפרטיות נאכפת באחידות (פרופילים פרטיים מוסתרים). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | אפשר או השבת התראות עבור תגובה מסוימת. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | אפשר או השבת התראות עבור עמוד. כאשר משתמשים מנויים לעמוד, התראות נוצרות עבור תגובות שורש חדשות, וכן |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | העלה ושנה גודל של תמונה |
...
## תיעוד עבור מודלים
 ...
 - [DeletedCommentResultComment](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Models/DeletedComment