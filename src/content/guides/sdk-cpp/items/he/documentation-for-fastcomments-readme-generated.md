...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | מאגד מסמכים על‑ידי קיבוץ שלהם (באם מתווסף groupBy) ויישום של מספר פעולות. נתמכות פעולות שונות (למשל sum, countDistinct, avg וכו'). |
...
*PublicApi* | [**getCommentsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getCommentsPublic) | **GET** /comments/{tenantId} |  נדרש tenantId urlId |
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  נדרש tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  נדרש tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  נדרש tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | מגיבים קודמים לדף שאינם מחוברים כעת. ממוין לפי displayName. השתמש בזה לאחר שמיצית את /users/online כדי להציג חלק \"Members\". דפדוף בעזרת מצביע על שם מגיב: השרת מקפיץ את חיפוש החלק {tenantId, urlId, commenterName} אחרי afterName קדימה באמצעות $gt, ללא עלות $skip. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | משתמשים שמקושרים כעת לצפייה בדף: אנשים שה‑websocket שלהם מנוי לשף כרגע. מחזיר anonCount + totalCount (מנויים לכל החדר, כולל צופים אנונימיים שאינם מפורטים). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | רשימת דפים לשוכר. משומשת על‑ידי לקוח ה‑desktop של FChat למלא את רשימת החדרים שלו. דורש שה‑`enableFChat` יהיה true בתצורה המותאמת של כל דף. דפים הדורשים SSO מסוננים לפי גישת קבוצת המשתמש המבקש. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | מידע משותף של משתמשים לשוכר. עם userIds, מחזיר מידע תצוגה מ‑User / SSOUser. משמש את הווידג'ט להעשיר משתמשים שהופיעו זה עתה דרך אירוע נוכחות. ללא הקשר דף: פרטיות מוחלטת (פרופילים פרטיים מוסווים). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | הפעלה או השבתה של הודעות עבור תגובה ספציפית. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | הפעלה או השבתה של הודעות עבור דף. כאשר משתמשים מנויים לדף, נוצרות הודעות עבור תגובות שורש חדשות, וכן |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | העלאה ושינוי גודל של תמונה |
...
## תיעוד עבור מודלים
 ...
 - [BannedUserMatch](https://github.com/FastComments/fastcomments-c