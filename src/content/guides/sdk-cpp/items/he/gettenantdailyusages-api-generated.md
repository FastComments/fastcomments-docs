...
|------|------|----------|-------------|
| tenantId | string | כן |  |
| options | const GetTenantDailyUsagesOptions& | כן |  |

## תגובה

מחזיר: [`GetTenantDailyUsagesResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetTenantDailyUsagesResponse.h)
