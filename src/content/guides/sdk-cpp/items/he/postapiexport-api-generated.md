...
|------|------|----------|-------------|
| tenantId | string | כן |  |
| options | const PostApiExportOptions& | כן |  |

## תגובה

מחזיר: [`ModerationExportResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/ModerationExportResponse.h)

## דוגמה

[inline-code-attrs-start title = 'postApiExport דוגמה'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
