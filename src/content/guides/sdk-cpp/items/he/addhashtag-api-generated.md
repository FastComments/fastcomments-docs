...
|------|------|----------|-------------|
| tenantId | string | כן |  |
| createHashTagBody | CreateHashTagBody | כן |  |

## תגובה

מחזיר: [`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/CreateHashTagResponse.h)

## דוגמה

[inline-code-attrs-start title = 'addHashTag דוגמה'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
