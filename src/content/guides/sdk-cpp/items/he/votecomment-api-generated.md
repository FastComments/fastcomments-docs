...
| options | const VoteCommentOptions& | כן |  |

## Response

מחזיר: [`VoteResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/VoteResponse.h)

## דוגמה

[inline-code-attrs-start title = 'voteComment דוגמה'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
