...
|------|------|----------|-------------|
| tenantId | string | כן |  |
| options | const GetPagesPublicOptions& | כן |  |

## Response

מחזיר: [`GetPublicPagesResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetPublicPagesResponse.h)

## Example

[inline-code-attrs-start title = 'דוגמת getPagesPublic'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
