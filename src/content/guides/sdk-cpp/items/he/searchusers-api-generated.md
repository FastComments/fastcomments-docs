...
| tenantId | string | כן |  |
| urlId | string | כן |  |
| options | const SearchUsersOptions& | כן |  |

## Response

מחזיר: [`SearchUsersResult`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/SearchUsersResult.h)
