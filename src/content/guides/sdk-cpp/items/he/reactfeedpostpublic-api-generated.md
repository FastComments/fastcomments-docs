...
| options | const ReactFeedPostPublicOptions& | כן |  |

## Response

מחזיר: [`ReactFeedPostResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/ReactFeedPostResponse.h)

## Example

[inline-code-attrs-start title = 'דוגמת reactFeedPostPublic'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
