...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Belgeleri gruplandırarak (groupBy sağlanırsa) ve birden fazla işlem uygulayarak toplar. Farklı işlemler (örn. toplam, benzersiz sayım, ortalama vb.) desteklenmektedir. |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Bir görsel yükle ve yeniden boyutlandır |
