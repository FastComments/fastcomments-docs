...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Aggrega documenti raggruppandoli (se viene fornito [inline-code-start]groupBy[inline-code-end]) e applicando più operazioni. Sono supportate diverse operazioni (ad esempio sum, countDistinct, avg, ecc.). |
