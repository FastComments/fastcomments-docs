...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | 將文件分組（如提供 groupBy）並執行多種操作進行彙總。支援不同操作（如 sum、countDistinct、avg 等）。 |
...
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | 啟用或停用某個頁面的通知。當使用者訂閱頁面時，會為新的根留言建立通知，同時也 |
...
## 模型文件
 ...
 - [LiveEvent](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Models/Live