...
## Документация по API-эндпойнтам

Все URI указываются относительно *https://fastcomments.com*
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегирует документы, группируя их (если groupBy указан) и применяя несколько операций. Поддерживается множество различных операций (например, sum, countDistinct, avg и т.д.). |
...
## Документация по моделям
 ...
 - [PublicComment](https://github.com/FastComments/fast