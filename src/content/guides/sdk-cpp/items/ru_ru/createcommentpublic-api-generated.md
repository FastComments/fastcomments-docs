...
| options | const CreateCommentPublicOptions& | Да |  |

## Ответ

Возвращает: [`SaveCommentsResponseWithPresence`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/SaveCommentsResponseWithPresence.h)

## Пример

[inline-code-attrs-start title = 'Пример createCommentPublic'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
