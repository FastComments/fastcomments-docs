...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agregira dokumente grupisanjem (ako je groupBy naveden) i primenom više operacija. Različite operacije (npr. sum, countDistinct, avg, itd.) su podržane. |
...
*DefaultApi* | [**getFeedPosts**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#getFeedPosts) | **GET** /api/v1/feed-posts |  zahteva tenantId afterId |
...
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Raniji komentatori na stranici koji TRENUTNO NISU online. Sortirani po displayName. Koristi posle iscrpljivanja /users/online da prikažeš deo „Članovi”. Kursor paginacija po commenterName: server hoda po delimičnom {tenantId, urlId, commenterName} indeksu napred od afterName preko $gt, bez $skip troška. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Trenutno online gledaoci stranice: ljudi čija websocket sesija je sada pretplaćena na stranicu. Vraća anonCount + totalCount (pretplatnici na nivou sobe, uključujući anonimne gledaoce koje ne nabrajamo). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Prikaži stranice za tenant-a. Koristi FChat desktop klijent za popunjavanje svoje liste soba. Zahteva da je `enableFChat` postavljen na true u rešene custom podešavanja svake stranice. Stranice koje zahtevaju SSO filtriraju se prema pristupu grupe korisnika koji šalje zahtev. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Grupni podaci o korisnicima za tenant-a. Za dati skup userIds vraća display podatke iz User / SSOUser. Koristi koment widget za obogaćivanje korisnika koji su se upravo pojavili kroz presence event. Nema konteksta strane: privatnost je uvek ista (privatni profili su maskirani). |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Pošalji i promeni veličinu slike |
...
## Dokumentacija za Modele
 ...
 - [DeletedCommentResultComment](https://github.com/FastComments/fast