...
Όλα τα URI είναι σχετικοί με το *https://fastcomments.com*
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Ομαδοποιεί τα έγγραφα και εφαρμόζει πολλαπλές λειτουργίες (αν δοθεί το groupBy). Υποστηρίζονται διάφορες λειτουργίες (π.χ. άθροισμα, countDistinct, avg, κτλ.). |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Ανέβασμα και αλλαγή μεγέθους εικόνας |
