...
| options | const PostUnFlagCommentOptions& | Ναι |  |
...
[inline-code-attrs-start title = 'postUnFlagComment Παράδειγμα'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
