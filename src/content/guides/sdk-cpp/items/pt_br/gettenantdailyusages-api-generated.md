...
|------|------|-------------|-----------|
| tenantId | string | Sim |  |
| options | const GetTenantDailyUsagesOptions& | Sim |  |

## Resposta

Retorna: [`GetTenantDailyUsagesResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/client/include/FastCommentsClient/model/GetTenantDailyUsagesResponse.h)

## Exemplo

[inline-code-attrs-start title = 'Exemplo getTenantDailyUsages'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
