...
|------|------|-------------|-----------|
| tenantId | string | Sim |  |
| options | const GetTenantsOptions& | Sim |  |

## Resposta

Retorna: [`GetTenantsResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetTenantsResponse.h)

## Exemplo

[inline-code-attrs-start title = 'Exemplo getTenants'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
