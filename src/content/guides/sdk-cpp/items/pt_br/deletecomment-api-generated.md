...
| tenantId | string | Sim |  |
| id | string | Sim |  |
| options | const DeleteCommentOptions& | Sim |  |

## Resposta

Retorna: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/DeleteCommentResult.h)

## Exemplo

[inline-code-attrs-start title = 'Exemplo deleteComment'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
