...
Retorna anonCount + totalCount (inscritos de toda a sala, incluindo visualizadores anônimos que não enumeramos).
...
[inline-code-attrs-start title = 'Exemplo de getOnlineUsers'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
