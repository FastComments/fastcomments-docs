...
| options | const VoteCommentOptions& | Sim |  |

## Resposta

Retorna: [`VoteResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/VoteResponse.h)

## Exemplo

[inline-code-attrs-start title = 'Exemplo voteComment'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
