...
|------|------|----------|-------------|
| tenantId | string | 예 |  |
| createHashTagBody | CreateHashTagBody | 예 |  |

## 응답

반환: [`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/CreateHashTagResponse.h)

## 예시

[inline-code-attrs-start title = 'addHashTag 예시'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
