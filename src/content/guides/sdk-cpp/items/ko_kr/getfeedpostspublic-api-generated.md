...
|------|------|----------|-------------|
| tenantId | string | 예 |  |
| options | const GetFeedPostsPublicOptions& | 예 |  |

## 응답

반환: [`PublicFeedPostsResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/PublicFeedPostsResponse.h)

## 예시

[inline-code-attrs-start title = 'getFeedPostsPublic 예시'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
