...
| tenantId | string | 예 |  |
| tag | string | 예 |  |
| updateHashTagBody | UpdateHashTagBody | 예 |  |

## 응답

반환: [`UpdateHashTagResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/UpdateHashTagResponse.h)
