...
| commentId | string | 예 |  |
| direction | string | 예 |  |
| options | const CreateVoteOptions& | 예 |  |

## 응답

반환: [`VoteResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/VoteResponse.h)

## 예시

[inline-code-attrs-start title = 'createVote 예시'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
