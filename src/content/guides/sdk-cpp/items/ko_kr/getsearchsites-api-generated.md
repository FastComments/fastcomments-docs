...
|------|------|----------|-------------|
| tenantId | string | 예 |  |
| options | const GetSearchSitesOptions& | 예 |  |

## 응답

반환: [`ModerationSiteSearchResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/ModerationSiteSearchResponse.h)

## 예제

[inline-code-attrs-start title = 'getSearchSites 예제'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
