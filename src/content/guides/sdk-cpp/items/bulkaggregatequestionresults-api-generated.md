...
auto aggTask = api->bulkAggregateQuestionResults(tenantId, request, forceRecalculate)
.then([](pplx::task<std::shared_ptr<BulkAggregateQuestionResults_200_response>> t)
{
    try {
        auto resp = t.get();
        auto copied = std::make_shared<BulkAggregateQuestionResults_200_response>(*resp);
        return copied;
    } catch (...) {
        return std::shared_ptr<BulkAggregateQuestionResults_200_response>();
    }
});
aggTask.wait();
[inline-code-end]
