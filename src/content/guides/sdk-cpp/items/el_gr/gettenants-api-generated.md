...
|------|------|------------|-----------|
| tenantId | string | Ναι |  |
| options | const GetTenantsOptions& | Ναι |  |

## Απόκριση

Επιστρέφει: [`GetTenantsResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetTenantsResponse.h)

## Παράδειγμα

[inline-code-attrs-start title = 'getTenants Παράδειγμα'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
