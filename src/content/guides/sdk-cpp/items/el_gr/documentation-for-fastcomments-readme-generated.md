...
Όλα τα URIs είναι σχετικοί προς *https://fastcomments.com*
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Ομαδοποιεί έγγραφα (αν το groupBy έχει οριστεί) και εκτελεί πολλαπλές λειτουργίες. Υποστηρίζονται διάφορες λειτουργίες (π.χ. sum, countDistinct, avg, κ.ά.). |
...
## Τεκμηρίωση για τα Μοντέλα
 ...
 - [ImageContentProfanityLevel](https://github.com/Fast