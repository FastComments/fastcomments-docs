...
|------|------|------------|------------|
| tenantId | string | Ναι |  |
| options | const GetCommentsOptions& | Ναι |  |

## Απόκριση

Επιστρέφει: [`APIGetCommentsResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/APIGetCommentsResponse.h)
