...
| tenantId | string | Ναι |  |
| tag | string | Ναι |  |
| updateHashTagBody | UpdateHashTagBody | Ναι |  |

## Απάντηση

Επιστρέφει: [`UpdateHashTagResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/UpdateHashTagResponse.h)
