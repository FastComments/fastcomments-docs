...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Aggregiert Dokumente durch Gruppieren (falls groupBy angegeben ist) und die Anwendung mehrerer Operationen. Verschiedene Operationen (z. B. sum, countDistinct, avg, usw.) werden unterstützt. |
...
## Dokumentation der Modelle
 ...
 - [LiveEvent](https://github.com/FastComments/fastcomments-cpp