...
| tenantId | string | Да |  |
| id | string | Да |  |
| options | const FlagCommentOptions& | Да |  |

## Отговор

Връща: [`FlagCommentResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/FlagCommentResponse.h)

## Пример

[inline-code-attrs-start title = 'Пример за flagComment'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
