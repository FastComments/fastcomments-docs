...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Събира документи чрез групирането им (ако е предоставен groupBy) и прилагането на множество операции. Поддържат се различни операции (напр. sum, countDistinct, avg и др.). |
