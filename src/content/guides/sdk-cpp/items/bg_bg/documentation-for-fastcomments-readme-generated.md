...
## Документация за API Endpoint-и
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегира документи чрез групирането им (ако е предоставен groupBy) и прилага множество операции. Поддържат се различни операции (например sum, countDistinct, avg и др.). |
