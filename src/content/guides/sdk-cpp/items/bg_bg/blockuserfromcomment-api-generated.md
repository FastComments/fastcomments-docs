...
| options | const BlockUserFromCommentOptions& | Да |  |

## Отговор

Връща: [`BlockSuccess`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/BlockSuccess.h)

## Пример

[inline-code-attrs-start title = 'blockUserFromComment пример'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
