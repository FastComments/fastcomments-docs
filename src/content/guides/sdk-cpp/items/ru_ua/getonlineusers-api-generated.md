---
Текущие онлайн-зрители страницы: люди, чья websocket session подписана на страницу прямо сейчас.
Возвращает anonCount + totalCount (room-wide подписчики, включая анонимных зрителей, которых мы не перечисляем).
...
[inline-code-attrs-start title = 'Пример использования getOnlineUsers'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
