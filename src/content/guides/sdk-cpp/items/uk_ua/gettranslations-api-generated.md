...
|------|------|----------|-------------|
| r_namespace | string | Так |  |
| component | string | Так |  |
| options | const GetTranslationsOptions& | Так |  |
...
[inline-code-attrs-start title = 'getTranslations Приклад'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
