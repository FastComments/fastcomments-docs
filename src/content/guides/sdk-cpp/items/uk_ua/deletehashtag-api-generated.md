...
| tenantId | string | Так |  |
| tag | string | Так |  |
| deleteHashTagRequestBody | DeleteHashTagRequestBody | Так |  |
...
[inline-code-attrs-start title = 'Приклад deleteHashTag'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
