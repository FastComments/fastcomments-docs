Користувачі сторінки, які наразі онлайн: люди, чиї websocket-сесії підписані на цю сторінку прямо зараз.
Повертає anonCount + totalCount (підписники кімнати в цілому, включаючи анонімних глядачів, яких ми не перераховуємо).
