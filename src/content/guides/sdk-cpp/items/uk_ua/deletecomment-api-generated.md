...
| tenantId | string | Так |  |
| id | string | Так |  |
| options | const DeleteCommentOptions& | Так |  |

## Відповідь

Повертає: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/DeleteCommentResult.h)

## Приклад

[inline-code-attrs-start title = 'deleteComment Приклад'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
