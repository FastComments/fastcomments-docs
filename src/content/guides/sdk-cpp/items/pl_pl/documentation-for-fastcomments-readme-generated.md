...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agreguje dokumenty poprzez ich grupowanie (jeśli podano groupBy) i zastosowanie wielu operacji. Wspierane są różne operacje (np. sum, countDistinct, avg, itp.). |
