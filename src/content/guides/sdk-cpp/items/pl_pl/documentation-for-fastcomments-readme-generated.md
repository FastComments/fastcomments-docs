...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agreguje dokumenty przez grupowanie ich (jeśli podano `groupBy`) i stosowanie wielu operacji. Wspierane są różne operacje (np. sum, countDistinct, avg itp.). |
