...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Združi dokumente po skupinah (če je določen groupBy) in izvaja več različnih operacij. Podprte so različne operacije (npr. seštevanje, štetje različnih vrednosti, povprečje itd.). |
...
*DefaultApi* | [**getFeedPosts**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#getFeedPosts) | **GET** /api/v1/feed-posts |  potreben tenantId afterId |
...
*PublicApi* | [**getCommentsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getCommentsPublic) | **GET** /comments/{tenantId} |  zahteva tenantId urlId |
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  zahteva tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  zahteva tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  zahteva tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Pretekli komentatorji na strani, ki trenutno NISO spletni. Razvrščeni po displayName. Uporabite to potem, ko izčrpate /users/online, za prikaz razdelka »Člani«. Paginacija kurzorja na commenterName: strežnik postopoma iz prejšnjega {tenantId, urlId, commenterName} naprej s pomočjo $gt, brez stroška $skip. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Trenutno aktivni obiskovalci strani: osebe, katerih websocket seja je trenutno naročena na stran. Vrne anonCount + totalCount (vsi naročniki v »sobi«, vključno z anonimnimi obiskovalci, ki jih ne naštevamo posebej). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Seznam strani za najemodajalca. Uporablja ga FChat namizni odjemalec za izpolnjevanje svojega seznama sob. Zahteva, da je `enableFChat` nastavljen na true v rešenih uporabniških nastavitvah za vsako stran. Strani, ki zahtevajo SSO, se filtrirajo glede na dostopno skupino uporabnika. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Skupne informacije o uporabnikih za najemodajalca. Glede na userIds vrne prikazane podatke iz User / SSOUser. Uporablja jih pripomoček za komentarje za obogatitev uporabniških podatkov, ko se uporabnik prikaže preko dogodka o prisotnosti. Ni konteksta strani, zato je zasebnost dosledno zagotovljena (zasebni profili so prikriti). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | Omogočite ali onemogočite obvestila za določen komentar. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | Omogočite ali onemogočite obvestila za stran. Ko so uporabniki naročeni na stran, se obvestila ustvarijo za nove osnovne komentarje, prav tako pa tudi |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Naloži in spremeni velikost slike |
...
## Dokumentacija za modele
 ...
 - [DeleteSSOUserAPIResponse](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Models/DeleteSSOUserAPI