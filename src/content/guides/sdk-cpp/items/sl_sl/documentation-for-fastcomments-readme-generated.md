...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Združuje dokumente po skupinah (če je groupBy naveden) in izvaja več operacij. Podprte so različne operacije (npr. sum, countDistinct, avg itd.). |
