...
|------|------|----------|-------------|
| tenantId | string | Sí |  |
| options | const GetManualBadgesForUserOptions& | Sí |  |

## Respuesta

Devuelve: [`GetUserManualBadgesResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/GetUserManualBadgesResponse.h)
