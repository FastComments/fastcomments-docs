Vistas actualmente en línea de una página: personas cuya sesión de websocket está suscrita a la página en este momento.  
...
| tenantId | string | Sí |  |
| urlId | string | Sí |  |
| options | const GetOnlineUsersOptions& | Sí |  |
...
[inline-code-attrs-start title = 'Ejemplo getOnlineUsers'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
