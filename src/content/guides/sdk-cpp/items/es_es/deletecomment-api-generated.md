...
| tenantId | string | Sí |  |
| id | string | Sí |  |
| options | const DeleteCommentOptions& | Sí |  |

## Respuesta

Devuelve: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/DeleteCommentResult.h)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo deleteComment'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
