...
Devuelve: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-cpp/blob/master/client/include/FastCommentsClient/model/PatchDomainConfigResponse.h)

## Example

[inline-code-attrs-start title = 'Ejemplo patchDomainConfig'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
api->patchDomainConfig(tenantId, domainToUpdate, patchDomainConfigParams)
    ...
    .then([](pplx::task<void> t) {
        try { t.get(); } catch (const std::exception& e) { /* manejo de error */ }
    });
[inline-code-end]