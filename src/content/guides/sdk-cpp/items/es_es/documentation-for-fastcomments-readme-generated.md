...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agrega documentos agrupándolos (si se proporciona groupBy) y aplicando varias operaciones. Se soportan diferentes operaciones (por ejemplo, sum, countDistinct, avg, etc.). |
