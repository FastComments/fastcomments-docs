...
[inline-code-attrs-start title = 'Ejemplo de updateEmailTemplate'; type = 'cpp'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
api->updateEmailTemplate(tenantId, templateId, body)
    ...
    .then([](pplx::task<void> t) {
        try { t.get(); } catch (const std::exception &) { /* manejo de errores */ }
    });
[inline-code-end]
