...
## Документација за API Endpoint-е

Сви URI-и су релативни у односу на *https://fastcomments.com*
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегира документе груписањем (ако је groupBy прослеђен) и применом више операција. Подржане су различите операције (нпр. sum, countDistinct, avg итд.). |
...
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Претходни коментатори на страници који ТРЕНУТНО нису онлајн. Сортирано по displayName. Користите ово након што исцрпите /users/online да рендерујете секцију "Чланови". Курсор пагинација преко commenterName: сервер "шета" парцијални {tenantId, urlId, commenterName} индекс од afterName па надаље преко $gt, без $skip трошка. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Тренутно онлајн посетиоци на страници: људи чија је websocket сесија тренутно претплаћена на ову страницу. Враћа anonCount + totalCount (претплатници целе собе, укључујући анонимне гледаоце које не набрајамо). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Листа страница за један tenant. Користи је FChat десктоп клијент за попуњавање своје листе соба. Захтева да је `enableFChat` подешено на true у решеном custom config за сваку страницу. Странице које траже SSO се филтрирају према приступу групе корисника који шаље захтев. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Масовне информације о корисницима за један tenant. Дате userIds, враћа приказ(не) инфо из User / SSOUser. Користи се у виџету за коментаре да обогати кориснике који су се управо појавили преко presence event-а. Нема контекста странице: приватност се примењује универсално (приватни профили су сакривени). |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-cpp/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Отпреми и промени величину слике |
...
## Документација за Моделе
 ...
 - [DeletePageAPIResponse](https://github