FastComments replaces the default WordPress moderation tools with its own. [You can access Comment Moderation here](https://fastcomments.com/auth/my-account/moderate-comments).
