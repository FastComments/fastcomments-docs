For the plugin to work, a token is saved in your WordPress database and also your FastComments account. When the plugin makes request to our servers, it provides
this token.
