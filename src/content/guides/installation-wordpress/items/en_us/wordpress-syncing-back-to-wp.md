...
The sync schedule back to WordPress can be customized by installing a plugin. We recommend [WP Crontrol](https://wordpress.org/plugins/wp-crontrol/#description).
