FastComments works with members-only sites by using what is called SSO, or single sign-on. Your members sign in to your WordPress site, but
don't have to worry about creating an account with FastComments, or logging in with social media, to comment. If your members (including admins) are logged into
