...
- **Title** (optional): The heading shown above the list. Defaults to "最近のコメント".
...
[inline-code-attrs-start title = '最近のコメントのショートコード'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
