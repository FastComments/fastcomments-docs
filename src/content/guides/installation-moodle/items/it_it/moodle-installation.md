...
Dopo l'installazione, vai su **Amministrazione del sito > Plugin > Plugin locali > FastComments** per inserire le impostazioni. Consulta la sezione [Configurazione](#items-moodle-configuration) per i dettagli su ogni opzione.
