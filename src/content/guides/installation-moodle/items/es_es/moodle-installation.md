...
Después de la instalación, vaya a **Administración del sitio > Plugins > Plugins locales > FastComments** para introducir sus ajustes. Consulte la sección [Configuración](#items-moodle-configuration) para obtener detalles sobre cada opción.