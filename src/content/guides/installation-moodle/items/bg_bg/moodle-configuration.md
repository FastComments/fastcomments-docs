...
Изберете как потребителите се удостоверяват. Вижте раздела [SSO Modes](#moodle-sso-modes) за подробности за всяка опция.
...
Изберете преживяването при коментиране. Вижте [Commenting Styles](#moodle-commenting-styles) за екранни снимки на всеки режим.
