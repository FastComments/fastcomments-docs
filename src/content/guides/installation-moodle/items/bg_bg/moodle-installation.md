...
След инсталацията отидете на **Администриране на сайта > Плъгини > Локални плъгини > FastComments**, за да въведете настройките си. Вижте секцията [Конфигурация](#moodle-configuration) за подробности за всяка опция.
