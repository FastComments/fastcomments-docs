...
Выберите, как аутентифицируются пользователи. Смотрите раздел [Режимы SSO](#moodle-sso-modes) для подробностей по каждому варианту.
...
Выберите опыт взаимодействия с комментариями. Смотрите раздел [Стили комментирования](#moodle-commenting-styles) для скриншотов каждого режима.
