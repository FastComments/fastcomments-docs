...
После установки перейдите в **Администрирование сайта > Плагины > Локальные плагины > FastComments**, чтобы ввести ваши настройки. См. раздел [Конфигурация](#items-moodle-configuration) для подробностей по каждой опции.
