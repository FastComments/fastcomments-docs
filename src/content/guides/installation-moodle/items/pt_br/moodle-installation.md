...
Após a instalação, vá para **Administração do site > Plugins > Plugins locais > FastComments** para inserir suas configurações. Consulte a seção [Configuração](#moodle-configuration) para detalhes sobre cada opção.