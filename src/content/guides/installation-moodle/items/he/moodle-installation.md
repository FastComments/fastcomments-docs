...
לאחר ההתקנה, עבור אל **ניהול אתר > תוספים > תוספים מקומיים > FastComments** כדי להזין את ההגדרות שלך. ראה את הסעיף [הגדרות](#moodle-configuration) לפרטים על כל אפשרות.