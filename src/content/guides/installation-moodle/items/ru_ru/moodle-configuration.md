...
Выберите способ аутентификации пользователей. См. раздел [Режимы SSO](#items-moodle-sso-modes) для подробностей по каждому варианту.
...
Выберите стиль комментариев. См. [Commenting Styles](#items-moodle-commenting-styles) для скриншотов каждого режима.
