...
Скачайте ZIP последних релизов из <a href="https://github.com/FastComments/fastcomments-moodle/" target="_blank">репозитория FastComments Moodle на GitHub</a>.

#### Распакуйте в каталог Moodle

Распакуйте ZIP в установку Moodle так, чтобы плагин находился по пути `<moodle-root>/local/fastcomments`. Каталог плагина должен содержать `version.php`, `lib.php` и другие файлы плагина непосредственно (не вложенные в подпапку).
