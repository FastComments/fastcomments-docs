...
Po namestitvi pojdite na **Upravljanje mesta > Vtičniki > Lokalni vtičniki > FastComments**, da vnesete nastavitve. Oglejte si razdelek [Konfiguracija](#items-moodle-configuration) za podrobnosti o vsaki možnosti.