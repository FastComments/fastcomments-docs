...
Μετά την εγκατάσταση, μεταβείτε στο **Διαχείριση ιστότοπου > Πρόσθετα > Τοπικά πρόσθετα > FastComments** για να εισαγάγετε τις ρυθμίσεις σας. Δείτε την ενότητα [Διαμόρφωση](#moodle-configuration) για λεπτομέρειες σχετικά με κάθε επιλογή.
