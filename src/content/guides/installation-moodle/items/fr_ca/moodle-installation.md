...
Après l'installation, allez à **Administration du site > Plugins > Plugins locaux > FastComments** pour entrer vos paramètres. Consultez la [Configuration](#items-moodle-configuration) section pour les détails sur chaque option.