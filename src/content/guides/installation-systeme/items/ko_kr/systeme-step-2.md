이제 코드를 복사하겠습니다. 코드 스니펫의 6번째 줄에 `tenantId: "demo"`라고 되어 있으면 FastComments 계정에 로그인한 다음
이 페이지를 새로고침하여 복사된 코드 스니펫에 계정 ID가 표시되게 하세요.
