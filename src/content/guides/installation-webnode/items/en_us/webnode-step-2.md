Next, determine where you want to add comments. Hover over the bottom of the previous content area
...
Now place an HTML block in that section, where the code snippet will go. Select `HTML`:
