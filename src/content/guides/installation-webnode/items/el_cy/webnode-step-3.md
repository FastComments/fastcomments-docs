...
<div class="screenshot white-bg">
    <div class="title">Βήμα Τρία: Επικόλληση Κώδικα</div>
    <img class="screenshot-image" src="/images/installation-guides/webnode-step-4.png" alt="Επικόλληση Κώδικα" />
</div>

Θα πρέπει να φαίνεται έτσι στον επεξεργαστή:
