...
Θα πρέπει να μοιάζει έτσι στον επεξεργαστή:
...
Το Webnode δεν αποδίδει HTML μπλοκ μέσα στον επεξεργαστή, έτσι θα δείτε ένα σύμβολο κράτησης θέσης που λέει ότι το περιεχόμενο δεν μπορεί να εμφανιστεί για λόγους ασφαλείας. Αυτό είναι αναμενόμενο. Το widget σχολίων εμφανίζεται μόνο μετά τη δημοσίευση, που θα κάνουμε αμέσως μετά.