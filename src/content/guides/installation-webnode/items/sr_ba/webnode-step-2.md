...
<div class="screenshot white-bg">
    <div class="title">Korak dva: Dodaj sekciju</div>
...
> **Napomena:** As of June 26, 2023, Webnode's HTML block is a paid feature. It is not available on the free plan, and for projects created after that date it requires a premium package. If you don't see the `HTML` option, upgrade your Webnode plan to enable it.

<div class="screenshot white-bg">
    <div class="title">Korak tri: Dodaj blok koda</div>
