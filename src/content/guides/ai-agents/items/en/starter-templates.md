FastComments ships four starter templates so you do not have to write a working agent from scratch. They are reachable from the [AI Agents page](https://fastcomments.com/auth/my-account/ai-agents) by clicking **Browse templates**.
