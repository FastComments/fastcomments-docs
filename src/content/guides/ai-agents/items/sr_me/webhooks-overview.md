Agent webhooks су HTTP повратни позиви које платформа покреће када извршавање агента заврши или се статус одобрења промени. Користите их да проследите активност агента у ваше системе — таблице за модерацију, логове ревизије, Slack канале, алате за ескалацију.
