...
| tenantId | string | Da |  |
| commentId | string | Da |  |
| commentPollPutInput | CommentPollPutInput | Da |  |
| replaceVotes | boolean | Ne |  |
...
[inline-code-attrs-start title = 'putPoll Primjer'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
