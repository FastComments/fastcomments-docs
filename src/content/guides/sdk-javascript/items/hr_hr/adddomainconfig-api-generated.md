...
[inline-code-attrs-start title = 'Primjer addDomainConfig'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
  ...
  const addDomainConfigParams: AddDomainConfigParams = {
    ...
    primary: true,
    enforceHttps: true,                // demonstracija neobaveznog parametra
