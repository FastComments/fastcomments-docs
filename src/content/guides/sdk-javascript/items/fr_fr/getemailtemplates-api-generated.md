...
Retourne : [`GetEmailTemplatesResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetEmailTemplatesResponse1.ts)
...
(async () => {
  ...
  // Appel avec le paramètre optionnel 'skip' paramètre
