...
[inline-code-attrs-start title = 'Exemple updateModerator'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const updateModeratorBody: UpdateModeratorBody = {
  ...
  active: true,
  avatarUrl: "https://cdn.acme.com/avatars/sofia.jpg" // champ optionnel démontré
};
