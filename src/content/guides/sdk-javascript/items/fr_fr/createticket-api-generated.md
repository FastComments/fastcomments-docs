...
Retourne : [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreateTicketResponse.ts)
...
async function submitTicket() {
  ...
  const ticketBody: CreateTicketBody = {
    ...
    priority: "medium",
    // champ optionnel dans CreateTicketBody
