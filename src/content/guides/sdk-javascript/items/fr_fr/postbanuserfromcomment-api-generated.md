...
const result: BanUserFromCommentResult = await postBanUserFromComment(
  commentId,
  true,        // banEmail — bannir l'adresse e-mail
  false,       // banEmailDomain — bannir le domaine de l'e-mail
  true,        // banIP — bannir l'adresse IP
  true,        // deleteAllUsersComments — supprimer tous les commentaires de l'utilisateur
  bannedUntil,
  false,       // isShadowBan — shadow-ban
  updateId,
  banReason,
  sso
);
