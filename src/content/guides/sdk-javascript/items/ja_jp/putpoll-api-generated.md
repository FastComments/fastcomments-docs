...
| tenantId | string | はい |  |
| commentId | string | はい |  |
| commentPollPutInput | CommentPollPutInput | はい |  |
| replaceVotes | boolean | いいえ |  |

## レスポンス

返り値: [`SavePollResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/SavePollResponse.ts)

## 例

[inline-code-attrs-start title = 'putPoll の例'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
