...
// Des paramètres facultatifs (si pris en charge) peuvent être passés en second argument, par exemple getEmailTemplateDefinitions(tenantId /*, { includeDrafts: true } */);
[inline-code-end]
