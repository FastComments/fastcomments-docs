...
async function demoDeleteTenantUser() {
  ...
  // Supprimer l'utilisateur et tous ses commentaires, en utilisant le mode de suppression permanente
  ...
  // Supprimer l'utilisateur sans retirer les commentaires (comportement par défaut)
