...
Retourne : [`CreateTicket200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreateTicket200Response.ts)
...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // champ facultatif inclus
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // champ facultatif inclus
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // facultatif
};
