...
Retourne : [`GetModerationCommentResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetModerationCommentResponse.ts)
...
async function fetchCommentDetails() {
  ...
  // Appel minimal en n’utilisant que l’argument requis
  const minimalResult: GetModerationCommentResponse = await getModerationComment("cmt_67890def");

  // Utiliser les résultats selon les besoins...
}
[inline-code-end]