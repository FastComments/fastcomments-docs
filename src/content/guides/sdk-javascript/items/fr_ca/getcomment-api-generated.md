...
[inline-code-attrs-start title = 'Exemple d\'utilisation de getComment'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
const tenantId: string = 'tenant_6f1a2b';
const commentId: string = 'cmt_4d9e8f';
const includeReplies: boolean | undefined = true; // exemple de paramètre optionnel (non transmis à getComment)
