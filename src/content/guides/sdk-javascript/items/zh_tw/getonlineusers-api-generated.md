---
目前線上的頁面檢視者：當前其 websocket 會話已訂閱該頁面的人員。
回傳 anonCount + totalCount（房間範圍內的訂閱者，包括我們不列舉的匿名觀眾）。
...
回傳: [`PageUsersOnlineResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/PageUsersOnlineResponse.ts)
