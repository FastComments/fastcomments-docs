...
|------|------|----------|-------------|
| tenantId | string | 是 |  |
| createPollVoteBody | CreatePollVoteBody | 是 |  |

## 回應

返回：[`CreatePollVoteResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreatePollVoteResponse.ts)

## 範例

[inline-code-attrs-start title = 'createPollVote 範例'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
