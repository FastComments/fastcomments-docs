...
Враћа: [`CreateQuestionResultResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreateQuestionResultResponse.ts)
...
(async () => {
  ...
  const createQuestionResultBody: CreateQuestionResultBody = {
    ...
    // демонстрирани опциони параметри
    sessionId: "sess_a12f",
