...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // опционо поље укључено
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // опционо поље укључено
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // опционо
};
