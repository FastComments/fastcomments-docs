Уклоните анкету из њеног коментара, заједно са свим гласовима датим за њу. Сам коментар остаје нетакнут.
...
[inline-code-attrs-start title = 'deletePoll Пример'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
