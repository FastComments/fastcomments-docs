...
Користите ово након исцрпљивања /users/online да прикажете одељак "Чланови".
Курсорска пагинација по commenterName: сервер пролази делимични индекс {tenantId, urlId, commenterName} од afterName унапред преко $gt, без трошка $skip.
