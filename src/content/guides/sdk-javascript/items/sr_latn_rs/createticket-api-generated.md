...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // opciono polje uključeno
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // opciono polje uključeno
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // opciono
};
