...
[inline-code-attrs-start title = 'Primer za updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // opcioni niz uključen
  links: [link],          // opcioni linkovi uključeni
  isPublished: true       // opciona zastavica za objavljivanje korišćena ovde
};
