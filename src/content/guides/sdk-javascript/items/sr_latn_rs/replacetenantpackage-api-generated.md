...
[inline-code-attrs-start title = 'Primer upotrebe replaceTenantPackage'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const replaceTenantPackageBody: ReplaceTenantPackageBody = {
  ...
  customConfigParameters: { maxCommentLength: 1200, allowImages: true }, // uključena opcionalna podešavanja
