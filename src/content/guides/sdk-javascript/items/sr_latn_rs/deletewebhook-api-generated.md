Odjave (REST hook odjava). Samo pretplate kreirane putem ovog API‑ja mogu se izbrisati ovde; webhook‑ovi upravljani putem kontrolne table se uređuju u kontrolnoj tabli.
