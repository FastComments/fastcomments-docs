...
Возвращает: [`GetV2PageReactsResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetV2PageReactsResponse.ts)
...
async function demoGetPageReacts(): Promise<void> {
    ...
    // пример доступа к необязательному свойству
