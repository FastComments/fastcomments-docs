...
Возвращает: [`PostRemoveCommentResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/PostRemoveCommentResponse.ts)

## Пример

[inline-code-attrs-start title = 'Пример postRemoveComment'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
