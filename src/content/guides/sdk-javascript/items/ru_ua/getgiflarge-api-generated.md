...
[inline-code-attrs-start title = 'Пример использования getGifLarge'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const includePreview: boolean | undefined = undefined; // необязательный флаг, который может использовать вызывающий код
