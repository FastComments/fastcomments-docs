...
[inline-code-attrs-start title = 'Пример updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // необязательный массив включён
  links: [link],          // включены необязательные ссылки
  isPublished: true       // здесь используется необязательный флаг публикации
};
