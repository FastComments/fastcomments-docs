...
const startTime: number = Date.now() - 7 * 24 * 60 * 60 * 1000; // 7 дней назад
const endTimeOptional: number | undefined = undefined; // необязательный конец временного интервала
