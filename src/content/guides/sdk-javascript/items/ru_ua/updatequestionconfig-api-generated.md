...
[inline-code-attrs-start title = 'Пример использования updateQuestionConfig'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const updateQuestionConfigBody: UpdateQuestionConfigBody = {
  ...
  enabled: true,
  required: false, // необязательный параметр (пример)
  options
};
