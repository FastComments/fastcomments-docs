...
|------|------|----------|-------------|
| banUserUndoParams | BanUserUndoParams | Ναι |  |
| sso | string | Όχι |  |
...
[inline-code-attrs-start title = 'Παράδειγμα postBanUserUndo'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
