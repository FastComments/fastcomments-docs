...
[inline-code-attrs-start title = 'changeTicketState Παράδειγμα'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const changeTicketStateBody: ChangeTicketStateBody = {
  state: 'closed',
  notifyParticipants: true, // προαιρετική παράμετρος για επίδειξη
