...
Returns: [`GetTenantDailyUsagesResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetTenantDailyUsagesResponse1.ts)
...
async function fetchDailyUsage() {
  ...
  const monthNumber: number = 5; // May
  ...
  // Using only required and one optional parameter
