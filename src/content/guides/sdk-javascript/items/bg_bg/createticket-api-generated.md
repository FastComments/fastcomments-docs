...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // незадължително поле, включено
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // незадължително поле, включено
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // незадължително
};
