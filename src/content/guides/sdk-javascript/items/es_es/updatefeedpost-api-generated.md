...
[inline-code-attrs-start title = 'Ejemplo de updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // array opcional incluido
  links: [link],          // enlaces opcionales incluidos
  isPublished: true       // indicador de publicación opcional usado aquí
};
