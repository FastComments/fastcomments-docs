...
Devuelve: [`DeleteCommentPublicResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/DeleteCommentPublicResponse.ts)

## Ejemplo

[inline-code-attrs-start title = 'deleteCommentPublic Ejemplo'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
