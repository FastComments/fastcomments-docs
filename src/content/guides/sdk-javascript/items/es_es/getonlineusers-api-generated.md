...
Devuelve anonCount + totalCount (suscriptores de toda la sala, incluyendo espectadores anónimos que no enumeramos).
...
Devuelve: [`GetOnlineUsers200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetOnlineUsers200Response.ts)
