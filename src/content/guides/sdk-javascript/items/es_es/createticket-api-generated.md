...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // campo opcional incluido
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // campo opcional incluido
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // opcional
};
