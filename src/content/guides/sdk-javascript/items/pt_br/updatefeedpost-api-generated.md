...
[inline-code-attrs-start title = 'Exemplo de updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // array opcional incluído
  links: [link],          // links opcionais incluídos
  isPublished: true       // sinalizador de publicação opcional usado aqui
};
