...
|------|------|------------|-----------|
| tenantId | string | Sim |  |
| postIds | Array<string> | Sim |  |
| sso | string | Não |  |

## Resposta

Retorna: [`GetFeedPostsStats200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetFeedPostsStats200Response.ts)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de getFeedPostsStats'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
