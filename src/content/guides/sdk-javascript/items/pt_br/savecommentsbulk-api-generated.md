...
|------|------|------------|-----------|
| tenantId | string | Sim |  |
| createCommentParams | Array<CreateCommentParams> | Sim |  |
| isLive | boolean | Não |  |
...
Retorna: `Array<SaveCommentsBulkResponse`

## Exemplo

[inline-code-attrs-start title = 'Exemplo de saveCommentsBulk'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
