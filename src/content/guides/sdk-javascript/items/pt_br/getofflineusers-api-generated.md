...
Paginação por cursor em commenterName: o servidor percorre a parcial {tenantId, urlId, commenterName}
Indexa a partir de afterName para frente usando $gt, sem custo de $skip.
