...
반환: [`GetAuditLogsResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetAuditLogsResponse1.ts)
...
(async () => {
  ...
  const after: number = Date.now() - 3 * 24 * 60 * 60 * 1000; // 3일 전
