...
[inline-code-attrs-start title = 'updateQuestionConfig 예시'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
  ...
  const updateBody: UpdateQuestionConfigBody = {
    ...
    // isActive, customOptions 등은 선택 사항이며 생략되었습니다
  };
