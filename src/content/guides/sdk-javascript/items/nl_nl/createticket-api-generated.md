...
Retourneert: [`CreateTicket200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreateTicket200Response.ts)
...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // optioneel veld opgenomen
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // optioneel veld opgenomen
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // optioneel
};
