...
|------|------|----------|-------------|
| tenantId | string | Ja |  |
| postIds | Array<string> | Nee |  |
| sso | string | Nee |  |

## Respons

Retourneert: [`GetUserReactsPublic200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetUserReactsPublic200Response.ts)

## Voorbeeld

[inline-code-attrs-start title = 'getUserReactsPublic Voorbeeld'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
