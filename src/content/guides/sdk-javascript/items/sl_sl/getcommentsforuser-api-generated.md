...
Vrne: [`GetCommentsForUser200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetCommentsForUser200Response.ts)
...
const comments: GetCommentsForUser200Response = await getCommentsForUser(
  userId,
  undefined, // direction izpuščeno
  undefined, // repliesToUserId izpuščeno
  page,
  includei10n,
  locale,
  isCrawler
