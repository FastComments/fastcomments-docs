...
Vrne: [`GetVotesResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetVotesResponse1.ts)
...
async function fetchVotes(): Promise<void> {
  ...
  // Primer dostopa do optionalnega polja v odgovoru
