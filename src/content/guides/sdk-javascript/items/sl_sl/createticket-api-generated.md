...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // vključeno neobvezno polje
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // vključeno neobvezno polje
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // neobvezno
};
