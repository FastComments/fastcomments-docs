...
Vrne: [`GetTicketsResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetTicketsResponse1.ts)
...
async function loadTickets() {
  ...
  const state: number = 2; // npr., zaprt
