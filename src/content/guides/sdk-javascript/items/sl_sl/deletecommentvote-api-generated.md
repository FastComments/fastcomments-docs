...
const editKey: string = "edit_abc123"; // opcijsko
const ssoToken: string = "sso_token_xyz"; // opcijsko

// Klic z le zahtevanimi parametri in enim opcijskem
...
// Klic z obema opcijskima parametra
