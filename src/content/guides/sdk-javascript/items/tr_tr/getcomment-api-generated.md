...
Döndürür: [`APIGetCommentResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/APIGetCommentResponse.ts)
...
async function fetchComment(): Promise<void> {
  ...
  // İsteğe bağlı alanların gösterimi
