...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // isteğe bağlı alan eklendi
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // isteğe bağlı alan eklendi
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // isteğe bağlı
};
