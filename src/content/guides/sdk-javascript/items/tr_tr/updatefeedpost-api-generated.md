...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // isteğe bağlı dizi dahil edildi
  links: [link],          // isteğe bağlı bağlantılar dahil edildi
  isPublished: true       // burada kullanılan isteğe bağlı yayınlama bayrağı
};
