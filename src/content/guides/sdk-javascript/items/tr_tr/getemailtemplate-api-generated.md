...
Döndürür: [`GetEmailTemplate200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetEmailTemplate200Response.ts)
...
(async () => {
  ...
  const locale: string | undefined = 'en-US'; // isteğe bağlı parametre örneği
