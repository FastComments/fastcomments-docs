...
Döndürür: [`DeleteEmailTemplateResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/DeleteEmailTemplateResponse.ts)
...
async () => {
  ...
  // Yanıttan isteğe bağlı bir özelliğe erişme örneği
