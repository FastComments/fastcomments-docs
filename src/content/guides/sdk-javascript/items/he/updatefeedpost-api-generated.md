...
[inline-code-attrs-start title = 'דוגמת updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
async function runUpdate() {
  ...
  const feedPost: FeedPost = {
    ...
    mediaItems: [mediaItem], // אופציונלי
    links: [link] // אופציונלי
  };
