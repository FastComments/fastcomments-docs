...
מחזיר: [`VoteCommentResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/VoteCommentResponse.ts)
...
const voteBodyParams: VoteBodyParams = {
  vote: "up",               // למשל, "up" | "down"
  weight: 1,                // משקל אופציונלי של ההצבעה
};
