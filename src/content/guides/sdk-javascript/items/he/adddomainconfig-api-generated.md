...
[inline-code-attrs-start title = 'דוגמה ל-addDomainConfig'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
  ...
  const addDomainConfigParams: AddDomainConfigParams = {
    ...
    primary: true,
    enforceHttps: true,                // פרמטר אופציונלי להדגמה
