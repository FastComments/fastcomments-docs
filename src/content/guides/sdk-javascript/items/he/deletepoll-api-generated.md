הסר סקר מההערה שלו, יחד עם כל הצבעה שניתנה עליו. ההערה עצמה נשארת ללא שינוי.
...
[inline-code-attrs-start title = 'deletePoll דוגמה'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
