...
[inline-code-attrs-start title = 'Примјер createEmailTemplate'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const createEmailTemplateBody: CreateEmailTemplateBody = {
  ...
  enabled: true,
  defaultLocale: "en-US",
  metadata: { createdBy: "admin@example.com", purpose: "notify_comment" } // опциони додатни подаци
};
