...
[inline-code-attrs-start title = 'updateFeedPost Primjer'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // neobavezni niz uključen
  links: [link],          // neobavezni linkovi uključeni
  isPublished: true       // neobavezna zastavica za objavu korištena ovdje
};
