...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // neobavezno polje uključeno
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // neobavezno polje uključeno
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // neobavezno
};
