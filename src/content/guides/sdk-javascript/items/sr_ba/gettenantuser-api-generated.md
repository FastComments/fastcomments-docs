...
[inline-code-attrs-start title = 'Примјер getTenantUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const user: User | undefined = (result as any).user; // приступање payload-у
