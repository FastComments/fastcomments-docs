...
Повертає: [`GetQuestionConfigsResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetQuestionConfigsResponse1.ts)
...
async function fetchQuestionConfigs() {
    ...
    // Виклик без необов’язкового параметра 'skip'
