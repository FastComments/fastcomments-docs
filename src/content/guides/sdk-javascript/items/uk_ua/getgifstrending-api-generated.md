...
Повертає: [`GetGifsTrendingResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetGifsTrendingResponse.ts)
...
async function runExample(): Promise<void> {
  ...
  // Використовуючи лише необхідний параметр
