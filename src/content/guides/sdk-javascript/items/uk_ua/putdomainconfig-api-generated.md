...
[inline-code-attrs-start title = 'putDomainConfig Приклад'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
async function runExample() {
  ...
  const updateDomainConfigParams: UpdateDomainConfigParams = {
    ...
    // опційне поле опущено, наприклад, maxCommentLength?: number
  };
