Видалити опитування з його коментаря разом із усіма голосами, які були віддані. Сам коментар залишається без змін.
...
[inline-code-attrs-start title = 'deletePoll Приклад'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
