...
Повертає: [`PostAdjustCommentVotesResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/PostAdjustCommentVotesResponse.ts)
...
const adjustParams: AdjustCommentVotesParams = {
  voteDelta: 1,
  // додаткові поля, які потрібні згідно AdjustCommentVotesParams
};
