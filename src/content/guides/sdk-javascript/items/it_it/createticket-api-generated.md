...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // campo opzionale incluso
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // campo opzionale incluso
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // opzionale
};
