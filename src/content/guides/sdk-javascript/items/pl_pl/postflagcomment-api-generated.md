...
[inline-code-attrs-start title = 'postFlagComment Przykład'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
async function runExample() {
  const tenantId: string = "tenant_12345";
  const commentId: string = "cmt_98765";

  // Tylko wymagane parametry
  const result1: APIEmptyResponse = await postFlagComment(tenantId, commentId);

  // Zawierające opcjonalne parametry
