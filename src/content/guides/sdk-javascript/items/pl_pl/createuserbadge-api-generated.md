...
[inline-code-attrs-start title = 'Przykład użycia createUserBadge'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
  ...
  const createUserBadgeParams: CreateUserBadgeParams = {
    ...
    isActive: true,
    notifyUsers: true // parametr opcjonalny
  };
