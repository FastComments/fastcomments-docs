...
|------|------|----------|-------------|
| tenantId | string | Tak |  |
| createCommentParams | Array<CreateCommentParams> | Tak |  |
| isLive | boolean | Nie |  |
...
Zwraca: `Array<SaveCommentsBulkResponse`

## Przykład

[inline-code-attrs-start title = 'Przykład saveCommentsBulk'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
