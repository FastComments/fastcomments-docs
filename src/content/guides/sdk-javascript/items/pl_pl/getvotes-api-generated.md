...
Zwraca: [`GetVotesResponse1`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/GetVotesResponse1.ts)
...
async function fetchVotes(): Promise<void> {
  ...
  // Przykład dostępu do opcjonalnego pola w odpowiedzi
