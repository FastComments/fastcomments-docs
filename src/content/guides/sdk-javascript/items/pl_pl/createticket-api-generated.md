...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // pole opcjonalne uwzględnione
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // pole opcjonalne uwzględnione
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // opcjonalne
};
