...
|------|------|----------|-------------|
| commentId | string | Да |  |
| includeByUserIdAndEmail | boolean | Нет |  |
| includeByIP | boolean | Нет |  |
| includeByEmailDomain | boolean | Нет |  |
| sso | string | Нет |  |

## Ответ

Возвращает: [`PreBanSummary`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/PreBanSummary.ts)
