...
Возвращает: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/APICreateUserBadgeResponse.ts)

## Пример

[inline-code-attrs-start title = 'Пример использования createUserBadge'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
(async () => {
  ...
  const createUserBadgeParams: CreateUserBadgeParams = {
    ...
    isActive: true,
    notifyUsers: true // необязательный параметр
  };
