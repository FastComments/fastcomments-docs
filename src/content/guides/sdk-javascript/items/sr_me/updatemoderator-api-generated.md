...
[inline-code-attrs-start title = 'Primjer ažuriranja moderatora'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const updateModeratorBodyWithOptional: UpdateModeratorBody = {
  ...
  notifyOnFlag: true // neobavezni parametar
};
