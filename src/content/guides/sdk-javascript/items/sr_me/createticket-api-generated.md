...
const createTicketBody: CreateTicketBody = {
  ...
  priority: 'high', // необавезно поље укључено
  contactEmail: 'jane.doe@acme-corp.com',
  ccEmails: ['eng-oncall@acme-corp.com'], // необавезно поље укључено
  metadata: { page: '/blog/product-update', browser: 'Chrome 112' } // необавезно
};
