...
Враћа: [`CreateTicket200Response`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/CreateTicket200Response.ts)

## Примјер

[inline-code-attrs-start title = 'createTicket Примјер'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const createTicketBody: CreateTicketBody = {
  ...
  priority: "high", // необавезно поље (пример)
  contactEmail: "billing@acme-corp.com", // необавезна контакт информација
