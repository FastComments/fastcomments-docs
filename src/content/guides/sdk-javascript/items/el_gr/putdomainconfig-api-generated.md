...
[inline-code-attrs-start title = 'putDomainConfig Παράδειγμα'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
async function runExample() {
  ...
  const updateDomainConfigParams: UpdateDomainConfigParams = {
    ...
    // προαιρετικό πεδίο παραλείπεται, π.χ., maxCommentLength?: number
  };
