Το SDK είναι γραμμένο σε TypeScript και παρέχει πλήρεις ορισμούς τύπων για όλες τις μεθόδους του API και τα μοντέλα απάντησης:
...
// Χρήση με το SDK για προγράμματα περιήγησης
