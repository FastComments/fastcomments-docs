...
Gibt zurück: [`APIEmptySuccessResponse`](https://github.com/FastComments/fastcomments-sdk-js/blob/main/src/generated/src/models/APIEmptySuccessResponse.ts)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für updateUserBadge'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const updateUserBadgeParams: UpdateUserBadgeParams = {
  ...
  active: true,
  expiresAt: "2026-12-31T23:59:59Z", // optionales Ablaufdatum demonstriert
  notifyUsers: true,
