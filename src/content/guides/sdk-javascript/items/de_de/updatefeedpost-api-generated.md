...
[inline-code-attrs-start title = 'updateFeedPost Beispiel'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // optionales Array eingeschlossen
  links: [link],          // optionale Links eingeschlossen
  isPublished: true       // optionales Veröffentlichungs-Flag verwendet
};
