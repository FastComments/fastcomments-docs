...
[inline-code-attrs-start title = 'Eksempel på updateFeedPost'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
const feedPost: FeedPost = {
  ...
  media: [mediaItem],     // valgfrit array inkluderet
  links: [link],          // valgfri links inkluderet
  isPublished: true       // valgfrit publiceringsflag brugt her
};
