---
Quando um usuário deixa um comentário, ou voto, e não está logado, ou sua conta está
não verificada, receberá um e-mail pedindo que verifique essa ação.

No entanto, fazemos o possível para não enviar spam aos seus usuários com e-mails, e não enviaremos mais de um
e-mail de verificação por sessão. Veja a seção Sessões para mais detalhes.

Por padrão, os e-mails de verificação de comentários ficam assim:
...
Por padrão, os e-mails de verificação de voto ficam assim:
...
Por padrão, o FastComments exibirá seu logo e nome no rodapé desses e-mails:
...
Se você estiver nos planos Flex ou Pro, [O nome do remetente, o e-mail e a identidade visual podem ser personalizados](/guide-multiple-sites.html#from-name-email-logo).
