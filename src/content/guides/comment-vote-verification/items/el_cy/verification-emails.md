Όταν ένας χρήστης αφήνει ένα σχόλιο, ή ψήφο, και δεν είναι συνδεδεμένος, ή ο λογαριασμός του είναι
μη επαληθευμένος, θα λάβει ένα email που του ζητά να επαληθεύσει αυτή τη δράση.

Ωστόσο, κάνουμε το καλύτερο δυνατό για να μην σπαμάρουμε τους χρήστες σας με emails, και δεν θα στείλουμε περισσότερα από ένα
email επιβεβαίωσης ανά συνεδρία. Δείτε την ενότητα Συνεδρίες για περισσότερες λεπτομέρειες.

Από προεπιλογή, τα emails επιβεβαίωσης σχολίων εμφανίζονται όπως το παρακάτω:
...
Από προεπιλογή, τα emails επιβεβαίωσης ψήφου εμφανίζονται όπως το παρακάτω:
...
Αν βρίσκεστε στα επίπεδα Flex ή Pro, [Το όνομα αποστολέα, το email και το branding μπορούν να προσαρμοστούν](/guide-multiple-sites.html#from-name-email-logo).