Lorsqu'un utilisateur laisse un commentaire, ou vote, et qu'il n'est pas connecté, ou que son compte est
non vérifié, il recevra un courriel lui demandant de vérifier cette action.

Cependant, nous faisons de notre mieux pour ne pas spammer vos utilisateurs avec des courriels, et nous n'enverrons pas plus d'un
courriel de vérification par session. Consultez la section Sessions pour plus de détails.

Par défaut, les courriels de vérification de commentaire ressemblent à ce qui suit :
...
Par défaut, les courriels de vérification de vote ressemblent à ce qui suit :
...
Par défaut, FastComments affichera son logo et son nom dans le pied de page de ces courriels :
...
Si vous êtes sur les paliers Flex ou Pro, [Le nom de l'expéditeur, l'adresse courriel et l'image de marque peuvent être personnalisés](/guide-multiple-sites.html#from-name-email-logo).