[inline-code-attrs-start title = 'Domyślny CSS widżetu komentarzy'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus dla SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* ważne, aby obramowanie było po prawej stronie, ponieważ nie zawsze się wyświetla */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* nie wybierać inline-image w edytorze WYSIWYG */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* nie wybierać inline-image w edytorze WYSIWYG */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* można ustawić podczas początkowego zapisywania komentarza */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* można ustawić podczas początkowego zapisywania komentarza */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* wspólne style etykiet (etykieta niezweryfikowana, etykieta administratora, niestandardowe etykiety, itp.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* position: relative jest wymagane dla komunikatu o zablokowaniu */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px, aby zapewnić przykrycie strzałki */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* jeśli top jest zbyt niski, będzie się pojawiać nad podświetleniem podczas akcji administratora */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* jeśli top jest zbyt niski, będzie się pojawiać nad podświetleniem podczas akcji administratora */
