[inline-code-attrs-start title = 'Standard-CSS des Kommentar-Widgets'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus für SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* wichtig, dass die Border beim rechten Element ist, da sie nicht immer angezeigt wird */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* relativ positioniert für Elemente wie Benachrichtigungslisten */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* darf im WYSIWYG nicht inline-image auswählen */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* darf im WYSIWYG nicht inline-image auswählen */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* kann beim ersten Speichern des Kommentars gesetzt werden */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* kann beim ersten Speichern des Kommentars gesetzt werden */
    ...
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative ist für die Blockiert-Meldung erforderlich */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px, um sicherzustellen, dass er den Pfeil überdeckt */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* wenn top zu niedrig ist, kann es über die Hervorhebung für Admin-Aktionen hinausragen */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* wenn top zu niedrig ist, kann es über die Hervorhebung für Admin-Aktionen hinausragen */
