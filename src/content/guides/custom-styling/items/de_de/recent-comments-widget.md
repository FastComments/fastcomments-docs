...
[inline-code-attrs-start title = 'Installation des Recent Comments Widgets'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **count** (optional): Anzahl der anzuzeigenden Kommentare. Standard ist `10`
- **hasDarkBackground** (optional): Dunkelmodus-Design erzwingen. Wird vom Seitenhintergrund automatisch erkannt, wenn nicht gesetzt

## Widget-Struktur

Das Widget wird mit folgender HTML-Struktur gerendert:

[inline-code-attrs-start title = 'HTML-Struktur des Recent Comments Widgets'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rc2">
...
[inline-code-attrs-start title = 'Standard-CSS des Recent Comments Widgets'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
...
[inline-code-attrs-start title = 'Benutzerdefinierte Avatar-Größe'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-avatar {
...
[inline-code-attrs-start title = 'Mehr Kommentarzeilen anzeigen'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-body {
