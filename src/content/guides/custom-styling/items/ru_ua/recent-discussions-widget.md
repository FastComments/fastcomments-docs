...
[inline-code-attrs-start title = 'CSS по умолчанию виджета «Последние обсуждения»'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rd2 {
...
[inline-code-attrs-start title = 'Убрать рамку контейнера'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rd2 {
