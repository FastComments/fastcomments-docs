[inline-code-attrs-start title = 'CSS виджета комментариев по умолчанию'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* важно, чтобы граница была справа, так как она не всегда отображается */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* не выбирать inline-image в WYSIWYG */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* не выбирать inline-image в WYSIWYG */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* можно установить при первоначальном сохранении комментария */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* можно установить при первоначальном сохранении комментария */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* общие стили меток (неподтверждённая метка, метка администратора, пользовательские метки и т.д.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative требуется для сообщения о блокировке */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px чтобы перекрыть стрелку */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* если top слишком низок, будет отображаться выше подсветки для действий администратора */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* если top слишком низок, будет отображаться выше подсветки для действий администратора */
