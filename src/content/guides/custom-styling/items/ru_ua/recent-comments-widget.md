...
[inline-code-attrs-start title = 'Установка виджета «Последние комментарии»'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'HTML-структура виджета «Последние комментарии»'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rc2">
...
[inline-code-attrs-start title = 'CSS по умолчанию виджета «Последние комментарии»'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
...
[inline-code-attrs-start title = 'Пользовательский размер аватара'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-avatar {
