[inline-code-attrs-start title = 'CSS predefinito del widget dei commenti'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus per ssr */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* è importante che il bordo sia su quello a destra, poiché non sempre viene mostrato */
    ...
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative è richiesto per il messaggio bloccato */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px per assicurarsi che copra la freccia */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* se top è troppo basso, andrà sopra l'evidenziazione per le azioni admin */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* se top è troppo basso, andrà sopra l'evidenziazione per le azioni admin */
