...
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus voor ssr */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* belangrijk dat de rand aan de rechterkant zit, omdat deze niet altijd zichtbaar is */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* mag inline-image niet selecteren in wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* mag inline-image niet selecteren in wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* kan worden ingesteld bij het aanvankelijk opslaan van het commentaar */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* kan worden ingesteld bij het aanvankelijk opslaan van het commentaar */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* algemene label-styling (niet-geverifieerd label, admin label, aangepaste labels, enz.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative is vereist voor geblokkeerd bericht */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px om ervoor te zorgen dat het de pijl bedekt */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* als top te laag is, komt het boven de markering voor beheerdersacties uit */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* als top te laag is, komt het boven de markering voor beheerdersacties uit */
