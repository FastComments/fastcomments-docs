[inline-code-attrs-start title = 'Προεπιλεγμένο CSS Widget Σχολίων'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus για SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* σημαντικό: το περίγραμμα πρέπει να είναι στο δεξί στοιχείο, καθώς δεν εμφανίζεται πάντα */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* να μην επιλέγεται το inline-image στο wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* να μην επιλέγεται το inline-image στο wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* μπορεί να οριστεί όταν αποθηκευτεί αρχικά το σχόλιο */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* μπορεί να οριστεί όταν αποθηκευτεί αρχικά το σχόλιο */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* κοινή μορφοποίηση ετικέτας (ετικέτα μη επαληθευμένου, ετικέτα διαχειριστή, προσαρμοσμένες ετικέτες κ.λπ.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* το relative απαιτείται για το μήνυμα αποκλεισμού */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px για να εξασφαλιστεί ότι καλύπτει το βέλος προς τα πάνω */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* εάν το top είναι πολύ χαμηλό, θα εμφανιστεί πάνω από το highlight για ενέργειες διαχειριστή */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* εάν το top είναι πολύ χαμηλό, θα εμφανιστεί πάνω από το highlight για ενέργειες διαχειριστή */
