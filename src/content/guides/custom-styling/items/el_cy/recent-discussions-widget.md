Το Widget Πρόσφατων Συζητήσεων εμφανίζει μια λίστα σελίδων ταξινομημένη με βάση την πιο πρόσφατη δραστηριότητα σχολίων. Περιλαμβάνει μια κεφαλίδα, ημερομηνίες τελευταίας δραστηριότητας, αριθμούς σχολίων με εικονίδια και αυτόματη ανίχνευση σκοτεινής λειτουργίας.
...
- **tenantId** (απαιτείται): Το tenant ID του FastComments σας
- **count** (προαιρετικό): Αριθμός σελίδων για εμφάνιση. Προεπιλογή `20`, μέγιστο `100`
- **hasDarkBackground** (προαιρετικό): Επιβάλλει στυλ σκοτεινής λειτουργίας. Εντοπίζεται αυτόματα από το φόντο της σελίδας αν δεν οριστεί

## Δομή Widget

Το widget αποδίδεται με την ακόλουθη δομή HTML:

[inline-code-attrs-start title = 'Δομή HTML του Widget Πρόσφατων Συζητήσεων'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rd2">
...
### Αφαίρεση Περιγράμματος Δοχείου

[inline-code-attrs-start title = 'Αφαίρεση Περιγράμματος Δοχείου'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rd2 {
