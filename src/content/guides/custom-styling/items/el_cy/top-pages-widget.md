Το widget Most Discussed Pages εμφανίζει μια κατάταξη των σελίδων σας με τα περισσότερα σχόλια. Περιλαμβάνει μια επικεφαλίδα, αριθμημένες θέσεις κατάταξης, αριθμό σχολίων με εικονίδια, ημερομηνίες τελευταίας δραστηριότητας και αυτόματη ανίχνευση σκοτεινής λειτουργίας.

## Basic Installation

[inline-code-attrs-start title = 'Εγκατάσταση Widget Most Discussed Pages'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **tenantId** (required): Το tenant ID σας στο FastComments
- **hasDarkBackground** (optional): Εξαναγκάζει το στυλ σε σκοτεινή εμφάνιση. Αν δεν οριστεί, εντοπίζεται αυτόματα από το φόντο της σελίδας

## Widget Structure

Το widget αποδίδει την ακόλουθη δομή HTML:

[inline-code-attrs-start title = 'Δομή HTML του Widget Most Discussed Pages'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'Προεπιλεγμένο CSS για το Widget Most Discussed Pages'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
[inline-code-attrs-start title = 'Αφαίρεση Εμβλημάτων Κατάταξης'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
...
[inline-code-attrs-start title = 'Αφαίρεση Περιγράμματος Περιέκτη'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
