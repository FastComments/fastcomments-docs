The Recent Comments Widget prikazuje listu najnovijih komentara na vašem sajtu ili za određenu stranicu. Sadrži naslov, zaobljene avatare, pregled komentara, klikabilne datume koji vode direktno do komentara i automatsko otkrivanje tamnog režima.

## Osnovna instalacija

[inline-code-attrs-start title = 'Instalacija vidžeta Najnoviji komentari'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **urlId** (optional): Filtrirajte na jednu stranicu. Ostavite null za sve stranice
- **count** (optional): Broj komentara za prikaz. Podrazumevano je `10`
- **hasDarkBackground** (optional): Forsirajte tamni režim. Ako nije postavljeno, tamni režim se automatski detektuje iz pozadine stranice

## Struktura vidžeta

Vidžet se renderuje sa sledećom HTML strukturom:

[inline-code-attrs-start title = 'HTML struktura vidžeta Najnoviji komentari'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rc2">
...
[inline-code-attrs-start title = 'Podrazumevani CSS vidžeta Najnoviji komentari'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
