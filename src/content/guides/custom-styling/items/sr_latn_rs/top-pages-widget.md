Vidžet Najraspravljenije stranice prikazuje rangiranu listu vaših stranica sa najviše komentara. Uključuje naslov, numerisane pozicije, broj komentara sa ikonama, datume poslednje aktivnosti i automatsko otkrivanje tamnog režima.

## Osnovna instalacija

[inline-code-attrs-start title = 'Instalacija vidžeta Najraspravljenije stranice'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **hasDarkBackground** (optional): Prisilno primeni tamni režim. Ako nije postavljeno, automatski se otkriva na osnovu pozadine stranice

## Struktura vidžeta

Vidžet se renderuje sa sledećom HTML strukturom:

[inline-code-attrs-start title = 'HTML struktura vidžeta Najraspravljenije stranice'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'Podrazumevani CSS vidžeta Najraspravljenije stranice'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
### Ukloni bedževe ranga

[inline-code-attrs-start title = 'Ukloni bedževe ranga'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
