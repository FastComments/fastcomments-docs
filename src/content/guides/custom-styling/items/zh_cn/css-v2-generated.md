[inline-code-attrs-start title = '评论小部件默认 CSS'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus 用于 SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* 重要：边框必须放在右侧元素上，因为有时不会显示 */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* 使用相对定位以便用于通知列表等 */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* 在所见即所得编辑器中不要选择 inline-image */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* 在所见即所得编辑器中不要选择 inline-image */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* 可在初次保存评论时设置 */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* 可在初次保存评论时设置 */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* 使用 -2px 以确保覆盖向上箭头 */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* 如果 top 值太低，会覆盖管理员操作的高亮 */
