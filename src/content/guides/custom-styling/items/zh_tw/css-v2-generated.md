[inline-code-attrs-start title = '評論小工具預設 CSS'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* 供 SSR 使用的 .comment-reply textarea:focus */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* 重要：邊框需在右側元素，否則可能不會顯示 */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* 相對定位，用於通知列表等 */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* 不應在所見即所得編輯器中選取 inline-image */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* 不應在所見即所得編輯器中選取 inline-image */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* 可以在初次儲存留言時設定 */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* 可以在初次儲存留言時設定 */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* 共用標籤樣式（未驗證標籤、管理員標籤、自訂標籤等） */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* 被封鎖訊息需要相對定位 */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px 以確保覆蓋上箭頭 */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* 如果 top 設得太低，會蓋過管理員操作的高亮 */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* 如果 top 設得太低，會蓋過管理員操作的高亮 */
