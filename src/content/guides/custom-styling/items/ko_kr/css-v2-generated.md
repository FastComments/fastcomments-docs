[inline-code-attrs-start title = '댓글 위젯 기본 CSS'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* SSR용 .comment-reply textarea:focus */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* 경계선은 오른쪽 요소에 있어야 합니다. 항상 보이지는 않기 때문 */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* 상대 위치는 알림 목록과 같은 요소에 필요함 */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* WYSIWYG에서 inline-image를 선택하면 안 됩니다 */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* WYSIWYG에서 inline-image를 선택하면 안 됩니다 */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* 댓글을 처음 저장할 때 설정할 수 있음 */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* 댓글을 처음 저장할 때 설정할 수 있음 */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* 공통 레이블 스타일(미확인 레이블, 관리자 레이블, 커스텀 레이블 등) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* 차단 메시지에 상대 위치(relative)가 필요함 */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* 위쪽 화살표를 덮기 위해 -2px */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* top 값이 너무 낮으면 관리자 액션의 하이라이트 위로 올라갈 수 있음 */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* top 값이 너무 낮으면 관리자 액션의 하이라이트 위로 올라갈 수 있음 */
