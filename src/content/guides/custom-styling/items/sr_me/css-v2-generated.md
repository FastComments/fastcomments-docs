[inline-code-attrs-start title = 'Подразумевани CSS видџета за коментаре'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* важно је да border буде на оној са десне стране, јер се не приказује увек */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* не смије се селектовати inline-image у wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* не смије се селектовати inline-image у wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* може бити постављено при почетном чувању коментара */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* може бити постављено при почетном чувању коментара */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* заједнички стил етикета (непотврђена етикета, админ етикета, прилагођене етикете итд.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative је потребан за поруку о блокирању */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px да би се осигурало да покрије стрелицу горе */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* ако је top превише низак, појавиће се изнад истицања за администраторске радње */
