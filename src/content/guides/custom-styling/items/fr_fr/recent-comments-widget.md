...
[inline-code-attrs-start title = 'Installation du widget Commentaires récents'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **count** (optionnel): Nombre de commentaires à afficher. La valeur par défaut est `10`
...
[inline-code-attrs-start title = 'Structure HTML du widget Commentaires récents'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rc2">
...
[inline-code-attrs-start title = 'CSS par défaut du widget Commentaires récents'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
...
[inline-code-attrs-start title = 'Taille avatar personnalisée'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-avatar {
...
[inline-code-attrs-start title = 'Afficher plus de lignes de commentaire'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-body {
