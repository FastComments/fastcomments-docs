[inline-code-attrs-start title = 'CSS par défaut du widget de commentaires'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus pour le SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* important que la bordure soit sur celui de droite, car elle n'apparaît pas toujours */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* positionnement relatif pour des éléments comme la liste des notifications */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* ne doit pas sélectionner inline-image dans l'éditeur WYSIWYG */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* ne doit pas sélectionner inline-image dans l'éditeur WYSIWYG */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* peut être défini lors de l'enregistrement initial du commentaire */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* peut être défini lors de l'enregistrement initial du commentaire */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* style commun des étiquettes (étiquette non vérifiée, étiquette admin, étiquettes personnalisées, etc.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* la position relative est requise pour le message bloqué */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px pour s'assurer de recouvrir la flèche */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* si top est trop bas, il passera au-dessus du surlignage pour les actions administrateur */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* si top est trop bas, il passera au-dessus du surlignage pour les actions administrateur */
