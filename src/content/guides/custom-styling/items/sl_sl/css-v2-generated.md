[inline-code-attrs-start title = 'Privzeta CSS pripomočka za komentarje'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* pomembno, da je obroba na desnem elementu, saj se včasih ne prikaže */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* relativno pozicionirano za elemente, kot je seznam obvestil */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* ne sme izbrati inline-image v urejevalniku WYSIWYG */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* ne sme izbrati inline-image v urejevalniku WYSIWYG */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* lahko je nastavljeno pri začetnem shranjevanju komentarja */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* lahko je nastavljeno pri začetnem shranjevanju komentarja */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* skupna stilizacija oznak (nepreverjena oznaka, skrbniška oznaka, lastne oznake itd.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relativna pozicija je potrebna za sporočilo o blokadi */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px, da pokrije puščico navzgor */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* če je top prenizek, bo šel nad označevanje za skrbniške akcije */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* če je top prenizek, bo šel nad označevanje za skrbniške akcije */
