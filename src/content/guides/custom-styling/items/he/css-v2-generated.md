[inline-code-attrs-start title = 'CSS ברירת המחדל של ווידגט ההערות'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus עבור SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* חשוב שהborder יהיה על האלמנט מימין, כי הוא לא תמיד מוצג */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* מיקום relative עבור פריטים כמו רשימת התראות */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* יש להימנע מבחירת inline-image בתוך wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* יש להימנע מבחירת inline-image בתוך wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* ניתן להגדיר זאת בעת שמירת התגובה בתחילה */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* ניתן להגדיר זאת בעת שמירת התגובה בתחילה */
    ...
    .badges .badge { display: inline-block; vertical-align: middle; line-height: initial; margin: 3px 5px 3px 0; padding: 5px 7px; cursor: default; font-size: 12px; white-space: nowrap; border-radius: 4px; color: #000; } /* עיצוב תוויות משותף (תווית לא מאומתת, תווית מנהל, תוויות מותאמות אישית, וכו') */
    ...
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative נדרש עבור הודעה חסומה */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px כדי להבטיח כיסוי של החץ */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* אם top נמוך מדי, עלול להופיע מעל ההדגשה עבור פעולות מנהל */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* אם top נמוך מדי, עלול להופיע מעל ההדגשה עבור פעולות מנהל */
