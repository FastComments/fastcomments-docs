[inline-code-attrs-start title = 'Подразумевани CSS виџета коментара'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus за SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* важно је да граница буде на елементу са десне стране, јер се не приказује увек */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* позиционирано као relative за елементе попут листе обавештења */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* не сме селектовати inline-image у WYSIWYG уређивачу */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* не сме селектовати inline-image у WYSIWYG уређивачу */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* може бити подешено при почетном чувању коментара */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* може бити подешено при почетном чувању коментара */
    ...
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* потребно је relative позиционирање за поруку о блокирању */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px да би покрио стрелицу */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* ако је top превише низак, иде изнад истакнутог за админ акције */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* ако је top превише низак, иде изнад истакнутог за админ акције */
