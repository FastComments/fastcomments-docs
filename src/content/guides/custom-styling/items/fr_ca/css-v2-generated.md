...
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus pour le rendu côté serveur (SSR) */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* important que la bordure soit sur celui de droite, car elle ne s'affiche pas toujours */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* positionné en relatif pour des éléments comme la liste de notifications */
    ...
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative est requis pour le message bloqué */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px pour s'assurer qu'il recouvre la flèche */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* si top est trop bas, ira au-dessus du surlignage pour les actions d'administration */ /* if top is too low, will go above highlighting for admin actions */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* si top est trop bas, ira au-dessus du surlignage pour les actions d'administration */
