...
[inline-code-attrs-start title = 'Installation du widget des pages les plus commentées'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Structure HTML du widget des pages les plus commentées'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'CSS par défaut du widget des pages les plus commentées'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
[inline-code-attrs-start title = 'Supprimer les badges de classement'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
