...
[inline-code-attrs-start title = 'Installation du widget des discussions récentes'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Structure HTML du widget des discussions récentes'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rd2">
...
[inline-code-attrs-start title = 'CSS par défaut du widget des discussions récentes'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rd2 {
