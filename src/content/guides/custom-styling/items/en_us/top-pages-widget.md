...
[inline-code-attrs-start title = 'Most Discussed Pages Widget Installation'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Most Discussed Pages Widget HTML Structure'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'Most Discussed Pages Widget Default CSS'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
[inline-code-attrs-start title = 'Remove Rank Badges'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
...
[inline-code-attrs-start title = 'Remove Container Border'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
