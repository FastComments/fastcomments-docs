[inline-code-attrs-start title = 'CSS за замовчуванням віджета коментарів'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus для SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* важливо, щоб рамка була справа, оскільки вона не завжди відображається */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* не слід вибирати inline-image у WYSIWYG */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* не слід вибирати inline-image у WYSIWYG */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* може бути встановлено при початковому збереженні коментаря */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* може бути встановлено при початковому збереженні коментаря */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* загальний стиль міток (мітка непідтверджена, мітка адміністратора, користувацькі мітки тощо) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* position: relative необхідний для повідомлення про блокування */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px, щоб перекрити стрілку */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* якщо top занадто низький, елемент опиниться над підсвічуванням для дій адміністратора */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* якщо top занадто низький, елемент опиниться над підсвічуванням для дій адміністратора */
