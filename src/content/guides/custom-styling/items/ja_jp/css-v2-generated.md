[inline-code-attrs-start title = 'コメントウィジェットのデフォルトCSS'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* SSR のための .comment-reply textarea:focus */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* 重要: 境界線は右側の要素に付けること。常に表示されない場合があるため */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* relative は通知リストなどのために必要 */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* WYSIWYGでinline-imageを選択しない */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* WYSIWYGでinline-imageを選択しない */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* コメント保存時に設定される可能性がある */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* コメント保存時に設定される可能性がある */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* 共通のラベルスタイル（未検証ラベル、管理者ラベル、カスタムラベル等） */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative はブロックメッセージのために必要 */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px は矢印を覆うために必要 */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* topが低すぎると、管理者アクションのハイライトの上に出てしまう */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* topが低すぎると、管理者アクションのハイライトの上に出てしまう */
