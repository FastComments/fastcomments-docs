[inline-code-attrs-start title = 'Προεπιλεγμένο CSS για το Widget Σχολίων'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* σημαντικό ότι το περίγραμμα βρίσκεται στο στοιχείο δεξιά, καθώς δεν εμφανίζεται πάντα */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* σχετική θέση για στοιχεία όπως λίστα ειδοποιήσεων */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* δεν πρέπει να επιλέγεται inline-image στο wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* δεν πρέπει να επιλέγεται inline-image στο wysiwyg */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* κοινό στυλ ετικέτας (μη επαληθευμένη ετικέτα, ετικέτα διαχειριστή, προσαρμοσμένες ετικέτες κ.λπ.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* απαιτείται relative για το μπλοκαρισμένο μήνυμα */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px για να καλύπτει το βέλος */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* αν το top είναι πολύ χαμηλό, θα εμφανιστεί πάνω από το highlight για ενέργειες διαχειριστή */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* αν το top είναι πολύ χαμηλό, θα εμφανιστεί πάνω από το highlight για ενέργειες διαχειριστή */
