Widget Najviše raspravljenih stranica prikazuje rangiranu listu vaših stranica s najviše komentara. Uključuje naslov, numerirane pozicije, brojače komentara s ikonama, datume posljednje aktivnosti i automatsko prepoznavanje tamnog načina.

## Osnovna instalacija

[inline-code-attrs-start title = 'Instalacija widgeta Najviše raspravljenih stranica'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **hasDarkBackground** (optional): Primorava tamni način prikaza. Ako nije postavljeno, automatski se otkriva iz pozadine stranice

## Struktura widgeta

Widget se prikazuje s sljedećom HTML strukturom:

[inline-code-attrs-start title = 'HTML struktura widgeta Najviše raspravljenih stranica'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'Zadani CSS widgeta Najviše raspravljenih stranica'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
### Uklonite oznake ranga

[inline-code-attrs-start title = 'Uklonite oznake ranga'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
