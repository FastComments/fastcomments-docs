Widget Najnoviji komentari prikazuje popis najnovijih komentara na vašoj stranici ili za određenu stranicu. Uključuje zaglavlje, zaobljene avatare, pregled komentara, klikabilne datume koji vode izravno na komentar i automatsko otkrivanje tamnog načina prikaza.

## Osnovna instalacija

[inline-code-attrs-start title = 'Instalacija widgeta Najnovijih komentara'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **tenantId** (obavezno): ID vašeg FastComments tenant-a
- **urlId** (neobavezno): Filtrira na jednu stranicu. Ostavite null za sve stranice
- **count** (neobavezno): Broj komentara za prikaz. Zadano je `10`
- **hasDarkBackground** (neobavezno): Primorava tamni stil prikaza. Ako nije postavljeno, tamni način se automatski otkriva iz pozadine stranice

## Struktura widgeta

Widget se prikazuje sljedećom HTML strukturom:
...
[inline-code-attrs-start title = 'Prikaži više redova teksta komentara'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-body {
...
### Ukloni obrub spremnika

[inline-code-attrs-start title = 'Ukloni obrub spremnika'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
