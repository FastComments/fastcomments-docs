[inline-code-attrs-start title = 'Podrazumevani CSS komentarskog widgeta'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus za SSR */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* važno je da granica bude na desnom elementu, jer se ponekad ne prikazuje */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* pozicionirano relativno za stvari poput liste obavještenja */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* ne smije odabrati inline-image u WYSIWYG-u */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* ne smije odabrati inline-image u WYSIWYG-u */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* može se postaviti pri inicijalnom spremanju komentara */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* može se postaviti pri inicijalnom spremanju komentara */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* uobičajeno stilizovanje oznaka (oznaka neprovjerenog, administratorska oznaka, prilagođene oznake, itd.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative je potreban za poruku o blokiranju */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px da osigura prekrivanje strelice */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* ako je top suviše nizak, pojavit će se iznad isticanja za administrativne akcije */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* ako je top suviše nizak, pojavit će se iznad isticanja za administrativne akcije */
