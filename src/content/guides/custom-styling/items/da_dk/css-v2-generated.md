[inline-code-attrs-start title = 'Standard CSS til Kommentar-widget'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    input:focus, textarea:focus, textarea:focus + .horizontal-border-wrapper, .comment-input textarea:focus { border-color: #555 } /* .comment-reply textarea:focus til ssr */
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* vigtigt, at grænsen er på den til højre, da den ikke altid vises */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* må ikke vælge inline-image i wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* må ikke vælge inline-image i wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* kan sættes ved første gem af kommentaren */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* kan sættes ved første gem af kommentaren */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* fælles label-styling (ikke-verificeret label, admin-label, brugerdefinerede labels osv.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative er påkrævet for blokeret meddelelse */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px for at sikre, at den dækker pilen */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* hvis top er for lav, vil den gå over fremhævningen for admin-handlinger */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* hvis top er for lav, vil den gå over fremhævningen for admin-handlinger */
