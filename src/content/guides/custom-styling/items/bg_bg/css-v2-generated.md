[inline-code-attrs-start title = 'По подразбиране CSS за уиджета за коментари'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* важно е границата да е отдясно, тъй като не винаги се показва */
    ...
    .comment-reply .comment-reply-top-bar { position: relative; min-height: 25px; margin: 0 26px 15px 26px; line-height: 25px; } /* относително позициониран за елементи като списък с известия */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* не трябва да се селектира inline-image в wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* не трябва да се селектира inline-image в wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* може да бъде зададено при първоначалното записване на коментара */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* може да бъде зададено при първоначалното записване на коментара */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* общ стил за етикети (етикет „непотвърден“, администраторски етикет, потребителски етикети и т.н.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative е необходимо за съобщението за блокиране */
