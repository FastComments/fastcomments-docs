Уиджетът „Най-обсъжданите страници“ показва подреден списък с най-коментираните ви страници. Включва заглавие, номерирани рангове, брой коментари с икони, дати на последна активност и автоматично откриване на тъмен режим.

## Основна инсталация

[inline-code-attrs-start title = 'Инсталиране на уиджета "Най-обсъжданите страници"'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
- **hasDarkBackground** (незадължително): Принудително прилагане на тъмен режим. Ако не е зададено, се определя автоматично от фона на страницата

## Структура на уиджета

Уиджетът се рендерира със следната HTML структура:

[inline-code-attrs-start title = 'HTML структура на уиджета "Най-обсъжданите страници"'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-tp2">
...
[inline-code-attrs-start title = 'CSS по подразбиране на уиджета "Най-обсъжданите страници"'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2 {
...
### Премахване на значките за ранг

[inline-code-attrs-start title = 'Премахване на значките за ранг'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-tp2-rank {
