[inline-code-attrs-start title = 'CSS predeterminado del widget de comentarios'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
body { margin: 0; padding: 0; }
    ...
    .pagination .load-all { padding-left: 25px; border-left: 2px solid #555; } /* es importante que el borde esté en el de la derecha, ya que no siempre se muestra */
    ...
    .comment .comment-text .inline-image { display: block; max-width: 500px; margin: 3px 0 3px 0 } /* no debe seleccionar inline-image en wysiwyg */
    .comment .comment-text .inline-image img { max-width: 100%; max-height: 400px } /* no debe seleccionar inline-image en wysiwyg */
    .disable-image-redirect .comment .inline-image { cursor: default; }
    .comment.is-live > .inner { animation: backgroundToNormal 1.5s }
    .comment.is-unread > .inner .avatar-wrapper { box-shadow: 0 0 20px #89f796; }
    .comment.unverified > .commenter-name, .comment.unverified > .comment-content .commenter-name { opacity: 0.7 }
    .comment.unverified > .comment-content > .comment-text { opacity: 0.7 }
    .comment.is-spam > .comment-content { border: 1px solid red; } /* puede establecerse al guardar el comentario inicialmente */
    .comment.is-unapproved > .comment-content { border: 1px solid #ffa700; } /* puede establecerse al guardar el comentario inicialmente */
    ...
    .comment .commenter-name .label { font-size: 10px; text-transform: uppercase; font-weight: 500; color: #666666; } /* estilo común de etiquetas (etiqueta no verificada, etiqueta de administrador, etiquetas personalizadas, etc.) */
    .comment > .inner { position: relative; padding: 8px 8px 10px 8px; } /* relative es necesario para el mensaje bloqueado */
    ...
    .comment .prompt { position: absolute; top: -2px; left: 0; width: 100%; height: 100%; padding: 10px; box-sizing: border-box; background: rgba(255, 255, 255, 0.9); text-align: center } /* -2px para asegurar que cubra la flecha superior */
    ...
    @media(max-width: 500px) { .comment > .inner > .top-right { top: -10px; } } /* si top está demasiado bajo, se superpondrá al resaltado para acciones de administrador */
    ...
    @media(max-width: 500px) { .comment .menu { padding: 10px 5px 10px 0; } } /* si top está demasiado bajo, se superpondrá al resaltado para acciones de administrador */
