...
[inline-code-attrs-start title = 'Instalación del widget de Comentarios recientes'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Estructura HTML del widget de Comentarios recientes'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<div class="fc-rc2">
...
[inline-code-attrs-start title = 'CSS predeterminado del widget de Comentarios recientes'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
...
[inline-code-attrs-start title = 'Tamaño de avatar personalizado'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-avatar {
...
[inline-code-attrs-start title = 'Mostrar más líneas de comentario'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2-body {
...
[inline-code-attrs-start title = 'Quitar el borde del contenedor'; type = 'css'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
.fc-rc2 {
