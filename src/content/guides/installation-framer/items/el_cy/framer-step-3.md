...
[inline-code-attrs-start title = 'Απόσπασμα FastComments ειδικό για Framer (Σχόλια)'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Απόσπασμα FastComments ειδικό για Framer (Streaming Chat)'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
<div class="screenshot white-bg">
    <div class="title">Προεπισκόπηση του widget σχολίων</div>
    <img class="screenshot-image" src="/images/installation-guides/framer-step-3-paste.png" alt="Προεπισκόπηση του widget σχολίων" />
</div>
