...
Note that the summaries are cached for 30 seconds, or five minutes if there is a large number of reviews. Because of this, your review may not appear immediately in the summary, but this
allows us to reduce the cost of serving the summary widget.