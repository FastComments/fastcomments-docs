Możemy skonfigurować FastComments, aby powiadamiał Google Analytics 4, gdy ktoś wchodzi w interakcję z widżetem komentarzy.

Możemy śledzić, kiedy użytkownicy:

- Komentują.
- Głosują.

Oto przykładowy fragment kodu, aby to zrobić:
