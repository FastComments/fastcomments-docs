...
[inline-code-attrs-start title = 'Παράδειγμα κώδικα για Floating Likes'; type = 'html'; isFunctional = false; type = 'html';  inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Παράδειγμα κώδικα Floating Likes (Async)'; isFunctional = false; type = 'html';  inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Παράδειγμα κώδικα Floating Likes με Secure SSO'; type = 'html'; isFunctional = false; type = 'html';  inline-code-attrs-end]
[inline-code-start]
<script src="https://cdn.fastcomments.com/js/embed-page-likes-floating.min.js"></script>
<div id="fastcomments-page-likes-floating"></div>
<script>
...
[inline-code-attrs-start title = 'Παράδειγμα κώδικα Floating Likes με Simple SSO'; type = 'html'; isFunctional = false; type = 'html';  inline-code-attrs-end]
[inline-code-start]
<script src="https://cdn.fastcomments.com/js/embed-page-likes-floating.min.js"></script>
<div id="fastcomments-page-likes-floating"></div>
<script>
