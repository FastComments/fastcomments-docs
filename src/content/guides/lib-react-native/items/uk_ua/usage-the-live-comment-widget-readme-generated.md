API трохи відрізняється від `fastcomments-react`. У нативній версії ми передаємо об'єкт конфігурації, який відповідає [цій структурі](https://github.com/FastComments/fastcomments-typescript/blob/main/src/fast-comments-comment-widget-config.ts#L35).
