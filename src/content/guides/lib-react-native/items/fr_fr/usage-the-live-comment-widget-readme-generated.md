L'API est légèrement différente par rapport à `fastcomments-react`. Avec la version native, nous passons un objet de configuration qui suit [cette structure](https://github.com/FastComments/fastcomments-typescript/blob/main/src/fast-comments-comment-widget-config.ts#L35).
