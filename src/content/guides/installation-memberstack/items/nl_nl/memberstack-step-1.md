We kunnen FastComments eenvoudig verbinden met Memberstack met een klein codefragment:
...
**Ze kunnen ook reageren door hun naam en e-mail achter te laten, als ze niet zijn ingelogd.**

### Alleen-leden reacties

Als u **alleen-leden reacties** wilt hebben, probeer dan het volgende codefragment, maar verander `https://example.com/login` naar de plek waar u wilt dat gebruikers naartoe gaan wanneer ze op de `Login`-knop klikken:
