...
The example below is interactive (click Run in the top left) and allows you to add and swap comment threads on demand.
We can also remove them by calling `instance.destroy` instead of update.
        ...
        (function () {
            ...
            function addWidget({name, productID, productURL}) {
                ...
                window.FastCommentsUI(widgetTarget, {
                    "tenantId": tenantId,
                    "pageTitle": name, // for notification emails and the moderation dashboard
                    "url": productURL, // for notification emails and the moderation dashboard
                    "urlId": productID,
