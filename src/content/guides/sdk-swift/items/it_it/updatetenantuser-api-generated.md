...
[inline-code-attrs-start title = 'Esempio di updateTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = "updateComments_example" // String |  (opzionale)
