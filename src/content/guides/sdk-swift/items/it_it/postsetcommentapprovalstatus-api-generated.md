...
[inline-code-attrs-start title = 'Esempio di postSetCommentApprovalStatus'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let approved = true // Bool |  (opzionale)
