...
Restituisce: [`SaveComment200Response`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/SaveComment200Response.swift)

## Esempio

[inline-code-attrs-start title = 'Esempio di saveComment'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// I seguenti esempi di codice sono ancora in versione beta. Per qualsiasi problema, si prega di segnalare tramite http://github.com/OpenAPITools/openapi-generator/issues/new
...
let sendEmails = true // Bool |  (opzionale)
let populateNotifications = true // Bool |  (opzionale)
