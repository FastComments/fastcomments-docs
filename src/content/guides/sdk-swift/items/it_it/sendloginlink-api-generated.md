...
[inline-code-attrs-start title = 'Esempio di sendLoginLink'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let redirectURL = "redirectURL_example" // String |  (opzionale)
