...
Враћа: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)
...
let isLive = true // Bool |  (опциони)
let doSpamCheck = true // Bool |  (опциони)
let sendEmails = true // Bool |  (опциони)
let populateNotifications = true // Bool |  (опциони)
