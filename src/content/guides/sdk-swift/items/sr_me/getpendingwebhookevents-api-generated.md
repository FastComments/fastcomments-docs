...
[inline-code-start]
// Sljedeći primjeri koda su još u beta fazi. Za bilo koji problem, prijavite se na http://github.com/OpenAPITools/openapi-generator/issues/new
import FastCommentsSwift

let tenantId = "tenantId_example" // String | 
let commentId = "commentId_example" // String |  (nije obavezno)
let externalId = "externalId_example" // String |  (nije obavezno)
let eventType = "eventType_example" // String |  (nije obavezno)
let type = "type_example" // String |  (nije obavezno)
let domain = "domain_example" // String |  (nije obavezno)
let attemptCountGT = 987 // Double |  (nije obavezno)
let skip = 987 // Double |  (nije obavezno)
