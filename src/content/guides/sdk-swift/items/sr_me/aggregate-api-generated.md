---
Агрегира документе групишући их (ако је groupBy наведен) и примјењући више операција. Подржавају се различите операције (нпр. sum, countDistinct, avg, итд.).
...
[inline-code-attrs-start title = 'Примјер агрегације'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let parentTenantId = "parentTenantId_example" // String |  (опционално)
let includeStats = true // Bool |  (опционално)
