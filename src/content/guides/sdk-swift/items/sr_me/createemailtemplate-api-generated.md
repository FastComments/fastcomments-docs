...
Враћа: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateEmailTemplateResponse.swift)

## Пример

[inline-code-attrs-start title = 'createEmailTemplate Пример'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
