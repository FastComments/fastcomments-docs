...
Возвращает: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/AddPageAPIResponse.swift)

## Пример

[inline-code-attrs-start title = 'Пример addPage'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
