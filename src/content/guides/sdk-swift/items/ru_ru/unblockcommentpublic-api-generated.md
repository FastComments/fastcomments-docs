...
[inline-code-start]
// Следующие примеры кода всё ещё находятся в бета-версии. Если возникнут проблемы, сообщите об этом по адресу http://github.com/OpenAPITools/openapi-generator/issues/new
