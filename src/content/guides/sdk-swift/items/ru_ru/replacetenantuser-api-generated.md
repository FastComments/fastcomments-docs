...
[inline-code-attrs-start title = 'Пример replaceTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следующие примеры кода всё ещё находятся в бета-стадии. Если возникнут проблемы, пожалуйста, сообщите через http://github.com/OpenAPITools/openapi-generator/issues/new
...
let updateComments = "updateComments_example" // String |  (необязательно)
