...
[inline-code-attrs-start title = 'updateUserNotificationPageSubscriptionStatus Пример'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следующие примеры кода всё ещё находятся в бета-версии. О проблемах сообщайте через http://github.com/OpenAPITools/openapi-generator/issues/new
