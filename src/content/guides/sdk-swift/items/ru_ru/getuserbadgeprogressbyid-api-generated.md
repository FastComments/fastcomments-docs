...
[inline-code-start]
// Следующие примеры кода все ещё являются бета-версией. В случае проблем, пожалуйста, сообщите по адресу http://github.com/OpenAPITools/openapi-generator/issues/new
