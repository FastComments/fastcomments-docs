...
[inline-code-start]
// Следующие примеры кода всё ещё являются бета-версией. По любым проблемам, пожалуйста, сообщите через http://github.com/OpenAPITools/openapi-generator/issues/new
