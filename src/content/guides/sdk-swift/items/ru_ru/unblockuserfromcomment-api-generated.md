...
[inline-code-start]
// Следующий пример кода всё ещё находится в бета‑версии. При возникновении проблем, пожалуйста, сообщайте через http://github.com/OpenAPITools/openapi-generator/issues/new
