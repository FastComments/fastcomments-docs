...
[inline-code-attrs-start title = 'Przykład deleteTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let deleteComments = "deleteComments_example" // String |  (opcjonalne)
let commentDeleteMode = "commentDeleteMode_example" // String |  (opcjonalne)
