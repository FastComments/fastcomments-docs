...
Zwraca: [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/APISaveCommentResponse.swift)

## Przykład

[inline-code-attrs-start title = 'saveComment Przykład'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Poniższe przykłady kodu są nadal w wersji beta. W przypadku jakichkolwiek problemów, proszę zgłaszać je za pośrednictwem http://github.com/OpenAPITools/openapi-generator/issues/new
...
let isLive = true // Bool |  (opcjonalny)
let doSpamCheck = true // Bool |  (opcjonalny)
let sendEmails = true // Bool |  (opcjonalny)
let populateNotifications = true // Bool |  (opcjonalny)
