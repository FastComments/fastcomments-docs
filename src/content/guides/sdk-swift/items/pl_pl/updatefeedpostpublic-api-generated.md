...
Zwraca: [`CreateFeedPostResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateFeedPostResponse.swift)

## Przykład

[inline-code-attrs-start title = 'updateFeedPostPublic Przykład'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Następujące przykłady kodu są nadal w wersji beta. W razie problemów prosimy zgłosić je poprzez http://github.com/OpenAPITools/openapi-generator/issues/new
