...
Zwraca: [`[SaveComment200Response]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveComment200Response].swift)

## Przykład

[inline-code-attrs-start title = 'saveCommentsBulk Przykład'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Następujące przykłady kodu są nadal w wersji beta. W przypadku problemów prosimy zgłaszać na http://github.com/OpenAPITools/openapi-generator/issues/new
...
let doSpamCheck = true // Bool |  (opcjonalne)
let sendEmails = true // Bool |  (opcjonalne)
let populateNotifications = true // Bool |  (opcjonalne)
