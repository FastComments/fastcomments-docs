...
Zwraca: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## Przykład

[inline-code-attrs-start title = 'saveCommentsBulk Przykład'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Następujące przykłady kodu są wciąż w wersji beta. W razie problemów, prosimy zgłaszać je pod http://github.com/OpenAPITools/openapi-generator/issues/new
