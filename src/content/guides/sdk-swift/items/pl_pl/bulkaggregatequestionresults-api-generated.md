...
Zwraca: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/BulkAggregateQuestionResults200Response.swift)

## Przykład

[inline-code-attrs-start title = 'Przykład bulkAggregateQuestionResults'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Następujące przykłady kodu są nadal w wersji beta. Jeśli wystąpi problem, zgłoś go pod adresem http://github.com/OpenAPITools/openapi-generator/issues/new
