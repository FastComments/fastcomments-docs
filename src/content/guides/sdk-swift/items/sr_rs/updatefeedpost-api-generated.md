...
[inline-code-attrs-start title = 'Пример за updateFeedPost'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следећи примери кода су још у бета верзији. За било какав проблем, јавите га преко http://github.com/OpenAPITools/openapi-generator/issues/new
