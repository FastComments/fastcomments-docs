...
Враћа: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/PatchSSOUserAPIResponse.swift)

## Пример

[inline-code-attrs-start title = 'patchSSOUser Пример'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = true // Bool |  (опционално)
