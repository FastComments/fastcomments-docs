...
[inline-code-start]
// Следећи примери кода су још увек у бета фази. За било који проблем, молимо пријавите га преко http://github.com/OpenAPITools/openapi-generator/issues/new
import FastCommentsSwift

let tenantId = "tenantId_example" // String | 
let commentId = "commentId_example" // String |  (необавезно)
let externalId = "externalId_example" // String |  (необавезно)
let eventType = "eventType_example" // String |  (необавезно)
let type = "type_example" // String |  (необавезно)
let domain = "domain_example" // String |  (необавезно)
let attemptCountGT = 987 // Double |  (необавезно)
