...
let tenantId = "tenantId_example" // String |  (необавезно)
let deleteHashTagRequestBody = DeleteHashTagRequestBody(tenantId: "tenantId_example") // DeleteHashTagRequestBody |  (необавезно)
