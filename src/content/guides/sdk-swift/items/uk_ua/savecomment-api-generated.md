...
Повертає: [`SaveComment200Response`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/SaveComment200Response.swift)

## Приклад

[inline-code-attrs-start title = 'Приклад saveComment'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Наведені нижче приклади коду ще в бета-версії. Якщо виникнуть проблеми, будь ласка, повідомте через http://github.com/OpenAPITools/openapi-generator/issues/new
...
let doSpamCheck = true // Bool |  (необов'язково)
let sendEmails = true // Bool |  (необов'язково)
let populateNotifications = true // Bool |  (необов'язково)
