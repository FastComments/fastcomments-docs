...
[inline-code-start]
// Наступні зразки коду все ще у бета-версії. У разі будь-якої проблеми, будь ласка, повідомте за посиланням http://github.com/OpenAPITools/openapi-generator/issues/new
