...
[inline-code-attrs-start title = 'Приклад replaceTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Наведені приклади коду все ще перебувають у бета-версії. Для будь-яких проблем, будь ласка, повідомте через http://github.com/OpenAPITools/openapi-generator/issues/new
...
let updateComments = "updateComments_example" // String |  (необов'язковий)
