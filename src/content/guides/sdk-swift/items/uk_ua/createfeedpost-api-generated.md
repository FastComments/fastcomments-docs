...
[inline-code-start]
// Наступні зразки коду все ще в бета-версії. У разі проблем, будь ласка, повідомте за адресою http://github.com/OpenAPITools/openapi-generator/issues/new
...
let skipDupCheck = true // Bool |  (необов’язковий)
