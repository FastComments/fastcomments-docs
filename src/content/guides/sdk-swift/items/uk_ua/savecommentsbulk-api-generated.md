...
Повертає: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## Example

[inline-code-attrs-start title = 'saveCommentsBulk Приклад'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Наступні приклади коду ще бета. У разі проблем, будь ласка, повідомте за адресою http://github.com/OpenAPITools/openapi-generator/issues/new
...
let isLive = true // Bool | (опційно)
let doSpamCheck = true // Bool | (опційно)
let sendEmails = true // Bool | (опційно)
let populateNotifications = true // Bool | (опційно)
