...
[inline-code-start]
// Наступні приклади коду все ще знаходяться в бета-версії. У разі проблеми, будь ласка, повідомте через http://github.com/OpenAPITools/openapi-generator/issues/new
