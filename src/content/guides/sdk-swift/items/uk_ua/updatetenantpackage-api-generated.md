...
[inline-code-attrs-start title = 'Приклад updateTenantPackage'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Наведені приклади коду все ще в бета-версії. Якщо виникнуть проблеми, будь ласка, повідомте про них за адресою http://github.com/OpenAPITools/openapi-generator/issues/new
