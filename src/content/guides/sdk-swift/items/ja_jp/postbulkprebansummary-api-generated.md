...
戻り値: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/BulkPreBanSummary.swift)

## 例

[inline-code-attrs-start title = 'postBulkPreBanSummary の例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let includeByUserIdAndEmail = true // Bool |  (オプション)
let includeByIP = true // Bool |  (オプション)
let includeByEmailDomain = true // Bool |  (オプション)
