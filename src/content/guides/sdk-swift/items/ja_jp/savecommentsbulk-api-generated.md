...
戻り値: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)
...
let sendEmails = true // Bool |  （任意）
let populateNotifications = true // Bool |  （任意）
