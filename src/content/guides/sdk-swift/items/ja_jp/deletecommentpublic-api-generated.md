...
| tenantId | 文字列 | パス | はい |  |
| commentId | 文字列 | パス | はい |  |
| broadcastId | 文字列 | クエリ | はい |  |
| editKey | 文字列 | クエリ | いいえ |  |
| sso | 文字列 | クエリ | いいえ |  |

## 応答

返り値: [`PublicAPIDeleteCommentResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/PublicAPIDeleteCommentResponse.swift)
