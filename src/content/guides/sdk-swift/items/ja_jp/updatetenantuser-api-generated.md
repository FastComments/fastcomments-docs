...
[inline-code-attrs-start title = 'updateTenantUser の例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = "updateComments_example" // String |  (オプション)
