...
戻り値: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/PatchSSOUserAPIResponse.swift)

## 例

[inline-code-attrs-start title = 'patchSSOUser の例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = true // Bool |  (オプション)
