ドキュメントをグルーピングして（groupBy が提供されている場合）複数の操作を適用して集計します。sum、countDistinct、avg など、さまざまな操作がサポートされています。
...
戻り値: [`AggregateResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/AggregateResponse.swift)
