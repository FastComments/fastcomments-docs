...
let commentId = "commentId_example" // String |  (optional) -> // String |  (可選)
let externalId = "externalId_example" // String |  (optional) -> // String |  (可選)
let eventType = "eventType_example" // String |  (optional) -> // String |  (可選)
let type = "type_example" // String |  (optional) -> // String |  (可選)
let domain = "domain_example" // String |  (optional) -> // String |  (可選)
let attemptCountGT = 987 // Double |  (optional) -> // Double |  (可選)
