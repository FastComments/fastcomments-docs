...
| urlId | string | query | No | 用於判斷目前的頁面是否已訂閱。 |
...
[inline-code-attrs-start title = '取得使用者通知 範例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 以下程式碼範例仍屬測試階段。若有任何問題，請透過 http://github.com/OpenAPITools/openapi-generator/issues/new 回報
import FastCommentsSwift

let tenantId = "tenantId_example" // String | 
let urlId = "urlId_example" // String | 用於判斷目前的頁面是否已訂閱。 (optional)
