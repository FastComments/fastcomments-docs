...
回傳： [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## 範例

[inline-code-attrs-start title = 'saveCommentsBulk 範例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let doSpamCheck = true // Bool |  (可選)
let sendEmails = true // Bool |  (可選)
let populateNotifications = true // Bool |  (可選)
