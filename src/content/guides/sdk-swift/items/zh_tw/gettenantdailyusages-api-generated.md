...
回傳：[`GetTenantDailyUsagesResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/GetTenantDailyUsagesResponse.swift)
...
let yearNumber = 987 // Double |  （可選）
let monthNumber = 987 // Double |  （可選）
let dayNumber = 987 // Double |  （可選）
