...
Devuelve: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateFeedPostsResponse.swift)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de createFeedPost'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let skipDupCheck = true // Bool |  (opcional)
