...
Devuelve: [`CreateUserBadge200Response`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateUserBadge200Response.swift)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de createUserBadge'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Los siguientes ejemplos de código aún están en beta. Si ocurre algún problema, repórtelo en http://github.com/OpenAPITools/openapi-generator/issues/new
