...
[inline-code-attrs-start title = 'Ejemplo de replaceTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Los siguientes ejemplos de código todavía están en versión beta. Para cualquier problema, por favor repórtelo vía http://github.com/OpenAPITools/openapi-generator/issues/new
...
let updateComments = "updateComments_example" // String |  (opcional)
