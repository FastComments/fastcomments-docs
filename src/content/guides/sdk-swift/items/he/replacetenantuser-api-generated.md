...
[inline-code-attrs-start title = 'דוגמה ל-replaceTenantUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = "updateComments_example" // String |  (אופציונלי)
