...
[inline-code-attrs-start title = 'דוגמת updateTenant'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמאות הקוד שלהלן עדיין בבטא. עבור כל בעיה, אנא דווחו בכתובת http://github.com/OpenAPITools/openapi-generator/issues/new
