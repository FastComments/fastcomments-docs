...
[inline-code-attrs-start title = 'דוגמת deleteUserBadge'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דגימות הקוד הבאות עדיין בטא. עבור כל בעיה, נא דווח בכתובת http://github.com/OpenAPITools/openapi-generator/issues/new
