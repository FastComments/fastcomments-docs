...
[inline-code-attrs-start title = 'deleteTenantUser דוגמה'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let deleteComments = "deleteComments_example" // String |  (אופציונלי)
let commentDeleteMode = "commentDeleteMode_example" // String |  (אופציונלי)
