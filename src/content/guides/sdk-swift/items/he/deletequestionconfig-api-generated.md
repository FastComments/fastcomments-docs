...
[inline-code-attrs-start title = 'דוגמה ל־deleteQuestionConfig'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמיות הקוד הבאות עדיין בבטא. עבור כל תקלה, אנא דווח דרך http://github.com/OpenAPITools/openapi-generator/issues/new
