מאגד מסמכים על ידי קיבוץ שלהם (אם groupBy סופק) ויישום של מספר פעולות. תומכות פעולות שונות (למשל sum, countDistinct, avg וכו').
...
[inline-code-attrs-start title = 'דוגמה של אגירה'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
