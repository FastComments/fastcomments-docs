...
[inline-code-attrs-start title = 'postBanUserUndo דוגמה'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמיות הקוד הבאות עדיין בטא. לכל בעיה, בבקשה דווח דרך http://github.com/OpenAPITools/openapi-generator/issues/new
