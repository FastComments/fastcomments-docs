...
[inline-code-attrs-start title = 'דוגמת getCommentChildren'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמות הקוד הבאות עדיין בטא. לכל בעיה, אנא דווח באמצעות http://github.com/OpenAPITools/openapi-generator/issues/new
