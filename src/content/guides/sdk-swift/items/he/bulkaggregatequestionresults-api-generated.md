...
מחזיר: [`BulkAggregateQuestionResultsResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/BulkAggregateQuestionResultsResponse.swift)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-bulkAggregateQuestionResults'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמאות הקוד שלהלן עדיין בבטא. לכל בעיה, אנא דווחו באמצעות http://github.com/OpenAPITools/openapi-generator/issues/new
