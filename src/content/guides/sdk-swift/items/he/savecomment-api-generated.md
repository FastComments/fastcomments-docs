...
מחזיר: [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/APISaveCommentResponse.swift)

## דוגמה

[inline-code-attrs-start title = 'דוגמת saveComment'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דגימות הקוד הבאות עדיין בגרסת בטא. עבור כל בעיה, אנא דווח via http://github.com/OpenAPITools/openapi-generator/issues/new
