...
מחזיר: [`[SaveComment200Response]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveComment200Response].swift)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-saveCommentsBulk'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמאות הקוד שלהלן עדיין בבטא. במקרה של בעיה, דווחו דרך http://github.com/OpenAPITools/openapi-generator/issues/new
