...
[inline-code-attrs-start title = 'דוגמת updateFeedPost'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// דוגמאות הקוד הבאות עדיין בבטא. עבור כל תקלה, אנא דווח באמצעות http://github.com/OpenAPITools/openapi-generator/issues/new
