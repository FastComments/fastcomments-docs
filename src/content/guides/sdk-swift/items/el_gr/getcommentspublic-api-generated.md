...
[inline-code-start]
// Τα παρακάτω δείγματα κώδικα είναι ακόμη σε δοκιμαστική φάση. Για οποιοδήποτε πρόβλημα, παρακαλούμε αναφέρετέ το via http://github.com/OpenAPITools/openapi-generator/issues/new
