...
[inline-code-start]
// Οι ακόλουθες δειγματικές υλοποιήσεις κώδικα είναι ακόμη beta. Για οποιοδήποτε πρόβλημα, αναφέρετέ το μέσω http://github.com/OpenAPITools/openapi-generator/issues/new
