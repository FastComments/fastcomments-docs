...
[inline-code-start]
// Τα παρακάτω παραδείγματα κώδικα είναι ακόμα σε κατάσταση beta. Για οποιοδήποτε ζήτημα, παρακαλούμε αναφέλτε το μέσω http://github.com/OpenAPITools/openapi-generator/issues/new
