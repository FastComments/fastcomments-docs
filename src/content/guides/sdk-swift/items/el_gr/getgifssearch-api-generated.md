...
[inline-code-start]
// Τα παρακάτω δείγματα κώδικα είναι ακόμη beta. Για οποιοδήποτε πρόβλημα, παρακαλώ κάντε αναφορά μέσω http://github.com/OpenAPITools/openapi-generator/issues/new
