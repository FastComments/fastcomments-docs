...
[inline-code-attrs-start title = 'Παράδειγμα postSetCommentReviewStatus'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let reviewed = true // Bool |  (προαιρετικό)
