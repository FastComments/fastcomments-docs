...
[inline-code-start]
// Το παρακάτω δείγμα κώδικα είναι ακόμη σε έκδοση beta. Για οποιοδήποτε πρόβλημα, παρακαλούμε να το αναφέρετε μέσω http://github.com/OpenAPITools/openapi-generator/issues/new
