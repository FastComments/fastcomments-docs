...
Връща: [`GetTicketResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/GetTicketResponse.swift)

## Пример

[inline-code-attrs-start title = 'Пример за getTicket'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
