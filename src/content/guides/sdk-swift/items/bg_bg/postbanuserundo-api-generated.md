...
[inline-code-start]
// Следващите примерни кодове все още са бета. За каквито и да е проблем, моля съобщете чрез http://github.com/OpenAPITools/openapi-generator/issues/new
...
ModerationAPI.postBanUserUndo(tenantId: tenantId, banUserUndoParams: banUserUndoParams, sso: sss) { (response, error) in
