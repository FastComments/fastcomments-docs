...
[inline-code-attrs-start title = 'updateComment Пример'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следващите примерни кодове все още са в бета статус. За каквито и да е проблем, моля, съобщете чрез http://github.com/OpenAPITools/openapi-generator/issues/new
