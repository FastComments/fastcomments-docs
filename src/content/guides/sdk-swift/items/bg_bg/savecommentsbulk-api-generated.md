...
Връща: [`[SaveComment200Response]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveComment200Response].swift)

## Пример

[inline-code-attrs-start title = 'Пример за saveCommentsBulk'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следващите примери на код са все още в бета версия. За проблеми, моля докладвайте чрез http://github.com/OpenAPITools/openapi-generator/issues/new
