...
[inline-code-attrs-start title = 'Пример за postSetCommentReviewStatus'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let reviewed = true // Bool |  (не задължително)
let sso = "sso_example" // String |  (не задължително)
