...
Връща: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateFeedPostsResponse.swift)

## Пример

[inline-code-attrs-start title = 'Пример за createFeedPost'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Следните примери на код все още са в бета версия. За всеки проблем, моля докладвайте чрез http://github.com/OpenAPITools/openapi-generator/issues/new
...
let doSpamCheck = true // Bool |  (незадължително)
let skipDupCheck = true // Bool |  (незадължително)
