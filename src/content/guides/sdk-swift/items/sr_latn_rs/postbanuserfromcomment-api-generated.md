...
let banEmail = true // Bool |  (opciono)
let banEmailDomain = true // Bool |  (opciono)
let banIP = true // Bool |  (opciono)
let deleteAllUsersComments = true // Bool |  (opciono)
let bannedUntil = "bannedUntil_example" // String |  (opciono)
let isShadowBan = true // Bool |  (opciono)
let updateId = "updateId_example" // String |  (opciono)
let banReason = "banReason_example" // String |  (opciono)
