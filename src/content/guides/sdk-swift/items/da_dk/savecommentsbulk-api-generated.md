...
Returnerer: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## Eksempel

[inline-code-attrs-start title = 'saveCommentsBulk Eksempel'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let populateNotifications = true // Bool |  (valgfri)
