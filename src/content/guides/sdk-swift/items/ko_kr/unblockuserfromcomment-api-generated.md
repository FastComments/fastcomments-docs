...
반환: [`UnBlockCommentPublic200Response`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/UnBlockCommentPublic200Response.swift)

## 예제

[inline-code-attrs-start title = 'unBlockUserFromComment 예제'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let userId = "userId_example" // 문자열 |  (선택 사항)
let anonUserId = "anonUserId_example" // 문자열 |  (선택 사항)
