...
반환: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## 예시

[inline-code-attrs-start title = 'saveCommentsBulk 예시'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let doSpamCheck = true // Bool | (옵션)
let sendEmails = true // Bool | (옵션)
let populateNotifications = true // Bool | (옵션)
