...
- **Client Module** - FastComments REST API용 API 클라이언트
  ...
  - 인증된 (`DefaultAPI`), 공개 (`PublicAPI`), 및 모더레이션 (`ModerationAPI`) 메서드
  - 완전한 async/await 지원
  - 자세한 API 문서는 [client/README.md](https://github.com/FastComments/fastcomments-swift/blob/main/client/README.md)를 참조하세요
