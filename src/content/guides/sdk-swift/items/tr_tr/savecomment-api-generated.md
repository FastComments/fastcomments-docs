...
[inline-code-attrs-start title = 'saveComment Örneği'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Aşağıdaki kod örnekleri hâlâ beta durumdadır. Herhangi bir sorun olursa lütfen http://github.com/OpenAPITools/openapi-generator/issues/new adresinden bildirin
...
let sendEmails = true // Bool |  (isteğe bağlı)
let populateNotifications = true // Bool |  (isteğe bağlı)
