...
Döndürür: [`AwardUserBadgeResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/AwardUserBadgeResponse.swift)

## Örnek

[inline-code-attrs-start title = 'putAwardBadge Örneği'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let commentId = "commentId_example" // String |  (opsiyonel)
