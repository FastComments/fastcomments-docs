...
Döndürür: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)
...
let sendEmails = true // Bool | (opsiyonel)
let populateNotifications = true // Bool | (opsiyonel)
