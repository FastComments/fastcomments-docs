---
Belgeleri gruplayarak (groupBy sağlanmışsa) toplar ve birden çok işlem uygular. Farklı işlemler (ör. sum, countDistinct, avg, vb.) desteklenir.
...
Döndürür: [`AggregateResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/AggregateResponse.swift)
