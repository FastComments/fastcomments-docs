...
Retourne : [`APISaveCommentResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/APISaveCommentResponse.swift)

## Exemple

[inline-code-attrs-start title = 'Exemple de saveComment'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let sendEmails = true // Bool |  (facultatif)
let populateNotifications = true // Bool |  (facultatif)
