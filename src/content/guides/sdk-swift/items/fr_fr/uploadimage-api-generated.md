...
[inline-code-attrs-start title = 'uploadImage Exemple'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let urlId = "urlId_example" // String | Identifiant de la page depuis laquelle le téléversement a lieu, à configurer (optionnel)
