...
返回: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/PutSSOUserAPIResponse.swift)

## 示例

[inline-code-attrs-start title = 'putSSOUser 示例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let updateComments = true // Bool |  (可选)
