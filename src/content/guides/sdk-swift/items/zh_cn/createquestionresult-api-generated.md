...
返回: [`CreateQuestionResultResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/CreateQuestionResultResponse.swift)

## 示例

[inline-code-attrs-start title = 'createQuestionResult 示例'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
