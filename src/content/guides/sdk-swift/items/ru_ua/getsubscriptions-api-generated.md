...
Возвращает: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/GetSubscriptionsAPIResponse.swift)

## Пример

[inline-code-attrs-start title = 'Пример getSubscriptions'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
