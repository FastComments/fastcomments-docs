...
[inline-code-start]
// Следующие примеры кода по-прежнему находятся в бета-версии. По любым проблемам, пожалуйста, сообщите через http://github.com/OpenAPITools/openapi-generator/issues/new
