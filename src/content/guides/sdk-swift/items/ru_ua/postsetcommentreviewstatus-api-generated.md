...
[inline-code-attrs-start title = 'Пример postSetCommentReviewStatus'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let reviewed = true // Bool |  (необязательно)
