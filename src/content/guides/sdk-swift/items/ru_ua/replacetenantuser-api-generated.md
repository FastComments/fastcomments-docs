...
[inline-code-start]
// Приведённые примеры кода всё ещё находятся в бета‑версии. В случае проблем, пожалуйста, сообщите по адресу http://github.com/OpenAPITools/openapi-generator/issues/new
