...
| Ime | Tip | Lokacija | Oblobiten | Opis |
|------|------|----------|----------|-------------|
...
[inline-code-start]
// Naslednji primeri kode so še v beta fazi. Za kakršno koli težavo, prosimo, poročajte na http://github.com/OpenAPITools/openapi-generator/issues/new
