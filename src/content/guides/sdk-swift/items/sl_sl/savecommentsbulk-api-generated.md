...
Vrne: [`[SaveCommentsBulkResponse]`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/[SaveCommentsBulkResponse].swift)

## Primer

[inline-code-attrs-start title = 'Primer saveCommentsBulk'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Naslednji primeri kode so še v beta fazi. Za morebitne težave jih prosimo prijavite preko http://github.com/OpenAPITools/openapi-generator/issues/new
...
let isLive = true // Bool |  (izbirno)
let doSpamCheck = true // Bool |  (izbirno)
let sendEmails = true // Bool |  (izbirno)
let populateNotifications = true // Bool |  (izbirno)
