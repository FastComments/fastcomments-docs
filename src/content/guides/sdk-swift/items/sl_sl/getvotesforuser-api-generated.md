...
Vrne: [`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/GetVotesForUserResponse.swift)

## Example

[inline-code-attrs-start title = 'Primer getVotesForUser'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Naslednji primeri kode so še v beta različici. Za kakršnekoli težave, prosimo, poročajte preko http://github.com/OpenAPITools/openapi-generator/issues/new
