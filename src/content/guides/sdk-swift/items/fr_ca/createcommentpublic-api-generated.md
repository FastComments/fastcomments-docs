...
Retourne : [`SaveCommentsResponseWithPresence`](https://github.com/FastComments/fastcomments-swift/blob/main/client/FastCommentsSwift/Models/SaveCommentsResponseWithPresence.swift)

## Exemple

[inline-code-attrs-start title = 'Exemple createCommentPublic'; type = 'swift'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
let broadcastId = "broadcastId_example" // Chaîne | 
...
let sessionId = "sessionId_example" // Chaîne |  (facultatif)
let sso = "sso_example" // Chaîne |  (facultatif)
