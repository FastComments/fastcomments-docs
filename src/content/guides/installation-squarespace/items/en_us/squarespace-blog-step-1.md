Start by opening Pages on the left in the Editor:
...
At the bottom you should see `Blog` with a gear on the right. Click the gear to open the blog settings:
...
Next, go to `Advanced`, then `Post Blog Item Code Injection`:
