Τώρα μπορούμε να αντιγράψουμε το παρακάτω απόσπασμα κώδικα. Χρησιμοποιήστε το κουμπί αντιγραφής που εμφανίζεται στην επάνω δεξιά γωνία του αποσπάσματος.

Υπάρχουν μερικά πράγματα που μπορείτε να διαμορφώσετε στον κώδικα — δείτε τις γραμμές 4 έως 7.

[inline-code-attrs-start title = 'Κώδικας σχολίων για όλες τις σελίδες του Squarespace'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
