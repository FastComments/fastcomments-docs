...
В коде можно настроить несколько параметров — смотрите строки 4–7.
...
Если возникают проблемы, убедитесь, что внизу не указано `"tenantId": "demo"`. Там должен отображаться ваш tenant id, если вы вошли в систему. Если нет — обратитесь в поддержку.