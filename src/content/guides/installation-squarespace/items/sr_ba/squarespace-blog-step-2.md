...
[inline-code-attrs-start title = 'Squarespace код за коментаре на блогу'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
...затим налепите у поље за код и кликните сачувај:
