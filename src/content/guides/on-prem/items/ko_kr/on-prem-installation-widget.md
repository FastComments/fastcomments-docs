온프레미스용 프론트엔드 코드 스니펫과 라이브러리는 SaaS 제품과 동일합니다. 그러나 `apiHost`와 올바른 스크립트 경로를 지정해야 합니다:
...
위 예시는 매우 단순한 예입니다. 1st-party React, Angular, Vue, Svelte 등 라이브러리도 사용할 수 있습니다.