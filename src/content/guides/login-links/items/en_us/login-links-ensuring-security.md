Since the login links are essentially passwords, we take security very seriously.
...
guessed login links. Some login links are split into multiple passwords, and if one is guessed,
