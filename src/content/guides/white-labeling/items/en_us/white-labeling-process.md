...
1. Choose how billing will be handled.
   ...
   3. You set the limits for each tenant in both cases.
...
2. Familiarize yourself with the FastComments.com terminology:
...
3. Integrate with our [API](/guide-api.html) or use [scripts](https://github.com/FastComments/fastcomments-code-examples/tree/master/white-labeling) to onboard tenants.