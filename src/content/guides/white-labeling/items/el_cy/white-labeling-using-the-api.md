---
Για να χρησιμοποιήσουμε το API για να δημιουργήσουμε έναν white-labeled tenant, πρέπει να κάνουμε τα ακόλουθα:
...
5. Καλέστε το [Moderators API](/guide-api.html#moderator-structure) για να προσθέσετε και να καλέσετε moderators για τον tenant.
6. Προαιρετικά, [Setup SSO](/guide-customizations-and-configuration.html#sso).

Αυτό μπορεί όλα να γίνει μέσα στην περίοδο δοκιμής.
