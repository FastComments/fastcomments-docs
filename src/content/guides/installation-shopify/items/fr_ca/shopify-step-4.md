...
Copiez maintenant l'extrait de code suivant, qui est conçu **spécifiquement pour Shopify - n'utilisez pas les extraits de code d'autres tutoriels** :
...
Placez maintenant le curseur sur `line 101` - juste après la `</div>` - et collez. Vous devriez avoir quelque chose comme ceci :
