...
<div class="screenshot white-bg">
    <div class="title">Adicionar o código do FastComments</div>
    <img class="screenshot-image" src="/images/installation-guides/shopify-step-2-8-code-pasted.png" alt="Adicionar o código do FastComments" />
</div>
