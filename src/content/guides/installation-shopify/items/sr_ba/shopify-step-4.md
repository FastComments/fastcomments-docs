...
Сада копирајте сљедећи исјечак кода, који је дизајниран **специјално за Shopify - не користите исјечке кода из других туторијала**:
...
Сада желимо да поставимо курсор на `line 101` - одмах након `</div>` - и залепимо. Требало би да имате нешто овакво:
