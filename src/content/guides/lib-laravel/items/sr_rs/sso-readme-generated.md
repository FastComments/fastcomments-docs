...
API кључ је обавезан за secure SSO — користи се за потписивање SSO података.

### Мапирање засновано на конфигурацији
...
'sso' => [
    ...
    'user_map' => [
        ...
        'email' => 'email',
        'username' => 'name',
        'avatar' => 'profile.avatar_url', // подржана нотација тачкама
    ],
