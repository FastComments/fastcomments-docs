...
[app-screenshot-start url='/auth/my-account/manage-data/webhooks'; selector = '.content'; alt='Webhooks admin page with a domain selector and an endpoint URL field per comment event, plus Send Test Payload'; title='Webhooks Configuration'; cacheBuster = 'v3' app-screenshot-end]
