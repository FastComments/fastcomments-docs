...
Κάθε συμβάν περιλαμβάνει τα πλήρη δεδομένα του σχολίου στο σώμα του αιτήματος (δείτε τις [Δομές δεδομένων](/guide-webhooks.html#webhooks-structures) για το μορφότυπο του payload).
