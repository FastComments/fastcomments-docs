...
Chaque événement inclut l'intégralité des données du commentaire dans le corps de la requête (voir [Structures de données](/guide-webhooks.html#webhooks-structures) pour le format de la charge utile).