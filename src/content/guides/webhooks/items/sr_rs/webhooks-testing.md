...
Сваки догађај укључује целокупне податке коментара у телу захтева (погледајте [Структуре података](/guide-webhooks.html#webhooks-structures) за формат података).
