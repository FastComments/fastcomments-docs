...
Κάθε συμβάν περιλαμβάνει τα πλήρη δεδομένα του σχολίου στο σώμα του αιτήματος (βλέπε [Δομές Δεδομένων](/guide-webhooks.html#webhooks-structures) για τη μορφή του payload).