...
Каждое событие включает полные данные комментария в теле запроса (см. [Структуры данных](/guide-webhooks.html#webhooks-structures) для формата полезной нагрузки).
