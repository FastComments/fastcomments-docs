...
개발 중에 들어오는 웹훅 페이로드를 검사하려면 [webhook.site](https://webhook.site) 또는 [ngrok](https://ngrok.com) 같은 도구를 사용할 수 있습니다.
...
각 이벤트는 요청 본문에 전체 댓글 데이터를 포함합니다 (페이로드 형식은 [데이터 구조](/guide-webhooks.html#webhooks-structures)를 참조하세요).
