...
| `fastcomments_comment_count` | Nombre de commentaires pour la page actuelle |
| `fastcomments_comment_count_bulk` | Nombre de commentaires pour plusieurs pages sur une liste/page d'index |
...
| `fastcomments_recent_comments` | Commentaires récents sur tout le site |
...
| `fastcomments_user_activity_feed` | Flux d'activité par utilisateur |
