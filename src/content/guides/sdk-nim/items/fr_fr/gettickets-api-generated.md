...
Renvoie : [`Option[GetTicketsResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_get_tickets_response.nim)
...
if ticketsOpt.isSome:
  ...
  # utilisez les tickets selon vos besoins
[inline-code-end]