...
|------|------|----------|-------------|
| tenantId | string | כן |  |
| createAPIPageData | CreateAPIPageData | לא |  |

## תגובה

מחזיר: [`Option[AddPageAPIResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_add_page_api_response.nim)

## דוגמה

[inline-code-attrs-start title = 'דוגמת addPage'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
