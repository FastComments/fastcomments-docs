...
| tenantId | string | כן |  |
| userId | string | לא |  |
| createTicketBody | CreateTicketBody | לא |  |

## תגובה

מחזיר: [`Option[CreateTicket_200_response]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_create_ticket200response.nim)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-createTicket'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
