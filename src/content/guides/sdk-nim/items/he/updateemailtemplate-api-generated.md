...
| tenantId | string | כן |  |
| id | string | לא |  |
| updateEmailTemplateBody | UpdateEmailTemplateBody | לא |  |
...
[inline-code-attrs-start title = 'דוגמה ל-updateEmailTemplate'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
