...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Συγκεντρώνει έγγραφα ομαδοποιώντας τα (εάν παρέχεται το groupBy) και εφαρμόζοντας πολλαπλές λειτουργίες. Υποστηρίζονται διαφορετικές λειτουργίες (π.χ. sum, countDistinct, avg κ.λπ.). |
...
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Παλιότεροι σχολιαστές στη σελίδα που ΔΕΝ είναι αυτή τη στιγμή σε σύνδεση. Ταξινομημένα κατά displayName. Χρησιμοποιήστε το μετά την εξάντληση του /users/online για να εμφανίσετε μια ενότητα \"Μέλη\". Σελιδοποίηση με κέρσορα στο commenterName: ο διακομιστής περνά το μερικό ευρετήριο {tenantId, urlId, commenterName} από το afterName προς τα εμπρός μέσω $gt, χωρίς κόστος $skip. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Παρόχοι προβολής που είναι αυτή τη στιγμή σε σύνδεση σε μια σελίδα: άτομα των οποίων η συνεδρία websocket είναι εγγεγραμμένη στη σελίδα αυτή τη στιγμή. Επιστρέφει anonCount + totalCount (συνδρομητές ολόκληρου του δωματίου, συμπεριλαμβανομένων ανώνυμων θεατών που δεν απαριθμούμε). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Λίστα σελίδων για ένα ενοικιαστή. Χρησιμοποιείται από τον πελάτη επιφάνειας εργασίας FChat για να γεμίσει τη λίστα δωματίων του. Απαιτεί `enableFChat` να είναι true στη λύση του προσαρμοσμένου config για κάθε σελίδα. Σελίδες που απαιτούν SSO φιλτράρονται βάσει της πρόσβασης ομάδας του χρήστη που κάνει το αίτημα. |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Ανέβασμα και αλλαγή μεγέθους εικόνας |
...
## Τεκμηρίωση για τα Μοντέλα
 ...
 - [BulkAggregateQuestionResultsResponse](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Models/BulkAggregateQuestionResults