...
| tenantId | string | Ναι |  |
| id | string | Όχι |  |
| options | UnFlagCommentOptions | Όχι |  |

## Απάντηση

Επιστρέφει: [`Option[FlagCommentResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_flag_comment_response.nim)
