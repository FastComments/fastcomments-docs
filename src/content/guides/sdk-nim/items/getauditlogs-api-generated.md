...
[inline-code-start]
let (response, httpResponse) = client.getAuditLogs(tenantId = "my-tenant-123", limit = 100.0, skip = 0.0, order = SORTDIR.DESC, after = 0.0, before = 0.0)
if response.isSome:
  let audit = response.get()
  echo "Received audit logs"
else:
