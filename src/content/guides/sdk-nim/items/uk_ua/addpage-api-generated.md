...
Повертає: [`Option[AddPageAPIResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_add_page_api_response.nim)

## Приклад

[inline-code-attrs-start title = 'Приклад addPage'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
