...
|------|------|-------------|-------------|
| tenantId | string | Oui |  |
| options | GetApiIdsOptions | Non |  |

## Réponse

Retourne : [`Option[ModerationAPIGetCommentIdsResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_moderation_api_get_comment_ids_response.nim)
