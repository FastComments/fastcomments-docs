...
|------|------|----------|-------------|
| tenantId | string | Oui |  |
| options | CombineCommentsWithQuestionResultsOptions | Non |  |
...
[inline-code-attrs-start title = 'combineCommentsWithQuestionResults Exemple'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
