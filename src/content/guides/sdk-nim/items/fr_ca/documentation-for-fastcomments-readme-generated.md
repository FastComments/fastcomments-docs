...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agrège les documents en les groupant (si groupBy est fourni) et en appliquant plusieurs opérations. Différentes opérations (ex. somme, countDistinct, moyenne, etc.) sont prises en charge. |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Télécharger et redimensionner une image |
...
## Documentation des modèles
 ...
 - [LiveEvent](https://github.com/FastComments/fastcomments-nim/blob/master