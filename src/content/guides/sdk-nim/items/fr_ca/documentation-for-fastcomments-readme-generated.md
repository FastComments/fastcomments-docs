...
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Visionneurs actuellement en ligne sur une page : personnes dont la session websocket est abonnée à la page présentement. Retourne anonCount + totalCount (abonnés à la salle incluant les visiteurs anonymes qui ne sont pas énumérés). |
