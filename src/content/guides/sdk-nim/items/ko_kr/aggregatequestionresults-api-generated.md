...
|------|------|----------|-------------|
| tenantId | string | 예 |  |
| options | AggregateQuestionResultsOptions | 아니오 |  |
...
[inline-code-attrs-start title = 'aggregateQuestionResults 예시'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
