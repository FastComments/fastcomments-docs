...
| tenantId | string | 예 |  |
| commentId | string | 예 |  |
| options | PostBanUserFromCommentOptions | 아니오 |  |

## Response

반환값: [`Option[BanUserFromCommentResult]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_ban_user_from_comment_result.nim)
