...
| tenantId | string | 예 |  |
| id | string | 아니요 |  |
| updateNotificationBody | UpdateNotificationBody | 아니요 |  |
| userId | string | 아니요 |  |
...
[inline-code-attrs-start title = 'updateNotification 예제'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
