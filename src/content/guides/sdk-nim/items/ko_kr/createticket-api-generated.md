...
| tenantId | string | 예 |  |
| userId | string | 아니요 |  |
| createTicketBody | CreateTicketBody | 아니요 |  |

## 응답

반환: [`Option[CreateTicket_200_response]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_create_ticket200response.nim)
