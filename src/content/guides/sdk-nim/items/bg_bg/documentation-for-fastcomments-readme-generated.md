...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Обединява документи, като ги групира (ако е предоставено groupBy) и прилага множество операции. Поддържат се различни операции (например sum, countDistinct, avg и др.). |
...
## Документация за модели
 ...
 - [CreateSubscriptionAPIResponse](https://github.com/F