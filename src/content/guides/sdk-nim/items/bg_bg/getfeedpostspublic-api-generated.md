...
|------|------|----------|-------------|
| tenantId | string | Да |  |
| options | GetFeedPostsPublicOptions | Не |  |

## Отговор

Връща: [`Option[PublicFeedPostsResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_public_feed_posts_response.nim)
