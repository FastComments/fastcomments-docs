...
Връща: [`Option[AddPageAPIResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_add_page_api_response.nim)

## Пример

[inline-code-attrs-start title = 'Пример за addPage'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
