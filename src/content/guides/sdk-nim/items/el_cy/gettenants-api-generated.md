...
|------|------|------------|-----------|
| tenantId | string | Ναι |  |
| options | GetTenantsOptions | Όχι |  |

## Απόκριση

Επιστρέφει: [`Option[GetTenantsResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_get_tenants_response.nim)
