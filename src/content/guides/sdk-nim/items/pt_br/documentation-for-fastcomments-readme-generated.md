...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agrupa documentos agrupando-os (se [inline-code-start]groupBy[inline-code-end] for fornecido) e aplicando várias operações. Diferentes operações (ex: sum, countDistinct, avg, etc.) são suportadas. |
