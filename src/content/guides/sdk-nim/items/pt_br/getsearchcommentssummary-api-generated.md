...
|------|------|-------------|-----------|
| tenantId | string | Sim |  |
| options | GetSearchCommentsSummaryOptions | Não |  |
...
[inline-code-attrs-start title = 'getSearchCommentsSummary Exemplo'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
