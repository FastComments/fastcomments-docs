...
|------|------|-------------|-----------|
| tenantId | string | Sim |  |
| options | CombineCommentsWithQuestionResultsOptions | Não |  |
...
[inline-code-attrs-start title = 'combineCommentsWithQuestionResults Exemplo'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
