...
Svi URI su relativni na *https://fastcomments.com*
...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agregira dokumente grupisanjem (ako je naveden groupBy) i primjenom više operacija. Podržane su različite operacije (npr. sum, countDistinct, avg, itd.). |
...
## Dokumentacija za modele
 ...
 - [APIModerateGetUserBanPreferencesResponse](https://github.com/Fast