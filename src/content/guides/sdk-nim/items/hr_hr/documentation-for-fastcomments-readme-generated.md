...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Grupira dokumente (ako je naveden groupBy) i primjenjuje više radnji. Podržane su različite radnje (npr. suma, jedinstveno brojanje, prosjek itd.). |
...
*DefaultApi* | [**getFeedPosts**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#getFeedPosts) | **GET** /api/v1/feed-posts |  obavezno tenantId afterId |
...
*PublicApi* | [**getCommentsPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getCommentsPublic) | **GET** /comments/{tenantId} |  obavezno tenantId urlId |
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  obavezno tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  obavezno tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  obavezno tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Prijašnji komentatori na stranici KOJI TRENUTNO NISU online. Poredano po displayName. Koristite nakon što iscrpite /users/online za prikaz odjeljka \"Članovi\". Kursor paginacija po commenterName: server prolazi kroz djelomični {tenantId, urlId, commenterName} indeks od afterName unaprijed, bez $skip troška. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Trenutno online gledatelji stranice: osobe koje su sa svojom websocket sesijom pretplaćene na stranicu sada. Vraća anonCount + totalCount (pretplaćeni na sobu, uključujući anonimne gledatelje koje ne navodimo pojedinačno). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Prikaz popisa stranica za najmoprimca. Koristi ga FChat desktop klijent za punjenje popisa soba. Zahtijeva da je `enableFChat` postavljeno na true u prilagođenoj konfiguraciji svake stranice. Stranice koje zahtijevaju SSO se filtriraju na temelju pristupa korisničke grupe. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Grupirane informacije o korisnicima za najmoprimca. Za zadane userIds, vraća prikazane informacije iz User / SSOUser objekta. Koristi widget za komentare radi obogaćivanja korisnika koji su se upravo pojavili kroz događaj prisutnosti. Nema konteksta stranice: privatnost je uvijek osigurana (privatni profili su maskirani). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | Omogući ili onemogući obavijesti za određeni komentar. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | Omogući ili onemogući obavijesti za stranicu. Kada su korisnici pretplaćeni na stranicu, obavijesti se kreiraju za nove korijenske komentare, kao i |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Prenesi i promijeni veličinu slike |
...
## Dokumentacija za modele
 ...
 - [DeleteSubscriptionAPIResponse](https://github.com/FastComments/fastcomments-nim