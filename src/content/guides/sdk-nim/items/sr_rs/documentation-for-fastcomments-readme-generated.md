...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегира документе груписањем (ако је наведен groupBy) и примењивањем више операција. Подржане су различите операције (нпр. sum, countDistinct, avg, итд.). |
...
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Претходни коментатори на страници који **НИСУ** тренутно онлајн. Сортирано према displayName. Користите ово након што исцрпите /users/online за приказ секције „Members”. Курсорска пагинација на commenterName: сервер пролази парцијални {tenantId, urlId, commenterName} индекс након afterName помоћу $gt, без $skip трошка. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Тренутно онлајн прегледачи странице: људи чија вебсоцкет сесија је тренутно претплаћена на страницу. Враћа anonCount + totalCount (сви претплатници у просторији, укључујући анонимне прегледаче које не наводимо). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Листа страница за tenant. Користи се од стране FChat десктоп клијента за попуњавање листе соба. Захтева да `enableFChat` буде true у решеном прилагођеном конфигу за сваку страницу. Странице које захтевају SSO су филтриране у складу са приступом групе корисника који захтева. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Масовни кориснички подаци за tenant. На основу userIds, враћа приказне податке из User / SSOUser. Користи се од стране widget-а за коментаре да обогати кориснике који се управо појаве преко presence догађаја. Без контекста странице: приватност се примењује уједначено (приватни профили су маскирани). |
...
*PublicApi* | [**updateUserNotificationCommentSubscriptionStatus**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#updateUserNotificationCommentSubscriptionStatus) | **POST** /user-notifications/{notificationId}/mark-opted/{optedInOrOut} | Омогућава или онемогућава обавештења за конкретан коментар. |
*PublicApi* | [**updateUserNotificationPageSubscriptionStatus**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#updateUserNotificationPageSubscriptionStatus) | **POST** /user-notifications/set-subscription-state/{subscribedOrUnsubscribed} | Омогућава или онемогућава обавештења за страницу. Када су корисници претплаћени на страницу, генеришу се обавештења за нове root коментаре, и такође |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Постављање и мењање величине слике |
...
## Документација за моделе
 ...
 - [CreateQuestionConfigResponse](https://github.com/F