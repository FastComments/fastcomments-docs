...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегира документе груписањем (ако је groupBy обезбеђен) и применом више операција. Подржане су разне операције (нпр. sum, countDistinct, avg, итд.). |
...
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Корисници који су раније коментарисали на страници и ТРЕНУТНО нису онлајн. Сортирано по displayName. Користите након што исцрпите /users/online за приказ секције „Чланови”. Курсор пагинација по commenterName: сервер пролази кроз делимични индекс {tenantId, urlId, commenterName} од afterName надаље преко $gt, нема $skip трошка. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Тренутно онлајн посетиоци странице: људи чија је websocket сесија тренутно претплаћена на страницу. Враћа anonCount + totalCount (претплатници собе, укључујући анонимне које не набрајамо). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Приказује листу страница за један изнајмљивач (tenant). Користи га FChat десктоп клијент да попуни своју листу соба. Захтева да је `enableFChat` подешен на true у прилагођеној конфигурацији за сваку страницу. Странице које захтевају SSO се филтрирају на основу приступа групи корисника који шаље захтев. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Вишекорисничке информације за један изнајмљивач (tenant). Даје userId листу, враћа информације за приказ из User / SSOUser. Користи се за обогаћивање корисника који се појаве преко догађаја присуства у виџету за коментаре. Нема контекста странице: приватност се примењује увек исто (приватни профили су скривени). |
...
## Документација за моделе
 ...
 - [DeleteHashTagRequestBody](https://github.com/FastComments/fastcomments-nim/blob/master/docs