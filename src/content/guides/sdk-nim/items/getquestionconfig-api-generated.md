...
[inline-code-start]
let (response, httpResponse) = client.getQuestionConfig(tenantId = "my-tenant-123", id = "question-42")
if response.isSome:
  let config = response.get()
  echo "Received question config for tenant my-tenant-123:", config
else:
  echo "No question config returned"
[inline-code-end]
