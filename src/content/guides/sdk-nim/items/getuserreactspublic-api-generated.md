...
[inline-code-start]
let (response, httpResponse) = client.getUserReactsPublic(tenantId = "my-tenant-123", postIds = @["news/the-latest-2026", "blog/how-to-code"], sso = "")
if response.isSome:
  let reacts = response.get()
  echo "Reacts received:", reacts
else:
