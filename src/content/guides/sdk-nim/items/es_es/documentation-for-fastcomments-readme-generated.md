...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agrega documentos agrupándolos (si se proporciona groupBy) y aplicando múltiples operaciones. Se soportan diferentes operaciones (por ejemplo, sum, countDistinct, avg, etc.). |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Subir y redimensionar una imagen |
