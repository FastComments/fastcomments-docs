...
|------|------|--------------|--------------|
| tenantId | string | Ja |  |
| options | GetTenantDailyUsagesOptions | Nein |  |

## Antwort

Rückgabe: [`Option[GetTenantDailyUsagesResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_get_tenant_daily_usages_response.nim)
