...
| *DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Aggregiert Dokumente, indem sie nach Gruppen zusammengefasst werden (wenn groupBy angegeben ist) und mehrere Operationen angewendet werden. Unterschiedliche Operationen (z. B. sum, countDistinct, avg usw.) werden unterstützt. |
...
| *PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Ein Bild hochladen und skalieren |
