...
| tenantId | string | Ja |  |
| commentId | string | Ja |  |
| options | GetModerationCommentOptions | Nein |  |

## Antwort

Rückgabe: [`Option[ModerationAPICommentResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_moderation_api_comment_response.nim)
