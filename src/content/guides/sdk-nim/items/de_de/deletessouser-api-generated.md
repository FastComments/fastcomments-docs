...
| tenantId | string | Ja |  |
| id | string | Nein |  |
| options | DeleteSSOUserOptions | Nein |  |

## Antwort

Rückgabe: [`Option[DeleteSSOUserAPIResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_delete_sso_user_api_response.nim)
