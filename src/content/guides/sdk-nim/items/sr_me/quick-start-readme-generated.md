...
1. **401 грешка аутентификације**: Уверите се да сте поставили заглавље `x-api-key` на вашем HttpClient пре него што пошаљете DefaultAPI захтеве: `client.headers["x-api-key"] = "your-api-key"`
