...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agregira dokumente grupišući ih (ako je naveden groupBy) i primenjujući više operacija. Podržane su različite operacije (npr. sum, countDistinct, avg, itd.). |
...
## Dokumentacija za modele
 ...
 - [BulkPreBanSummary](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Models