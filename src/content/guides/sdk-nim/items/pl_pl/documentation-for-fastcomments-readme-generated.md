...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Agreguje dokumenty poprzez ich grupowanie (jeśli groupBy jest podany) i zastosowanie wielu operacji. Obsługiwane są różne operacje (np. sum, countDistinct, avg itp.). |
...
*PublicApi* | [**uploadImage**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#uploadImage) | **POST** /upload-image/{tenantId} | Prześlij i zmień rozmiar obrazu |
