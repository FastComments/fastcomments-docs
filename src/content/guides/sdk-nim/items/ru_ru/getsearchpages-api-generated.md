...
|------|------|-------------|----------|
| tenantId | string | Да |  |
| options | GetSearchPagesOptions | Нет |  |

## Ответ

Возвращает: [`Option[ModerationPageSearchResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_moderation_page_search_response.nim)
