...
| tenantId | string | Да |  |
| commentId | string | Да |  |
| options | PostRestoreDeletedCommentOptions | Нет |  |
...
[inline-code-attrs-start title = 'Пример postRestoreDeletedComment'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
