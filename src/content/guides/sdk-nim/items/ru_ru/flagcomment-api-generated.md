...
| tenantId | string | Да |  |
| id | string | Нет |  |
| options | FlagCommentOptions | Нет |  |

## Ответ

Возвращает: [`Option[FlagCommentResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_flag_comment_response.nim)
