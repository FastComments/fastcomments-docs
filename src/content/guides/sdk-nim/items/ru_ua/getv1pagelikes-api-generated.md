...
Возвращает: [`Option[GetV1PageLikes]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_get_v1_page_likes.nim)
...
if response.isSome:
  ...
  # использовать pageLikes по мере необходимости
[inline-code-end]