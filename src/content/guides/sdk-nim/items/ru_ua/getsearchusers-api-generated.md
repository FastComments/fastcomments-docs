...
|------|------|----------|-------------|
| tenantId | string | Да |  |
| options | GetSearchUsersOptions | Нет |  |

## Ответ

Возвращает: [`Option[ModerationUserSearchResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_moderation_user_search_response.nim)
