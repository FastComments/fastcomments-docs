...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Агрегирует документы, группируя их (если указано groupBy) и применяя несколько операций. Поддерживаются различные операции (например, sum, countDistinct, avg и т.д.). |
...
## Документация по моделям
 ...
 - [CommentLogData](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Models/CommentLogData