...
Возвращает: [`Option[PatchSSOUserAPIResponse]`](https://github.com/FastComments/fastcomments-nim/blob/master/client/fastcomments/models/model_patch_sso_user_api_response.nim)

## Пример

[inline-code-attrs-start title = 'Пример patchSSOUser'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
