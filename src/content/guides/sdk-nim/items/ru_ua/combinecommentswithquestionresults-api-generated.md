...
|------|------|--------------|------|
| tenantId | string | Так |  |
| options | CombineCommentsWithQuestionResultsOptions | Ні |  |
...
[inline-code-attrs-start title = 'combineCommentsWithQuestionResults Приклад'; type = 'nim'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
