...
*DefaultApi* | [**aggregate**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/DefaultApi.md#aggregate) | **POST** /api/v1/aggregate | Aggregira dokumente grupišući ih (ako je obezbeđen groupBy) i primenjujući više operacija. Podržane su različite operacije (npr. sum, countDistinct, avg, itd.). |
...
*PublicApi* | [**getEventLog**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getEventLog) | **GET** /event-log/{tenantId} |  zahtev tenantId urlId userIdWS |
*PublicApi* | [**getFeedPostsPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getFeedPostsPublic) | **GET** /feed-posts/{tenantId} |  zahtev tenantId afterId |
...
*PublicApi* | [**getGlobalEventLog**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getGlobalEventLog) | **GET** /event-log/global/{tenantId} |  zahtev tenantId urlId userIdWS |
*PublicApi* | [**getOfflineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOfflineUsers) | **GET** /pages/{tenantId}/users/offline | Prethodni komentatori na stranici koji NISU trenutno online. Sortirani po displayName. Koristite ovo nakon što iscrpite /users/online da prikažete sekciju „Members“. Paginacija kursora po commenterName: server prolazi kroz parcijalni indeks {tenantId, urlId, commenterName} od afterName napred kroz $gt, bez troška $skip. |
*PublicApi* | [**getOnlineUsers**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getOnlineUsers) | **GET** /pages/{tenantId}/users/online | Trenutno online posetioci stranice: korisnici čija je websocket sesija trenutno pretplaćena na stranicu. Vraća anonCount + totalCount (pretplatnici u celom sobi, uključujući anonimne posetioce koje ne nabrajamo). |
*PublicApi* | [**getPagesPublic**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getPagesPublic) | **GET** /pages/{tenantId} | Lista stranica za tenant. Koristi FChat desktop klijent za popunjavanje spiska soba. Zahteva da `enableFChat` bude postavljen na true u razrešenoj prilagođenoj konfiguraciji za svaku stranicu. Stranice koje zahtevaju SSO su filtrirane prema grupnom pristupu korisnika koji zahteva. |
...
*PublicApi* | [**getUsersInfo**](https://github.com/FastComments/fastcomments-nim/blob/master/docs/Apis/PublicApi.md#getUsersInfo) | **GET** /pages/{tenantId}/users/info | Grupni podaci o korisnicima za tenant. Na osnovu userIds, vraća prikazne informacije iz User / SSOUser. Koristi se od strane widgeta za komentare kako bi obogatio korisnike koji su se upravo pojavili putem događaja prisustva. Nema kontekst stranice: privatnost se primenjuje uniformno (privatni profili su maskirani). |
...
## Dokumentacija za modele
 ...
 - [AggregationRequest](https://github.com/FastComments/fastcomments-nim/blob