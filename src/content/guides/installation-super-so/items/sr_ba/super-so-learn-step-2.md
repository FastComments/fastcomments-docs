...
<script>
    (function () {
        ...
        // Провјеравај на сваких 500мс за промјене
        setInterval(() => {
            // Поново учитај ако се pathname промијени
            ...
            // Поново учитај ако је контејнер празан
            const target = document.querySelector('.super-content');
...
<div class="screenshot white-bg">
    <div class="title">Залепљени код</div>
    <img class="screenshot-image" src="/images/installation-guides/super-so-step-3-pasted-code.png" alt="Залепљени код" />
</div>
