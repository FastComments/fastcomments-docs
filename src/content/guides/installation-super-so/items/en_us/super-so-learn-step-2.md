In this next step, copy the pre-made widget code below.

As long as you're logged in to FastComments.com, the code snippet below will already contain your account information. Copy it:
...
Now paste it into the `Body` area:
...
- Make sure you're logged in to your fastcomments.com account.
- Make sure third-party cookies are enabled.
- Refresh this page and copy the code snippet again. It should have `tenantId` populated with your tenant's identifier.
