...
返回: [`GetPendingWebhookEventCountResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_pending_webhook_event_count_response.rs)

## 示例

[inline-code-attrs-start title = '获取待处理 webhook 事件计数 示例'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
