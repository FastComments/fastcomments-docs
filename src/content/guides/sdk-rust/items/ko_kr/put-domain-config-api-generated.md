...
| update_domain_config_params | models::UpdateDomainConfigParams | 예 |  |

## 응답

반환: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/put_domain_config_response.rs)

## 예제

[inline-code-attrs-start title = 'put_domain_config 예제'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
