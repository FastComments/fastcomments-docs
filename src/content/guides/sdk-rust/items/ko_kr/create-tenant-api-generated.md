...
|------|------|----------|-------------|
| tenant_id | String | 예 |  |
| create_tenant_body | models::CreateTenantBody | 예 |  |

## 응답

반환: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/create_tenant_200_response.rs)

## 예제

[inline-code-attrs-start title = 'create_tenant 예제'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
