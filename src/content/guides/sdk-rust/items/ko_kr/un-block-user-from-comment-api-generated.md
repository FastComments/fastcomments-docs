...
| tenant_id | String | 예 |  |
| id | String | 예 |  |
| un_block_from_comment_params | models::UnBlockFromCommentParams | 예 |  |
| user_id | String | 아니오 |  |
| anon_user_id | String | 아니오 |  |

## 응답

반환: [`UnBlockCommentPublic200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/un_block_comment_public_200_response.rs)
