...
|------|------|----------|-------------|
| tenant_id | String | 예 |  |
| create_question_result_body | models::CreateQuestionResultBody | 예 |  |

## 응답

반환: [`CreateQuestionResult200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/create_question_result_200_response.rs)

## 예제

[inline-code-attrs-start title = 'create_question_result 예제'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
