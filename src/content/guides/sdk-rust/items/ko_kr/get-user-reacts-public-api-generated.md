...
|------|------|----------|-------------|
| tenant_id | String | 예 |  |
| post_ids | Vec<String> | 아니요 |  |
| sso | String | 아니요 |  |

## 응답

반환: [`GetUserReactsPublic200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_user_reacts_public_200_response.rs)

## 예제

[inline-code-attrs-start title = 'get_user_reacts_public 예제'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
