...
| replies_to_user_id | String | Nein |  |
| page | f64 | Nein |  |
...
Gibt zurück: [`GetCommentsForUserResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_comments_for_user_response.rs)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für get_comments_for_user'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
