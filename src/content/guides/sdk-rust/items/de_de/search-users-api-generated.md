...
| mention_group_ids | Vec<String> | Nein |  |
| sso | String | Nein |  |
| search_section | String | Nein |  |

## Antwort

Gibt zurück: [`SearchUsers200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/search_users_200_response.rs)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für search_users'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
