...
Возвращает: [`ApiCreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/api_create_user_badge_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример create_user_badge'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
