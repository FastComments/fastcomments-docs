...
Возвращает: [`PatchPageApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/patch_page_api_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример patch_page'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
