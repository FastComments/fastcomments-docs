...
Возвращает: [`AddPageApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/add_page_api_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример add_page'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
