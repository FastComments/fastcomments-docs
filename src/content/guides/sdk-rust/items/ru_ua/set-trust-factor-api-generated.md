...
|------|------|----------|-------------|
| user_id | String | Нет |  |
| trust_factor | String | Нет |  |
| sso | String | Нет |  |

## Ответ

Возвращает: [`SetUserTrustFactorResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/set_user_trust_factor_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример set_trust_factor'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
