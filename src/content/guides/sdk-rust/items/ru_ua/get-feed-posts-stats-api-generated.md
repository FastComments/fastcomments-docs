...
Возвращает: [`FeedPostsStatsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/feed_posts_stats_response.rs)
...
async fn example_main(configuration: &configuration::Configuration) -> Result<(), Error> {
    ...
    let _api_status: ApiStatus = /* используйте stats по мере необходимости */ stats.into();
    Ok(())
}
[inline-code-end]
