...
Döndürür: [`CreateSubscriptionApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/create_subscription_api_response.rs)

## Örnek

[inline-code-attrs-start title = 'create_subscription Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
