...
Döndürür: [`ModerationSuggestResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/moderation_suggest_response.rs)

## Örnek

[inline-code-attrs-start title = 'get_search_suggest Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
