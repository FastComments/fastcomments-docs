...
Döndürür: [`PublicApiSetCommentTextResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/public_api_set_comment_text_response.rs)

## Örnek

[inline-code-attrs-start title = 'set_comment_text Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
