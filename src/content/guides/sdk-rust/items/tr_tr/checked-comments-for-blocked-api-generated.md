...
Döndürür: [`CheckedCommentsForBlocked200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/checked_comments_for_blocked_200_response.rs)

## Örnek

[inline-code-attrs-start title = 'checked_comments_for_blocked Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
