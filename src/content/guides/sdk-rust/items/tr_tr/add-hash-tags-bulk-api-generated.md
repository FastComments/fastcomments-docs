...
Döndürür: [`BulkCreateHashTagsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_create_hash_tags_response.rs)

## Örnek

[inline-code-attrs-start title = 'add_hash_tags_bulk Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
