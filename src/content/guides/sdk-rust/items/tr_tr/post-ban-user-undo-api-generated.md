...
|------|------|----------|-------------|
| ban_user_undo_params | models::BanUserUndoParams | Evet |  |
| sso | String | Hayır |  |
...
[inline-code-attrs-start title = 'post_ban_user_undo Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
