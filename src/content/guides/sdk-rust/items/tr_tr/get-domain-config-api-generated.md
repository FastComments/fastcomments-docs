...
Döndürür: [`GetDomainConfigResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_domain_config_response.rs)

## Örnek

[inline-code-attrs-start title = 'get_domain_config Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
