...
| id | String | Evet |  |
| update_api_user_subscription_data | models::UpdateApiUserSubscriptionData | Evet |  |
| user_id | String | Hayır |  |

## Yanıt

Döndürür: [`UpdateSubscriptionApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/update_subscription_api_response.rs)

## Örnek

[inline-code-attrs-start title = 'update_subscription Örneği'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
