...
[inline-code-start]
async fn flag_comment_example() -> Result<FlagComment200Response, Error> {
    let params: FlagCommentParams = FlagCommentParams {
        tenant_id: "acme-corp-tenant".to_string(),
        id: "news/article/2026/01/13/state-of-tech/comment/98765".to_string(),
        user_id: Some("user_jane_doe".to_string()),
        anon_user_id: None,
    };
