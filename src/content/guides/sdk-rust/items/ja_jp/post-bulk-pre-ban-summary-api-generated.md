...
| 名前 | 型 | 必須 | 説明 |
|------|------|----------|-------------|
| bulk_pre_ban_params | models::BulkPreBanParams | はい |  |
...
戻り値: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_pre_ban_summary.rs)

## 例

[inline-code-attrs-start title = 'post_bulk_pre_ban_summary の例'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
