...
| value | String | 任意 |  |
| filters | String | 任意 |  |
| search_filters | String | 任意 |  |
| sso | String | 任意 |  |

## レスポンス

戻り値: [`ModerationCommentSearchResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/moderation_comment_search_response.rs)
