...
|------|------|---------|--------------|
| tenant_id | String | Ja |  |
| post_ids | Vec<String> | Nee |  |
| sso | String | Nee |  |

## Antwoord

Retourneert: [`GetUserReactsPublic200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_user_reacts_public_200_response.rs)

## Voorbeeld

[inline-code-attrs-start title = 'get_user_reacts_public Voorbeeld'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
