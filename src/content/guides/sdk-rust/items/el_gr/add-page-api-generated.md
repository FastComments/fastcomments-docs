...
Επιστρέφει: [`AddPageApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/add_page_api_response.rs)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα add_page'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
