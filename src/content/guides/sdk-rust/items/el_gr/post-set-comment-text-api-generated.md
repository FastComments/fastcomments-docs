...
| set_comment_text_params | models::SetCommentTextParams | Ναι |  |
| broadcast_id | String | Όχι |  |
| sso | String | Όχι |  |

## Απάντηση

Επιστρέφει: [`SetCommentTextResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/set_comment_text_response.rs)

## Παράδειγμα

[inline-code-attrs-start title = 'post_set_comment_text Παράδειγμα'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
