...
|------|------|----------|-------------|
| tenant_id | String | Sí |  |
| ban_user_undo_params | models::BanUserUndoParams | Sí |  |
| sso | String | No |  |
...
[inline-code-attrs-start title = 'post_ban_user_undo Ejemplo'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
