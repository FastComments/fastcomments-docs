...
| adjust_comment_votes_params | models::AdjustCommentVotesParams | Sí |  |
| sso | String | No |  |

## Respuesta

Devuelve: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/adjust_votes_response.rs)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de post_adjust_comment_votes'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
