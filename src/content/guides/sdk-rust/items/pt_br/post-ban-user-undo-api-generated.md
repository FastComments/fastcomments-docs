...
|------|------|----------|-------------|
| ban_user_undo_params | models::BanUserUndoParams | Sim |  |
| sso | String | Não |  |
...
[inline-code-attrs-start title = 'Exemplo de post_ban_user_undo'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
