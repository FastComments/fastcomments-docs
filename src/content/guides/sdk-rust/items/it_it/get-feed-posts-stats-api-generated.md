...
|------|------|--------------|-------------|
| tenant_id | String | Sì |  |
| post_ids | Vec<String> | Sì |  |
| sso | String | No |  |

## Risposta

Restituisce: [`GetFeedPostsStats200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_feed_posts_stats_200_response.rs)

## Esempio

[inline-code-attrs-start title = 'Esempio di get_feed_posts_stats'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
