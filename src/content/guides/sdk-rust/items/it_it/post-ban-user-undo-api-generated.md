...
|------|------|--------------|-------------|
| ban_user_undo_params | models::BanUserUndoParams | Sì |  |
| sso | String | No |  |
...
[inline-code-attrs-start title = 'Esempio di post_ban_user_undo'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
