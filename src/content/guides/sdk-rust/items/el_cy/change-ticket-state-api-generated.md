...
| user_id | String | Ναι |  |
| id | String | Ναι |  |
| change_ticket_state_body | models::ChangeTicketStateBody | Ναι |  |

## Απόκριση

Επιστρέφει: [`ChangeTicketState200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/change_ticket_state_200_response.rs)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα change_ticket_state'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
