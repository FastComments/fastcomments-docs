...
Επιστρέφει: [`PutSsoUserApiResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/put_sso_user_api_response.rs)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα put_sso_user'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
