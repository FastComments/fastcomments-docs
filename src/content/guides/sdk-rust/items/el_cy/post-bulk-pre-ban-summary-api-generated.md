...
|------|------|----------|-------------|
| bulk_pre_ban_params | models::BulkPreBanParams | Ναι |  |
| include_by_user_id_and_email | bool | Όχι |  |
| include_by_ip | bool | Όχι |  |
| include_by_email_domain | bool | Όχι |  |
| sso | String | Όχι |  |

## Απόκριση

Επιστρέφει: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_pre_ban_summary.rs)

## Παράδειγμα

[inline-code-attrs-start title = 'post_bulk_pre_ban_summary Παράδειγμα'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
