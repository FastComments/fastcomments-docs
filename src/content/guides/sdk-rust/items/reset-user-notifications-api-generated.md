...
[inline-code-start]
async fn reset_notifications_example(configuration: &configuration::Configuration) -> Result<ResetUserNotifications200Response, Error> {
    let params: ResetUserNotificationsParams = ResetUserNotificationsParams {
        tenant_id: "acme-corp-tenant".to_string(),
        after_id: Some("notif_12345".to_string()),
        after_created_at: Some(1700000000i64),
        unread_only: Some(true),
        dm_only: Some(false),
        no_dm: Some(false),
        sso: Some("sso-session-789".to_string()),
    };
