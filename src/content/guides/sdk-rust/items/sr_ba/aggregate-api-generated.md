Агрегира документе груписањем (ако је groupBy обезбеђен) и примјеном више операција. Подржане су различите операције (нпр. sum, countDistinct, avg, итд.).
...
[inline-code-attrs-start title = 'Пример агрегације'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
