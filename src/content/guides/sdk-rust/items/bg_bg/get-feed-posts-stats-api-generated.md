...
Връща: [`FeedPostsStatsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/feed_posts_stats_response.rs)
...
async fn example_main(configuration: &configuration::Configuration) -> Result<(), Error> {
    ...
    let _api_status: ApiStatus = /* използвайте статистиките при необходимост */ stats.into();
    Ok(())
}
[inline-code-end]