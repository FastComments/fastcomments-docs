...
Връща: [`ModerationApiCountCommentsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/moderation_api_count_comments_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример за get_count'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
