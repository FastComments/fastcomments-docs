...
Връща: [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/create_ticket_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример за create_ticket'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
