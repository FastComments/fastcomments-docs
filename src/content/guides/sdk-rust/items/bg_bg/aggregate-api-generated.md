...
Връща: [`AggregateResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/aggregate_response.rs)

## Пример

[inline-code-attrs-start title = 'Пример за агрегиране'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
