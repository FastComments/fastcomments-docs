...
| url_id | String | Nie |  |
| start_date | chrono::DateTime<chrono::FixedOffset> | Nie |  |
...
Zwraca: [`CombineQuestionResultsWithCommentsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/combine_question_results_with_comments_response.rs)

## Przykład

[inline-code-attrs-start title = 'Przykład combine_comments_with_question_results'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
