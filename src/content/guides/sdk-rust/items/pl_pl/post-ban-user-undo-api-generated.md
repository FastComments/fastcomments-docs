...
|------|------|----------|-------------|
| ban_user_undo_params | models::BanUserUndoParams | Tak |  |
| sso | String | Nie |  |
...
[inline-code-attrs-start title = 'post_ban_user_undo Przykład'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
