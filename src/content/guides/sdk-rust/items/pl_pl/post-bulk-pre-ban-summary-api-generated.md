...
| bulk_pre_ban_params | models::BulkPreBanParams | Tak |  |
...
Zwraca: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_pre_ban_summary.rs)

## Przykład

[inline-code-attrs-start title = 'post_bulk_pre_ban_summary Przykład'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
