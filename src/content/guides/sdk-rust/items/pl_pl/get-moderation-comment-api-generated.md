...
| include_email | bool | Nie |  |
| include_ip | bool | Nie |  |
| sso | String | Nie |  |

## Odpowiedź

Zwraca: [`ModerationApiCommentResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/moderation_api_comment_response.rs)

## Przykład

[inline-code-attrs-start title = 'Przykład użycia get_moderation_comment'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
