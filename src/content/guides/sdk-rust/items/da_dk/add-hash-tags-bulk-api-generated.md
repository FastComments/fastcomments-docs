...
| bulk_create_hash_tags_body | models::BulkCreateHashTagsBody | Nej |  |

## Svar

Returnerer: [`BulkCreateHashTagsResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_create_hash_tags_response.rs)

## Eksempel

[inline-code-attrs-start title = 'add_hash_tags_bulk Eksempel'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
