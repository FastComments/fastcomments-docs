...
| set_comment_text_params | models::SetCommentTextParams | Так |  |
| sso | String | Ні |  |

## Відповідь

Повертає: [`SetCommentTextResponse`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/set_comment_text_response.rs)

## Приклад

[inline-code-attrs-start title = 'Приклад post_set_comment_text'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
