...
|------|------|-------------|------|
| bulk_pre_ban_params | models::BulkPreBanParams | Так |  |
...
Повертає: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/bulk_pre_ban_summary.rs)

## Приклад

[inline-code-attrs-start title = 'Приклад post_bulk_pre_ban_summary'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
