...
async fn example() -> Result<(), Error> {
    let params: AggregateQuestionResultsParams = AggregateQuestionResultsParams {
        ...
        question_id: Some("q-123-upvote".to_string()),
        question_ids: Some(vec!["q-123-upvote".to_string(), "q-456-rating".to_string()]),
        url_id: Some("news/article/2025/01/13".to_string()),
