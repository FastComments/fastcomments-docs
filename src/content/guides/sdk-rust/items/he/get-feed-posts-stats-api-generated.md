...
|------|------|----------|-------------|
| tenant_id | String | כן |  |
| post_ids | Vec<String> | כן |  |
| sso | String | לא |  |

## תגובה

מחזיר: [`GetFeedPostsStats200Response`](https://github.com/FastComments/fastcomments-rust/blob/main/client/src/models/get_feed_posts_stats_200_response.rs)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_feed_posts_stats'; type = 'rust'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
