...
| urlId | string | query | לא | משמש כדי לקבוע האם העמוד הנוכחי מנוי. |
...
מחזיר: [`GetMyNotificationsResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/get_my_notifications_response.rb)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-get_user_notifications'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
opts = {
  url_id: 'url_id_example', # String | משמש כדי לקבוע האם העמוד הנוכחי מנוי.
