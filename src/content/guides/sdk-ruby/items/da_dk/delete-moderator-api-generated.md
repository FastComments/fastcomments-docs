...
[inline-code-attrs-start title = 'delete_moderator Eksempel'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Fjern kommentaren fra følgende linje for at sætte et præfiks til API-nøglen, f.eks. 'Bearer' (standard: nil)
