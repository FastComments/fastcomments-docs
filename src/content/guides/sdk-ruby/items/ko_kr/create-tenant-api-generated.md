...
반환: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/create_tenant_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # 다음 줄의 주석을 제거하여 API 키에 접두사(예: 'Bearer')를 설정하세요(기본값: nil)
