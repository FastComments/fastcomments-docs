...
[inline-code-attrs-start title = 'replace_tenant_package 예제'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
begin
  ...
  puts "DefaultApi->replace_tenant_package 호출 시 오류: #{e}"
end
[inline-code-end]