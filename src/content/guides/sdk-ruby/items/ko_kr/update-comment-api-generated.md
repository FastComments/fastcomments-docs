...
[inline-code-attrs-start title = 'update_comment 예제'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # API 키에 대한 접두사(예: 'Bearer', 기본값: nil)를 설정하려면 다음 줄의 주석 처리를 해제하세요
