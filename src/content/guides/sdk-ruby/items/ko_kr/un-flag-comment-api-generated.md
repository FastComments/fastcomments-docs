...
[inline-code-attrs-start title = 'un_flag_comment 예제'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # 다음 줄의 주석을 해제하여 API 키에 대한 접두사를 설정하십시오. 예: 'Bearer' (기본값은 nil)
