...
[inline-code-attrs-start title = 'Beispiel für get_domain_config'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Entfernen Sie das Kommentarzeichen vor der folgenden Zeile, um einen Präfix für den API-Schlüssel festzulegen, z. B. 'Bearer' (Standard: nil)
