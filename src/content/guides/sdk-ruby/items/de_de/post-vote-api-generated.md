...
Rückgabe: [`VoteResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/vote_response.rb)
...
begin
  ...
  puts "Fehler beim Aufruf von ModerationApi->post_vote: #{e}"
end
[inline-code-end]