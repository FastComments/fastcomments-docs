...
Gibt zurück: [`AggregateResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/aggregate_response.rb)

## Beispiel

[inline-code-attrs-start title = 'Aggregate Beispiel'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Kommentarzeichen der folgenden Zeile entfernen, um einen Präfix für den API-Schlüssel festzulegen, z. B. 'Bearer' (Standard: nil)
