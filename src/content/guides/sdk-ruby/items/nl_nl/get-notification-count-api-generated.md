...
Retourneert: [`GetNotificationCount200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/get_notification_count200_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # Verwijder het commentaar voor de volgende regel om een prefix voor de API-sleutel in te stellen, bijv. 'Bearer' (standaard: nil)
