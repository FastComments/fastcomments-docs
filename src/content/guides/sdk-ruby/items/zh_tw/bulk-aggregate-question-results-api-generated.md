...
回傳: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/bulk_aggregate_question_results200_response.rb)

## 範例

[inline-code-attrs-start title = 'bulk_aggregate_question_results 範例'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # 取消註解下行以為 API 金鑰設定前綴，例如 'Bearer'（預設為 nil）
