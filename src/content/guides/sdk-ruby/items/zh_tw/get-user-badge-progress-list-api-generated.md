...
回傳: [`GetUserBadgeProgressList200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/get_user_badge_progress_list200_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # 若要為 API 金鑰設定前綴（例如 'Bearer'），取消註解下列行（預設為 nil）
