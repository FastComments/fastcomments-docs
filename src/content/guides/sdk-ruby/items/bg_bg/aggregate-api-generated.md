Агрегира документи чрез групиране (ако е посочено groupBy) и прилагане на множество операции.
...
[inline-code-attrs-start title = 'Пример за aggregate'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
