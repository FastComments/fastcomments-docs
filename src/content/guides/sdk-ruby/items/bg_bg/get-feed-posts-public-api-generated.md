...
Връща: [`GetFeedPostsPublic200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/get_feed_posts_public200_response.rb)
...
opts = {
  ...
  limit: 56, # Цяло число | 
  tags: ['inner_example'], # Масив<String> | 
  sso: 'sso_example', # Низ | 
  is_crawler: true, # Булев | 
  include_user_info: true # Булев | 
}
