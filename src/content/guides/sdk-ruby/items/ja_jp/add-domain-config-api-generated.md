...
[inline-code-attrs-start title = 'add_domain_config の例'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # APIキーにプレフィックスを設定するには、次の行のコメントを外します。例: 'Bearer' (デフォルト: nil)
