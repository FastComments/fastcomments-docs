...
戻り値: [`GetSSOUsersResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/get_sso_users_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # APIキーにプレフィックスを設定するには、以下の行のコメントアウトを外してください。例: 'Bearer' (defaults to nil)
