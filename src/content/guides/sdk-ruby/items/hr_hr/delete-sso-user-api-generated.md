...
Vraća: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/delete_sso_user_api_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # Poništite komentiranje sljedeće linije da postavite prefiks za API ključ, npr. 'Bearer' (zadano nil)
