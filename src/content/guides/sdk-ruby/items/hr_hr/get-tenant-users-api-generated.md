...
[inline-code-attrs-start title = 'Primjer get_tenant_users'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Otkomentirajte sljedeći redak da postavite prefiks za API ključ, npr. 'Bearer' (zadana vrijednost je nil)
