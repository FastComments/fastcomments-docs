...
Döndürür: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/create_tenant_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # API anahtarı için bir önek ayarlamak isterseniz aşağıdaki satırın yorumunu kaldırın, ör. 'Bearer' (varsayılan nil)
