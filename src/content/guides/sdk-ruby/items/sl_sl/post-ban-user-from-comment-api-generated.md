...
Vrne: [`BanUserFromCommentResult`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/ban_user_from_comment_result.rb)
...
begin
  ...
  puts "Napaka pri klicanju ModerationApi->post_ban_user_from_comment: #{e}"
end
[inline-code-end]