...
[inline-code-attrs-start title = 'Приклад put_reopen_thread'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
begin
  ...
  puts "Помилка під час виклику ModerationApi->put_reopen_thread: #{e}"
end
[inline-code-end]