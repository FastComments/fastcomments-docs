...
[inline-code-attrs-start title = 'Пример delete_tenant'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Откомунтујте следећи ред да бисте поставили префикс за API кључ, нпр. 'Bearer' (подразумевано је nil)
