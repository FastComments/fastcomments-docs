...
Враћа: [`APIGetUserBadgesResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/api_get_user_badges_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # Откоментишите следећу линију да бисте поставили префикс за API кључ, нпр. 'Bearer' (подразумевано је nil)
