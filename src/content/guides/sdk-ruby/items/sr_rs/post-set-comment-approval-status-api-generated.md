...
[inline-code-attrs-start title = 'post_set_comment_approval_status Primer'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
begin
  ...
  puts "Greška prilikom pozivanja ModerationApi->post_set_comment_approval_status: #{e}"
end
[inline-code-end]