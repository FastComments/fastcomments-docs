...
| broadcastId | string | consulta | Não |  |
| sso | string | consulta | Não |  |

## Resposta

Retorna: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/adjust_votes_response.rb)

## Exemplo

[inline-code-attrs-start title = 'Exemplo post_adjust_comment_votes'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
