...
Retorna: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/put_sso_user_api_response.rb)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de put_sso_user'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
