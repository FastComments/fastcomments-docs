...
Retorna: [`CreateTenantPackageResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/create_tenant_package_response.rb)
...
FastCommentsClient.configure do |config|
  ...
  # Descomente a linha abaixo para definir um prefixo para a chave de API, p.ex. 'Bearer' (padrão: nil)
