...
Retorna: [`CreateTenantPackage200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/create_tenant_package200_response.rb)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de create_tenant_package'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Descomente a linha a seguir para definir um prefixo para a API key, e.g. 'Bearer' (defaults to nil)
