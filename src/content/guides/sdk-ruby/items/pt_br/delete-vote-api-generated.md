...
[inline-code-attrs-start title = 'Exemplo de delete_vote'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Descomente a linha abaixo para definir um prefixo para a chave de API, por ex. 'Bearer' (padrão: nil)
