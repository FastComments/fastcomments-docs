...
Restituisce: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/put_sso_user_api_response.rb)

## Esempio

[inline-code-attrs-start title = 'put_sso_user Esempio'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
