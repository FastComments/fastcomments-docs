...
[inline-code-attrs-start title = 'Esempio di delete_page'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Decommenta la seguente riga per impostare un prefisso per la API key, e.g. 'Bearer' (defaults to nil)
