...
| commentIds | string | query | Ναι | Λίστα αναγνωριστικών σχολίων, διαχωρισμένη με κόμμα. |
...
comment_ids = 'comment_ids_example' # String | Λίστα αναγνωριστικών σχολίων, διαχωρισμένη με κόμμα.
opts = {
