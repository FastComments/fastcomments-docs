...
Επιστρέφει: [`SaveComment200Response`](https://github.com/FastComments/fastcomments-ruby/blob/master/client/lib/fastcomments-client/models/save_comment200_response.rb)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα save_comment'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Αφαιρέστε το σχολιασμό της επόμενης γραμμής για να ορίσετε πρόθεμα για το κλειδί API, π.χ. 'Bearer' (προεπιλεγμένο nil)
