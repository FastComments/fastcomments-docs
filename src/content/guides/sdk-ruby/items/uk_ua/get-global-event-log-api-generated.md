...
[inline-code-attrs-start title = 'Приклад get_global_event_log'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
start_time = 789 # Ціле число | 
end_time = 789 # Ціле число | 
