...
[inline-code-attrs-start title = 'delete_notification_count Primjer'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Otkomentariši sljedeću liniju da postaviš prefiks za API ključ, npr. 'Bearer' (podrazumijevano nil)
