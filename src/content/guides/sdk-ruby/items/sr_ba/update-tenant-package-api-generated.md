...
[inline-code-attrs-start title = 'Primjer update_tenant_package'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Otkomentarišite sljedeću liniju da biste postavili prefiks za API ključ, npr. 'Bearer' (podrazumijevano nil)
