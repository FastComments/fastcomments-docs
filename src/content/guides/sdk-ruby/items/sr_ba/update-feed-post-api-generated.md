...
[inline-code-attrs-start title = 'update_feed_post Пример'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Уклоните коментар са следеће линије да бисте поставили префикс за API кључ, нпр. 'Bearer' (подразумевано је nil)
