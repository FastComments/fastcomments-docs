...
[inline-code-attrs-start title = 'get_user_badge_progress_by_id Primjer'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Uklonite komentar sa sljedeće linije da postavite prefiks za API ključ, npr. 'Bearer' (podrazumijevano nil)
