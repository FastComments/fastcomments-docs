...
[inline-code-attrs-start title = 'Primjer update_moderator'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
FastCommentsClient.configure do |config|
  ...
  # Otkomentari sljedeću liniju da postaviš prefiks za API ključ, npr. 'Bearer' (podrazumijevano: nil)
