...
[inline-code-attrs-start title = 'Primjer get_manual_badges_for_user'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
...
begin
  ...
  puts "Greška prilikom pozivanja ModerationApi->get_manual_badges_for_user: #{e}"
end
[inline-code-end]