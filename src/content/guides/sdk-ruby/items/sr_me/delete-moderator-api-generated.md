...
[inline-code-attrs-start title = 'delete_moderator Примјер'; type = 'ruby'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
require 'time'
require 'fastcomments-client'
# подешавање овлашћења
FastCommentsClient.configure do |config|
  # Конфигуришите овлашћење са API кључем: api_key
