...
<div class="screenshot white-bg">
    <div class="title">Вставьте код в разделе Footer</div>
    <img class="screenshot-image" src="/images/installation-guides/typeflo-step-3-paste-code-in-footer-section.png" alt="Вставьте код FastComments в разделе Footer" />
</div>

После вставки кода нажмите кнопку **Save**, чтобы применить изменения.

Note: этот код содержит логику для динамического размещения виджета FastComments в оптимальном месте на страницах вашего блога Typeflo.io. Другие фрагменты кода не будут корректно работать с макетом Typeflo.io.

Не забудьте заменить `'demo'` на ваш реальный FastComments tenant ID после регистрации. Если вы вошли в аккаунт на FastComments.com, он уже должен быть заменён.