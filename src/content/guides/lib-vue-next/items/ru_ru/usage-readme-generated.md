...
Виджет поддерживает множество опций - см. FastCommentsConfig [здесь](https://github.com/FastComments/fastcomments-typescript/blob/eae973fb7885de4df58b21b7a22a3e40c89feefa/src/fastcomments-config.ts#L14).
