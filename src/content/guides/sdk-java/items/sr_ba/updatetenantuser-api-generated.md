...
[inline-code-attrs-start title = 'Пример updateTenantUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Увези класе:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Уклони коментар са следећег реда да поставиш префикс за API кључ, нпр. "Token" (подразумевано null)
