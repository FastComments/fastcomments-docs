...
[inline-code-attrs-start title = 'Primjer updateQuestionResult'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvoz klasa:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Ukloni komentar sa sljedeće linije da postaviš prefiks za API ključ, npr. "Token" (podrazumijevano je null)
