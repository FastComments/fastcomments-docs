...
[inline-code-attrs-start title = 'Primjer za saveComment'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvezi klase:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Otkomentariši sljedeći red za postavljanje prefiksa za API ključ, npr. "Token" (podrazumijevano je null)
