...
Returns: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PutSSOUserAPIResponse.java)

## Example

[inline-code-attrs-start title = 'putSSOUser Example'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:
