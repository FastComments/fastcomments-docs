...
[inline-code-attrs-start title = 'Παράδειγμα updateTenantUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Διαμόρφωση της εξουσιοδότησης με κλειδί API: api_key
