...
[inline-code-attrs-start title = 'Παράδειγμα updateFeedPost'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Κατάργησε το σχόλιο στην ακόλουθη γραμμή για να ορίσεις πρόθεμα για το API key, π.χ. "Token" (προεπιλογή null)
