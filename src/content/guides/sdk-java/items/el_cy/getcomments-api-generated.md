...
Επιστρέφει: [`APIGetCommentsResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/APIGetCommentsResponse.java)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα getComments'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Καταργήστε το σχολιασμό της παρακάτω γραμμής για να ορίσετε ένα πρόθεμα για το κλειδί API, π.χ. "Token" (η προεπιλογή είναι null)
