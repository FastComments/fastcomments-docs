...
[inline-code-attrs-start title = 'Παράδειγμα deleteEmailTemplate'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Αποσχολιάστε την παρακάτω γραμμή για να ορίσετε ένα πρόθεμα για το API key, π.χ. "Token" (προεπιλεγμένο null)
