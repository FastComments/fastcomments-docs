...
[inline-code-attrs-start title = 'Παράδειγμα deleteNotificationCount'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Αποσχολίαση της επόμενης γραμμής για να οριστεί ένα πρόθεμα για το κλειδί API, π.χ. "Token" (προεπιλογή null)
