...
[inline-code-attrs-start title = 'Παράδειγμα getUserBadgeProgressList'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Εισαγωγή κλάσεων:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Απο-σχολιάστε την ακόλουθη γραμμή για να ορίσετε πρόθεμα για το API key, π.χ. "Token" (προεπιλογή: null)
