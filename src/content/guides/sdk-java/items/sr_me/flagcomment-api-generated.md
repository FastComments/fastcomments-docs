...
[inline-code-attrs-start title = 'flagComment Пример'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Увези класе:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Откоментаришите следећу линију да поставите префикс за API кључ, нпр. "Token" (по подразумеваној вредности null)
