...
[inline-code-attrs-start title = 'deleteEmailTemplate Пример'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Увези класе:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Ако желите да уклоните коментар са следећег реда и поставите префикс за API кључ, нпр. "Token" (подразумевано null)
