...
[inline-code-attrs-start title = 'getTenantPackage Primer'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvoz klasa:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Otkomentarišite sledeću liniju da postavite prefiks za API ključ, npr. "Token" (podrazumijevano je null)
