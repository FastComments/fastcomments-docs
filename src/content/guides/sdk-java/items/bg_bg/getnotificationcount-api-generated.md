...
Връща: [`GetNotificationCount200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetNotificationCount200Response.java)

## Пример

[inline-code-attrs-start title = 'Пример за getNotificationCount'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
