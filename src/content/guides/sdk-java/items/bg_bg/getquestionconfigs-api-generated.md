...
Връща: [`GetQuestionConfigs200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetQuestionConfigs200Response.java)

## Пример

[inline-code-attrs-start title = 'Пример за getQuestionConfigs'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
