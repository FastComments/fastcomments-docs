...
Връща: [`CreateQuestionResult200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/CreateQuestionResult200Response.java)

## Пример

[inline-code-attrs-start title = 'Пример за createQuestionResult'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
public class Example {
  public static void main(String[] args) {
    ...
    // Конфигуриране на удостоверяването чрез API ключ: api_key
