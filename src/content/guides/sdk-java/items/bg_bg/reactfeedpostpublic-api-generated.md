...
Връща: [`ReactFeedPostPublic200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/ReactFeedPostPublic200Response.java)

## Пример

[inline-code-attrs-start title = 'Пример за reactFeedPostPublic'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
