...
Връща: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AddSSOUserAPIResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример за addSSOUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
