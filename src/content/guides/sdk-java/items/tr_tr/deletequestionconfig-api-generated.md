...
[inline-code-attrs-start title = 'deleteQuestionConfig Örneği'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Sınıfları içe aktar:
...
public class Example {
  public static void main(String[] args) {
    ...
    // API anahtarı için bir önek ayarlamak üzere aşağıdaki satırın başındaki // işaretini kaldırın, ör. "Token" (varsayılan null)
