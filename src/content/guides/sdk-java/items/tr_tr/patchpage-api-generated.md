...
Döndürür: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PatchPageAPIResponse.java)

## Örnek

[inline-code-attrs-start title = 'patchPage Örneği'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Sınıfları içe aktar:
