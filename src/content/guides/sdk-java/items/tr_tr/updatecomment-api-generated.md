...
[inline-code-attrs-start title = 'updateComment Örneği'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Sınıfları içe aktar:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Aşağıdaki satırın yorumunu kaldırarak API anahtarı için bir önek ayarlayabilirsiniz, örn. "Token" (varsayılan olarak null)
