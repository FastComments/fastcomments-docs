...
[inline-code-attrs-start title = 'deleteModerator Örneği'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Sınıfları içe aktar:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Aşağıdaki satırın yorumunu kaldırarak API anahtarına bir ön ek ayarlayın, örn. "Token" (varsayılan null)
