...
Возвращает: [`GetPageByURLIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetPageByURLIdAPIResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример getPageByURLId'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Импорт классов:
