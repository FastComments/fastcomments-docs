...
Возвращает: [`SetCommentTextResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/SetCommentTextResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример postSetCommentText'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:  // Импорт классов:
