...
Retorna: [`AggregationResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AggregationResponse.java)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de agregação'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomente a linha abaixo para definir um prefixo para a chave de API, por exemplo "Token" (valor padrão é null)
