...
[inline-code-attrs-start title = 'Exemplo de deleteTenant'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Configurar autorização por api_key: api_key
    ApiKeyAuth api_key = (ApiKeyAuth) defaultClient.getAuthentication("api_key");
    api_key.setApiKey("YOUR API KEY");
    // Descomente a linha a seguir para definir um prefixo para a API key, ex. "Token" (padrão é null)
