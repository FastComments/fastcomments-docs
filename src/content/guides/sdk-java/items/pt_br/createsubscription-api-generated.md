...
Retorna: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/CreateSubscriptionAPIResponse.java)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de createSubscription'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
