...
Retorna: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSubscriptionsAPIResponse.java)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de getSubscriptions'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
