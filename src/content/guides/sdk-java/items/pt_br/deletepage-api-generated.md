...
Retorna: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeletePageAPIResponse.java)

## Exemplo

[inline-code-attrs-start title = 'Exemplo de deletePage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
