...
[inline-code-attrs-start title = 'Exemplo de deleteQuestionConfig'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomente a linha a seguir para definir um prefixo para a chave de API, e.g. "Token" (padrão: null)
