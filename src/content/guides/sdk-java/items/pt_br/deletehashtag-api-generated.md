...
[inline-code-attrs-start title = 'Exemplo deleteHashTag'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomente a linha a seguir para definir um prefixo para a chave API, ex.: "Token" (o padrão é null)
