...
[inline-code-attrs-start title = 'Exemplo de deleteTenantUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomente a linha abaixo para definir um prefixo para a chave de API, por ex. "Token" (o padrão é null)
