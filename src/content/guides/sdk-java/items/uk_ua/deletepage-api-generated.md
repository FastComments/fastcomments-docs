...
Повертає: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeletePageAPIResponse.java)

## Приклад

[inline-code-attrs-start title = 'Приклад deletePage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Імпорт класів:
