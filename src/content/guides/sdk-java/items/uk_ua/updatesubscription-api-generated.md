...
Повертає: [`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/UpdateSubscriptionAPIResponse.java)

## Приклад

[inline-code-attrs-start title = 'Приклад updateSubscription'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Імпортувати класи:
