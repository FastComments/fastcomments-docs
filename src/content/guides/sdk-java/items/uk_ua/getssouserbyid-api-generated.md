...
Повертає: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSSOUserByIdAPIResponse.java)

## Приклад

[inline-code-attrs-start title = 'getSSOUserById Приклад'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Імпортувати класи:
