...
Повертає: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetPagesAPIResponse.java)

## Приклад

[inline-code-attrs-start title = 'Приклад getPages'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Імпортувати класи:
