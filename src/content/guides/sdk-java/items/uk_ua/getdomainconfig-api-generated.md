...
| Назва | Тип | Розташування | Необхідно | Опис |
|------|------|----------|----------|-------------|
...
Повертає: [`GetDomainConfigResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetDomainConfigResponse.java)
