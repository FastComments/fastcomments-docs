...
[inline-code-attrs-start title = 'postRestoreDeletedComment Приклад'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      // Exception when calling ModerationApi#postRestoreDeletedComment
