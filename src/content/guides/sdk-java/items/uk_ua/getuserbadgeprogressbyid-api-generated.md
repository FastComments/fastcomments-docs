...
[inline-code-attrs-start title = 'Приклад getUserBadgeProgressById'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Імпорт класів:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Розкоментуйте наступний рядок, щоб задати префікс для API-ключа, напр. "Token" (defaults to null)
