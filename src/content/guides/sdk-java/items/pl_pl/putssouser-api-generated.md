...
Zwraca: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PutSSOUserAPIResponse.java)

## Przykład

[inline-code-attrs-start title = 'Przykład putSSOUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importuj klasy:
