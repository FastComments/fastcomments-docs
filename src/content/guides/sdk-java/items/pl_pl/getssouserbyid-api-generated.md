...
Zwraca: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSSOUserByIdAPIResponse.java)

## Przykład

[inline-code-attrs-start title = 'Przykład getSSOUserById'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import klas:
