...
[inline-code-attrs-start title = 'Przykład updateTenantPackage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import klas:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Konfiguracja uwierzytelniania klucza API: api_key
