...
Zwraca: [`GetGifsSearchResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetGifsSearchResponse.java)

## Przykład

[inline-code-attrs-start title = 'Przykład getGifsSearch'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import klas:
