...
Zwraca: [`DeleteCommentResult`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeleteCommentResult.java)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      // Wyjątek podczas wywoływania DefaultApi#deleteComment
