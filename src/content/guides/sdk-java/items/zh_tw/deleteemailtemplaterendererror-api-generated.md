...
[inline-code-attrs-start title = 'deleteEmailTemplateRenderError 範例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 匯入類別:
...
public class Example {
  public static void main(String[] args) {
    ...
    // 若要為 API key 設定前綴（例如 "Token"，預設為 null），請取消註解下列一行
