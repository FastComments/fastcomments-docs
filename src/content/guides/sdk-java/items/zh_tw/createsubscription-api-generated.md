...
回傳: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/CreateSubscriptionAPIResponse.java)

## 範例

[inline-code-attrs-start title = 'createSubscription 範例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 匯入類別:
