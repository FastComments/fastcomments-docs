...
回傳：[`UpdateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/UpdateSubscriptionAPIResponse.java)

## 範例

[inline-code-attrs-start title = 'updateSubscription 範例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 匯入類別:
