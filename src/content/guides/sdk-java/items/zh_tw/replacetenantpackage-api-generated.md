...
[inline-code-attrs-start title = 'replaceTenantPackage 範例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 匯入類別:
...
public class Example {
  public static void main(String[] args) {
    ...
    // 取消註解以下行以為 API 金鑰設定前綴，例如 "Token" (defaults to null)
