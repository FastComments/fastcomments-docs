...
[inline-code-attrs-start title = 'deleteNotificationCount Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importiere Klassen:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Kommentiere die folgende Zeile aus, um ein Präfix für den API-Schlüssel zu setzen, z. B. "Token" (Standard: null)
