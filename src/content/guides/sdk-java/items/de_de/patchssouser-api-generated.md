...
Gibt zurück: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PatchSSOUserAPIResponse.java)

## Beispiel

[inline-code-attrs-start title = 'patchSSOUser Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Klassen importieren:
