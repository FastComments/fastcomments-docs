...
[inline-code-attrs-start title = 'updateComment Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Klassen importieren:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Die folgende Zeile einkommentieren, um ein Präfix für den API-Schlüssel festzulegen, z. B. "Token" (Standard: null)
