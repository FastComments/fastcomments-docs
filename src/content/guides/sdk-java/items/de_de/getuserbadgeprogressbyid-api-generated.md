...
[inline-code-attrs-start title = 'getUserBadgeProgressById Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Klassen importieren:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Entkommentieren Sie die folgende Zeile, um eine Präfix für den API-Schlüssel festzulegen, z.B. "Token" (Standard ist null)
