...
[inline-code-attrs-start title = 'deleteQuestionResult Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Klassen importieren:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Heben Sie die folgende Zeile aus dem Kommentar auf, um ein Präfix für den API-Schlüssel festzulegen, z. B. "Token" (Standard: null)
