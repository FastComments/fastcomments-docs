...
[inline-code-attrs-start title = 'deleteQuestionConfig Beispiel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Klassen importieren:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Entfernen Sie das Kommentarzeichen für die folgende Zeile, um ein Präfix für den API-Schlüssel festzulegen, z. B. "Token" (standardmäßig null)
