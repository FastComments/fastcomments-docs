...
[inline-code-attrs-start title = 'Ejemplo de sendInvite'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar clases:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomenta la siguiente línea para establecer un prefijo para la clave de API, p. ej. "Token" (predeterminado null)
