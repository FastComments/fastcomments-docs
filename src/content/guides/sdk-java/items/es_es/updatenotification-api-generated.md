...
[inline-code-attrs-start title = 'Ejemplo de updateNotification'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar clases:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Descomenta la siguiente línea para establecer un prefijo para la clave de la API, p. ej. "Token" (por defecto es null)
