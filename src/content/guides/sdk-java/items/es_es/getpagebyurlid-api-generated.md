...
Devuelve: [`GetPageByURLIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetPageByURLIdAPIResponse.java)

## Ejemplo

[inline-code-attrs-start title = 'Ejemplo de getPageByURLId'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importar clases:
