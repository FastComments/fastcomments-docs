...
[inline-code-attrs-start title = 'updateQuestionResult Voorbeeld'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importeer klassen:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Configureer API-sleutel autherisatie: api_key
