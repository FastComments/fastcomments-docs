...
[inline-code-attrs-start title = 'Voorbeeld sendLoginLink'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importeer klassen:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Haal het commentaar voor de volgende regel weg om een prefix voor de API-sleutel in te stellen, bijv. "Token" (standaard null)
