...
public class Example {
  public static void main(String[] args) {
    ...
    // Ontcommentarieer de volgende regel om een prefix voor de API-sleutel in te stellen, bijvoorbeeld "Token" (standaard null)
    ...
    try {
      ...
      // Uitzondering bij het aanroepen van DefaultApi#deleteHashTag
