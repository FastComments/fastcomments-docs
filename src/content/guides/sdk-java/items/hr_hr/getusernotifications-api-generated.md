...
[inline-code-attrs-start title = 'Primjer getUserNotifications'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvoz klasa:
...
public class Example {
  public static void main(String[] args) {
    ...
    String urlId = "urlId_example"; // String | Koristi se za određivanje je li trenutna stranica pretplaćena.
