...
| urlId | string | query | Ne | ID stranice s koje se vrši otpremanje, za konfiguraciju |
...
[inline-code-attrs-start title = 'Primjer uploadImage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    SizePreset sizePreset = SizePreset.fromValue("Default"); // SizePreset | Predložak veličine: \"Default\" (1000x1000px) ili \"CrossPlatform\" (stvara veličine za popularne uređaje)
    String urlId = "urlId_example"; // String | ID stranice s koje se vrši otpremanje, za konfiguraciju
    try {
