...
[inline-code-attrs-start title = 'Primjer getManualBadges'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Izuzetak prilikom poziva ModerationApi#getManualBadges");
