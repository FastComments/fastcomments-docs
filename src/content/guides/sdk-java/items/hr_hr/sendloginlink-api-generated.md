...
[inline-code-attrs-start title = 'Primjer sendLoginLink'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvoz klasa:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Uklonite // ispred sljedećeg retka da postavite prefiks za API ključ, npr. "Token" (zadano null)
