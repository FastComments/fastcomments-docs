...
Vraća: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PatchSSOUserAPIResponse.java)

## Primjer

[inline-code-attrs-start title = 'patchSSOUser Primjer'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvezi klase:
