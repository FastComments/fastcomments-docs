...
[inline-code-attrs-start title = 'Primjer deleteQuestionConfig'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvezite klase:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Poništite komentiranje sljedeće linije da postavite prefiks za API ključ, npr. "Token" (zadano null)
