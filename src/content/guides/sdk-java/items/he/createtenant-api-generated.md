...
מוחזר: [`CreateTenant200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/CreateTenant200Response.java)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-createTenant'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// ייבוא מחלקות:
...
public class Example {
  public static void main(String[] args) {
    ...
    // קונפיגורציית מפתח ה-API: api_key
