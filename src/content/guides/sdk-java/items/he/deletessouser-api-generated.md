...
מחזיר: [`DeleteSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeleteSSOUserAPIResponse.java)

## דוגמה

[inline-code-attrs-start title = 'דוגמה ל-deleteSSOUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// ייבוא מחלקות:
