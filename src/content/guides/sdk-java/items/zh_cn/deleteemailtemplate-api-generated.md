...
[inline-code-attrs-start title = 'deleteEmailTemplate 示例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Import classes:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Uncomment the following line to set a prefix for the API key, e.g. "Token" (默认为 null)
