...
返回: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/CreateSubscriptionAPIResponse.java)

## 示例

[inline-code-attrs-start title = 'createSubscription 示例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 导入类:
