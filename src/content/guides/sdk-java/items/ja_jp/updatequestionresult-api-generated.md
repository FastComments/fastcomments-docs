...
[inline-code-attrs-start title = 'updateQuestionResult の例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// クラスをインポート:
...
public class Example {
  public static void main(String[] args) {
    ...
    // APIキーのプレフィックスを設定するには、次の行のコメントアウトを外してください。例: "Token"（既定値は null）
