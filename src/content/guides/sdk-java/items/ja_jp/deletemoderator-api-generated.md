...
[inline-code-attrs-start title = 'deleteModerator の例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// クラスのインポート:
...
public class Example {
  public static void main(String[] args) {
    ...
    // APIキーのプレフィックスを設定するには、次の行のコメントアウトを外してください。例: "Token"（デフォルトはnull）
