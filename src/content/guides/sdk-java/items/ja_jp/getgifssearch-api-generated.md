...
戻り値: [`GetGifsSearchResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetGifsSearchResponse.java)

## 例

[inline-code-attrs-start title = 'getGifsSearch の例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// クラスをインポート:
