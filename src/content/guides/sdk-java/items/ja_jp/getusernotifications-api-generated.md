...
返却値: [`GetUserNotifications200Response`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetUserNotifications200Response.java)

## 例

[inline-code-attrs-start title = 'getUserNotifications の例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// インポートするクラス:
