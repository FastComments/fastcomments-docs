...
[inline-code-attrs-start title = 'deleteQuestionResult の例'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// クラスをインポート:
...
public class Example {
  public static void main(String[] args) {
    ...
    // 以下の行のコメントを外して、API キーにプレフィックスを設定します。例: "Token"（デフォルトは null）
