...
Возвращает: [`GetPagesAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetPagesAPIResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример getPages'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Импорт классов:
