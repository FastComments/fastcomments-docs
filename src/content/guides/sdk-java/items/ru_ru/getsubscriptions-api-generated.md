...
Возвращает: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSubscriptionsAPIResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример getSubscriptions'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Импорт классов:
