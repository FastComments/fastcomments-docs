...
Возвращает: [`ModerationAPICountCommentsResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/ModerationAPICountCommentsResponse.java)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      // Exception when calling ModerationApi#getCount
