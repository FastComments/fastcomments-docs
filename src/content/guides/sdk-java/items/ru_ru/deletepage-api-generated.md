...
Возвращает: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeletePageAPIResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример deletePage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Импорт классов:
