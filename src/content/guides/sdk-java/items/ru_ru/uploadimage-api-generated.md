...
public class Example {
  public static void main(String[] args) {
    ...
    SizePreset sizePreset = SizePreset.fromValue("Default"); // SizePreset | Предустановка размера: \"Default\" (1000x1000px) или \"CrossPlatform\" (создает размеры для популярных устройств)
    String urlId = "urlId_example"; // String | Идентификатор страницы, с которой выполняется загрузка, для настройки
    try {
