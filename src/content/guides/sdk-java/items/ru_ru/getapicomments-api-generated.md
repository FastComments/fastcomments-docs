...
Возвращает: [`ModerationAPIGetCommentsResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/ModerationAPIGetCommentsResponse.java)

## Пример

[inline-code-attrs-start title = 'Пример getApiComments'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
