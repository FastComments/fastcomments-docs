...
| Ime | Type | Location | Required | Opis |
|------|------|----------|----------|-------------|
...
Vrne: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/BulkPreBanSummary.java)
