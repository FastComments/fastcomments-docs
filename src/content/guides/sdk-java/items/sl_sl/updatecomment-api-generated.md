...
[inline-code-attrs-start title = 'Primer updateComment'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvozi razrede:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Odstrani zakomentiranje naslednje vrstice za nastavitev predpone za API ključ, npr. "Token" (privzeto null)
