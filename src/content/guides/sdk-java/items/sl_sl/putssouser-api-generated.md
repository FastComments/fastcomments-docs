...
Vrača: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PutSSOUserAPIResponse.java)

## Primer

[inline-code-attrs-start title = 'Primer putSSOUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvozi razrede:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Konfiguriraj pooblaščenje z API ključem: api_key
