...
Renvoie : [`PageUsersInfoResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/PageUsersInfoResponse.java)

## Exemple

[inline-code-attrs-start title = 'Exemple de getUsersInfo'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
public class Example {
  public static void main(String[] args) {
    ...
    String ids = "ids_example"; // String | userIds délimités par des virgules.
    try {
