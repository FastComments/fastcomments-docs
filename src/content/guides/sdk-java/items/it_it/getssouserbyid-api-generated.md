...
Restituisce: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSSOUserByIdAPIResponse.java)

## Esempio

[inline-code-attrs-start title = 'Esempio di getSSOUserById'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa le classi:
