...
Restituisce: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AddPageAPIResponse.java)

## Esempio

[inline-code-attrs-start title = 'Esempio di addPage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
