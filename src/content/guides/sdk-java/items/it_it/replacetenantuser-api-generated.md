...
[inline-code-attrs-start title = 'Esempio di replaceTenantUser'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Rimuovi il commento dalla linea seguente per impostare un prefisso per la API key, es. "Token" (predefinito null)
