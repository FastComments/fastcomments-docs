...
[inline-code-attrs-start title = 'Esempio di deleteEmailTemplate'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Decomenta la riga seguente per impostare un prefisso per la API key, es. "Token" (predefinito null)
