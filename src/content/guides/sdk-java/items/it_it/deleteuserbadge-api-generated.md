...
[inline-code-attrs-start title = 'Esempio di deleteUserBadge'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa le classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Rimuovi il commento dalla seguente riga per impostare un prefisso per la API key, es. "Token" (di default null)
