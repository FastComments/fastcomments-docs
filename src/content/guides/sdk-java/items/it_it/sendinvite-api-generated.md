...
[inline-code-attrs-start title = 'Esempio di sendInvite'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Rimuovi il commento dalla riga seguente per impostare un prefisso per la chiave API, es. "Token" (valore predefinito null)
