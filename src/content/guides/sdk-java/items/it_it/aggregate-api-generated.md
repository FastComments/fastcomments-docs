...
Sono supportate diverse operazioni (ad esempio sum, countDistinct, avg, ecc.).
...
Restituisce: [`AggregateResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AggregateResponse.java)
