...
Restituisce: [`DeleteSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/DeleteSubscriptionAPIResponse.java)

## Esempio

[inline-code-attrs-start title = 'Esempio di deleteSubscription'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
