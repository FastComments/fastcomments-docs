...
[inline-code-attrs-start title = 'Esempio di deleteQuestionResult'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Decommenta la seguente riga per impostare un prefisso per la API key, es. "Token" (valore predefinito null)
