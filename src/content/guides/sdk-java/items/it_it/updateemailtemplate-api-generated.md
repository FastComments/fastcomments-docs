...
[inline-code-attrs-start title = 'Esempio di updateEmailTemplate'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Rimuovi il commento dalla riga seguente per impostare un prefisso per l'API key, es. "Token" (valore predefinito null)
