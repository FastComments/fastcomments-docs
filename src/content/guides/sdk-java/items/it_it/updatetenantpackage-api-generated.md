...
[inline-code-attrs-start title = 'Esempio di updateTenantPackage'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importa le classi:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Configura autorizzazione API key: api_key
    ApiKeyAuth api_key = (ApiKeyAuth) defaultClient.getAuthentication("api_key");
    api_key.setApiKey("YOUR API KEY");
    // Decommenta la riga seguente per impostare un prefisso per la API key, es. "Token" (impostazione predefinita: null)
