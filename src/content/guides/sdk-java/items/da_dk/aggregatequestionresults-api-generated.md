...
Returnerer: [`AggregateQuestionResultsResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AggregateQuestionResultsResponse.java)

## Eksempel

[inline-code-attrs-start title = 'aggregateQuestionResults Eksempel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importer klasser:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Fjern kommentartegnet fra følgende linje for at sætte et præfiks for API-nøglen, f.eks. "Token" (standard: null)
