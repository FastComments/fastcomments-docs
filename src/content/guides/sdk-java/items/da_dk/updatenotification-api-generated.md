...
[inline-code-attrs-start title = 'updateNotification Eksempel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importer klasser:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Fjern kommentaren for følgende linje for at sætte et præfiks for API-nøglen, f.eks. "Token" (standard er null)
