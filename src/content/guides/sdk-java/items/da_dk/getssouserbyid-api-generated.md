...
Returnerer: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/GetSSOUserByIdAPIResponse.java)

## Eksempel

[inline-code-attrs-start title = 'getSSOUserById Eksempel'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Importer klasser:
