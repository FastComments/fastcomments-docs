...
[inline-code-attrs-start title = 'deleteModerator 예제'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 클래스 가져오기:
...
public class Example {
  public static void main(String[] args) {
    ...
    // API 키에 접두사(예: "Token")를 설정하려면 다음 행의 주석을 제거하세요 (기본값은 null)
