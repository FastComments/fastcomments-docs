...
[inline-code-attrs-start title = 'deleteTenantPackage 예제'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 클래스 가져오기:
...
public class Example {
  public static void main(String[] args) {
    ...
    // 다음 줄의 주석을 제거하여 API 키에 접두사를 설정하세요. 예: "Token" (기본값은 null)
