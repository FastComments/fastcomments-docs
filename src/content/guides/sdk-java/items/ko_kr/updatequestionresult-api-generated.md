...
[inline-code-attrs-start title = 'updateQuestionResult 예제'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 클래스 임포트:
...
public class Example {
  public static void main(String[] args) {
    ...
    // API 키에 대한 접두사(예: "Token")를 설정하려면 다음 줄의 주석 처리를 해제하세요 (기본값은 null)
