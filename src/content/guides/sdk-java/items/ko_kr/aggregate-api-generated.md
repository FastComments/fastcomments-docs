...
합계(sum), 고유 개수(countDistinct), 평균(avg) 등 다양한 연산이 지원됩니다.
...
반환: [`AggregationResponse`](https://github.com/FastComments/fastcomments-java/blob/main/client/src/main/java/com/fastcomments/model/AggregationResponse.java)
