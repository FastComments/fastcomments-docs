...
[inline-code-attrs-start title = 'deleteEmailTemplate 예제'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// 클래스 임포트:
...
public class Example {
  public static void main(String[] args) {
    ...
    // API 키 접두사를 설정하려면 다음 줄의 주석을 제거하세요. 예: "Token" (기본값은 null)
