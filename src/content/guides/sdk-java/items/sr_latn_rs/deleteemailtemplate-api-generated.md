...
[inline-code-attrs-start title = 'Primer deleteEmailTemplate'; type = 'java'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
// Uvoz klasa:
...
public class Example {
  public static void main(String[] args) {
    ...
    // Otkomentarišite sledeću liniju da biste podesili prefiks za API ključ, npr. "Token" (podrazumevano je null)
