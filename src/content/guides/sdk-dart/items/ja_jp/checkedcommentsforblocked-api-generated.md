...
[inline-code-attrs-start title = 'checkedCommentsForBlocked の例'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // String | 
final commentIds = commentIds_example; // String | コメントIDのカンマ区切りリスト
