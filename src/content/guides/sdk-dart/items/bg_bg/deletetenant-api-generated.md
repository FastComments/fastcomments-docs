...
[inline-code-attrs-start title = 'Пример за deleteTenant'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигуриране на авторизация с API ключ: api_key
