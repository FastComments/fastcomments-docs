...
[inline-code-attrs-start title = 'Пример за createUserBadge'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигурирайте оторизация с API ключ: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// Откоментирайте долния ред, за да настроите префикс (напр. Bearer) за API ключа, ако е необходимо
