...
[inline-code-attrs-start title = 'getUserNotifications Пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // String |
final urlId = urlId_example; // String | Използва се за определяне дали текущата страница е абонирана.
