...
[inline-code-attrs-start title = 'getQuestionResult Пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигуриране на авторизацията с API ключ: api_key
