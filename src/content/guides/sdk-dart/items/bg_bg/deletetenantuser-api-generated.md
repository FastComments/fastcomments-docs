...
[inline-code-attrs-start title = 'deleteTenantUser Пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигуриране на упълномощаване с API ключ: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// махнете кометара по-долу, за да зададете префикс (e.g. Bearer) за API ключа, ако е необходимо
