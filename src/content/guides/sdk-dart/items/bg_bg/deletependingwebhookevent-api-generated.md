...
[inline-code-attrs-start title = 'deletePendingWebhookEvent Пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигурирайте API ключ за удостоверяване: api_key
