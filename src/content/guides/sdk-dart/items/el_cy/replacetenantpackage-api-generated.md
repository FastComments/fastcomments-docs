...
[inline-code-attrs-start title = 'Παράδειγμα replaceTenantPackage'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Διαμόρφωση εξουσιοδότησης κλειδιού API: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// αποσχολίαση παρακάτω για ρύθμιση προθέματος (π.χ. Bearer) για το κλειδί API, αν χρειαστεί
