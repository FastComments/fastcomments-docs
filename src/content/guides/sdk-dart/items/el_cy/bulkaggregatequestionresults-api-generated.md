...
| Ονομασία | Τύπο | Τοποθεσία | Απαιτείται | Περιγραφή |
|------|------|----------|----------|-------------|
...
[inline-code-attrs-start title = 'Παράδειγμα bulkAggregateQuestionResults'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
