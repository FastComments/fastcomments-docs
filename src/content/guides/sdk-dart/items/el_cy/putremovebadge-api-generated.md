...
[inline-code-attrs-start title = 'Παράδειγμα putRemoveBadge'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Εξαίρεση κατά την κλήση του ModerationApi->putRemoveBadge: $e\n');
}
[inline-code-end]