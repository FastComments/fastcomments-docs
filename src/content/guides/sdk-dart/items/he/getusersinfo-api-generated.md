...
| ids | string | query | Yes | מופרדים בפסיקים userIds. |
...
[inline-code-attrs-start title = 'דוגמת getUsersInfo'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // מחרוזת | 
final ids = ids_example; // מחרוזת | userIds מופרדים בפסיקים.
