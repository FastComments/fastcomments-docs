...
מחזיר: `GetQuestionResultResponse`

## דוגמה

[inline-code-attrs-start title = 'דוגמת getQuestionResult'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO קונפיגור את אימות מפתח API: api_key
