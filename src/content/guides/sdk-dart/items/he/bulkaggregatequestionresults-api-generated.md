...
מחזיר: `BulkAggregateQuestionResultsResponse`

## Example

[inline-code-attrs-start title = 'bulkAggregateQuestionResults דוגמה'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
