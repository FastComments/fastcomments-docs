...
מחזיר: `APIGetUserBadgesResponse`

## דוגמה

[inline-code-attrs-start title = 'getUserBadges דוגמה'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO קבעו הרשאת מפתח API: api_key
