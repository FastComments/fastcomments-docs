...
[inline-code-attrs-start title = 'addDomainConfig דוגמה'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO קבע אישור מפתח API: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// בטל השבתת ההערה למטה כדי להגדיר קידומת (למשל Bearer) למפתח ה-API, אם נדרש
