Enable або disable сповіщення для сторінки. Коли користувачі підписані на сторінку, створюються сповіщення
...
Returns: `UpdateUserNotificationPageSubscriptionResponse`
...
try {
    ...
    print('Исключение при вызове PublicApi->updateUserNotificationPageSubscriptionStatus: $e\n');
}
[inline-code-end]