...
[inline-code-attrs-start title = 'getTenantDailyUsages Primjer'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurišite autorizaciju API ključa: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// otkomentarisati dolje za postavljanje prefiksa (npr. Bearer) za API ključ, ako je potrebno
