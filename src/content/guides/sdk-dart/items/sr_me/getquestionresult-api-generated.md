...
[inline-code-attrs-start title = 'getQuestionResult Primer'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигурисати ауторизацију API кључа: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// одкоментариши испод за постављање префикса (нпр. Bearer) за API кључ, ако је потребно
