...
[inline-code-attrs-start title = 'unBlockUserFromComment Пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Изузетак при позиву DefaultApi->unBlockUserFromComment: $e\n');
}
[inline-code-end]