...
[inline-code-attrs-start title = 'Ejemplo de createSubscription'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Excepción al llamar a DefaultApi->createSubscription: $e\n');
}
[inline-code-end]