...
[inline-code-attrs-start title = 'Ejemplo de getDomainConfigs'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Excepción al llamar a DefaultApi->getDomainConfigs: $e\n');
}
[inline-code-end]