...
| isLive | boolean | consulta | No |  |
| doSpamCheck | boolean | consulta | No |  |
| sendEmails | boolean | consulta | No |  |
| populateNotifications | boolean | consulta | No |  |
...
[inline-code-attrs-start title = 'Ejemplo de saveComment'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
