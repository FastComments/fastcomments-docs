...
[inline-code-attrs-start title = 'Ejemplo getQuestionConfig'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Excepción al llamar a DefaultApi->getQuestionConfig: $e\n');
}
[inline-code-end]