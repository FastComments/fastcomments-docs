...
[inline-code-attrs-start title = 'Ejemplo getNotificationCount'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Excepción al llamar a DefaultApi->getNotificationCount: $e\n');
}
[inline-code-end]