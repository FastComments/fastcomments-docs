...
반환값: `AddDomainConfigResponse`

## Example

[inline-code-attrs-start title = 'addDomainConfig 예시'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO API 키 인증 구성: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// 필요한 경우 API 키의 프리픽스(e.g. Bearer)를 설정하려면 아래의 주석을 해제하세요
