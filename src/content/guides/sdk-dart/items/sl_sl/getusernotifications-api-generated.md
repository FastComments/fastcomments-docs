...
[inline-code-attrs-start title = 'getUserNotifications Primer'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // String | 
final urlId = urlId_example; // String | Uporablja se za določitev, ali je trenutna stran naročena.
