...
[inline-code-attrs-start title = 'bulkAggregateQuestionResults Örneği'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO API anahtarı yetkilendirmesini yapılandır: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// aşağıdaki satırı yorumdan çıkararak API anahtarı için önek (örn. Bearer) ayarlayın, gerekirse
