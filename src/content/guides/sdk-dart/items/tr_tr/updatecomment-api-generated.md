...
[inline-code-attrs-start title = 'updateComment Örneği'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO API anahtarı yetkilendirmesini yapılandır: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// API anahtarının ön ekini (ör. Bearer) ayarlamak için aşağıdakini yorumdan kaldır, gerekirse
