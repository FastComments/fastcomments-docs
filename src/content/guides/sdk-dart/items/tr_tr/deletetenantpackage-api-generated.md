...
[inline-code-attrs-start title = 'deleteTenantPackage Örneği'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO API anahtarı yetkilendirmesini yapılandır: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// aşağıdaki satırı yorumdan kaldırarak API anahtarı için önek (ör. Bearer) ayarlayın, gerekirse
