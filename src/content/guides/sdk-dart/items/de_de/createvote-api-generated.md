...
[inline-code-attrs-start title = 'createVote Beispiel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurieren Sie die API-Schlüsselautorisierung: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// Kommentieren Sie die folgende Zeile aus, um das Präfix (z. B. Bearer) für den API‑Schlüssel einzurichten, falls erforderlich
