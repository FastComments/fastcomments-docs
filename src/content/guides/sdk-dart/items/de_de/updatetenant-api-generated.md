...
[inline-code-attrs-start title = 'updateTenant Beispiel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO API-Schlüssel-Autorisierung konfigurieren: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// auskommentieren Sie unten, um ein Prefix (z.B. Bearer) für den API-Schlüssel einzurichten, falls erforderlich
