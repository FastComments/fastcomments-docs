Aggregiert Dokumente, indem sie (falls `groupBy` angegeben ist) gruppiert und mehrere Vorgänge angewendet werden.  
Verschiedene Vorgänge (z. B. sum, countDistinct, avg usw.) werden unterstützt.
...
[inline-code-attrs-start title = 'Aggregationsbeispiel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
