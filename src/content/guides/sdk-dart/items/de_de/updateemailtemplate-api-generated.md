...
[inline-code-attrs-start title = 'updateEmailTemplate Beispiel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurieren Sie die API-Schlüssel-Authentifizierung: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// Kommentar entfernen, um das Präfix (z. B. Bearer) für den API-Schlüssel festzulegen, falls erforderlich
