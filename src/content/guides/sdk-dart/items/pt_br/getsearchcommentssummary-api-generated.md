...
[inline-code-attrs-start title = 'Exemplo getSearchCommentsSummary'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Exceção ao chamar ModerationApi->getSearchCommentsSummary: $e\n');
}
[inline-code-end]
