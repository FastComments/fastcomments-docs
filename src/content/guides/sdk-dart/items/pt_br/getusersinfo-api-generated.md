...
| ids | string | query | Yes | IDs de usuário delimitados por vírgula. |
...
[inline-code-attrs-start title = 'Exemplo getUsersInfo'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
