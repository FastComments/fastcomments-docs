...
| banEmail | boolean | upit | Ne |  |
| banEmailDomain | boolean | upit | Ne |  |
| banIP | boolean | upit | Ne |  |
| deleteAllUsersComments | boolean | upit | Ne |  |
| bannedUntil | string | upit | Ne |  |
| isShadowBan | boolean | upit | Ne |  |
| updateId | string | upit | Ne |  |
| banReason | string | upit | Ne |  |
| sso | string | upit | Ne |  |
