...
[inline-code-attrs-start title = 'saveCommentsBulk пример'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Конфигуришите ауторизацију API кључа: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// ukomentarišite ispod da postavite префикс (нпр. Bearer) за API кључ, ако је потребно
