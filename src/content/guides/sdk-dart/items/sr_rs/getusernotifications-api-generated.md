...
| urlId | string | query | No | Korišćeno za određivanje da li je trenutna stranica pretplaćena. |
...
final urlId = urlId_example; // String | Korišćeno za određivanje da li je trenutna stranica pretplaćena.
