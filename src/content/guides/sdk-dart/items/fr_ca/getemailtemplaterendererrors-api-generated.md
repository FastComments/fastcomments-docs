...
[inline-code-attrs-start title = 'getEmailTemplateRenderErrors Exemple'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Exception lors de l\'appel de DefaultApi->getEmailTemplateRenderErrors: $e\n');
}
[inline-code-end]