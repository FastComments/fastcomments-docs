...
[inline-code-attrs-start title = 'replaceTenantUser Exemple'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Exception lors de l\'appel de DefaultApi->replaceTenantUser : $e\n');
}
[inline-code-end]