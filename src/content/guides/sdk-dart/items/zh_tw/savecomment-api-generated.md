...
| isLive | boolean | 查詢 | 否 |  |
| doSpamCheck | boolean | 查詢 | 否 |  |
| sendEmails | boolean | 查詢 | 否 |  |
| populateNotifications | boolean | 查詢 | 否 |  |
...
[inline-code-attrs-start title = 'saveComment 範例'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
