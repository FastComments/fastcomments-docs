...
[inline-code-attrs-start title = 'deleteTenant Voorbeeld'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Configureer API-sleutel autorisatie: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// haal de onderstaande uit commentaar om prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
