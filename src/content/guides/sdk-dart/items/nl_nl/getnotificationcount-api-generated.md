...
[inline-code-attrs-start title = 'getNotificationCount Voorbeeld'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Configureer API-sleutel autorisatie: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// verwijder de ondercommentaar om prefix (bijv. Bearer) voor API-sleutel in te stellen, indien nodig
