...
[inline-code-attrs-start title = 'patchDomainConfig Voorbeeld'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Configureer API-sleutel autorisatie: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// decommentarieer onderstaande code om een prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
