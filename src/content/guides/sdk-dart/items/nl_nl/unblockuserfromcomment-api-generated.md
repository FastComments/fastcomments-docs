...
[inline-code-attrs-start title = 'unBlockUserFromComment Voorbeeld'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Configureer API‑sleutel autorisatie: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// ontcomment hieronder om prefix (bijv. Bearer) in te stellen voor API‑sleutel, indien nodig
