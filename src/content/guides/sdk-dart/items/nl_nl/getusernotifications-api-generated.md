...
[inline-code-attrs-start title = 'Voorbeeld getUserNotifications'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // String | 
final urlId = urlId_example; // String | Gebruikt om te bepalen of de huidige pagina is geabonneerd.
...
try {
    ...
    print('Uitzondering bij het aanroepen van PublicApi->getUserNotifications: $e\n');
}
[inline-code-end]