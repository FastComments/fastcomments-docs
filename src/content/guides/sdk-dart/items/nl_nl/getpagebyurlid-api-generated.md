...
[inline-code-attrs-start title = 'Voorbeeld getPageByURLId'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Exceptie bij het aanroepen van DefaultApi->getPageByURLId: $e\n');
}
[inline-code-end]
