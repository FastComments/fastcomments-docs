...
[inline-code-attrs-start title = 'Esempio getQuestionConfigs'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Eccezione durante la chiamata a DefaultApi->getQuestionConfigs: $e\n');
}
[inline-code-end]