...
Returnerer: `CreateHashTagResponse`

## Eksempel

[inline-code-attrs-start title = 'addHashTag Eksempel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurer API-nøgle autorisation: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// fjern kommentar nedenfor for at sætte præfix (f.eks. Bearer) for API-nøgle, hvis nødvendigt
