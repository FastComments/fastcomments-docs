...
Returnerer: `CreateTenantUserResponse`

## Eksempel

[inline-code-attrs-start title = 'createTenantUser Eksempel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurer API-nøgleautorisation: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// fjerne kommentar nedenfor for at opsætte præfiks (f.eks. Bearer) for API-nøgle, hvis nødvendigt
