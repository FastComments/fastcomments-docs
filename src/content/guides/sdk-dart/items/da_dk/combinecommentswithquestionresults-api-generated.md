...
[inline-code-attrs-start title = 'combineCommentsWithQuestionResults Eksempel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Undtagelse ved kald af DefaultApi->combineCommentsWithQuestionResults: $e\n');
}
[inline-code-end]