...
Returnerer: `FlagCommentResponse`

## Eksempel

[inline-code-attrs-start title = 'flagComment Eksempel'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';
// TODO Konfigurér API-nøgle autorisation: api_key
//defaultApiClient.getAuthentication<ApiKeyAuth>('api_key').apiKey = 'YOUR_API_KEY';
// fjern kommentar nedenfor for at indstille præfiks (f.eks. Bearer) for API-nøgle, hvis nødvendigt
