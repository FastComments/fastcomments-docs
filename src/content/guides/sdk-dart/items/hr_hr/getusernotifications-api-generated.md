...
| urlId | string | query | No | Korišteno za određivanje je li trenutna stranica pretplaćena. |
...
[inline-code-attrs-start title = 'Primjer getUserNotifications'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
import 'package:fastcomments_dart/api.dart';

final api_instance = PublicApi();
final tenantId = tenantId_example; // String | 
final urlId = urlId_example; // String | Korišteno za određivanje je li trenutna stranica pretplaćena.
