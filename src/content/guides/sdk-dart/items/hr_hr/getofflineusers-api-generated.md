...
| afterUserId | string | query | No | Kursor razrješavač povezanosti: proslijedite nextAfterUserId iz prethodnog odgovora. Potrebno kada je afterName postavljen kako bi se izbjeglo izostavljanje unosa zbog istih imena. |
...
final urlId = urlId_example; // String | Identifikator URL‑a stranice (čišćen na poslužitelju).
final afterName = afterName_example; // String | Kursor: proslijedite nextAfterName iz prethodnog odgovora.
final afterUserId = afterUserId_example; // String | Kursor razrješavač povezanosti: proslijedite nextAfterUserId iz prethodnog odgovora. Potrebno kada je afterName postavljen kako bi se izbjeglo izostavljanje unosa zbog istih imena.
