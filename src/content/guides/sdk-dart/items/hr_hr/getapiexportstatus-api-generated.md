...
[inline-code-attrs-start title = 'getApiExportStatus Primjer'; type = ''; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
try {
    ...
    print('Izuzetak prilikom poziva ModerationApi->getApiExportStatus: $e\n');
}
[inline-code-end]