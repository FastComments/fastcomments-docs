...
[inline-code-attrs-start title = 'GoHighLevel kod za komentare na sajtu'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
<script>
    (function () {
        ...
        // Izmjene History API-ja za podršku SPA
        ...
        function ensureScriptLoaded() {
            return new Promise((resolve) => {
                // Provjeri da li tag skripte već postoji
                ...
                if (!scriptTag) {
                    ...
                    // Rezervna opcija u slučaju da se skripta već učitava
        ...
        async function render() {
            ...
            function tryNext() {
                ...
                if (container) {
                    // Dodatna provjera da li je FastCommentsUI dostupan
                    if (!window.FastCommentsUI) {
                    ...
                    // Preuzmi trenutni URL kao urlId
                    const newUrlId = window.location.pathname;
    
                    // Provjeri da li treba ponovo renderovati (urlId se promijenio ili je prvo renderovanje)
                    ...
                    // Nadzor da li je kontejner uklonjen ili se URL promijenio
        ...
        // Ponovo renderuj pri promjeni lokacije (za SPA)
