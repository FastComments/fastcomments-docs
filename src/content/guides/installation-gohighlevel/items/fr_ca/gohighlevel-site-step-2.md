...
[inline-code-attrs-start title = 'Code des commentaires du site GoHighLevel'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
<script>
    (function () {
        ...
        // Modifications de l'API History pour le support des SPA
        ...
        function ensureScriptLoaded() {
            return new Promise((resolve) => {
                ...
                if (!scriptTag) {
                    ...
                    // Solution de repli au cas où le script est en cours de chargement
                    ...
                    // Délai d'attente après 10 secondes
                    setTimeout(() => {
                        clearInterval(checkInterval);
        ...
        async function render() {
            ...
            function tryNext() {
                ...
                if (container) {
                    // Vérifier à nouveau si FastCommentsUI est disponible
                    if (!window.FastCommentsUI) {
                    ...
                    // Obtenir l'URL courante en tant que urlId
                    const newUrlId = window.location.pathname;
    
                    // Vérifier si nous devons re-rendre (urlId changé ou premier rendu)
        ...
        // Re-rendu lors du changement de localisation (pour les SPA)
