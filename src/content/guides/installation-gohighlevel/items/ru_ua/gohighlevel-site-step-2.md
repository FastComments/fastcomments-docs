...
<script>
    (function () {
        ...
        // Функция, которая гарантирует загрузку скрипта
        function ensureScriptLoaded() {
            return new Promise((resolve) => {
                // Проверяем, существует ли уже тег скрипта
                ...
                if (!scriptTag) {
                    ...
                    // Тег скрипта существует и уже загружен
                    console.log('FastComments: Script already loaded');
                    resolve();
                } else {
                    // Тег скрипта существует, но ещё не готов
        ...
        async function render() {
            ...
            function tryNext() {
                ...
                if (container) {
                    // Дополнительная проверка доступности FastCommentsUI
                    if (!window.FastCommentsUI) {
                    ...
                    // Проверяем, нужно ли перерендерить (urlId изменился или это первый рендер)
                    ...
                    // Следим за тем, был ли контейнер удалён или изменился ли URL
        ...
        // Начальный рендер, когда DOM готов
        ...
        // Перерендер при изменении местоположения (для SPA)
...
<div class="screenshot white-bg">
    ...
    <img class="screenshot-image" src="/images/installation-guides/gohighlevel-site-step-7-paste-code.png" alt="Вставить код" />
</div>
