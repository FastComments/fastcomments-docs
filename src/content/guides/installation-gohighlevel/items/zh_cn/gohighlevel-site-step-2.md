...
[inline-code-attrs-start title = 'GoHighLevel 站点评论代码'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
<div class="screenshot white-bg">
    ...
    <img class="screenshot-image" src="/images/installation-guides/gohighlevel-site-step-7-paste-code.png" alt="粘贴代码" />
</div>
