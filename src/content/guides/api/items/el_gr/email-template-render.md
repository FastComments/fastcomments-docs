...
[inline-code-attrs-start title = 'Ελάχιστο EmailTemplate Προεπισκόπηση POST cURL Παράδειγμα'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request POST \
