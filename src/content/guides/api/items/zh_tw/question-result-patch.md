...
[inline-code-attrs-start title = 'QuestionResult 更新 cURL 範例'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'QuestionResult 更新請求結構'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'QuestionResult 更新回應結構'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
