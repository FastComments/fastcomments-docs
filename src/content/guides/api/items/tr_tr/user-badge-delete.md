...
[inline-code-attrs-start title = 'DELETE İsteği Örneği'; type = 'bash'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Hata: Eksik ID'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
  "code": "missing-id",
