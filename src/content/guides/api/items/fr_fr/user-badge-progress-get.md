...
- `userId` - Obtenir la progression pour un utilisateur spécifique
- `limit` - Nombre maximum d'enregistrements à retourner (par défaut 30, max 200)
- `skip` - Nombre d'enregistrements à ignorer (pour la pagination)
