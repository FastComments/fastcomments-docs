...
Cette route fournit la capacité de remplacer un seul `TenantUser`.

Le remplacement d'un `TenantUser` a les restrictions suivantes :
...
[inline-code-attrs-start title = 'Exemple cURL de Remplacement de TenantUser'; type = 'bash'; useDemoTenantUser = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'Structure de Requête de Remplacement de TenantUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Structure de Réponse de Remplacement de TenantUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
