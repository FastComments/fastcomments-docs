...
[inline-code-attrs-start title = 'Мінімальний приклад cURL для попереднього перегляду EmailTemplate POST'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request POST \
...
[inline-code-attrs-start title = 'Структура запиту EmailTemplate POST'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Структура відповіді EmailTemplate POST'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
