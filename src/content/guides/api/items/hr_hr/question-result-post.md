...
[inline-code-attrs-start title = 'Primjer cURL zahtjeva za QuestionResult (POST)'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request POST \
...
[inline-code-attrs-start title = 'Struktura zahtjeva za QuestionResult (POST)'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Struktura odgovora za QuestionResult (POST)'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
