...
[inline-code-attrs-start title = 'Pogreška: Nedostaje User ID'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Pogreška: Nije pronađeno'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
  "code": "not-found",
