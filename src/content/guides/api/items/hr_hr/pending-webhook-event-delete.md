...
[inline-code-attrs-start title = 'Primjer cURL DELETE zahtjeva za PendingWebhookEvent'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request DELETE \
