...
[inline-code-attrs-start title = 'Primjer cURL zahtjeva za brisanje NotificationCount'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request DELETE \
...
[inline-code-attrs-start title = 'Struktura zahtjeva za uklanjanje NotificationCount'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Struktura odgovora za uklanjanje NotificationCount'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
