...
interface QuestionConfigPatchBody {
    ...
    question?: string
    helpText?: string
    /** Упозорење! Мјењање type може пореметити извјештавање ако су min/max различити. **/
...
[inline-code-attrs-start title = 'Примјер cURL захтјева за ажурирање QuestionConfig'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'Структура захтјева за ажурирање QuestionConfig'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
