...
[inline-code-attrs-start title = 'Пример cURL захтева за добијање коментара по ИД-у'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request GET \
  --url 'https://fastcomments.com/api/v1/comments/some-id?tenantId=demo&API_KEY=DEMO_API_SECRET'
[inline-code-end]

[inline-code-attrs-start title = 'Структура захтева за добијање коментара по ИД-у'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Структура одговора за добијање коментара по ИД-у'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
