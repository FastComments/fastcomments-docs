...
[inline-code-attrs-start title = 'GET リクエスト例'; type = 'bash'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'エラー: テナントIDが不足しています'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'エラー: ユーザーIDが不足しています'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
