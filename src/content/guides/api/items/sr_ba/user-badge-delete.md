...
[inline-code-attrs-start title = 'Primjer DELETE zahtjeva'; type = 'bash'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Greška: Nedostaje ID zakupca'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
