...
Ovaj id ne mora odgovarati nijednom korisničkom objektu bilo gdje (otuda anonimno). To je jednostavno identifikator
za sesiju, tako da možete ponovo dohvatiti glasove u istoj sesiji, kako biste provjerili je li komentar
dobio glas.

Ako nemate nešto što biste nazvali "anonimne sesije" kao što to ima FastComments - možete jednostavno
postaviti ovo na nasumični ID, poput UUID-a (iako cijenimo manje identifikatore radi uštede prostora).
