...
[inline-code-attrs-start title = 'Primjer cURL zahtjeva za masovno kreiranje HashTag-ova'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'Struktura zahtjeva za masovno kreiranje HashTag-ova'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
