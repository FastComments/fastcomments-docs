...
[inline-code-attrs-start title = 'POST Anmodningseksempel'; type = 'bash'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
1. Badge'et skal eksistere og være aktiveret i din tenants badge-katalog
2. Du kan kun tildele badges til brugere, der tilhører din tenant eller har kommenteret på din side
...
[inline-code-attrs-start title = 'Fejl: Manglende Badge ID'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Fejl: Badge Ikke Fundet'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Fejl: Uautoriseret Bruger'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
