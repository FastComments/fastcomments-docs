...
Esta ruta proporciona la capacidad de reemplazar un único `TenantUser`.

Reemplazar un `TenantUser` tiene las siguientes restricciones:
...
[inline-code-attrs-start title = 'Ejemplo cURL de Reemplazo de TenantUser'; type = 'bash'; useDemoTenantUser = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'Estructura de Solicitud de Reemplazo de TenantUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Estructura de Respuesta de Reemplazo de TenantUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
