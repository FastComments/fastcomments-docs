...
[inline-code-attrs-start title = 'Primer POST zahtevka'; type = 'bash'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Napaka: Manjkajoči ID uporabnika'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Napaka: Manjkajoči ID značke'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Napaka: Značka ni bila najdena'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
...
[inline-code-attrs-start title = 'Napaka: Nepooblaščen uporabnik'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "failed",
