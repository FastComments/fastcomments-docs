...
[inline-code-attrs-start title = 'Пример cURL захтева за DomainConfig PUT'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'Структура захтева за DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Структура одговора за DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
