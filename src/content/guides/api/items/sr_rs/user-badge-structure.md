...
export interface UserBadge {
    /** Јединствени идентификатор овог додељивања значке кориснику */
    id: string
    /** ИД корисника којем је ова значка додељена */
    userId: string
    /** ИД дефиниције значке из каталога значки тенанта */
    badgeId: string
    /** ИД тенанта који је креирао/доделио ову значку */
    fromTenantId: string
    /** Када је ова значка креирана (миллисекунде од епохе) */
    createdAt?: number
    /** Када је корисник примио ову значку (миллисекунде од епохе) */
    receivedAt?: number
    /** 
     * Тип значке: 
    ...
    /** Боја оквира значке (хекс код) */
    borderColor?: string
    /** Боја текста значке (хекс код) */
    textColor?: string
    /** Додатна CSS класа за стиловање */
    cssClass?: string
    /** За ветеране значке, временски праг у милисекундама */
    veteranUserThresholdMillis?: number
    /** Да ли се ова значка приказује на корисниковим коментарима */
    displayedOnComments: boolean
    /** Редослед приказивања значке */
    order?: number
    /** Ако је подешено, ова значка се приказује само на страници са одговарајућим urlId-ом. Null за глобалне значке. */
    urlId?: string | null
}
[inline-code-end]
---