...
Diese Route bietet die Möglichkeit, einen einzelnen `TenantUser` zu ersetzen.

Das Ersetzen eines `TenantUser` hat die folgenden Einschränkungen:
...
[inline-code-attrs-start title = 'TenantUser Ersetzen cURL Beispiel'; type = 'bash'; useDemoTenantUser = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'TenantUser Ersetzen Anfragestruktur'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'TenantUser Ersetzen Antwortstruktur'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
