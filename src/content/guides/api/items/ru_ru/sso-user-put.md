...
[inline-code-attrs-start title = 'Структура ответа при обновлении SSOUser'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
interface SSOUserPutResponse {
    ...
    /** Включается при ошибке. **/
    reason?: string
    user?: SSOUser; // Мы возвращаем обновлённого пользователя при успешном запросе.
}
[inline-code-end]
