...
[inline-code-attrs-start title = 'Esempio cURL per DomainConfig PUT'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'Struttura della richiesta DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Struttura della risposta DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
