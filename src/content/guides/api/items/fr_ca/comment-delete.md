...
interface CommentDeleteQueryParams {
	...
	/** Indique si le commentaire doit être supprimé « en direct » pour les utilisateurs affichant des instances du widget de commentaires avec le même urlId. REMARQUE : double le coût en crédits de 1 à 2. **/
    isLive?: 'true' | 'false'
}
[inline-code-end]
