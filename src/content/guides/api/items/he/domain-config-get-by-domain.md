...
[inline-code-attrs-start title = 'דוגמת cURL לקונפיגורציית דומיין לפי דומיין'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request GET \
  --url 'https://fastcomments.com/api/v1/domain-configs/example.com?tenantId=demo&API_KEY=DEMO_API_SECRET'
[inline-code-end]

[inline-code-attrs-start title = 'מבנה בקשת קונפיגורציית דומיין לפי דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'מבנה תגובת קונפיגורציית דומיין לפי דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
