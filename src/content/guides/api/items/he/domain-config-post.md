...
[inline-code-attrs-start title = 'דוגמת cURL ל-POST קונפיגורציית דומיין'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request POST \
...
[inline-code-attrs-start title = 'מבנה בקשת POST קונפיגורציית דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'מבנה תגובת POST קונפיגורציית דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
