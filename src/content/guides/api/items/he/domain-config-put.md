...
[inline-code-attrs-start title = 'דוגמת cURL ל-PUT קונפיגורציית דומיין'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'מבנה בקשת PUT קונפיגורציית דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'מבנה תגובת PUT קונפיגורציית דומיין'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
