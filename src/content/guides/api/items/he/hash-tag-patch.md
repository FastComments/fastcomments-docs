...
[inline-code-attrs-start title = 'דוגמת cURL לעדכון האשטאג'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'מבנה בקשת עדכון האשטאג'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'מבנה תגובת עדכון האשטאג'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
