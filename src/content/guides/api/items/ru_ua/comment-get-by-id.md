...
[inline-code-attrs-start title = 'Структура запроса на получение комментария по id'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Структура ответа при получении комментария по id'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
