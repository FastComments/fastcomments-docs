...
[inline-code-attrs-start title = 'Структура запроса обновления HashTag'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Структура ответа на обновление HashTag'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
interface HashTagPatchResponse {
    ...
    /** Указывается при неудаче. **/
    reason?: string
    hashTag?: HashTag; // Мы возвращаем полностью обновлённый HashTag при успехе.
}
[inline-code-end]
