...
[inline-code-attrs-start title = 'Пример cURL запроса Tenant'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request GET \
...
[inline-code-attrs-start title = 'Пример cURL запроса Tenant по meta'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request GET \
