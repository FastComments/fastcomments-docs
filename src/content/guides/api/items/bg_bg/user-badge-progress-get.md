...
- `userId` - Вземете напредъка за конкретен потребител
- `limit` - Максимален брой записи за връщане (по подразбиране 30, максимум 200)
- `skip` - Брой записи за пропускане (за пагинация)
