...
[inline-code-attrs-start title = 'DomainConfig PATCH — przykład cURL'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'DomainConfig PATCH — struktura żądania'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'DomainConfig PATCH — struktura odpowiedzi'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
