...
[inline-code-attrs-start title = 'DomainConfig PUT cURL Παράδειγμα'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PUT \
...
[inline-code-attrs-start title = 'Δομή Αιτήματος DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Δομή Απάντησης DomainConfig PUT'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
