...
[inline-code-attrs-start title = 'HashTag Bijwerken cURL-voorbeeld'; type = 'bash'; useDemoTenant = true; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
curl --request PATCH \
...
[inline-code-attrs-start title = 'Structuur van HashTag-bijwerkverzoek'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Structuur van het antwoord bij het bijwerken van een HashTag'; type = 'typescript'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
interface HashTagPatchResponse {
    ...
    /** Opgenomen bij mislukking. **/
    reason?: string
    hashTag?: HashTag; // Bij succes geven we de volledig bijgewerkte hashtag terug.
}
[inline-code-end]