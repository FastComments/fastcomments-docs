---
The comment widget can be <a href="/guide-customizations-and-configuration.html#custom-css" target="_blank">自定义</a> differently for each site.
...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = 'label.domain'; alt='小部件自定义页面上的域名下拉列表，设置为 All 或特定站点'; title='自定义规则域' app-screenshot-end]
