To find out the limit for the number of domains in your account, visit the [Billing Page](https://fastcomments.com/auth/my-account/billing-info).
...
In the example where you're on a tier with five million monthly page loads and have five domains added to your account, and
