---
The comment widget can be <a href="/guide-customizations-and-configuration.html#custom-css" target="_blank">prilagođen</a> differently for each site.
...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = 'label.domain'; alt='Padajući meni domena na stranici za prilagođavanje widgeta, postavljen na All ili jedan određeni sajt'; title='Domen pravila prilagođavanja' app-screenshot-end]
