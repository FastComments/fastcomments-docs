...
[app-screenshot-start url='/auth/my-account/configure-domains'; selector = '.content form'; alt='도메인별 이메일 설정 양식 (From Name, From Email 및 로고 업로드 필드 포함)'; title='From Name, Email 및 로고 사용자 지정' app-screenshot-end]
