The comment widget can be <a href="/guide-customizations-and-configuration.html#custom-css" target="_blank">customized</a> differently for each site.
...
[app-screenshot-start url='/auth/my-account/customize-widget/new'; selector = 'label.domain'; alt='The domain dropdown on the widget customization page, set to All or one specific site'; title='Customization Rule Domain' app-screenshot-end]
