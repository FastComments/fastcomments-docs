Στη συνέχεια θα προσθέσουμε τον κώδικα του widget FastComments στην ιστοσελίδα σας. Αυτός ο κώδικας θα αναζητήσει όλες τις φόρμες με τον τίτλο `FastComments Goes Here` και
θα τις αντικαταστήσει με το FastComments.
...
<div class="screenshot white-bg">
    <div class="title">Άνοιγμα Προσαρμοσμένου Κώδικα Head</div>
    <img class="screenshot-image" src="/images/installation-guides/ionos-step-2-open-custom-head-code.png" alt="Άνοιγμα Προσαρμοσμένου Κώδικα Head" />
</div>
