...
<div class="screenshot white-bg">
    <div class="title">Åbn Indstillinger</div>
    <img class="screenshot-image" src="/images/installation-guides/ionos-step-2-open-settings.png" alt="Åbn Indstillinger" />
</div>

Open the `Custom Head Code` section:

<div class="screenshot white-bg">
    <div class="title">Åbn Custom Head Code</div>
    <img class="screenshot-image" src="/images/installation-guides/ionos-step-2-open-custom-head-code.png" alt="Åbn Custom Head Code" />
</div>
...
[inline-code-attrs-start title = 'Ionos FastComments-udsnit'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
        ...
        function attemptLoad() {
            ...
            nodes.forEach(function (node) {
                if (node.innerText && node.innerText.trim() === 'FastComments Goes Here') {
                    // vi finder elementet, som ikke er i fuld bredde
...
<div class="screenshot white-bg">
    <div class="title">Sæt ind og gem</div>
    <img class="screenshot-image" src="/images/installation-guides/ionos-step-2-paste-and-save.png" alt="Sæt ind og gem" />
</div>
