...
<div class="screenshot white-bg">
    <div class="title">Ouvrir le code d'en-tête personnalisé</div>
    <img class="screenshot-image" src="/images/installation-guides/ionos-step-2-open-custom-head-code.png" alt="Ouvrir le code d'en-tête personnalisé" />
</div>
        ...
        function attemptLoad() {
            ...
            nodes.forEach(function (node) {
                if (node.innerText && node.innerText.trim() === 'FastComments Goes Here') {
                    // nous récupérons l'élément qui n'est pas en pleine largeur
