...
[inline-code-attrs-start title = 'deleteHashTag Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Fjern kommentar nedenfor for at indstille præfiks (fx Bearer) for API-nøgle, hvis nødvendigt
