...
[inline-code-attrs-start title = 'Eksempel på updateTenantPackage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
require_once(__DIR__ . '/vendor/autoload.php');


// Konfigurer godkendelse via API-nøgle: api_key
