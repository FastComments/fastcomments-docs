...
[inline-code-attrs-start title = 'deleteTenantPackage Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Fjern kommentartegn nedenfor for at sætte præfiks (f.eks. Bearer) for API-nøglen, hvis nødvendigt
