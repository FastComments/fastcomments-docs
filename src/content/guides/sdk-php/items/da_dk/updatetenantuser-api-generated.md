...
[inline-code-attrs-start title = 'updateTenantUser Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Fjern kommentar på linjen nedenfor for at sætte præfiks (f.eks. Bearer) til API-nøglen, hvis nødvendigt
