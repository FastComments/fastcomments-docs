...
Returnerer: [`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantUserResponse.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Hvis du vil bruge en personlig http-klient, skal du videregive din klient som implementerer `GuzzleHttp\ClientInterface`.
