...
[inline-code-attrs-start title = 'unBlockUserFromComment Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Hvis du ønsker at bruge en brugerdefineret http-klient, send din klient som implementerer `GuzzleHttp\ClientInterface`.
