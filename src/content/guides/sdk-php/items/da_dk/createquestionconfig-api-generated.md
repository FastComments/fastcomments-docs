...
// Fjern kommentaren nedenfor for at opsætte præfiks (e.g. Bearer) til API key, if needed
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Hvis du vil bruge en brugerdefineret http client, pass din client som implementerer `GuzzleHttp\ClientInterface`.
    // Dette er optional, `GuzzleHttp\Client` vil blive brugt som default.
