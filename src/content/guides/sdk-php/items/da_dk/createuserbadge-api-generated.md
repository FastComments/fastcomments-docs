...
Returnerer: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/APICreateUserBadgeResponse.php)

## Eksempel

[inline-code-attrs-start title = 'createUserBadge Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Fjern kommenteringen nedenfor for at opsætte præfiks (f.eks. Bearer) for API-nøgle, hvis nødvendigt
