...
[inline-code-attrs-start title = 'createV1PageReact Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    // Hvis du vil bruge en tilpasset HTTP-klient, skal du aflevere din klient, som implementerer `GuzzleHttp\ClientInterface`.
