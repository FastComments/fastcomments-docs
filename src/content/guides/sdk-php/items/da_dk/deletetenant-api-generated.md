...
[inline-code-attrs-start title = 'deleteTenant Eksempel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Hvis du vil bruge en brugerdefineret HTTP-klient, videregiv din klient, der implementerer `GuzzleHttp\ClientInterface`.
