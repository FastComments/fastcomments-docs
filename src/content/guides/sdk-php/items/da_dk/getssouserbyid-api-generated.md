...
Returnerer: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetSSOUserByIdAPIResponse.php)

## Eksempel

[inline-code-attrs-start title = 'Eksempel på getSSOUserById'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
