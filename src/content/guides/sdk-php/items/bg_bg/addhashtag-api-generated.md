...
Връща: [`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateHashTagResponse.php)

## Пример

[inline-code-attrs-start title = 'Пример за addHashTag'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Разкоментирайте долния ред за добавяне на префикс (например Bearer) към API ключа, ако е необходимо
