...
Връща: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PatchPageAPIResponse.php)

## Пример

[inline-code-attrs-start title = 'patchPage Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
require_once(__DIR__ . '/vendor/autoload.php');


// Конфигуриране на оторизация на API ключ: api_key
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Това е по желание, `GuzzleHttp\Client` ще се използва по подразбиране.
