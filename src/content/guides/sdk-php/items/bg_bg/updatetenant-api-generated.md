...
[inline-code-attrs-start title = 'updateTenant Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Този ред разкоментарирайте, за да зададете префикс (напр. Bearer) за API ключа, ако е необходимо
