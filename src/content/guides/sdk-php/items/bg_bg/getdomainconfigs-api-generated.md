...
Връща: [`GetDomainConfigsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetDomainConfigsResponse.php)
...
// Откоментирайте по-долу, за да зададете представка (напр. Bearer) за API ключа, ако е необходимо
