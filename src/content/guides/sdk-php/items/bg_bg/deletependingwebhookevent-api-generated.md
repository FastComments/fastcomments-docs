...
[inline-code-attrs-start title = 'Пример за deletePendingWebhookEvent'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
require_once(__DIR__ . '/vendor/autoload.php');

// Конфигуриране на упълномощаване с API ключ: api_key
// Разкоментирайте следното, за да зададете префикс (напр. Bearer) за API ключа, ако е необходимо
