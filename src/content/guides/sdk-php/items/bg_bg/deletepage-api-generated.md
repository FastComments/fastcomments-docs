...
Връща: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/DeletePageAPIResponse.php)

## Пример

[inline-code-attrs-start title = 'Пример за deletePage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
