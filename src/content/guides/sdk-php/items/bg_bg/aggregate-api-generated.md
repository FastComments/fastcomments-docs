...
[inline-code-attrs-start title = 'пример за агрегиране'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$options = [
    'parent_tenant_id' => 'parent_tenant_id_example', // стринг
    'include_stats' => True, // булев
];
