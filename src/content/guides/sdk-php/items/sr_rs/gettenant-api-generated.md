...
[inline-code-attrs-start title = 'Primer getTenant'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ако желиш да користиш прилагођени http клијент, проследи свог клијента који имплементира `GuzzleHttp\ClientInterface`.
