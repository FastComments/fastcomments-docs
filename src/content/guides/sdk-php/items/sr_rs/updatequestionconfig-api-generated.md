...
[inline-code-attrs-start title = 'updateQuestionConfig Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Откоментари за подешавање префикса (нпр. Bearer) за API кључ, ако је потребно
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ако желите да користите прилагођени HTTP клиент, проследите свој клиент који имплементира `GuzzleHttp\ClientInterface`.
...
try {
    ...
    echo 'Изузетак приликом позивања DefaultApi->updateQuestionConfig: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]