...
[inline-code-attrs-start title = 'Пример deletePendingWebhookEvent'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Откоментирајте доле да подесите префикс (на пример Bearer) за API кључ, ако је потребно
