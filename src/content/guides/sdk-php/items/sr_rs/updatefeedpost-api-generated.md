...
[inline-code-attrs-start title = 'updateFeedPost Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ово је опционије, `GuzzleHttp\Client` ће се користити као подразумевано.
