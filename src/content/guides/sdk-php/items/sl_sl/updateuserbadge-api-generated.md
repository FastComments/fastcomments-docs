...
Vrne: [`UpdateUserBadge200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/UpdateUserBadge200Response.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // To ni potrebno, privzeto bo uporabljen `GuzzleHttp\Client`.
