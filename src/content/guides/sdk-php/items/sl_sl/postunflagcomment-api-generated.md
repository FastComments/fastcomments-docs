...
[inline-code-attrs-start title = 'Primer postUnFlagComment'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // To ni obvezno, `GuzzleHttp\Client` bo uporabljen kot privzeti.
