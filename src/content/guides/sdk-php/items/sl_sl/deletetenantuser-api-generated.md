...
[inline-code-attrs-start title = 'deleteTenantUser Primer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Če želite uporabiti uporabniški http odjemalec, posredujte svoj odjemalec, ki implementira `GuzzleHttp\ClientInterface`.
