...
Vrne: [`CreateTenantUser200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantUser200Response.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Če želite uporabiti prilagojenega HTTP klienta, podajte svoj klient, ki implementira `GuzzleHttp\ClientInterface`.
