...
// Odkomentiraj spodaj, da nastaviš predpono (npr. Bearer) za API ključ, če je potrebno
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Če želiš uporabiti prilagojen http odjemalec, podaj svoj odjemalec, ki implementira `GuzzleHttp\ClientInterface`.
