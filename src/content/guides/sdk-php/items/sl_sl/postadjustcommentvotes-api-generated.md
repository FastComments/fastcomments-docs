...
Vrne: [`AdjustVotesResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AdjustVotesResponse.php)

## Primer

[inline-code-attrs-start title = 'Primer postAdjustCommentVotes'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // To je neobvezno — kot privzeti odjemalec bo uporabljen `GuzzleHttp\Client`.
