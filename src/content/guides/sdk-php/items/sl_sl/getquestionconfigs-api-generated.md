...
Vrne: [`GetQuestionConfigsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetQuestionConfigsResponse.php)
...
// Konfiguracija avtentikacije API ključa: api_key
