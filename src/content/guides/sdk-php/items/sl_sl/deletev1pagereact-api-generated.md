...
[inline-code-attrs-start title = 'deleteV1PageReact Primer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    // Če želite uporabiti prilagojeni HTTP odjemalec, podajte svoj odjemalec, ki izvaja `GuzzleHttp\ClientInterface`.
