...
Vrne: [`RenderEmailTemplate200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/RenderEmailTemplate200Response.php)
...
// Odkomentirajte spodnje vrstice, da nastavite predpono (npr. Bearer) za API ključ, če je potrebno
