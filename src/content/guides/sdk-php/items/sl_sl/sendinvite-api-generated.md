...
// Nastavi pooblastitev API ključa: api_key
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Če želiš uporabiti svoj HTTP odjemalec, predaj svoj odjemalec, ki implementira `GuzzleHttp\ClientInterface`.
...
$id = 'id_example'; // niz
$from_name = 'from_name_example'; // niz
