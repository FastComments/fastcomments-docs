...
[inline-code-attrs-start title = 'Primer postFlagComment'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // To je neobvezno; kot privzeti se bo uporabljal `GuzzleHttp\Client`.
