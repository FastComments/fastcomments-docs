...
[inline-code-attrs-start title = 'Exemple patchHashTag'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Décommentez ci-dessous pour configurer le préfixe (par ex. Bearer) pour la clé API, si besoin
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Si vous souhaitez utiliser un client HTTP personnalisé, passez votre client implémentant `GuzzleHttp\ClientInterface`.
