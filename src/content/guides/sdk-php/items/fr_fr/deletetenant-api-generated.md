...
[inline-code-attrs-start title = 'Exemple deleteTenant'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel de DefaultApi->deleteTenant: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]