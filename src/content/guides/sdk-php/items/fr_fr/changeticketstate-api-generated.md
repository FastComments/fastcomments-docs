...
Retourne : [`ChangeTicketStateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/ChangeTicketStateResponse.php)

## Exemple

[inline-code-attrs-start title = 'changeTicketState Exemple'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel de DefaultApi->changeTicketState: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]
