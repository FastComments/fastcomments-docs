...
[inline-code-attrs-start title = 'Exemple createSubscription'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel à DefaultApi->createSubscription : ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]