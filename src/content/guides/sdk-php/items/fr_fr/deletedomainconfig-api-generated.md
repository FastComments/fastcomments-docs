...
| domain | string | chemin | Oui |  |

## Réponse

Retourne : [`DeleteDomainConfigResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/DeleteDomainConfigResponse.php)

## Exemple

[inline-code-attrs-start title = 'deleteDomainConfig Exemple'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
