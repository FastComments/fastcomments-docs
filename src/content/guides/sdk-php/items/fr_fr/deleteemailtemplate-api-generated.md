...
[inline-code-attrs-start title = 'Exemple deleteEmailTemplate'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel de DefaultApi->deleteEmailTemplate : ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]