---
Regroupe les documents en les groupant (si **groupBy** est fourni) et en appliquant plusieurs opérations.  
...
Renvoie : [`AggregateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AggregateResponse.php)
...
// Configurez l'autorisation de la clé API : api_key
...
$options = [
    'parent_tenant_id' => 'parent_tenant_id_example', // chaîne
