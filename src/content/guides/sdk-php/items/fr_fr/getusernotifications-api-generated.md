...
| urlId | string | query | Non | Utilisé pour déterminer si la page courante est abonnée. |
...
[inline-code-attrs-start title = 'Exemple de getUserNotifications'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$url_id = 'url_id_example'; // string | Utilisé pour déterminer si la page courante est abonnée.
$page_size = 56; // int
