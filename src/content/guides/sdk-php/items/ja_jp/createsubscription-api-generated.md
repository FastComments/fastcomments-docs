...
戻り値: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateSubscriptionAPIResponse.php)

## 例

[inline-code-attrs-start title = 'createSubscription の例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
