...
返却: [`APICreateUserBadgeResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/APICreateUserBadgeResponse.php)

## 例

[inline-code-attrs-start title = 'createUserBadge 例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
