...
[inline-code-attrs-start title = 'getQuestionResults 例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 必要に応じて、APIキーのプレフィックス（例: Bearer）を設定するには、コメントアウトを解除してください
...
$options = [
    ...
    'start_date' => 'start_date_example', // 文字列
    'question_id' => 'question_id_example', // 文字列
    'question_ids' => 'question_ids_example', // 文字列
    'skip' => 3.4, // 浮動小数点数
];
