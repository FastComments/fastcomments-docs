...
戻り値: [`GetModeratorsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetModeratorsResponse.php)
...
// 必要に応じて APIキーの接頭辞（例: Bearer）を設定するには、下の行のコメントを外してください
