...
返却: [`CreateTenantPackageResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantPackageResponse.php)

## 例

[inline-code-attrs-start title = 'createTenantPackage 例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
