...
[inline-code-attrs-start title = 'updateQuestionConfig の例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 必要に応じて、APIキー用のプレフィックス（例: Bearer）を設定する場合は以下の行のコメントを外してください
