...
返り値: [`GetCachedNotificationCountResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetCachedNotificationCountResponse.php)
...
// 必要に応じて、下のコメントアウトを解除して APIキーのプレフィックス（例: Bearer）を設定
