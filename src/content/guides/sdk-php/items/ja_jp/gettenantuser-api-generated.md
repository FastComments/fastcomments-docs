...
戻り値: [`GetTenantUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetTenantUserResponse.php)
...
// 必要に応じて下の行のコメントを外し、APIキーのプレフィックス（例: Bearer）を設定してください
