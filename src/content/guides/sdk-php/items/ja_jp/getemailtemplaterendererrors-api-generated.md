...
返り値: [`GetEmailTemplateRenderErrorsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetEmailTemplateRenderErrorsResponse.php)

## 例

[inline-code-attrs-start title = 'getEmailTemplateRenderErrors 例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
