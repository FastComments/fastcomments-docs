...
[inline-code-attrs-start title = 'postSetCommentText 例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'ModerationApi->postSetCommentText の呼び出し時の例外: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]