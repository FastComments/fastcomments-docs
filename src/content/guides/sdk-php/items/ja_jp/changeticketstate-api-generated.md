...
返却: [`ChangeTicketStateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/ChangeTicketStateResponse.php)
...
// 必要に応じて、以下のコメントアウトを外してプレフィックス (例: Bearer) を設定してください
