...
返却: [`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantUserResponse.php)
...
// 必要に応じて以下のコメントを外してプレフィックス (例: Bearer) を設定
