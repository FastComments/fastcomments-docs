...
戻り値: [`GetUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetUserResponse.php)
...
// 必要に応じて、APIキーのプレフィックス（例: Bearer）を設定するには下の行をコメント解除してください
