...
[inline-code-attrs-start title = 'deleteTenantUser の例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 必要に応じてAPIキーのプレフィックス（例：Bearer）を設定するには、以下の行のコメントを解除してください
