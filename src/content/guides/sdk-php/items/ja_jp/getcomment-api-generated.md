...
返り値: [`APIGetCommentResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/APIGetCommentResponse.php)
...
// 必要に応じて、以下のコメントを外して APIキー のプレフィックス (例: Bearer) を設定
