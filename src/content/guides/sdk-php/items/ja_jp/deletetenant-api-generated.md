...
[inline-code-attrs-start title = 'deleteTenant の例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 必要に応じて API キーのプレフィックス（例: Bearer）を設定する場合は下の行のコメントを解除
