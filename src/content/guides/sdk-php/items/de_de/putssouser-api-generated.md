...
Gibt zurück: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PutSSOUserAPIResponse.php)
...
// Unten auskommentieren, um ein Präfix einzurichten (z. B. Bearer) für den API-Schlüssel, falls benötigt
