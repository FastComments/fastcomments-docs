...
Gibt zurück: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateFeedPostsResponse.php)

## Beispiel

[inline-code-attrs-start title = 'Beispiel für createFeedPost'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Kommentar unten entfernen, um ein Präfix (z. B. Bearer) für den API-Schlüssel zu setzen, falls benötigt
