...
[inline-code-attrs-start title = 'deleteQuestionResult Beispiel'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Auskommentieren, um bei Bedarf ein Prefix (z. B. Bearer) für den API-Schlüssel einzurichten
