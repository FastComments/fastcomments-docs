...
[inline-code-attrs-start title = 'Exemple d\'envoi d\'invitation'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$from_name = 'from_name_example'; // chaîne
...
try {
    ...
    echo 'Exception lors de l\'appel de DefaultApi->sendInvite : ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]