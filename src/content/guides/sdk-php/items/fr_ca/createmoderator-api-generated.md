...
Retourne : [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateModeratorResponse.php)

## Exemple

[inline-code-attrs-start title = 'Exemple de createModerator'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ceci est optionnel, `GuzzleHttp\Client` sera utilisé comme défaut.
