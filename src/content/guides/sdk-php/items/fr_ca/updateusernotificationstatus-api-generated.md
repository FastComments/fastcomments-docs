...
[inline-code-attrs-start title = 'Exemple de updateUserNotificationStatus'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$new_status = 'new_status_example'; // chaîne
