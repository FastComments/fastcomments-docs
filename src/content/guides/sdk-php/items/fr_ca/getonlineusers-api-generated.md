...
| afterUserId | string | query | Non | Critère de départ du curseur : passez nextAfterUserId depuis la réponse précédente. Requis lorsque afterName est défini afin d'éviter que des égalités de noms n'entraînent la suppression d'entrées. |
...
[inline-code-attrs-start title = 'Exemple de getOnlineUsers'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$after_user_id = 'after_user_id_example'; // string | Critère de départ du curseur : passez nextAfterUserId depuis la réponse précédente. Requis lorsque afterName est défini afin d'éviter que des égalités de noms n'entraînent la suppression d'entrées.
