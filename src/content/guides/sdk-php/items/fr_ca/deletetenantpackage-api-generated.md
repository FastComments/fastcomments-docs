...
[inline-code-attrs-start title = 'Exemple de deleteTenantPackage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Décommentez ci‑dessous pour définir le préfixe (ex. Bearer) de la clé API, si nécessaire
