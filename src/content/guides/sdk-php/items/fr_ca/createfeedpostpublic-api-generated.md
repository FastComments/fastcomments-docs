...
[inline-code-attrs-start title = 'Exemple createFeedPostPublic'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel de PublicApi->createFeedPostPublic : ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]