...
Renvoie : [`GetModeratorResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetModeratorResponse.php)

## Exemple

[inline-code-attrs-start title = 'Exemple getModerator'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exception lors de l\'appel de DefaultApi->getModerator : ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]