...
[inline-code-attrs-start title = 'updateQuestionResult 示例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 如有需要，取消注释下面的行以设置前缀（例如 Bearer）用于 API 密钥
...
try {
    ...
    echo '调用 DefaultApi->updateQuestionResult 时的异常: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]