...
返回: [`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateEmailTemplateResponse.php)
...
// 如有需要，取消下面注释以设置前缀（例如 Bearer）用于 API 密钥
