...
[inline-code-attrs-start title = 'deleteModerator 示例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 如有需要，取消下面注释以设置 API 密钥前缀（例如 Bearer）
