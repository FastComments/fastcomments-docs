...
返回: [`CreateQuestionConfigResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateQuestionConfigResponse.php)
...
// 如果需要，取消注释下面为 API 密钥设置前缀（例如 Bearer）
