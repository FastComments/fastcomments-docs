...
$options = [
    'size_preset' => new \FastComments\Client\Model\\FastComments\Client\Model\SizePreset(), // \FastComments\Client\Model\SizePreset | 大小预设: \"Default\" (1000x1000px) 或 \"CrossPlatform\" (为常用设备创建尺寸)
    'url_id' => 'url_id_example', // string | 上传所在页面的 ID，用于配置
];
