...
返回：[`CreateHashTagResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateHashTagResponse.php)

## 示例

[inline-code-attrs-start title = 'addHashTag 示例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 如有需要，取消注释以下代码为 API 密钥设置前缀（例如 Bearer）
