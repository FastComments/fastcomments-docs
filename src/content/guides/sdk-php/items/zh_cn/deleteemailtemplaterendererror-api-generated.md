...
[inline-code-attrs-start title = 'deleteEmailTemplateRenderError 示例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 取消注释以下行以为 API 密钥设置前缀（例如 Bearer），如果需要的话
