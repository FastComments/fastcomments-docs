...
返回：[`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PatchSSOUserAPIResponse.php)

## 示例

[inline-code-attrs-start title = 'patchSSOUser 示例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 取消注释以下以设置 API 密钥的前缀（例如 Bearer），如果需要
