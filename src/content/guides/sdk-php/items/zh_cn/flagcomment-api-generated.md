...
返回: [`FlagComment200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/FlagComment200Response.php)
...
// 如有需要，取消下面代码的注释以设置 API 密钥的前缀（例如 Bearer）
