...
返回：[`GetQuestionResultResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetQuestionResultResponse.php)
...
// 如有需要，请取消注释下面的行以设置 API 密钥的前缀（例如 Bearer）
