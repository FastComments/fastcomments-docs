...
반환: [`PutDomainConfigResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PutDomainConfigResponse.php)
...
// 필요한 경우 API 키 접두사(예: Bearer)를 설정하려면 아래의 주석 처리를 해제하세요
