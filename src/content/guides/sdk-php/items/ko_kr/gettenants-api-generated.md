...
반환: [`GetTenantsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetTenantsResponse.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // 이 옵션은 선택 사항입니다. 기본적으로 `GuzzleHttp\Client`가 사용됩니다.
