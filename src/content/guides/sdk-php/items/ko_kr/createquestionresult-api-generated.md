...
반환: [`CreateQuestionResultResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateQuestionResultResponse.php)

## 예시

[inline-code-attrs-start title = 'createQuestionResult 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 아래의 주석을 해제하여 API 키 접두사를 설정합니다 (예: Bearer), 필요 시
