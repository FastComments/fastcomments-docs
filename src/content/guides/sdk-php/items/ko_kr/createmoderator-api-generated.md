...
반환: [`CreateModerator200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateModerator200Response.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // 이 부분은 선택 사항입니다. 기본으로 `GuzzleHttp\Client`가 사용됩니다.
