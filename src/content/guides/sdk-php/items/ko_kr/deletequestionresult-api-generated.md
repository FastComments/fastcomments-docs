...
[inline-code-attrs-start title = 'deleteQuestionResult 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요 시 API 키에 대한 접두사(예: Bearer)를 설정하려면 아래 주석을 해제하십시오
