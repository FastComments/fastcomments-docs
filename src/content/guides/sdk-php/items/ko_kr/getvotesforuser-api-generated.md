...
반환: [`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetVotesForUserResponse.php)
...
// 필요한 경우 아래 주석을 제거하여 API 키에 대한 접두사(예: Bearer)를 설정하세요
