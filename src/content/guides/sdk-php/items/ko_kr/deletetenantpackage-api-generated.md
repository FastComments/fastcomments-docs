...
[inline-code-attrs-start title = 'deleteTenantPackage 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요 시 API 키에 대한 프리픽스(e.g. Bearer)를 설정하려면 아래 주석을 해제하십시오
