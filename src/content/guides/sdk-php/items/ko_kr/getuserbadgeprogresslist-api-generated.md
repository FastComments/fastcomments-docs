...
[inline-code-attrs-start title = 'getUserBadgeProgressList 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 아래의 주석을 해제하면 API 키에 대한 접두사(e.g. Bearer)를 설정합니다, 필요 시
