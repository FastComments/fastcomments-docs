...
반환: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PutSSOUserAPIResponse.php)

## 예시

[inline-code-attrs-start title = 'putSSOUser 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요하면 아래의 주석을 해제하여 API 키 접두사(e.g. Bearer)를 설정합니다
