...
[inline-code-attrs-start title = 'deleteModerator 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요에 따라 아래 주석을 해제하여 API 키 접두사(e.g. Bearer)를 설정합니다
...
$id = 'id_example'; // 문자열
$send_email = 'send_email_example'; // 문자열
