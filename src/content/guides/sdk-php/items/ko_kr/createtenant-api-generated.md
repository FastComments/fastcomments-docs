...
반환: [`CreateTenantResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantResponse.php)

## 예제

[inline-code-attrs-start title = 'createTenant 예제'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요에 따라 API 키에 대한 접두사(e.g. Bearer)를 설정하려면 아래의 주석을 해제하십시오
