...
[inline-code-attrs-start title = 'deleteEmailTemplate 예제'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요하면 아래 주석을 해제하여 API 키에 대한 접두사(e.g. Bearer)를 설정합니다.
