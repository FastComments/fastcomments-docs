...
반환: [`GetQuestionResultsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetQuestionResultsResponse.php)
...
$start_date = 'start_date_example'; // 문자열
$question_id = 'question_id_example'; // 문자열
$question_ids = 'question_ids_example'; // 문자열
$skip = 3.4; // 실수
