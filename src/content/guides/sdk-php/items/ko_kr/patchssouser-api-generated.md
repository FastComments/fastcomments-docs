...
반환: [`PatchSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PatchSSOUserAPIResponse.php)

## 예시

[inline-code-attrs-start title = 'patchSSOUser 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 아래의 주석을 해제하여 프리픽스 설정 (예: Bearer) 을 API 키에 적용, 필요한 경우
