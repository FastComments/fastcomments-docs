...
반환: [`GetTicketResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetTicketResponse.php)

## 예시

[inline-code-attrs-start title = 'getTicket 예시'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// 필요하면 아래의 주석을 해제하여 API 키에 대한 접두사(e.g. Bearer)를 설정하세요
