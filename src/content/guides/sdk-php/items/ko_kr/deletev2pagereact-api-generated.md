...
[inline-code-attrs-start title = 'deleteV2PageReact 예제'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$tenant_id = 'tenant_id_example'; // string (문자열)
$url_id = 'url_id_example'; // string (문자열)
$id = 'id_example'; // string (문자열)
