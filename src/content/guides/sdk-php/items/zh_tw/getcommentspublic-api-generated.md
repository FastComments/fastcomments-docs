...
回傳: [`GetCommentsResponseWithPresencePublicComment`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetCommentsResponseWithPresencePublicComment.php)
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    ...
    // 這為選用項目，預設會使用 `GuzzleHttp\Client`。
