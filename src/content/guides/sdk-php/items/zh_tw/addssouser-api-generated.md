...
回傳: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AddSSOUserAPIResponse.php)
...
// 如有需要，請取消註解以下內容以為 API 金鑰設定前綴（例如 Bearer）
