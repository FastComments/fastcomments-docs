...
[inline-code-attrs-start title = 'postFlagComment 範例'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    // 如果您想使用自訂 http 客戶端，請傳入實作了 `GuzzleHttp\ClientInterface` 的客戶端。
