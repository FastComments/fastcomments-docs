...
回傳: [`CreateModeratorResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateModeratorResponse.php)
...
// 如需設定前綴（例如 Bearer）給 API 金鑰，請取消註解下列程式碼
