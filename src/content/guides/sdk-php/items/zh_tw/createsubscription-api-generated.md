...
回傳：[`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateSubscriptionAPIResponse.php)
...
// 如有需要，取消註解以下以設定前綴（例如 Bearer）給 API 金鑰
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // 如果要使用自訂的 http client，請傳入實作 `GuzzleHttp\ClientInterface` 的客戶端。
