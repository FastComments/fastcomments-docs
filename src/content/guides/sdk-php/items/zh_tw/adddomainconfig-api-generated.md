...
回傳：[`AddDomainConfig200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AddDomainConfig200Response.php)
...
// 若需要，取消註解下列內容以設定 API 金鑰前綴（例如 Bearer）
