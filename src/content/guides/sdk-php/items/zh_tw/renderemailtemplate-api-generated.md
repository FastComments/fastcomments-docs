...
回傳: [`RenderEmailTemplateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/RenderEmailTemplateResponse.php)
...
// 若需要，解除下方註解以設定 API 金鑰的前綴（例如 Bearer）
