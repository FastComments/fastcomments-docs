...
$options = [
    'size_preset' => new \FastComments\Client\Model\\FastComments\Client\Model\SizePreset(), // \FastComments\Client\Model\SizePreset | 尺寸預設：\"Default\" (1000x1000px) 或 \"CrossPlatform\" (為流行設備建立尺寸)
    'url_id' => 'url_id_example', // string | 上傳發生的頁面 ID，用於配置
];
