...
回傳：[`CreateEmailTemplateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateEmailTemplateResponse.php)
...
// 如需設定前綴（例如 Bearer）給 API 金鑰，可取消註解下列程式碼
