...
回傳：[`GetVotesForUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetVotesForUserResponse.php)
...
// 如有需要，取消註解以下以設定 API 金鑰的前置字串（例如 Bearer）
