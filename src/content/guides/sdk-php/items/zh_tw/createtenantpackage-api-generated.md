...
回傳: [`CreateTenantPackageResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantPackageResponse.php)
...
// 如有需要，取消下列註解以設定 API 金鑰的前綴（例如 Bearer）
