...
Повертає: [`GetSubscriptionsAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetSubscriptionsAPIResponse.php)

## Приклад

[inline-code-attrs-start title = 'Приклад getSubscriptions'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
