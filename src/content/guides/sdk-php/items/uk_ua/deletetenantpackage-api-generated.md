...
[inline-code-attrs-start title = 'Приклад deleteTenantPackage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Розкоментуйте нижче, щоб задати префікс (наприклад, Bearer) для ключа API, якщо потрібно
