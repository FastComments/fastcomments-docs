...
Повертає: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateFeedPostsResponse.php)

## Приклад

[inline-code-attrs-start title = 'Приклад createFeedPost'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$options = [
    ...
    'is_live' => True, // бул
    'do_spam_check' => True, // бул
    'skip_dup_check' => True, // бул
];
