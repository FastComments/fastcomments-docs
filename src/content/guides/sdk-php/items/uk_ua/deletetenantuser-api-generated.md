...
[inline-code-attrs-start title = 'Приклад deleteTenantUser'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Якщо бажаєте використовувати власний HTTP-клієнт, передайте клієнт, який реалізує `GuzzleHttp\ClientInterface`.
...
$id = 'id_example'; // рядок
$delete_comments = 'delete_comments_example'; // рядок
