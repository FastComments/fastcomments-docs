...
[inline-code-attrs-start title = 'Приклад postUnFlagComment'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // Це опціонально, `GuzzleHttp\Client` буде використано як значення за замовчуванням.
