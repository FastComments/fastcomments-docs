...
Повертає: [`AggregateQuestionResultsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AggregateQuestionResultsResponse.php)

## Приклад

[inline-code-attrs-start title = 'aggregateQuestionResults Приклад'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$options = [
    'question_id' => 'question_id_example', // рядок
