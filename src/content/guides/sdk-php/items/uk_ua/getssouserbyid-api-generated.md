...
Повертає: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetSSOUserByIdAPIResponse.php)

## Приклад

[inline-code-attrs-start title = 'Приклад getSSOUserById'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
