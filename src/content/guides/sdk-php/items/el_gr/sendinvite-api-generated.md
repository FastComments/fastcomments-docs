...
[inline-code-attrs-start title = 'Παράδειγμα sendInvite'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Εάν θέλετε να χρησιμοποιήσετε προσαρμοσμένο HTTP client, περάστε τον client που υλοποιεί την `GuzzleHttp\ClientInterface`.
