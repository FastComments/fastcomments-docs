...
[inline-code-attrs-start title = 'Παράδειγμα deleteQuestionConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Απενεργοποιήστε το παρακάτω για να ορίσετε πρόθεμα (π.χ. Bearer) για το κλειδί API, εάν απαιτείται
