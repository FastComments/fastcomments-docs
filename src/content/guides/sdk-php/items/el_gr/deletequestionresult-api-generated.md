...
[inline-code-attrs-start title = 'Παράδειγμα deleteQuestionResult'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
require_once(__DIR__ . '/vendor/autoload.php');


// Ρύθμιση εξουσιοδότησης με το κλειδί API: api_key
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Αυτό είναι προαιρετικό — θα χρησιμοποιηθεί ως προεπιλεγμένο το `GuzzleHttp\Client`.
