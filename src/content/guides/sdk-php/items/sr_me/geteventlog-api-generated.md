...
[inline-code-attrs-start title = 'Primjer getEventLog'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Izuzetak prilikom poziva PublicApi->getEventLog: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]