...
[inline-code-attrs-start title = 'Пример updateQuestionConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Ако је потребно, откоментарајте доле да бисте подесили префикс (нпр. Bearer) за API кључ
