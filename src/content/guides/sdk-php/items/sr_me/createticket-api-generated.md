...
Враћа: [`CreateTicketResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTicketResponse.php)
...
// Ако је потребно, откоменарујте испод да подесите префикс (нпр. Bearer) за API кључ
