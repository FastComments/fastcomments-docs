...
[inline-code-attrs-start title = 'Primjer putReopenThread'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // Ovo je neobavezno, kao zadani će se koristiti `GuzzleHttp\Client`.
