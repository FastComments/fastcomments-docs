...
[inline-code-attrs-start title = 'getQuestionConfigs Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ovo je opcionalno, za zadano će se koristiti `GuzzleHttp\Client`.
