...
Vraća: [`GetUserBadge200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetUserBadge200Response.php)

## Primjer

[inline-code-attrs-start title = 'Primjer getUserBadge'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Opcionalno je; `GuzzleHttp\Client` će se koristiti kao zadani.
