...
[inline-code-attrs-start title = 'deleteUserBadge Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ako želite koristiti prilagođeni http klijent, proslijedite svog klijenta koji implementira `GuzzleHttp\ClientInterface`.
