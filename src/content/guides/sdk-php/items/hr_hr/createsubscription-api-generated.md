...
Vraća: [`CreateSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateSubscriptionAPIResponse.php)

## Primjer

[inline-code-attrs-start title = 'createSubscription Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Otkomentiraj dolje za postavljanje prefiksa (npr. Bearer) za API ključ, po potrebi
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ovo je opcionalno, `GuzzleHttp\Client` će se koristiti po zadanom.
