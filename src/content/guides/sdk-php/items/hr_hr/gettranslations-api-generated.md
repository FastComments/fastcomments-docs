...
[inline-code-attrs-start title = 'getTranslations Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    ...
    // Ovo je opcionalno, kao zadani klijent bit će korišten `GuzzleHttp\Client`.
