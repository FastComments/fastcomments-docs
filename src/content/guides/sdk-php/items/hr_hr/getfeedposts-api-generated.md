...
Vraća: [`GetFeedPostsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetFeedPostsResponse.php)
...
// Otkomentiraj dolje da postaviš prefiks (npr. Bearer) za API ključ, ako je potrebno
