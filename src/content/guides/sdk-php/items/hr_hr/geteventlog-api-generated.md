...
[inline-code-attrs-start title = 'getEventLog Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    // Ako želite koristiti prilagođenog HTTP klijenta, proslijedite vaš klijent koji implementira `GuzzleHttp\ClientInterface`.
