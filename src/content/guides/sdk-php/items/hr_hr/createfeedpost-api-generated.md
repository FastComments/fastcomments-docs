...
Vraća: [`CreateFeedPostsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateFeedPostsResponse.php)

## Primjer

[inline-code-attrs-start title = 'createFeedPost Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Okomentiraj sljedeće za postavljanje prefiksa (npr. Bearer) za API ključ, ako je potrebno
