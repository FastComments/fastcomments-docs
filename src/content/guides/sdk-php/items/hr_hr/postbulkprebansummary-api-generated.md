...
Vraća: [`BulkPreBanSummary`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/BulkPreBanSummary.php)

## Primjer

[inline-code-attrs-start title = 'postBulkPreBanSummary Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // Ovo je opcionalno, `GuzzleHttp\Client` će se koristi kao zadano.
