...
Vraća: [`GetQuestionResultResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetQuestionResultResponse.php)

## Primjer

[inline-code-attrs-start title = 'getQuestionResult Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Otkomentirajte donju liniju da biste postavili prefiks (npr. Bearer) za API ključ, ako je potrebno
