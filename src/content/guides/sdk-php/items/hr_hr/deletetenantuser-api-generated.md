...
[inline-code-attrs-start title = 'deleteTenantUser Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ovo je opcionalno, zadani će se koristiti `GuzzleHttp\Client`.
