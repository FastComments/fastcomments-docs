...
[inline-code-attrs-start title = 'getSubscriptions Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ovo je opcionalno, zadano će se koristiti `GuzzleHttp\Client`.
