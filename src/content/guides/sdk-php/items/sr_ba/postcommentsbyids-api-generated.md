...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    // Уколико желите користити прилагођени HTTP клијент, проследите ваш клијент који имплементира `GuzzleHttp\ClientInterface`.
    // Ово је опционo, подразумевани клијент ће бити `GuzzleHttp\Client`.
