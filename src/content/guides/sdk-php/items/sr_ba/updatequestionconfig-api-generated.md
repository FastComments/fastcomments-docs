...
[inline-code-attrs-start title = 'Примјер updateQuestionConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ако желите користити прилагођени HTTP клијент, прослиједите клијента који имплементира `GuzzleHttp\ClientInterface`.
