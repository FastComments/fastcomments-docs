...
[inline-code-attrs-start title = 'updateNotification Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Откоментирајте у наставку да бисте поставили префикс (нпр. Bearer) за API кључ, ако је потребно
