...
[inline-code-attrs-start title = 'deleteHashTag Пример'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Откоментирајте доле наведено да бисте подесили префикс (нпр. Bearer) за API кључ, ако је потребно
