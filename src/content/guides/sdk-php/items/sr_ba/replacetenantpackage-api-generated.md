...
[inline-code-attrs-start title = 'replaceTenantPackage Primer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Izuzetak prilikom poziva DefaultApi->replaceTenantPackage: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]