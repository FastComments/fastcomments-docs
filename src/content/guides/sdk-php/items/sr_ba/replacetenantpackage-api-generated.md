...
[inline-code-attrs-start title = 'Пример replaceTenantPackage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Ако је потребно, откоментујте испод да бисте подесили префикс (нпр. Bearer) за API кључ
