...
[inline-code-attrs-start title = 'unLockComment Primjer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    $result = $apiInstance->unLockComment($tenant_id, $comment_id, $broadcast_id, $sno);
    print_r($result);
} catch (Exception $e) {
