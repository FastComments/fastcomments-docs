...
Vraća: [`DeleteSubscriptionAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/DeleteSubscriptionAPIResponse.php)

## Primjer

[inline-code-attrs-start title = 'Primjer deleteSubscription'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Otkomentarišite donje da postavite prefiks (npr. Bearer) za API ključ, po potrebi
