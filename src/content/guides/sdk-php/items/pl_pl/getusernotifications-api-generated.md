...
[inline-code-attrs-start title = 'getUserNotifications Przykład'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$options = [
    'url_id' => 'url_id_example', // string | Używany do określenia, czy bieżąca strona jest subskrybowana.
    'page_size' => 56, // int
