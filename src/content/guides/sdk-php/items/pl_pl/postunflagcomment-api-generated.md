...
[inline-code-attrs-start title = 'postUnFlagComment Przykład'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    // Jeśli chcesz używać własnego klienta HTTP, przekaż swój client, który implementuje `GuzzleHttp\ClientInterface`.
