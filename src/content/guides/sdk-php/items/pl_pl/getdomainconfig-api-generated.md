...
[inline-code-attrs-start title = 'Przykład getDomainConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Odkomentuj poniższy kod, aby ustawić prefiks (np. Bearer) dla klucza API, jeśli to konieczne
