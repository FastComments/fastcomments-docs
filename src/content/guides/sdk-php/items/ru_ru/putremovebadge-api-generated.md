...
Возвращает: [`RemoveUserBadgeResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/RemoveUserBadgeResponse.php)
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    ...
    // Это необязательно, для этого по умолчанию будет использоваться `GuzzleHttp\Client`.
