...
[inline-code-attrs-start title = 'Пример использования updateTenantUser'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$update_comments = 'update_comments_example'; // строка
