...
Возвращает: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AddPageAPIResponse.php)

## Пример

[inline-code-attrs-start title = 'Пример addPage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
