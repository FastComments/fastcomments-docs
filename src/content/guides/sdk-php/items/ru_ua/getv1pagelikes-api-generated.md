...
Возвращает: [`GetV1PageLikes`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetV1PageLikes.php)

## Пример

[inline-code-attrs-start title = 'Пример getV1PageLikes'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
