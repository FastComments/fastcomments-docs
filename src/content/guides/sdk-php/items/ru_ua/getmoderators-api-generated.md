...
Возвращает: [`GetModerators200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetModerators200Response.php)
...
// Раскомментируйте ниже, чтобы при необходимости установить префикс (например, Bearer) для API-ключа
