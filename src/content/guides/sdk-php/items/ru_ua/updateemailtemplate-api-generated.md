...
[inline-code-attrs-start title = 'updateEmailTemplate Приклад'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Розкоментуйте нижче, щоб налаштувати префікс (наприк., Bearer) для ключа API, якщо потрібно
