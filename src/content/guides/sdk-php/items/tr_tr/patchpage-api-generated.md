...
Döndürür: [`PatchPageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PatchPageAPIResponse.php)
...
// Gerekirse API anahtarı için öneki (örn. Bearer) ayarlamak üzere aşağıdaki satırın başındaki yorum işaretini kaldırın
