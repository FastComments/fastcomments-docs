...
[inline-code-attrs-start title = 'deleteTenantPackage Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Gerekirse API anahtarı için öneki (ör. Bearer) ayarlamak için aşağıdaki satırın başındaki // işaretini kaldırın
