...
Döndürür: [`GetTenantResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetTenantResponse.php)

## Örnek

[inline-code-attrs-start title = 'getTenant Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Gerekirse, API anahtarı için önek (ör. Bearer) ayarlamak üzere aşağıdakini yorum satırından çıkarın
