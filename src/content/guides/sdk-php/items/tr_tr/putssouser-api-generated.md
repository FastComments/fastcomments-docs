...
Döndürür: [`PutSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PutSSOUserAPIResponse.php)

## Örnek

[inline-code-attrs-start title = 'putSSOUser Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Aşağıdaki satırı yorumdan kaldırarak API anahtarı için (ör. Bearer) önek ayarlayabilirsiniz, gerekirse
