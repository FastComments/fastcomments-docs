...
[inline-code-attrs-start title = 'createUserBadge Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Aşağıdakini kaldırarak API anahtarı için önek (ör. Bearer) ayarlayın, gerekirse
