...
[inline-code-attrs-start title = 'sendLoginLink Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Gerekirse API anahtarı için öneki (örn. Bearer) ayarlamak amacıyla aşağıdaki satırın yorumunu kaldırın
