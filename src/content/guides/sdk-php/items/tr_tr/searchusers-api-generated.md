...
Döndürür: [`SearchUsersResult`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/SearchUsersResult.php)
...
$apiInstance = new FastComments\Client\Api\PublicApi(
    // Özelleştirilmiş bir HTTP istemcisi kullanmak istiyorsanız, `GuzzleHttp\ClientInterface` arabirimini uygulayan istemcinizi geçirin.
