...
[inline-code-attrs-start title = 'deleteModerator Örneği'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Özel bir HTTP istemcusu kullanmak isterseniz, `GuzzleHttp\ClientInterface` uygulayan istemcinizi geçin.
