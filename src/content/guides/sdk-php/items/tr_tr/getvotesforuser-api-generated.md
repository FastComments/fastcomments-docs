...
Döndürür: [`GetVotesForUser200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetVotesForUser200Response.php)
...
// Gerekirse API anahtarına ön ek (ör. Bearer) eklemek için aşağıdaki satırın yorumunu kaldırın
