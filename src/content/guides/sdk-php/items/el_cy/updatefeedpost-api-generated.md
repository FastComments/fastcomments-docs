...
[inline-code-attrs-start title = 'updateFeedPost Παράδειγμα'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Καταργήστε το σχόλιο της παρακάτω γραμμής για να ορίσετε πρόθεμα (π.χ. Bearer) για το κλειδί API, εάν χρειάζεται
