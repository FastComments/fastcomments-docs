...
[inline-code-attrs-start title = 'createCommentPublic Παράδειγμα'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$url_id = 'url_id_example'; // αλφαριθμητικό
$broadcast_id = 'broadcast_id_example'; // αλφαριθμητικό
$comment_data = new \FastComments\Client\Model\CommentData(); // \FastComments\Client\Model\CommentData
$options = [
    'session_id' => 'session_id_example', // αλφαριθμητικό
    'sso' => 'sso_example', // αλφαριθμητικό
];
