...
[inline-code-attrs-start title = 'Παράδειγμα updateQuestionResult'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Αν θέλετε να χρησιμοποιήσετε προσαρμοσμένο http client, περάστε τον client σας ο οποίος υλοποιεί `GuzzleHttp\ClientInterface`.
