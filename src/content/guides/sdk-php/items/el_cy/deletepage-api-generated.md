...
Επιστρέφει: [`DeletePageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/DeletePageAPIResponse.php)

## Παράδειγμα

[inline-code-attrs-start title = 'Παράδειγμα deletePage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
