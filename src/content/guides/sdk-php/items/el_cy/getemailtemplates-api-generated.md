...
[inline-code-attrs-start title = 'getEmailTemplates Παράδειγμα'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Αποσχολιασμός παρακάτω για ρύθμιση προθέματος (π.χ. Bearer) για το κλειδί API, αν χρειαστεί
