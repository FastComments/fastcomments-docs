...
[inline-code-attrs-start title = 'Esempio getTranslations'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$namespace = 'namespace_example'; // stringa
$component = 'component_example'; // stringa
$options = [
