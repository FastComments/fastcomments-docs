...
[inline-code-attrs-start title = 'Esempio di createQuestionResult'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Decommenta le righe sottostanti per impostare il prefisso (es. Bearer) per la chiave API, se necessario
