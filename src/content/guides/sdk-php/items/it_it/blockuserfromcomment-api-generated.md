...
[inline-code-attrs-start title = 'Esempio di blockUserFromComment'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Rimuovi il commento dalla riga sottostante per impostare un prefisso (es. Bearer) per la API key, se necessario
