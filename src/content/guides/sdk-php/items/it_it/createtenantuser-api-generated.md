...
Restituisce: [`CreateTenantUserResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantUserResponse.php)

## Esempio

[inline-code-attrs-start title = 'Esempio createTenantUser'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Decommenta sotto per impostare un prefisso (es. Bearer) per la chiave API, se necessario
