...
[inline-code-attrs-start title = 'Esempio di deleteTenantPackage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Questo è opzionale, verrà usato `GuzzleHttp\Client` come client predefinito.
