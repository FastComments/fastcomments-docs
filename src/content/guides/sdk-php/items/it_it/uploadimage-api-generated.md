...
[inline-code-attrs-start title = 'Esempio uploadImage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$options = [
    ...
    'url_id' => 'url_id_example', // string | ID della pagina da cui avviene il caricamento, da configurare
];
