...
[inline-code-attrs-start title = 'Ejemplo de sendInvite'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Excepción al llamar DefaultApi->sendInvite: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]