...
[inline-code-attrs-start title = 'Ejemplo deleteQuestionConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
require_once(__DIR__ . '/vendor/autoload.php');

// Configura la autorización de la clave API: api_key
// Descomenta la línea siguiente para configurar el prefijo (p. ej., Bearer) para la clave API, si es necesario
