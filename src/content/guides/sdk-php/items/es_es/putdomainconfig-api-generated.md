...
[inline-code-attrs-start title = 'Ejemplo de putDomainConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Descomente lo siguiente para establecer un prefijo (por ejemplo Bearer) para la clave API, si es necesario
