...
[inline-code-attrs-start title = 'Ejemplo getPageByURLId'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// Descomenta a continuación para configurar el prefijo (p.ej., Bearer) de la clave API, si es necesario
