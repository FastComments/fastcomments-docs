...
[inline-code-attrs-start title = 'דוגמה של addHashTag'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // אם תרצה להשתמש ב‑client HTTP מותאם, העבר את ה‑client שלך שממומש `GuzzleHttp\ClientInterface`.
