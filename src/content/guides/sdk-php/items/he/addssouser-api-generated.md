...
מחזירה: [`AddSSOUserAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AddSSOUserAPIResponse.php)

## דוגמה

[inline-code-attrs-start title = 'דוגמה של addSSOUser'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // אם ברצונך להשתמש ב‑client HTTP מותאם, העבר את ה‑client שלך שמיישם `GuzzleHttp\ClientInterface`.
