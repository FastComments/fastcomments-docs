...
[inline-code-attrs-start title = 'דוגמת getVotesForUser'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// בטל את ההערה שלמטה כדי להגדיר קידומת (למשל Bearer) למפתח API, אם נדרש
