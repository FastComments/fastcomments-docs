...
[inline-code-attrs-start title = 'דוגמת getUserBadgeProgressByUserId'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// בטל את השורה למטה אם צריך להגדיר קידומת (לדוגמה Bearer) למפתח ה‑API
