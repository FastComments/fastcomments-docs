...
[inline-code-attrs-start title = 'דוגמת getComments'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // אם ברצונך להשתמש ב‑client HTTP מותאם, העבר את ה‑client שלך שמימש `GuzzleHttp\ClientInterface`.
...
$options = [
    ...
    'context_user_id' => 'context_user_id_example', // מחרוזת
    'hash_tag' => 'hash_tag_example', // מחרוזת
