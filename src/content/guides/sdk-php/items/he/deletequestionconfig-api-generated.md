...
[inline-code-attrs-start title = 'דוגמה ל-deleteQuestionConfig'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // אם ברצונך להשתמש ב-client HTTP מותאם אישית, העבר את ה-client שלך שמיישם את `GuzzleHttp\ClientInterface`.
