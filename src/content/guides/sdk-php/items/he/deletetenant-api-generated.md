...
[inline-code-attrs-start title = 'דוגמה ל-deleteTenant'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // זה אופציונלי — ברירת המחדל היא שימוש ב-`GuzzleHttp\Client`.
