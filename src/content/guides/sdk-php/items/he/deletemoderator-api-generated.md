...
[inline-code-attrs-start title = 'דוגמה של deleteModerator'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// בטל את ההערה למטה כדי להגדיר קידומת (לדוגמה Bearer) למפתח ה-API, במידת הצורך
