...
מחזיר: [`AddPageAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AddPageAPIResponse.php)

## Example

[inline-code-attrs-start title = 'דוגמת addPage'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
