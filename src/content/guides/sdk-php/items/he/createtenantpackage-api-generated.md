...
מחזיר: [`CreateTenantPackageResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CreateTenantPackageResponse.php)

## דוגמה

[inline-code-attrs-start title = 'createTenantPackage דוגמה'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
// בטל את ההערה למטה כדי להגדיר קידומת (לדוגמא Bearer) למפתח API, אם נדרש
