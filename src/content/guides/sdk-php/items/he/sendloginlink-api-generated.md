...
[inline-code-attrs-start title = 'דוגמה ל-sendLoginLink'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // אם ברצונך להשתמש ב-cliet HTTP מותאם אישית, העבר לקוח שמממש את `GuzzleHttp\ClientInterface`.
