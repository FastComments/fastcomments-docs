...
[inline-code-attrs-start title = 'דוגמת putCloseThread'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\ModerationApi(
    // אם ברצונך להשתמש ב‑לקוח HTTP מותאם, העבר את ה‑לקוח שלך המממש `GuzzleHttp\ClientInterface`.
