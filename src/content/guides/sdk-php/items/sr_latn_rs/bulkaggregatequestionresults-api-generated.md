...
Vraća: [`BulkAggregateQuestionResults200Response`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/BulkAggregateQuestionResults200Response.php)
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ako želite da koristite prilagođeni HTTP klijent, prosledite instancu klijenta koja implementira `GuzzleHttp\ClientInterface`.
