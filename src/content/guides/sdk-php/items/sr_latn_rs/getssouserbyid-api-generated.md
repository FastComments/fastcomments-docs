...
Vraća: [`GetSSOUserByIdAPIResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/GetSSOUserByIdAPIResponse.php)

## Primer

[inline-code-attrs-start title = 'getSSOUserById Primer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    ...
    // Ovo je opciono, podrazumevani klijent će biti `GuzzleHttp\Client`.
