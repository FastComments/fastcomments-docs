...
[inline-code-attrs-start title = 'deleteQuestionConfig Primer'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Ako želite da koristite sopstveni http klijent, prosledite svoj klijent koji implementira `GuzzleHttp\ClientInterface`.
