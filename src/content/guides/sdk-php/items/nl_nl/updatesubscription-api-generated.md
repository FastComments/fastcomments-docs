...
// Haal de onderliggende regel weg om een prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
// $config = FastComments\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('x-api-key', 'Bearer');


$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Als je een aangepaste http-client wilt gebruiken, geef je jouw client mee die `GuzzleHttp\ClientInterface` implementeert.
...
try {
    ...
    echo 'Exceptie bij het aanroepen DefaultApi->updateSubscription: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]
