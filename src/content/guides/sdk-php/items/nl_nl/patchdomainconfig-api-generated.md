...
Retourneert: [`PatchDomainConfigResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/PatchDomainConfigResponse.php)
...
// Configureren van API-sleutel autorisatie: api_key
