...
Retourneert: [`APIGetCommentResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/APIGetCommentResponse.php)
...
// Ontcomment de onderstaande om een prefix (bijv. Bearer) voor de API-sleutel in te stellen, indien nodig
