...
| commentIds | string | query | Ja | Een door komma's gescheiden lijst van comment ids. |
| sso | string | query | Nee |  |

## Response

Retourneert: [`CheckBlockedCommentsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/CheckBlockedCommentsResponse.php)
...
$comment_ids = 'comment_ids_example'; // string | Een door komma's gescheiden lijst van comment ids.
