Aggegreert documenten door ze te groeperen (als groupBy is opgegeven) en meerdere bewerkingen toe te passen.
...
Retourneert: [`AggregateResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/AggregateResponse.php)

## Voorbeeld

[inline-code-attrs-start title = 'aggregate Voorbeeld'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
