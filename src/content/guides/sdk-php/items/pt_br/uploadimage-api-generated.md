...
| urlId | string | query | No | ID da página de onde o upload está ocorrendo, para configuração |
...
$options = [
    ...
    'url_id' => 'url_id_example', // string | ID da página de onde o upload está ocorrendo, para configuração
];
