...
[inline-code-attrs-start title = 'Exemplo de deleteTenant'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
$apiInstance = new FastComments\Client\Api\DefaultApi(
    // Se desejar usar um cliente HTTP customizado, passe seu cliente que implemente `GuzzleHttp\ClientInterface`.
