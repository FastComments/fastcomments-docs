Enable ou desativar notificações para uma página. Quando os usuários estão assinados a uma página, notificações são criadas para novos comentários raiz, e também
