...
Retorna: [`ModerationAPIGetCommentsResponse`](https://github.com/FastComments/fastcomments-php/blob/main/lib/Model/ModerationAPIGetCommentsResponse.php)

## Exemplo

[inline-code-attrs-start title = 'Exemplo getApiComments'; type = 'php'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<?php
...
try {
    ...
    echo 'Exceção ao chamar ModerationApi->getApiComments: ', $e->getMessage(), PHP_EOL;
}
[inline-code-end]