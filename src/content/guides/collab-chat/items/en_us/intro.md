...
Note that these docs are specific to the **Collab Chat** functionality. You can add commenting for content with lots of pages, like Books, with
thread-per-page, **without using collab chat**. FastComments also does not charge per-page or per-thread. Collab Chat is specifically when you
want to allow users to select text and comment on the highlighted section of text.

You can see [an example here](https://fastcomments.com/product/collab-chat).
