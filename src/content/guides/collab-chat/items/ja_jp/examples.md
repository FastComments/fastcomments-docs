...
[inline-code-attrs-start title = '基本的な Collab Chat の例'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
<!DOCTYPE html>
<html>
<head>
...
[inline-code-attrs-start title = 'カスタム URL ID を使用した Collab Chat'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<script src="https://cdn.fastcomments.com/js/embed-collab-chat.min.js"></script>
<script>
    FastCommentsCollabChat(document.getElementById('article-content'), {
...
[inline-code-attrs-start title = 'ダークモードの Collab Chat'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
<!DOCTYPE html>
<html>
<head>
...
[inline-code-attrs-start title = 'トップバーを無効にした Collab Chat'; type = 'html'; isFunctional = true; inline-code-attrs-end]
[inline-code-start]
<!DOCTYPE html>
<html>
<head>
...
[inline-code-attrs-start title = 'コメント数コールバックの Collab Chat'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
<script src="https://cdn.fastcomments.com/js/embed-collab-chat.min.js"></script>
<script>
    FastCommentsCollabChat(document.getElementById('article-content'), {
...
[inline-code-attrs-start title = '複数セクションでの Collab Chat'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
