...
[inline-code-attrs-start title = 'GET Request Example'; type = 'bash'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'POST Request Example'; type = 'bash'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'DELETE Request Example'; type = 'bash'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
[inline-code-attrs-start title = 'Error Response Example'; type = 'json'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
{
  "status": "error",
