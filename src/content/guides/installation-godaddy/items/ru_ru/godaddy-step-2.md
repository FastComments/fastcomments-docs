...
**Используйте следующий код для Godaddy, не код из других руководств. Этот код специфичен для Godaddy.**

Скопируйте следующий код:

[inline-code-attrs-start title = 'Фрагмент кода комментариев Godaddy'; type = 'html'; isFunctional = false; inline-code-attrs-end]
[inline-code-start]
...
Этот конкретный фрагмент кода разработан для совместимости с Godaddy и будет отображаться только в ваших записях блога, а не на главной странице.

Теперь вставьте код в область `Custom Code`, указанную в `Step One`.
