...
Il est important d'utiliser le code ci-dessus et non les extraits de code d'autres documentations, car ce fragment a été conçu spécifiquement
pour Hostinger.

Vous devriez maintenant avoir quelque chose de ressemblant à ce qui suit, qui semble vide. C'est normal. Déplacez votre souris sur la zone
où le widget devrait se trouver :
...
Faites maintenant glisser le widget à la taille désirée, vous le verrez apparaître :
