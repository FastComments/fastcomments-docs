...
You can see it in action at the bottom right of this page!

### Note!

These instructions are for the Hostinger Site Builder. If you're using Hostinger *WordPress*, just copy the code below and add it to your WordPress site
...
6. You won't see the widget in preview mode; it will appear on the published site.
