...
If you don't already have a section where you want the comments to go, add a blank section:
...
Now add the Hostinger Embed widget by clicking our new section and clicking `Add element` at the top and then `Embed code`:
